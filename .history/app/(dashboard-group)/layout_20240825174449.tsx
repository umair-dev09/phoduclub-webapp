    ...
    return (
        <div className="body">    {/*THIS MAIN CONTAINER*/}
            <div className="tabs">  {/*THIS IS NAVIGATION BAR*/}
                ...
                <div className="dashboard" onClick={() => setCurrentContent('dashboard')}>dashboard</div>
                <div className="learn" onClick={() => setCurrentContent('learn')}>learn</div>
                <div className="communities" onClick={() => setCurrentContent('communities')}>communities</div>
                <div className="analytics" onClick={() => setCurrentContent('analytics')}>analytics</div>
                <div className="settings" onClick={() => setCurrentContent('settings')}>settings</div>
