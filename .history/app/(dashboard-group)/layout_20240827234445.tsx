    ...
    return (
        <div className="body">
            <div className="side_bar">
                <button onClick={toggleSidebarCollapseHandler} className={isCollapsedSidebar ? 'rotate' : ''}>
                ...
                <div className="content-box">
                    <div className="headtab">
                        <div className="greeting">
                            <span id="Head-text">{getHeaderText()}</span>
                        </div>
    ...
    const getHeaderText = () => {
        switch (pathname) {
            case '/dashboard':
                        ...
                        return (
                        <div className="body">
                            <div className={`side_bar ${isCollapsedSidebar ? 'collapsed' : ''}`}>
                                <button onClick={toggleSidebarCollapseHandler} className="toggle-button">
                                    <div className="sidebar-icon">{isCollapsedSidebar ? '>' : '<'}</div>
                                </button>
