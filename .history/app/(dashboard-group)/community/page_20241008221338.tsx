...
const CommunityPage = () => {
    ...
    const adjustTextareaHeight = () => {
        ...
        if (textarea) {
            ...
            textarea.style.height = `${Math.min(textarea.scrollHeight, 52)}px`; // Set height based on scrollHeight
        }
    };
            ...
            <div className='flex flex-1 flex-col border-t border-r border-b border-lightGrey h-auto'>
                ...
                <div className="flex flex-row items-center justify-center h-auto bg-[#FFFFFF] gap-3 py-4">
                    <div
                        ...
                        style={{ minHeight: '52px', maxHeight: '52px' }} // Set minHeight to 52px and maxHeight to 150px
                    >
                        <textarea
                            ref={textareaRef}
                            value={text}
                            ...
                            className="outline-none placeholder-[#667085] font-normal w-full bg-[#FCFCFD] resize-none py-2"
