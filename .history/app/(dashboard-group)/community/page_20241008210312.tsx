        ...
        <div className='flex flex-1 flex-row'>
            ...
            <div className='flex flex-1 flex-col border-t border-r border-b border-lightGrey h-auto'>
                ...
                <div className="flex flex-row items-center justify-center h-auto bg-[#FFFFFF] gap-3 py-8">
                    <div
                        className="flex flex-row justify-between w-full ml-6 px-4 gap-2 bg-[#FFFFFF] border border-[#D0D5DD] rounded-[9px] overflow-hidden"
                    ...
                    <div className="mr-6">
                        <Image
                            src={isButtonDisabled ? '/icons/sendCommunity.svg' : '/icons/send.svg'} // Use the disabled icon when the button is disabled
                            alt='send icon'
                            width={24}
                            height={24}
                            className={isButtonDisabled ? 'opacity-50' : 'opacity-100'} // Optional: Change opacity for a disabled look
                            style={{ cursor: isButtonDisabled ? 'not-allowed' : 'pointer' }} // Change cursor to not-allowed when disabled
                        />
                    </div>
                </div>
