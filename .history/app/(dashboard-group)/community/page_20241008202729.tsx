    ...
    return (
        <div className='flex flex-1 flex-row'>
            ...
            <div className='flex flex-1 flex-col border-t border-r border-b border-lightGrey h-auto'>
                ...
                <div className='flex flex-row items-center justify-center h-auto bg-red-500 gap-3'> <div className='flex flex-row justify-between w-full h-auto ml-6 px-4 py-[0.625rem] gap-2 bg-green-300 border border-[#D0D5DD] rounded-[9px]'> <div className='w-full h-auto '> <textarea placeholder='Type your message here...' className='outline-none placeholder-[#667085] font-normal w-full bg-[#FCFCFD] max-h-[150px] resize-none overflow-auto' style={{ maxHeight: '150px', minHeight: '40px' }} // Set min height for initial display rows={1} // Initial display of one line /> </div> <div className='flex flex-row gap-3'> <Image src='/icons/emojies.svg' alt='emojies icon' width={20} height={20} /> <Image src='/icons/files.svg' alt='files icon' width={20} height={20} /> </div> </div> <div className='mr-6'> <Image src='/icons/send.svg' alt='files icon' width={24} height={24} /> </div> </div>
