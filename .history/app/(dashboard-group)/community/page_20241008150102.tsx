    ...
    return (
        <div className='flex flex-1 flex-row'>
            ...
            <div className='flex flex-1 flex-col border-t border-r border-b border-lightGrey'>
                {/* Fixed Header - Physics 101 */}
                <div className='flex items-center justify-between h-[72px] bg-white border-b border-lightGrey fixed w-[calc(100%-270px)] z-10'>
                ...
                {/* Content Section with margin to avoid overlapping */}
                <div className='flex flex-1 mt-[72px]'></div>

                {/* Fixed Message Input Section */}
                <div className='flex flex-row items-center justify-center h-[100px] bg-white gap-3 fixed bottom-0 w-[calc(100%-270px)] z-10'>
            ...
            <div className='flex flex-col w-[270px] bg-red-700 border-t border-r border-b border-lightGrey'>
                ...
                >
                    <div className='h-[72px] border-b border-lightGrey bg-slate-800'></div>
                    <div className='bg-emerald-500 h-full flex-1 flex'>Drawer Content</div>
                </Drawer>
            </div>
        </div>
    );
