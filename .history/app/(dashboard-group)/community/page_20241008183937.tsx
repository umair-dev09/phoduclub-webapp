                    ...
                    <div className='flex flex-row justify-between w-full h-auto ml-6 px-4 py-[0.625rem] gap-2 bg-[#FCFCFD] border border-[#D0D5DD] rounded-[9px]'>
                        <div className='w-full'>
                            <textarea
                                ...
                                className='outline-none placeholder-[#667085] font-normal w-full bg-[#FCFCFD] max-h-[150px] min-h-[40px] resize-none overflow-y-auto'
                                style={{
                                    lineHeight: '3.5', // Adjust line height for better spacing between lines
                                }}
                            />
                        </div>
