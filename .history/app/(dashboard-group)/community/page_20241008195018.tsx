...
const page = () => {
    ...
    return (
        <div className='flex flex-1 flex-row'>
            ...
            {!isCollapsed && (
                <div
                    className={`w-[270px] h-full overerflow-y-hidden bg-[#FFFFFF] border-t border-r border-b border-lightGrey overflow-hidden transition-all duration-300 ease-in-out ${isCollapsed ? 'max-h-0 opacity-0' : 'max-h-[500px] opacity-100'}`}
                >
                    <div className='flex items-center justify-center h-[72px] border-b border-lightGrey'>
