        ...
        <div className='flex flex-1 flex-row'>
            ...
            <div className='flex flex-1 flex-col border-t border-r border-b border-lightGrey'>
                ...
                <div className='flex flex-row items-center justify-center h-[100px] bg-white gap-3'>
                    <div className='flex flex-row justify-between items-center w-full h-[52px] ml-6 px-4 py-[0.625rem] gap-2 bg-[#FCFCFD] border border-[#D0D5DD] rounded-[9px]'>
                        <div className='w-full'>
                            <textarea
                                ...
                                className='outline-none placeholder-[#667085] font-normal w-full bg-[#FCFCFD] max-h-[150px] resize-none overflow-y-auto'
                                style={{
