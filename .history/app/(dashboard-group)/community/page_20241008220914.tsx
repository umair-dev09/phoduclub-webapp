        ...
        <div className='flex flex-1 flex-row'>
            ...
            <div className='flex flex-1 flex-col border-t border-r border-b border-lightGrey h-auto'>
                ...
                <div className="flex flex-row items-center justify-center h-auto bg-[#FFFFFF] gap-3 py-8">
                    <div
                        className={`flex flex-row justify-between w-full ml-6 px-4  bg-[#FFFFFF] 
                              border ${text.trim() ? 'border-[#D6BBFB]' : 'border-[#D0D5DD]'} rounded-[9px] overflow-hidden`}
                        style={{ minHeight: '10px', maxHeight: '150px' }} // Set minHeight to 52px and maxHeight to 150px
                    >
                        <textarea
                            ref={textareaRef}
                            value={text}
            ...
            {!isCollapsed && (
                <div className={` h-auto  bg-red-600'transition-all duration-300 ease-in-out overflow-y-auto ${isCollapsed ? 'max-h-0 opacity-0' : 'max-h-[500px] opacity-100'}`}>
