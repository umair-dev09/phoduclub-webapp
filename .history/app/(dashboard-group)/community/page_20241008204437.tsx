        ...
        <div className='flex flex-1 flex-row'>
            ...
            <div className='flex flex-1 flex-col border-t border-r border-b border-lightGrey h-auto'>
                ...
                <div className="flex flex-row items-center justify-center h-auto bg-[#FFFFFF] gap-3 py-8">
                    <div
                        className="flex flex-row justify-between w-full ml-6 px-4   gap-2 bg-slate-500 border border-[#D0D5DD] rounded-[9px]"
                    ...
                    >
                        ...
                        <textarea
                            ...
                            className="outline-none placeholder-[#667085] font-normal w-full bg-[#FCFCFD] resize-none overflow-hidden pt-2"
