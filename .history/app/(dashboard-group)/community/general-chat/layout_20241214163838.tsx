                        ...
                        <PopoverContent className='flex flex-col bg-white w-auto h-auto py-1 px-0 border border-lightGrey rounded-md shadow-md'>
                            ...
                            >
                                ...
                                <PopoverContent className="flex flex-col w-32 h-auto bg-white border border-lightGrey rounded-md py-1 px-0">
                                    {!isMuted && (
                                        <>
                                            <button onClick={() => { toggleMute(); closeBothPopovers(); }} className='text-sm text-[#0C111D] text-start w-ful py-[10px] hover:bg-[#F2F4F7]'>For 8 hours</button>
                                            <button onClick={() => { toggleMute(); closeBothPopovers(); }} className='text-sm text-[#0C111D] text-start  py-[10px] hover:bg-[#F2F4F7]'>For 1 week</button>
                                            <button onClick={() => { toggleMute(); closeBothPopovers(); }} className='text-sm text-[#0C111D] text-start  py-[10px] hover:bg-[#F2F4F7]'>Always</button>
                                        </>
                                    )}
