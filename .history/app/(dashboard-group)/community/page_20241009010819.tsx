...
const CommunityPage = () => {
    const [isCollapsed, setIsCollapsed] = useState(false);  // For collapse toggle
    ...
    return (
        <div className='flex flex-1 flex-row'>
            ...
            <div className='flex flex-1 flex-col border-t border-r border-b border-lightGrey h-auto'>
                ...
                {!isCollapsed && (
                    <div className={`transition-all ${isCollapsed ? 'max-h-0 opacity-0' : 'max-h-[500px] opacity-100'}`}>
                        <div className='flex items-center justify-center h-[72px] border-b border-lightGrey'>
