    ...
    return (
        <div className='flex flex-1 flex-row'>
            ...
            <div className='flex flex-1 flex-col border-t border-r border-b border-lightGrey h-auto'>
                ...
                <div className="flex flex-row items-center justify-center h-auto bg-red-500 gap-3">
                    <div
                        className="flex flex-row justify-between w-full ml-6 px-4 py-2 gap-2 bg-green-300 border border-[#D0D5DD] rounded-[9px]"
                        style={{ minHeight: '52px', maxHeight: '150px', overflowY: 'hidden' }} // Set minHeight to 52px
                    >
                        <div className="w-full h-auto">
                            <textarea
                                ...
                                className="outline-none placeholder-[#667085] font-normal w-full bg-[#FCFCFD] resize-none overflow-hidden"
                                style={{ minHeight: '40px' }} // Keep this for textarea
                            />
                        </div>
                        <div className="flex flex-row gap-3">
                            <img src="/api/placeholder/20/20" alt="emojies icon" width="20" height="20" />
                            <img src="/api/placeholder/20/20" alt="files icon" width="20" height="20" />
                        </div>
                    </div>
                    <div className="mr-6">
                        <img src="/api/placeholder/24/24" alt="send icon" width="24" height="24" />
                    </div>
                </div>
