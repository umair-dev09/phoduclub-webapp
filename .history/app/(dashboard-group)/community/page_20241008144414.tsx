...
const Page = () => {
    const [isOpen, setIsOpen] = useState(true); // Drawer is open by default
    const [isCollapsed, setIsCollapsed] = useState(false); // Manage icon rotation

    // Function to toggle drawer
    const toggleDrawer = () => {
        setIsOpen(!isOpen); // Toggle drawer open/close state
        setIsCollapsed(!isCollapsed); // Toggle icon rotation state
    };
    ...
    return (
        <div className="flex flex-1 flex-row">
                ...
                <div className="flex items-center justify-between h-[72px] bg-white border-b border-lightGrey">
                    ...
                    <div className="flex flex-row mr-6 gap-4">
                        ...
                        <button onClick={toggleDrawer}>
                            {/* Rotate icon when drawer is collapsed */}
                            <Image
            ...
            {/* Drawer Section */}
            <Drawer
                open={isOpen} // Manage drawer state with isOpen
                direction="right"
                onClose={toggleDrawer} // Toggle drawer on button click
