        ...
        <div className='flex flex-1 flex-row'>
            ...
            <div className='flex flex-1 flex-col border-t border-r border-b border-lightGrey h-auto'>
                ...
                <div className="flex flex-row items-center justify-center h-auto bg-[#FFFFFF] gap-3 py-8">
                    <div
                        className="flex flex-row justify-between w-full ml-6 px-4 gap-2 bg-red-500 border border-[#D0D5DD] rounded-[9px] overflow-y-auto" // Changed to overflow-y-auto
                        style={{ minHeight: '52px', maxHeight: '100px' }} // Set minHeight to 52px and maxHeight to 100px
                    >
                        <textarea
                            ref={textareaRef}
                            value={text}
                            ...
                            style={{ minHeight: '40px', maxHeight: '100px', overflowY: 'hidden' }} // Keep textarea height adjustable, but hide overflow
                        />
