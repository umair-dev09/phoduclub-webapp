            ...
            <div className="tabs" data-collapse={isCollapsedSidebar}>
                ...
                <div className={`dashboard ${pathname === '/dashboard' ? 'active' : ''}`}>
                    <Image
                        ...
                        height={20}
                    />
                    <Link href="/dashboard" className="tab-text">Dashboard</Link>
                </div>
                ...
                <div className={`learn ${pathname === '/learn' ? 'active' : ''}`}>
                    <Image
                        ...
                        alt="Learn Icon"
                    />
                    <Link href="/learn" className="tab-text">Learn</Link>
                </div>
                ...
                <div className={`communities ${pathname === '/community' ? 'active' : ''}`}>
                    <Image
                        ...
                        alt="Community Icon"
                    />
                    <Link href="/community" className="tab-text">Community</Link>
                </div>
                ...
                <div className={`analytics ${pathname === '/analytics' ? 'active' : ''}`}>
                    <Image
                        ...
                        alt="Analytics Icon"
                    />
                    <Link href="/analytics" className="tab-text">Analytics</Link>
                </div>
                ...
                <div className={`settings ${pathname === '/settings' ? 'active' : ''}`}>
                    <Image
                        ...
                        alt="Settings Icon"
                    />
                    <Link href="/settings" className="tab-text">Settings</Link>
                </div>
            </div>
