                    ...
                    <div className="w-[264px] h-[204px] rounded-[12px] border border-solid border-[#EAECF0] bg-[#FFFFFF]">
                        <div className="h-[156px] m-5 flex flex-col space-y-6">
                            <div className="h-[46px] flex flex-col">
                                ...
                                <span className="font-normal text-[12px] text-[#667085] ">5 Tests</span>
                            </div>
                ...
                <div className="w-[264px] h-[204px] rounded-[12px] border border-solid border-[#EAECF0] bg-[#FFFFFF]">
                    <div className="h-[156px] m-5 flex flex-col space-y-6">
                        <div className="h-[46px] flex flex-col">
                            ...
                            <span className="font-normal text-[12px] text-[#667085] mt-1">10 Tests</span>
                        </div>
                ...
                <div className="w-[264px] h-[204px] rounded-[12px] border border-solid border-[#EAECF0] bg-[#FFFFFF]">
                    <div className="h-[156px] m-5 flex flex-col space-y-6">
                        <div className="h-[46px] flex flex-col">
                            ...
                            <span className="font-normal text-[12px] text-[#667085] mt-1">5 Tests</span>
                        </div>
