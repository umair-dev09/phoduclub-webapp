        ...
        <div className="contianer flex flex-1 flex-col">
            ...
            <div className=" h-[204px] ml-8 mr-8 gap-4 flex flex-row">
                <div className="w-[264px] h-[204px] rounded-[12px] border border-solid border-[#EAECF0] bg-[#FFFFFF]">
                    <div className="h-[156px] m-6 flex flex-col gap-6">
                        ...
                        <div className="h-[44px] flex flex-col gap-2">
                            <div className="flex justify-between h-[24px] bg-slate-100">
                                <span>jabir</span>
                                <span>svcwe</span>
                            </div>
                        ...
                        <div className="flex justify-between">
                            <div className="flex relative w-full h-2 rounded-full bg-gray-200">
                                <div
                                    className="absolute top-0 left-0 h-3 rounded-full bg-progressPurple"
