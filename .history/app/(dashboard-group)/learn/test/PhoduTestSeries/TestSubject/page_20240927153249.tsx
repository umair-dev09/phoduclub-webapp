...
export default function TestSubject() {
    ...
    return (
        <div className="contianer flex flex-1 flex-col">
            ...
            {/* --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */}
            {/* Test Accordion */}
            <div className="h-auto ml-8 mr-8 rounded-[12px] border border-solid border-[#EAECF0] bg-[#FFFFFF]">
                <div className="h-[46px] m-2 flex justify-between">
                    ...
                    {accordionOpen ? (
                        <>
                            <button
                                className="flex  justify-between  ml-76" onClick={() => toggleCollapse(1)}>
                                <Image src={collapsed[1] ? "/icons/arrowdown.svg" : "/icons/arrowup.svg"} alt="arrow" width={24} height={24} className="" />
                            </button>
                                ...
                                <div className="flex flex-col mx-1">
                                    <div className="mx-5 my-5">
                                        ...
                                        <div className="flex flex-row text-sm font-normal">
                                            <Image src="/icons/read.svg" alt="test-icon" width={16} height={16} />
                                            <span>10:00</span>
                                        </div>
                                    </div>
                                    <div className="mx-5 my-5">
                                        <div className="text-base font-medium">2. Test Content</div>
                                        <div className="flex flex-row text-sm font-normal">
                                            <Image src="/icons/test.svg" alt="video-icon" width={16} height={16} />
                                            <span>10:00</span>
                                        </div>
                                    </div>
                                    <div className="mx-5 my-5">
                                        <div className="text-base font-medium">3. Test Summary</div>
                                        <div className="flex flex-row text-sm font-normal">
                                            <Image src="/icons/vedio.svg" alt="video-icon" width={16} height={16} />
                                            <span>10:00</span>
                                        </div>
                                    </div>
                                </div>
