        ...
        <div className="contianer flex flex-1 flex-col">
            ...
            <div className="h-[78px] ml-8 mr-8 rounded-[12px] border border-solid border-[#EAECF0] bg-[#FFFFFF]">
                <div className="h-[46] m-2 flex justify-between">
                    ...
                    <button onClick={toggleAccordion} className="mt-3 mr-2 flex items-center justify-center w-[116px] h-[36px] rounded-[6px] bg-[#9012FF] border border-solid border-[#800EE2] shadow-inner-button">
                ...
                {isAccordionOpen && (
                    <div className="ml-3 mt-2">
                        <p className="text-sm text-[#667085]">This test consists of 50 questions and has a time limit of 2 hours.</p>
                        <button
                            onClick={onStartQuiz}
                            className="mt-3 flex items-center justify-center w-[116px] h-[36px] rounded-[6px] bg-[#8501FF] border border-solid border-[#800EE2] shadow-inner-button"
                        >
