        ...
        <div className="contianer flex flex-1 flex-col">
            ...
            <Dialog open={showQuizDialog} onClose={() => setShowQuizDialog(false)} className="relative z-50">
                ...
                <div className="fixed inset-0 flex items-center justify-center ">
                    <DialogPanel transition className="bg-[#FFFFFF] rounded-2xl p-5 w-[480px] h-[306px] ">
                        {/* Header Section */}
                        ...
                        <div className=" flex flex-1 h-[230px] w-[480px] bg-red-500 border-b border-solid border-[#EAECF0] rounded-[12px]">
