                    ...
                    {!collapsed[1] && (
                        <div className="h-[240px] w-[1072px]">
                            <div className=" h-[129px] gap-[10px] bg-[#FFFFFF] ml-5 mr-5 w-[1072px]">
                                <div className="bg-[#FFFFFF] h-[50px] gap-[116px]  w-[1072px] mr-5 flex flex-row">
                                    <div className="flex flex-col w-[310px]  bg-red-900">
                                        <span>Attempted Questions</span>
                                        <span>8/50</span>

                                    </div>
                                    <div className="flex flex-col w-[310px]  bg-slate-600">
                                        <span>Score</span>
                                        <span>32</span>

                                    </div>
                                    <div className="flex flex-col w-[310px] bg-gray-200">
                                        <span>Acurracy</span>
                                        <span>80%</span>
