                    ...
                    >
                        ...
                        {!collapsed[1] && (
                            <div className="h-[180px] ">
                                <div className=" h-[129px]  bg-[#FFFFFF] ml-5 mr-5 border-t border-b border-solid border-[#EAECF0] ">
                                ...
                                <div className="h-[51px] ml-5 mr-5 justify-between flex " >
                            ...
                            <div>
                                ...
                                >
                                    <Image
                                        ...
                                        width={24}
                                        height={24}
                                        className="transition-transform duration-200" // Add a transition for smoothness
                                    />
                                </button>

                                {/* Additional Divs - only shown when arrow is displayed */}
                                <div className="mr-3">
                                    <span className="font-medium text-[14px] text-[#FCFCFD]">Additional Action 1</span>
                                </div>
                                <div>
                                    <span className="font-medium text-[14px] text-[#FCFCFD]">Additional Action 2</span>
                                </div>
                            </div>
                        )}
                    </div>
