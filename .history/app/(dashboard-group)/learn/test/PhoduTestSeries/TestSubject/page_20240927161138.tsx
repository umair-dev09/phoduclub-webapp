...
export default function TestSubject() {
    ...
    return (
        <div className="contianer flex flex-1 flex-col">
            ...
            {/* --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */}
            {/* Test Accordion  1*/}
            <div className="TEST CONTAINER ml-8 mr-8 rounded-[12px] border border-solid border-[#EAECF0] bg-[#FFFFFF] h-[12px]">
                <div className="h-[46px] m-2 flex justify-between items-center">
                    ...
                    <button
                        ...
                        onClick={() => toggleCollapse(1)} // Ensure this correctly toggles the state
                    >
                        <Image
