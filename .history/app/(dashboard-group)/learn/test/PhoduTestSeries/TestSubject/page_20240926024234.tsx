    ...
    return (
        <div className="contianer flex flex-1 flex-col">
            ...
            <div className=" h-[81px] ml-8 mr-8   rounded-[12px] border border-solid border-[#EAECF0] bg-[#FFFFFF]">
                <div className="h-[49px]  m-4 flex flex-row">
                    <div className="w-[178.69px] h-[49px] flex flex-col gap-[6px] border-r border-solid border-[#EAECF0]">
                    ...
                    <div className="w-[178.69px] h-[49px] flex flex-col gap-[6px] ">
                        <span className="font-normal text-[#667085] text-xs">Attempted Questions</span>
                        <span className="font-semibold text-[#1D2939] text-base">8/150</span>
