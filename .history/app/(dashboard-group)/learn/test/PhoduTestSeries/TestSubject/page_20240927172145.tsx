        ...
        <div className="contianer flex flex-1 flex-col">
            ...
            <div className="TEST CONTAINER ml-8 mr-8 rounded-[12px] border border-solid border-[#EAECF0] bg-[#FFFFFF] ">
                ...
                >
                    ...
                    {!collapsed[1] && (
                        <div className="h-[240px] w-[1072px]">
                            <div className=" h-[129px] gap-[10px] bg-[#FFFFFF] ml-5 mr-5 w-[1072px]">
                                <div className="bg-[#FFFFFF] h-[50px] w-[1072px] mr-5 flex justify-between items-center"> {/* Added justify-between for spacing */}
                                    <div className="flex flex-col w-[280px] bg-red-900">
                                        <span>Attempted Questions</span>
                                        <span>8/50</span>
                                    </div>

                                    <div className="jabir flex flex-col w-[280px] bg-slate-600 mx-[116px]"> {/* Jabir div with horizontal margin */}
                                        <span>Score</span>
                                        <span>32</span>
                                    </div>

                                    <div className="flex flex-col w-[280px] bg-gray-200">
                                        <span>Accuracy</span>
                                        <span>80%</span>
                                    </div>
                                </div>

                                <div className="bg-[#FFFFFF] h-[50px] ">
