        ...
        <div className="contianer flex flex-1 flex-col">
            ...
            <Dialog open={showQuizDialog} onClose={() => setShowQuizDialog(false)} className="relative z-50">
                ...
                <div className="fixed inset-0 flex items-center justify-center p-4">
                    <DialogPanel transition className="bg-white rounded-2xl p-5 w-[480px] h-[306px]">
                        {/* Header Section */}

                        <div className="h-[230px] w-[480px] border-b border-solid border-[#EAECF0]">
                            <div className="flex items-center justify-between mb-4">
                                <span className="text-lg font-bold text-[#1D2939]">Start Test</span>
                        ...
                        {/* Buttons */}
                        <div className="border-t border-[#EAECF0] w-[480px] h-[76px] mt-5 flex justify-end gap-2">
                            <div className="mt-5">
                                <button
