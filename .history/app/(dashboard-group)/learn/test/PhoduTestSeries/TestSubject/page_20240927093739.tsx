        ...
        <div className="contianer flex flex-1 flex-col">
            ...
            <Dialog open={showQuizDialog} onClose={() => setShowQuizDialog(false)} className="relative z-50">
                ...
                <div className="fixed inset-0 flex items-center justify-center p-4">
                    <DialogPanel transition className="bg-white rounded-2xl p-5 w-[480px] h-[306px] bg-green-400">
                        {/* Header Section */}
                        ...
                        <div className="h-[230px] w-[480px] bg-[#FFFFFF] border-b border-solid border-[#EAECF0]">
