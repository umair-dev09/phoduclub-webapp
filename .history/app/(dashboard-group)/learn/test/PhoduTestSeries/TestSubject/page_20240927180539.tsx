                ...
                >
                    ...
                    {!collapsed[1] && (
                        <div className="h-[180px] ">
                            ...
                            <div className="bg-red-800 h-[51px] ml-5 mr-5 justify-between flex " >
                                <div className="flex flex-row">
                                    <span className="font-normal text-xs text-[#1D2939]">5 times attempted</span>
                                    <Image
                                ...
                                <div className="flex flex-row">
                                    <div>
                                        <span className="font-semibold text-[#9012FF] text-sm">View Detailed Analytics</span>
                                        <Image
