                    ...
                    {sectionLoading ? (
                        ...
                        <>
                            {sectionss.length <= 0 ? (
                                ...
                                <div className="ml-8 mr-8 gap-4 flex flex-row flex-wrap ">
                                    {sectionss
                                        .sort((a, b) => {
                                        ...
                                        .map((section, index) => (
                                            <div key={index}>
                                                {section.hasQuestions ? (
                                                    <div className="flex w-full h-auto rounded-[12px] border border-solid border-[#EAECF0]  mt-1 bg-slate-950">
                                                        <Collapsible
                                                            trigger={
                                                                <div className="w-auto h-auto m-2 flex justify-between items-center min-w-[900px] bg-slate-950"
