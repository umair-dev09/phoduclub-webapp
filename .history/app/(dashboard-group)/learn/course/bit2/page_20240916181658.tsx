...
//         const [showCheckMark, setShowCheckMark] = useState<boolean>(false);  // Track the checkmark toggle

//         const toggleCheckmark = () => {
//           setShowCheckMark((prev) => !prev);  // Toggle the checkmark
//         };
...
export default function Bit2() {
    ...
    const toggleCheckmark = (e: React.MouseEvent<HTMLImageElement, MouseEvent>) => {
        e.stopPropagation(); // Prevent the click event from triggering tab change
        setShowCheckMark((prev) => !prev);  // Toggle the checkmark
    };
            ...
            <div className="absolute top-0 right-0 w-[363px] h-[581px] bg-[#FFFFFF] border border-b border-r">
                <div className="h-[480px] bg-[#FFFFFF]" style={{ borderRight: '1px solid #EAECF0' }}>
                    <div className="w-[331px] h-[70px] rounded-tl-lg m-3" style={{ paddingLeft: "10px", borderRadius: '8px 0 0 0' }}>
                                ...
                                <div className="flex-1 flex items-center flex-col">
                                    <div className="flex items-center flex-1">
                                        <Image
                                            ...
                                            style={{ marginTop: "9px", marginLeft: '15px' }}
                                        />
                                        {activeTab !== 'bit2.1' && showCheckMark && (
                                            <Image
                                                src="/icons/green-circle-tick.svg"
                                                width={20}
                                                height={20}
                                                alt="green-circle-tick"
                                                className="absolute top-0 left-0 cursor-pointer"
                                                style={{ marginTop: '9px', marginLeft: '15px' }}
                                                onClick={toggleCheckmark}  // Toggle checkmark on click
                                            />
                                        )}
                                        <span className={`flex ${activeTab === 'bit2.1' ? 'font-bold text-[#000000]' : 'font-normal text-[#000000]'}`} style={{ marginTop: "9px", marginLeft: '15px' }}>
                                    ...
                                    <div className="flex items-center flex-1" style={{ marginTop: "6px" }}>
                                        ...
                                        />
                                        <span className="flex font-normal text-[#667085]" style={{ marginLeft: '10px' }}>10:10</span>
                                    </div>
                                </div>
                            </button>
                        </div>

                        {/* Repeat button structure for other items */}
                        <div>
                            <button
                                onClick={() => handleTabClick('bit2.2', '/bit2/bit2.2')}
                                className={`w-full h-[70px] bg-[#FFFFFF] text-[#1D2939] text-base font-medium rounded-lg flex items-start ${activeTab === 'bit2.2' ? 'text-base font-bold bg-[#F8F0FF]' : ''}`}
                            >
                                <div className="flex-1 flex items-center flex-col">
                                    <div className="flex items-center flex-1">
                                        <Image
                                            src={activeTab === 'bit2.2' ? '/icons/course-circle.svg' : '/icons/course-circle2.svg'}
                                            width={20}
                                            height={20}
                                            alt="circle-course"
                                            style={{ marginTop: "9px", marginLeft: '15px' }}
                                        />
                                        <span className={`flex ${activeTab === 'bit2.2' ? 'font-bold text-[#000000]' : 'font-normal text-[#000000]'}`} style={{ marginTop: "9px", marginLeft: '15px' }}>
                                    ...
                                    <div className="flex items-center flex-1" style={{ marginTop: "6px" }}>
                                        <Image
                                            ...
                                            style={{ marginLeft: '45px' }}
                                        />
                                        <span className="flex font-normal text-[#667085]" style={{ marginLeft: '10px' }}>9:20</span>
                                    </div>
                                </div>
                            </button>
                        </div>
                        ...
                        <div>
                            <button
                                onClick={() => handleTabClick('bit2.3', '/bit2/bit2.3')}
                                className={`w-full h-[70px] bg-[#FFFFFF] text-[#1D2939] text-base font-medium rounded-lg flex items-start ${activeTab === 'bit2.3' ? 'text-base font-bold bg-[#F8F0FF]' : ''}`}
                            >
                                <div className="flex-1 flex items-center flex-col">
                                    <div className="flex items-center flex-1">
                                        <Image
                                            src={activeTab === 'bit2.3' ? '/icons/course-circle.svg' : '/icons/course-circle2.svg'}
                                            width={20}
                                            height={20}
                                            alt="circle-course"
                                            style={{ marginTop: "9px", marginLeft: '15px' }}
                                        />
                                        <span className={`flex ${activeTab === 'bit2.3' ? 'font-bold text-[#000000]' : 'font-normal text-[#000000]'}`} style={{ marginTop: "9px", marginLeft: '15px' }}>
                                            3. Chapter 01 heading
                                        </span>
                                    </div>
                                    <div className="flex items-center flex-1" style={{ marginTop: "6px" }}>
                                        <Image
                                            ...
                                            style={{ marginLeft: '45px' }}
                                        />
                                        <span className="flex font-normal text-[#667085]" style={{ marginLeft: '10px' }}>11:45</span>
                                    </div>
                                </div>
                            </button>
                        </div>
            ...
            <div className="h-[70px]">
                <div className="flex items-start ml-7 flex-col">
                    <div className='flex items-start'>
                        <span className="text-Ig text-[#1D2939] font-bold ml-5">1. Welcome and Introduction</span>
                    </div>
                    <div className="flex ml-5 mt-3 flex-row items-center">
                        <Image
                            src="/icons/course-learn.svg"
