...
export default function Bit2() {
    // State to manage each button individually
    ...
    const handleIconClick = (index: number, event: any) => {
        event.stopPropagation(); // Prevents button click propagation
        const updatedButtons = [...buttons];
        updatedButtons[index].iconClicked = !updatedButtons[index].iconClicked; // Toggle individual icon clicked state
                        ...
                        <div key={index} className="w-[331px] h-[70px] rounded-tl-lg m-3" style={{ paddingLeft: "10px", borderRadius: '8px 0 0 0' }}>
                            <div className="flex flex-col h-full justify-start">
                                <button
                                    ...
                                    className="w-full h-[70px] bg-[#F8F0FF] text-[#1D2939] text-base font-medium rounded-lg flex items-start"
                                >
                                    <div className="flex-1 flex items-center flex-col">
                                        <div className="flex items-center flex-1">
                                            ...
                                            >
                                                <Image
                                                    src={button.iconClicked ? '/icons/Green-tick.svg' : '/icons/course-circle.svg'}
                                                    width={20}
                                                    height={20}
                                                    alt="circle-course"
                                                    className=""
