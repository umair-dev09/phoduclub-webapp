...
export default function Bit2() {
    ...
    return (
        <div className="relative flex flex-col flex-1 pb-8">
            <div className="absolute top-0 right-0 w-[363px] h-[Fixed (862px)] bg-[#FFFFFF] border border-b border-r">
            ...
            <div className="overflow-y-auto p-5">
                ...
                <div className="overflow-y-auto p-5">
                    <div className="h-[750px] ml-2  mt-15 bg-blue-900" style={{ borderRadius: "5px" }}>
