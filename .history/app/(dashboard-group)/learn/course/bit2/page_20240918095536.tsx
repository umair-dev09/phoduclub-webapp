...
export default function Bit2() {
    ...
    const handleTabClick = (tabName: string, path: string) => {
        setActiveTab(tabName);
        setClickedTab(tabName); // Set clickedTab to highlight the checkmark
        router.push(path);
    };

    const isActive = (tabName: string) => activeTab === tabName;
    const isClicked = (tabName: string) => clickedTab === tabName;
                ...
                <div className="h-[480px] bg-[#FFFFFF]" style={{ borderRight: '1px solid #EAECF0' }}>
                    <div className="w-[331px] h-[70px] rounded-tl-lg m-3" style={{ paddingLeft: "10px", borderRadius: '8px 0 0 0' }}>
                        <div className="flex flex-col h-full justify-start">
                            <button
                                onClick={() => handleTabClick('bit2.1', '/bit2/bit2.1')}
                                className={`w-full h-[70px] ${isActive('bit2.1') ? 'bg-[#F8F0FF] text-[#1D2939] font-bold' : 'bg-[#FFFFFF] text-[#1D2939]'} text-base font-medium rounded-lg flex items-start`}
                            >
                                <div className="flex-1 flex items-center flex-col">
                                    <div className="flex items-center flex-1">
                                        <Image
                                            src={isClicked('bit2.1') ? '/icons/Green-tick.svg' : (isActive('bit2.1') ? '/icons/course-circle2.svg' : '/icons/course-circle.svg')}
                                            width={20}
                                            height={20}
                                            alt="icon"
                                            className=""
                                            style={{ marginTop: "9px", marginLeft: '15px' }}
                                        />
                                        <span className={`flex ${isActive('bit2.1') ? 'text-base font-bold text-[#000000]' : 'text-base font-bold text-[#000000]'}`} style={{ marginTop: "9px", marginLeft: '15px' }}>
                            ...
                            <button
                                ...
                                className={`w-full h-[70px] ${isActive('bit2.2') ? 'bg-[#F8F0FF] text-[#1D2939] font-bold' : 'bg-[#FFFFFF] text-[#1D2939]'} text-base font-medium rounded-lg flex items-start`}
                            >
                                <div className="flex-1 flex items-center flex-col">
                                    <div className="flex items-center flex-1">
                                        <Image
                                            src={isClicked('bit2.2') ? '/icons/Green-tick.svg' : (isActive('bit2.2') ? '/icons/course-circle2.svg' : '/icons/course-circle.svg')}
                                            width={20}
                                            height={20}
                                            alt="icon"
                                            className="" style={{ marginTop: "9px", marginLeft: '15px' }}
                                        />
                                        <span className={`flex ${isActive('bit2.2') ? 'text-base font-bold text-[#000000]' : 'text-base font-bold text-[#000000]'}`} style={{ marginTop: "9px", marginLeft: '15px' }}>
