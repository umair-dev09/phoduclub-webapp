...
export default function Bit2() {
    ...
    return (
        <div className="relative flex flex-col flex-1 pb-8">
            ...
            <div className="h-[450px] ml-11 mr-96 mt-5" style={{ borderRadius: "5px" }}>
                <div>
                    <video
                        width="100%" // Adjust the width of the video to fit the container
                        height="100%" // Adjust the height of the video
                        controls // Adds play/pause and other controls to the video
                    >
                        <source src="/icons/work-hard.mp4" type="video/mp4" /> {/* Replace with your video file */}
