            ...
            <div className="absolute top-0 right-0 w-[363px] h-[581px] bg-[#FFFFFF] border border-b border-r">
                <div className="h-[480px] bg-[#FFFFFF] "
                    ...
                    <div className="w-[331px] h-[70px] rounded-tl-lg m-3"
                        ...
                        <button className="w-full h-[70px] bg-[#ee2f2f] text-[#1D2939] text-base font-bold rounded-lg flex items-center space-x-2 mb-4">
                            <Image
                                ...
                                className="ml-4"
                            />
                            <span className="flex-1 text-left">1. Welcome and Introduction</span>
                        </button>
                    </div>
