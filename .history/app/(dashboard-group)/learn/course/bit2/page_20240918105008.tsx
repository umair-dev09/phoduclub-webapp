    ...
    return (
        <div className="relative flex flex-col flex-1 pb-8">
            ...
            <div className="overflow-y-auto p-5">
                <div className=" h-[32px] ml-6 mr-96 border-b border-[#EAECF0]  flex flex-row  gap-[10px]">
                    <button>
                        <div className="h-[32px] w-[83px] gap-[30px]">
                            <span className="text-base font-medium text-[#667085]">Overview</span>
