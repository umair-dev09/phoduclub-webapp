                                ...
                                <div className="flex-1 flex  itmes-center flex-col">
                                    <div className="flex items-center
                                        ...
                                        {activeTab !== 'bit2.1' && showCheckMark && (
                                            <Image
                                                src="/icons/green-circle-tick.svg"  // Path to your custom green circle with white tick
                                                width={20}
                                                height={20}
                                                alt="green-circle-tick"
                                                className="absolute top-0 left-0 cursor-pointer"  // Ensure it's clickable
                                                style={{ marginTop: '9px', marginLeft: '15px' }}
                                                onClick={(e) => {
                                                    e.stopPropagation();  // Prevent the entire button click
                                                    toggleCheckmark();  // Toggle the checkmark
                                                }}
                                            />
                                        )}
                                        <span
