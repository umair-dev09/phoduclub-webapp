...
export default function Bit2() {
    ...
    return (
        <div className="relative flex flex-col flex-1 pb-8">
            ...
            <div className="h-[70px]  bg-red-500">
                <div className="my-5 flex items-start ml-7">
                    <div className='flex items-start ml-5 mb-10'>   <span className="text-Ig text-[#1D2939] font-bold  ">1. Welcome and Introduction</span></div>
