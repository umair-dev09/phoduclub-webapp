...
export default function Bit2() {
    ...
    const [buttons, setButtons] = useState([
        { id: 'bit2.1', path: '/bit2/bit2.1', text: '1. Welcome and Introduction', time: '10:10', iconClicked: false },
        { id: 'bit2.2', path: '/bit2/bit2.2', text: '2. Chapter 01 Introduction', time: '9:20', iconClicked: false },
        { id: 'bit2.3', path: '/bit2/bit2.3', text: '3. Chapter 01 Heading', time: '11:45', iconClicked: false },
    ...
    // Handle button click to navigate and mark as active
    const handleTabClick = (index: number, path: string) => {
        setActiveIndex(index); // Set the clicked button as active
        router.push(path); // Navigate to the route
    };

    // Handle icon click independently
    const handleIconClick = (index: number, event: any) => {
        event.stopPropagation(); // Prevent the button click event from firing
        const updatedButtons = [...buttons];
        updatedButtons[index].iconClicked = !updatedButtons[index].iconClicked; // Toggle icon state
            ...
            <div className="absolute top-0 right-0 w-[363px] h-[581px] bg-[#FFFFFF] border border-b border-r">
                <div className="h-[480px] bg-[#FFFFFF]" style={{ borderRight: '1px solid #EAECF0' }}>
                    {buttons.map((button, index) => (
                        <div key={index} className="w-[331px] h-[70px] rounded-tl-lg m-3" style={{ paddingLeft: "10px", borderRadius: '8px 0 0 0' }}>
                            <div className="flex flex-col h-full justify-start">
                                <button
                                    onClick={() => handleTabClick(index, button.path)}
                                    className={`w-full h-[70px] text-[#1D2939] text-base font-medium rounded-lg flex items-start ${activeIndex === index ? 'bg-[#D6BCFA]' : 'bg-[#F8F0FF]'
                                    ...
                                    <div className="flex-1 flex items-center flex-col">
                                        <div className="flex items-center flex-1">
                                            ...
                                            >
                                                <Image
                                                    src={
                                                        activeIndex === index || button.iconClicked
                                                            ? '/icons/Green-tick.svg'
                                                            : '/icons/course-circle.svg'
                                                    } // Change icon based on active state or individual icon clicked
                                                    width={20}
                                                    height={20}
                                                    alt="circle-course"
                                                    className=""
                                            ...
                                            <span className="flex text-base font-bold text-[#000000]" style={{ marginTop: "9px", marginLeft: '15px' }}>
                                                {button.text}
                                            </span>
                                        </div>
