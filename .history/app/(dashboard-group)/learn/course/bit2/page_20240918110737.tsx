        ...
        <div className="relative flex flex-col flex-1 pb-8">
            ...
            <div className="overflow-y-auto p-5">
                <div className=" h-[32px] ml-6 mr-96 border-b border-[#EAECF0]  flex flex-row  gap-4">
                    <button>
                        <div className=" relative h-[32px] w-[83px] gap-[30px]">
                            <span
                                className=" absolute  left-1/2 transform -translate-x-1/2 text-base font-medium text-[#667085] hover:text-[#6941C6] mb-5"
                                style={{
                                    borderBottom: '2px solid #6941C6',
                                    width: '90%', // Adjust the width to control the length
                                    bottom: "0"
                                }}>Overview</span>
