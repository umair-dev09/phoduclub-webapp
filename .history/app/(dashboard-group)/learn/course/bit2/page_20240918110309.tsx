            ...
            <div className="overflow-y-auto p-5">
                <div className=" h-[32px] ml-6 mr-96 border-b border-[#EAECF0]  flex flex-row  gap-4">
                    <button className="relative flex items-center justify-center">
                        <div className="h-[32px] w-[83px] flex items-center justify-center">
                            <span className="relative text-base font-medium text-[#667085] transition-colors duration-200 group-hover:text-[#6941C6]">
                                Overview
                                <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-[2px] bg-[#6941C6] transition-all duration-200 group-hover:w-[70%]"></span>
                            </span>
                        </div>
                    </button>

                    <button>
                        <div className="h-[32px] w-[83px]">
                            <span className="text-base font-medium text-[#667085]">Discussion</span>
