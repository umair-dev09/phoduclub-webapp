                ...
                <div className="h-[480px] bg-[#FFFFFF]" style={{ borderRight: '1px solid #EAECF0' }}>
                    <div className="w-[331px] h-[70px] rounded-tl-lg m-3" style={{ paddingLeft: "10px", borderRadius: '8px 0 0 0' }}>
                        <div className="flex flex-col h-full justify-start">
                            <button
                                onClick={() => handleTabClick('bit2.1', '/bit2/bit2.1')}
                                className={`w-full h-[70px] ${isActive('bit2.1') ? 'bg-[#F8F0FF] text-[#1D2939] font-bold' : 'bg-[#FFFFFF] text-[#1D2939]'} text-base font-medium rounded-lg flex items-start relative`}
                            >
                                <div className="flex-1 flex items-center flex-col">
                                    <div className="flex items-center flex-1">
                                        <div className="relative flex items-center">
                                            ...
                                            />
                                            <span className={`flex ml-8 ${isActive('bit2.1') ? 'text-base font-bold text-[#000000]' : 'text-base font-bold text-[#000000]'}`}>
                            ...
                            <button
                                ...
                                className={`w-full h-[70px] ${isActive('bit2.2') ? 'bg-[#F8F0FF] text-[#1D2939] font-bold' : 'bg-[#FFFFFF] text-[#1D2939]'} text-base font-medium rounded-lg flex items-start relative`}
                            >
                                <div className="flex-1 flex items-center flex-col">
                                    <div className="flex items-center flex-1">
                                        <div className="relative flex items-center">
                                            <Image
                                                ...
                                                className="absolute left-3"
                                            />
                                            <span className={`flex ml-8 ${isActive('bit2.2') ? 'text-base font-bold text-[#000000]' : 'text-base font-bold text-[#000000]'}`}>
