        ...
        <div className="relative flex flex-col flex-1 pb-8">
            ...
            <div className="h-[65px] ml-11 mr-96" style={{ borderRadius: "5px", position: "relative" }}>
                <div className="flex justify-between items-end h-full">
                    ...
                    <button className="bg-[#8501FF] text-[#FFFFFF] text-sm font-semibold py-2 px-4 rounded-md w-[118px] h-[44px] ml-auto"
                        style={{
                            border: "1px solid #800EE2",
                            boxShadow: "0px 12px 24px -8px #1018280F, 0px -4px 4px 0px #1018281F inset, 0px 3px 2px 0px #FFFFFF3D inset"
                        }}>
                        Start Quiz
                    </button>
