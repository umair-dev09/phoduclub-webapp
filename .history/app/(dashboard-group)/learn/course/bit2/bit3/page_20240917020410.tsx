...
function Bit21() {
    ...
    return (
        <div className="relative flex flex-col flex-1 pb-8">
            ...
            <div className="flex justify-between items-center w-full h-auto mt-6 px-6">
                {/* Content on the left */}
                <div className="text-sm text-[#1D2939]">
                    <span>Content goes here (or it could be empty)</span>
                </div>

                {/* Right-aligned button */}
                <button className="bg-[#8501FF] text-[#FFFFFF] text-sm font-semibold py-2 px-4 rounded-md w-[118px] h-[44px]">
                    Start Quiz
                </button>
            </div>
