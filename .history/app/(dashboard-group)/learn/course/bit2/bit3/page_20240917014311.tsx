...
function Bit21() {
    ...
    return (
        <div className="relative flex flex-col flex-1 pb-8">
            ...
            <div className="flex flex-row ml-12 bg-red-500 mt-10 w-[602px] h-[104px] items-center">
                <span className="flex font-semibold text-sm text-[#1D2939] mb-18">
                    <Image
                        src="/icons/clock.svg"
                        width={20}
                        height={20}
                        alt="clock"
                        className="mr-2" // Add some margin between the image and text
                    />
                    5:00 Minutes
                </span>
            </div>
