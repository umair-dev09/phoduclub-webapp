                            ...
                            >
                                <div className="flex-1 flex items-center flex-col">
                                    <div className="flex items-center flex-1">
                                        <Image
                                            src={activeTab === 'bit2.1' ? '/icons/course-circle2.svg' : '/icons/course-circle1.svg'}
                                            width={20}
                                            height={20}
                                            alt="circle-course"
                                            className=""
                                    ...
                                    <div className="flex items-center flex-1" style={{ marginTop: "6px" }}>
                                        ...
                                        />
                                        <span
                                            className={`flex font-normal text-[#667085] ${activeTab === 'bit2.1' ? 'text-lg font-bold text-[#000000]' : ''
                                                }`}
