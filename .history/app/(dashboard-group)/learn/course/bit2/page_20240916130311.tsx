        ...
        <div className="relative flex flex-col flex-1 pb-8">
            ...
            <div className="h-[65px] ml-11 mr-96" style={{ borderRadius: "5px", position: "relative" }}>
                <div className="flex justify-between items-end h-full">
                    <button className="px-8 py-2 text-sm font-semibold bg-[#FFFFFF] border rounded-lg shadow-sm text-[#1D2939] opacity-5 hover:bg-[#8501FF] ml-0 hover:text-[#FFFFFF] hover:border-[1px] hover:border-[#800EE2]" style={{ borderRadius: "5px", border: "1.5px solid #EAECF0" }}>
                        Previous
                    </button>
                    <button className="px-8 py-2 text-sm font-semibold bg-[#FFFFFF] border rounded-lg shadow-sm text-[#1D2939] opacity-5 hover:bg-[#8501FF] ml-0 hover:text-[#FFFFFF] hover:border-[1px] hover:border-[#800EE2]" style={{ borderRadius: "5px", border: "1.5px solid #EAECF0" }}>
                        Next
