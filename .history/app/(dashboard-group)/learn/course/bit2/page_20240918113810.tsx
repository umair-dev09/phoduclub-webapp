...
export default function Bit2() {
    ...
    return (
        <div className="relative flex flex-col flex-1 pb-8">
            ...
            <div className="h-[65px] ml-11 mr-20rem" style={{ borderRadius: "5px", position: "relative" }}>
            ...
            <div className="overflow-y-auto p-5">
                ...
                <div className="overflow-y-auto p-5">
                    <div className="h-[750px] ml-2 mr-20rem mt-15 bg-blue-900" style={{ borderRadius: "5px" }}>
