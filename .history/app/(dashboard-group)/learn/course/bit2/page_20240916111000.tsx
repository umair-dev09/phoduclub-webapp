        ...
        <div className="relative flex flex-col flex-1 pb-8">
            ...
            <div className="h-[70px] ">
                <div className="flex items-start ml-7 flex-col">
                    ...
                    <div className="flex ml-5 mt-3 gap-4">
                        <span className="flex-row items-center">
                            <Image
                                ...
                                height={20}
                            />
                            <span className="text-bold font-bold text-[#1D2939]">3h 20m</span>
                            <span className="text-sm font-normal text-[#1D2939]">of readings left</span>
                        </span>
                        ...
                        <span className="flex-row items-center">
                            <Image
                                ...
                                height={20}
                            />
                            <span className="text-bold font-bold text-[#1D2939] flex-row flex">3h 20m</span>
                            <span className="text-sm font-normal text-[#1D2939]">of readings left</span>
                        </span>
