                    ...
                    <div className="w-[331px] h-[70px] rounded-tl-lg m-3" style={{ paddingLeft: "10px", borderRadius: '8px 0 0 0' }}>
                        ...
                        <div className="flex flex-col h-full justify-start">
                            <button
                                ...
                                className={`w-full h-[70px] bg-[#FFFFFF] text-[#1D2939] text-base font-medium rounded-lg flex items-start ${activeTab === 'dashboard' ? 'text-lg font-bold' : ''
                                    }`}
                            >
                                <div className="flex-1 flex items-center flex-col">
                                    <div className="flex items-center flex-1">
                                        ...
                                        />
                                        <span
                                            className={`flex ${activeTab === 'dashboard' ? 'text-lg font-bold text-[#000000]' : ''
                                                }`}
                                            style={{ marginTop: "9px", marginLeft: '15px' }}
                                        >
                                    ...
                                    <div className="flex items-center flex-1" style={{ marginTop: "6px" }}>
                                        <Image
                                            src={activeTab === 'dashboard' ? "/icons/dashboard.svg" : "/icons/dashboard-2.svg"}
                                            width={16}
                                            height={16}
                                            alt="circle-course"
                                            className=""
