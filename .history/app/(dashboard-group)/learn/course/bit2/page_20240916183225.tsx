...
//                 </div>
//             </div>
//             <div className="bg-red-500 h- mr-96 ml-11">
...
export default function Bit2() {
    const [activeTab, setActiveTab] = useState<string>('');
    const [checkboxes, setCheckboxes] = useState<boolean[][]>([[]]); // Assuming a default state for checkboxes
    const router = useRouter();
    ...
    return (
        <div className="relative flex flex-col flex-1 pb-8">
                            ...
                            >
                                <div className="flex-1 flex items-center flex-col">
                                    <div className="flex items-center flex-1">
                                        <input
                                            type="checkbox"
                                            className={`appearance-none w-5 h-5 rounded-md border-2 border-gray-300 bg-gray-200 cursor-pointer checked:bg-purple-700 checked:border-purple-700 checked:before:content-[''] checked:before:block checked:before:w-3 checked:before:h-3 checked:before:bg-[url('/icons/right.svg')] checked:before:bg-contain checked:before:bg-no-repeat checked:before:bg-center`}
                                            checked={false} // Replace with actual state if necessary
                                            onChange={() => handleCheckboxChange(0, 0)} // Replace with actual indices
                                        />
                                        <Image
                                            src={activeTab === 'bit2.1' ? '/icons/course-circle.svg' : '/icons/course-circle2.svg'}
                                            width={20}
                                            ...
                                            className="ml-4 mt-2"
                                        />
                                        <span className={`flex ${activeTab === 'bit2.1' ? 'text-base font-bold text-[#000000]' : 'text-base font-bold text-[#000000]'}`} style={{ marginTop: "9px", marginLeft: '15px' }}>
                                    ...
                                    <div className="flex items-center flex-1 mt-1">
                                        <Image
                                            ...
                                            className="ml-12"
                                        />
                                        <span className="flex font-normal text-[#667085] ml-2">
                                            10:10
                                        </span>
                                    </div>
                                </div>
            ...
            <div className="h-[70px]">
                <div className="my-5 flex items-center ml-7">
                    <button className="flex items-center ml-5">
                        <div className="text-[#1D2939] h-[24px] w-auto text-lg font-semibold">
                            Courses
                        </div>
                        <div className="ml-3 w-[24px]">
                            <Image
                    ...
                    <div className="text-[#667085] h-full w-auto -ml-1 text-lg font-medium">
                        BITSET Full Course
                    </div>
                </div>
            </div>
            ...
            <div className="h-[70px]">
                <div className="flex items-start ml-7 flex-col">
                    <div className="flex items-start">
                        <span className="text-[#1D2939] font-bold ml-5 text-xl">1. Welcome and Introduction</span>
                    </div>
                    <div className="flex ml-5 mt-3 flex-row items-center">
                        <Image src="/icons/course-learn.svg" alt="course-learn" width={20} height={20} />
                        <span className="text-sm font-semibold text-[#1D2939] ml-3">3h 20m</span>
                        <span className="text-sm font-normal text-[#1D2939] ml-1">of readings left</span>
                        <Image src="/icons/vedio.svg" alt="course-learn" width={20} height={20} className="ml-5" />
                        <span className="text-sm font-semibold text-[#1D2939] ml-3">3h 20m</span>
                        <span className="text-sm font-normal text-[#1D2939] ml-1">of readings left</span>
                        <Image src="/icons/course-learn.svg" alt="course-learn" width={20} height={20} className="ml-5" />
                        <span className="text-sm font-semibold text-[#1D2939] ml-3">3h 20m</span>
                        <span className="text-sm font-normal text-[#1D2939] ml-1">of readings left</span>
                    </div>
                </div>
            ...
            <div className="h-[450px] ml-11 mr-96 mt-15 bg-blue-900 rounded-lg">
                <div>
                    <h1 className="font-bold flex items-center text-white">VIDEO</h1>
                </div>
            </div>

            <div className="h-[65px] ml-11 mr-96 mt-5 rounded-lg relative">
                <div className="flex justify-between items-end h-full">
                    <button className="px-8 py-2 h-[44px] w-[118px] text-sm font-normal bg-[#FFFFFF] border rounded-lg shadow-sm text-[#667085] hover:bg-[#8501FF] hover:text-[#FFFFFF] hover:border-[#800EE2] hover:font-semibold transition-opacity duration-300 ease-in-out">
                        Previous
                    </button>
                    <button className="px-8 py-2 h-[44px] w-[118px] text-sm font-normal bg-[#FFFFFF] border rounded-lg shadow-sm text-[#667085] hover:bg-[#8501FF] hover:text-[#FFFFFF] hover:border-[#800EE2] hover:font-semibold transition-opacity duration-300 ease-in-out">
                        Next
            ...
            <div className="bg-red-500 h-16 mr-96 ml-11"></div>
        </div>
    );
}
