                ...
                <div className="h-[480px] bg-[#FFFFFF]" style={{ borderRight: '1px solid #EAECF0' }}>
                    <div className="w-[331px] h-[70px] rounded-tl-lg m-3" style={{ paddingLeft: "10px", borderRadius: '8px 0 0 0' }}>
                        ...
                        <div className="flex flex-col h-full justify-start">
                            <button className="w-full h-[70px] bg-[#ee2f2f] text-[#1D2939] text-base font-bold rounded-lg ">
                                <Image
                                    src="/icons/course-circle.svg"
                                    width={20}
                                    height={20}
                                    alt="circle-course"
                                    className="ml-4 mb-4 flex-1"
                                />
                                <span className=" flex-1 mb-1">1. Welcome and Introduction</span>
                            </button>
                        </div>
                    </div>
                </div>
