        ...
        <div className="relative flex flex-col flex-1 pb-8">
            ...
            <div className="h-[65px] bg-red-500 ml-11 mr-96" style={{ borderRadius: "5px", position: "relative" }}>
                <div className="flex justify-between items-end h-full">
                    <button className="px-8 py-2 text-lg bg-white border rounded-lg shadow-sm text-gray-500 hover:bg-gray-200 ml-0">
                        Previous
                    </button>
                    <button className="px-8 py-2 text-lg bg-purple-400 text-white rounded-lg shadow-lg hover:bg-purple-500 mr-0">
                        Next
                    </button>
                </div>
            </div>
