        ...
        <div className="relative flex flex-col flex-1 pb-8">
            ...
            <div className="overflow-y-auto p-5">
                <div className=" h-[32px] ml-6 mr-96 border-b border-[#EAECF0]  flex flex-row  gap-4">
                    <button className="relative h-[32px] w-[83px] flex items-center justify-center overflow-hidden">
                        <div className="relative">
                            <span className="text-base font-medium text-[#667085] relative z-10 transition-colors duration-200 hover:text-[#1D2939]">
                                Overview
                            </span>
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="w-full h-full flex items-center justify-center">
                                    <div className="border border-transparent hover:border-[#667085] transition-colors duration-200"></div>
                                </div>
                            </div>
                        </div>
                    </button>
