        ...
        <div className="relative flex flex-col flex-1 pb-8">
            ...
            <div className="h-[65px] ml-11 mr-96" style={{ borderRadius: "5px", position: "relative" }}>
                <div className="flex justify-between items-end h-full">
                    <button
                        className="px-8 py-2 text-sm font-normal bg-[#FFFFFF] border rounded-lg shadow-sm text-[#667085] opacity-50 hover:bg-[#8501FF] hover:text-[#FFFFFF] hover:border-[1px] hover:border-[#800EE2] hover:font-semibold transition-opacity duration-300 ease-in-out"
