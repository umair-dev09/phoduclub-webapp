        ...
        <div className='flex flex-col flex-1 px-8 overflow-auto'>
            ...
            <div className="h-[271px] flex items-center gap-4">
                ...
                <div className="flex flex-col flex-1 h-full bg-[#FFFFFF] border border-lightGrey rounded-xl">
                    ...
                    {/* Rating Section */}
                    <div className="  flex items-center justify-between  w-[255px] h-[24px] gap-[16px]">
                        {/* Star Icons */}
                        ...
                        {/* Rating and Reviews */}
                        <div className="text-[#1D2939] text-sm font-bold flex items-center gap-[16px]">
                            4.7 <span className="text-[#1D2939] font-normal flex items-center gap-[16px]">(500+ Ratings)</span>
                        </div>
                    </div>
