            ...
            <div className="h-[271px] flex items-center gap-4">
                ...
                <div className="flex flex-col flex-1 h-full bg-[#FFFFFF] border border-lightGrey rounded-xl">
                    ...
                    <div className='flex items-center justify-between h-full'>
                        <div className='flex items-center ml-4 mb-7 mt-7'>
                            <div className="text-[#1D2939] text-2xl font-bold mr-3">
                                ₹ 3,990
                            </div>
                            <div className="text-[#667085] text-base font-normal line-through mr-3">
                                ₹ 7,499
                            </div>
                            <div className='bg-[#DB6704] mr-3 w-[76px] h-[25px] flex items-center'
                                style={{
                                ...
                                <span
                                    className=' text-[#FFFFFF]  font-semibold   text-sm  ml-3 '
                                >
                                    86% off
                                </span>
                            </div>
