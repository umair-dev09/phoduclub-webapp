        ...
        <>
            ...
            {showBottomSheet && (
                <div className={`fixed bottom-0 left-0 w-full h-[98vh] bg-white rounded-t-2xl grid grid-rows-[69px_1fr_76px] transform ${showBottomSheet ? 'animate-slideUp' : 'animate-slideDown'} transition-transform duration-500 ease-in-out z-50`}>
                    ...
                    <div className="p-5 flex justify-between items-center h-[69px] w-full border-b-[2px] border-t-[2px] border-[#EAECF0]  rounded-tl-[18px] rounded-tr-[16px]">
                    ...
                    <div className="overflow-y-auto p-5">
                        <div className="flex items-center justify-center ">
                            <div className='w-[880px] h-[252px] rounded-[12px] bg-red-500 border-2 border-[#EAECF0] flex items-center justify-center'>
                                <div className='bg-slate-900 w-[832px] h-[204px] gap-[20px]'>
                                    <div className='w-[832px] h-[24px] gap-[6px] bg-slate-50'>
                                        <span>

                                        </span>

                                    </div>
                                    <div className='w-[168.75px] h-[160px] gap-[20px] bg-slate-100 flex'>
                                        <span className='font-normal text-base text-[#667085] flex flex-col'>
                                            <Image
