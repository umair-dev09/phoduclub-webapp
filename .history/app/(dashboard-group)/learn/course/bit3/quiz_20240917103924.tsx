        ...
        <Dialog open={isOpen} onClose={() => setIsOpen(false)} className="relative z-50">
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
                <DialogPanel className="bg-white rounded-2xl p-5 w-[480px] h-[261px]">
                    ...
                    <div className="border-t border-[#EAECF0]  w-full h-[76px] mt-auto  flex flex-row justify-between">
                        ...
                        <div className='w-[100px] h-[44px]  mt-5'>
                            <button

                                className="bg-[#8501FF] text-[#FFFFFF] text-sm font-semibold py-2 px-5 rounded-md w-[118px] h-[44px] mr-5"
                                style={{
