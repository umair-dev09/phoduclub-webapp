...
function Quiz() {
    ...
    return (
        <>
            ...
            {/* Bottom Sheet */}
            {showBottomSheet && (
                <div className={`fixed bottom-0 left-0 w-full h-[98vh] bg-white rounded-t-2xl grid grid-rows-[69px_1fr_76px] transform translate-y-0 transition-transform duration-500 ease-in-out z-50`}>
