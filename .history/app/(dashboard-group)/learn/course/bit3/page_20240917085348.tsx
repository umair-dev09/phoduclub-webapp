        ...
        <div className="relative flex flex-col flex-1 pb-8">
            ...
            <div className="h-[65px] ml-11 mr-96" style={{ borderRadius: "5px", position: "relative" }}>
                <div className="flex justify-between items-end h-full">
                    ...
                    <button className="bg-[#8501FF] text-[#FFFFFF] text-sm font-semibold  py-2 px-5 rounded-md w-[118px] h-[44px] ml-auto "
                        style={{
            ...
            {isQuizOpen && (
                <div
                    ...
                    onClick={toggleQuizModal} // Close the modal when clicking outside of it
                >
                    <div
                        className="bg-white p-8 rounded-md shadow-md w-[600px] h-[400px]"
                        onClick={(e) => e.stopPropagation()} // Prevent closing when clicking inside the modal
                    >
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-xl font-bold">Quiz Time</h2>
                            <button onClick={toggleQuizModal}>X</button>
                        </div>
                        <Quiz />
                    </div>
                </div>
