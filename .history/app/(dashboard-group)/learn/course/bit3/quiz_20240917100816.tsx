        ...
        <Dialog open={isOpen} onClose={() => setIsOpen(false)} className="relative z-50">
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
                <DialogPanel className="bg-white rounded-2xl p-5 w-[480px] h-[261px]">
                    ...
                    <div className="flex-shrink-0 mt-auto border-t border-[#EAECF0]">
                        {/* This ensures the divider line covers the full width */}
                        <div className="h-[50px] bg-red-700 flex items-center justify-center">
