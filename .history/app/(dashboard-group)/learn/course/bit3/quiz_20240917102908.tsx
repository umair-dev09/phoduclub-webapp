        ...
        <Dialog open={isOpen} onClose={() => setIsOpen(false)} className="relative z-50">
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
                <DialogPanel className="bg-white rounded-2xl p-5 w-[480px] h-[261px]">
                    ...
                    <div className="border-t border-[#EAECF0]  w-full h-[76px] mt-5 ">
                        <div className='w-[100px] h-[44px]'>
                            <button className='font-semibold text-sm text-[#1D2939]'>
                                Cancel

                            </button>
                        </div>
                        <div className='w-[100px] h-[44px]'>
                            <button className='font-semibold text-sm text-[#FFFFFF]'>
                                Start Now
                            </button>
                        </div>
