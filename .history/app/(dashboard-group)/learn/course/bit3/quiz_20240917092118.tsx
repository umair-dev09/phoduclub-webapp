...
function Quiz() {
    ...
    return (
        isOpen && ( // Only render if dialog is open
            <>
                {/* The backdrop, which will disappear when the dialog is closed */}
                <div
                    className="fixed inset-0 bg-black/30 z-40"
                    onClick={() => setIsOpen(false)} // Close dialog on clicking the backdrop
                />
