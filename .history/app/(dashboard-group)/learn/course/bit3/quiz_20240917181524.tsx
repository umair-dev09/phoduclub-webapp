        ...
        <>
            ...
            {showBottomSheet && (
                <div className={`fixed bottom-0 left-0 w-full h-[98vh] bg-white rounded-t-2xl grid grid-rows-[69px_1fr_76px] transform ${showBottomSheet ? 'animate-slideUp' : 'animate-slideDown'} transition-transform duration-500 ease-in-out z-50`}>
                    ...
                    <div className="p-5 flex justify-between items-center h-[69px] w-full border-b-[2px] border-t-[2px] border-[#EAECF0]  rounded-tl-[12px] rounded-tr-[12px]">
                        ...
                        <div className="w-[150px] h-[44px] bg-[#FFFFFF] border-[2px] border-[#EAECF0] rounded-[8px] flex items-center justify-center">
