...
function Quiz() {
    ...
    const openBottomSheet = () => {
        // Close dialog before opening bottom sheet
        setIsOpen(false);
    ...
    return (
        <>
            ...
            {/* Bottom Sheet */}
            {showBottomSheet && (
                <div className={`fixed bottom-0 left-0 w-full h-[98vh] bg-white rounded-t-2xl grid grid-rows-[69px_1fr_76px] transform ${showBottomSheet ? 'animate-slideUp' : 'animate-slideDown'
                    } transition-transform duration-500 ease-in-out z-50`}>
                    <div className="p-5 flex justify-between items-center">
                        <span className="text-lg font-semibold text-[#1D2939]">Quiz</span>
                        <button onClick={closeBottomSheet}>
                            <div className="w-[143px] h-[44px] py-[10px] px-[24px] bg-red-500 border border-[#EAECF0] rounded-tl-[8px] border-t-[1.5px] border-r-0 border-b-0 border-l-0 opacity-0">
