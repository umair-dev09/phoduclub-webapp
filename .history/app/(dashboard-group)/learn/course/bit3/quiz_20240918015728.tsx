...
//                 <div
//                     className={`fixed bottom-0 left-0 w-full h-[98vh] bg-white rounded-t-2xl grid grid-rows-[69px_1fr_76px] transform ${showBottomSheet ? 'animate-slideUp' : 'animate-slideDown'} transition-transform duration-500 ease-in-out z-50`}
//                 >
...
//                         <div className="w-[150px] h-[44px] bg-[#FFFFFF] border-[1px] border-[#EAECF0] rounded-[8px] flex items-center justify-center  transform ${showBottomSheet ? 'animate-slideDown' : 'animate-slideUp'} transition-transform duration-500 ease-in-out z-50`}">
//                             <button
...
function Quiz() {
    ...
    const openBottomSheet = () => {
        ...
        setTimeout(() => {
            setShowBottomSheet(true);  // Open the bottom sheet with a delay to ensure the dialog closes first
        }, 300); // Delay should match the dialog close animation duration
    };
    ...
    const closeBottomSheet = () => {
        setShowBottomSheet(false);
        setTimeout(() => {
            setIsDialogOpen(true);  // Reopen the dialog after the bottom sheet has closed
        }, 300); // Delay should match the bottom sheet close animation duration
    };
    return (
        <>
            {/* Dialog Component */}
            {isDialogOpen && (
                <div className="fixed inset-0 flex items-center justify-center p-4 z-50">
                    ...
                    <div className="relative bg-white rounded-2xl p-5 w-[480px] h-[261px]">
                        {/* Header Section */}
                        <div className="flex items-center justify-between mb-4">
                            <span className="text-lg font-bold text-[#1D2939]">Confirmation</span>
            ...
            {/* Bottom Sheet */}
            {showBottomSheet && (
                <div className={`fixed bottom-0 left-0 w-full h-[98vh] bg-white rounded-t-2xl z-50 transition-transform duration-500 ease-in-out ${showBottomSheet ? 'transform translate-y-0' : 'transform translate-y-full'}`}>
                            ...
                            <div className="flex items-center justify-center">
                                <div className='w-[880px] h-[252px] rounded-[12px] border-2 border-[#EAECF0] flex items-center justify-center'>
                                    <div className='bg-[#FFFFFF] w-[832px] h-[204px] gap-[20px]'>
                                        <div className='w-[832px] h-[24px] gap-[6px]'>
                                            <span className='text-[#1D2939] font-semibold text-base'>
                                                Q2. What is the result of the bitwise OR operation between 1010 and 1100?
                                            </span>
                                        </div>
                                        <div className='w-[168.75px] h-[160px] gap-[20px] flex flex-col mt-4'>
                                            <span className='font-normal text-base text-[#667085] flex flex-row'>
                                                <input
                                                    ...
                                                    value='1110'
                                                />
                                                <label className='ml-2'>1110</label>
                                            </span>
                                            <span className='font-normal text-base text-[#667085] flex flex-row'>
                                                <input
                                                    type='radio'
                                                    ...
                                                    value='1010'
                                                />
                                                <label className='ml-2'>1010</label>
                                            </span>
                                            <span className='font-normal text-base text-[#667085] flex flex-row'>
                                                <input
                                                    type='radio'
                                                    ...
                                                    value='1100'
                                                />
                                                <label className='ml-2'>1100</label>
                                            </span>
                                            <span className='font-normal text-base text-[#667085] flex flex-row'>
                                                <input
                                                    type='radio'
                                                    ...
                                                    value='0000'
                                                />
                                                <label className='ml-2'>0000</label>
                                            </span>
                                        </div>
                                    </div>
                                </div>
