                ...
                <div className={`fixed bottom-0 left-0 w-full h-[98vh] bg-white rounded-t-2xl grid grid-rows-[69px_1fr_76px] transform ${showBottomSheet ? 'animate-slideUp' : 'animate-slideDown'} transition-transform duration-500 ease-in-out z-50`}>
                    ...
                    <div className="overflow-y-auto p-5 ">
                        <div className='gap-[20px] flex flex-col'>
                            <div className="flex items-center justify-center border-1 border-[#EAECF0]">
                                <div className='w-[880px] h-[252px] rounded-[12px]  flex items-center justify-center'>
                            ...
                            <div className="flex items-center justify-center border-1 border-[#EAECF0]">
                                <div className='w-[880px] h-[252px] rounded-[12px]  bflex items-center justify-center'>
                                    <div className='bg-[#FFFFFF] w-[832px] h-[204px] gap-[20px]'>
                                        <div className='w-[832px] h-[24px] gap-[6px] '>
                                            <span className='text-[#1D2939] font-semibold text-base'>
                                                Q1. What is the result of the bitwise AND operation between 1010 and 1100?
                            ...
                            <div className="flex items-center justify-center ">
                                <div className='w-[880px] h-[252px] rounded-[12px]  border-1 border-[#EAECF0] flex items-center justify-center'>
                                    <div className='bg-[#FFFFFF] w-[832px] h-[204px] gap-[20px]'>
                                        <div className='w-[832px] h-[24px] gap-[6px] '>
                                            <span className='text-[#1D2939] font-semibold text-base'>
                                                Q1. What is the result of the bitwise AND operation between 1010 and 1100?
