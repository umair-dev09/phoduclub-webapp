    ...
    return (
        <>
            ...
            {showBottomSheet && (
                <div
                    id="bottomSheet"
                    className={`fixed bottom-0 left-0 w-full h-[98vh] bg-white rounded-t-2xl grid grid-rows-[69px_1fr_76px] z-50 transition-transform duration-500 ease-in-out ${showBottomSheet ? "translate-y-0" : "translate-y-full"
                        }`}
                >
