                    ...
                    <div className="border-t border-[#EAECF0]  w-full h-[76px] mt-5  flex flex-row gap-2 ">
                        <div className='w-[100px] h-[44px] bg-[#FFFFFF]  mt-5 '>
                            <button
                                ...
                                className="bg-[#FFFFFF] text-[#1D2939] text-sm font-semibold py-2 px-5 rounded-md w-[118px] h-[44px] mr-2"
                                style={{
                        ...
                        <div className='w-[100px] h-[44px]  mt-5  mr-5'>
                            <button
                                ...
                                className="bg-[#8501FF] text-[#FFFFFF] text-sm font-semibold py-2 px-5 rounded-md w-[118px] h-[44px] ml-2"
                                style={{
