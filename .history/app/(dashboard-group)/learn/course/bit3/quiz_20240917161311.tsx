            ...
            {showBottomSheet && (
                <div className={`fixed bottom-0 left-0 w-full h-[98vh] bg-white rounded-t-2xl grid grid-rows-[69px_1fr_76px] transform ${showBottomSheet ? 'animate-slideUp' : 'animate-slideDown'} transition-transform duration-500 ease-in-out z-50`}>
                    ...
                    <div className="p-5 flex justify-between items-center h-[69px] w-full ">
                        ...
                        <div className="w-[150px] h-[44px] bg-[#FFFFFF]"
                            style={{ border: "2px solid #EAECF0", padding: "10px 24px", borderRadius: "8px" }}>
                            <button onClick={closeBottomSheet}>
                                <span className='font-semibold text-sm text-[#1D2939] w-full h-full flex items-center justify-center'>Save and Exit</span>
                            </button>
                        </div>
