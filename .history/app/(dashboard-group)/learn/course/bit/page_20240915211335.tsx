...
// import Collaspe from '@/components/DashboardComponents/LearnComponents/CourseComponents/DynamicCourse/collaspe';
...
export default function Course({ params, }: {
    ...
    return (
        <div> <h1>this is course is{params.BitId}</h1></div>
    )
}