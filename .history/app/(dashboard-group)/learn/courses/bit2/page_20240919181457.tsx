    ...
    return (
        <div className="w-screen ">
            ...
            <div className="relative flex flex-col flex-1 pb-8 ">
                <div className="absolute top-0 right-0 w-[400px] h-full bg-[#FFFFFF] border border-b border-r">
                    <div className="h-full bg-[#FFFFFF]" style={{ borderRight: '1px solid #EAECF0' }}>
                        <div className="w-[400px] h-[70px] rounded-tl-lg m-3" style={{ paddingLeft: "10px", borderRadius: '8px 0 0 0' }}>
                ...
                <div className="h-[450px] ml-8 mr-96 mt-15 bg-blue-900" style={{ borderRadius: "5px" }}>
                    <div>
                        {/* <video
                        width="100%"
                        height="100%"
