...
export default function Layout() {
    return (
        <div className="h-screen w-full flex  justify-end ">
            {/* Left side container with fixed width of 363px */}
            <div className="w-full bg-red-500 flex justify-end h-full">
                <SideButton />
            </div>

            {/* Right side container with remaining space */}
