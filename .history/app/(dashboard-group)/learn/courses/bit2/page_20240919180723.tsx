...
export default function Bit2() {
    ...
    return (
        <div className="w-screen h-screen flex">
            <div className="fixed top-0 right-0 w-[363px] h-[253px] bg-[#FFFFFF] border border-b border-r overflow-y-auto mt-18 mr-10">
                <div className="w-[331px] m-3" style={{ paddingLeft: "10px", borderRadius: '8px 0 0 0' }}>
                    <div className="flex flex-col h-full">
                        ...
                        >
                            <div className="flex-1 flex flex-col items-center">
                                <div className="flex items-center flex-1">
                                    ...
                                    />
                                    <span
                                        className={`flex ${activeTab === 'bit2.1' ? '' : 'text-base font-bold text-[#000000]'}`}
                                        style={{ marginTop: "9px", marginLeft: '15px' }}
                                    >1. Welcome and Introduction</span>
                                </div>
                        ...
                        {/* Repeat similar button blocks as needed */}
                    </div>
                </div>
            </div>

            <div className="flex-1 ml-[363px] flex flex-col ">
                <div className="h-[70px]">
                    <div className="my-5 flex items-center mr-86">
                        <button className='flex items-center ml-5' onClick={() => router.back()}>
                ...
                <div className="flex-1 overflow-y-auto p-5">
                    <div className="flex flex-col ml-7 mt-3">
                        <span className="text-[#1D2939] font-bold">1. Welcome and Introduction</span>
                    ...
                    <div className="h-[450px] mt-15 bg-blue-900" style={{ borderRadius: "5px" }}>
                        <h1 className="font-bold flex items-center">VIDEO</h1>
                    </div>
                    <div className="h-[65px] mt-15" style={{ borderRadius: "5px", position: "relative" }}>
                        <div className="flex justify-between items-end h-full">
                            <button className="px-8 py-2 h-[44px] w-[118px] text-sm font-normal bg-[#FFFFFF] border rounded-lg shadow-sm text-[#667085] hover:bg-[#8501FF] hover:text-[#FFFFFF] hover:border-[1px] hover:border-[#800EE2] hover:font-semibold transition-opacity duration-300 ease-in-out" style={{ borderRadius: "5px", border: "1.5px solid #EAECF0" }}>
                                Previous
                            </button>
                            <button className="px-8 py-2 h-[44px] w-[118px] text-sm font-normal bg-[#FFFFFF] border rounded-lg shadow-sm text-[#667085] hover:bg-[#8501FF] hover:text-[#FFFFFF] hover:border-[1px] hover:border-[#800EE2] hover:font-semibold transition-opacity duration-300 ease-in-out" style={{ borderRadius: "5px", border: "1.5px solid #EAECF0" }}>
                                Next
                    ...
                    <div className="overflow-y-auto mt-15 bg-[#FFFFFF]" style={{ borderRadius: "5px" }}>
                        {/* Content goes here */}
                    </div>
                </div>
            </div>
