            ...
            <>
              <div className="MainCourseLayout flex flex-col flex-1 overflow-y-auto pt-3 pb-7 overflow-x-hidden w-full">
                ...
                <div className="mr-8 mt-[24px] rounded-md flex flex-col h-auto">
                  ...
                  <iframe src="https://player.vdocipher.com/v2/?otp=20160313versASE323Uat8YQORtojtVj6Fgeqtqp3cq90AH8NRy3ZRp5Qt1qb13l&playbackInfo=eyJ2aWRlb0lkIjoiM2Y0OWNkMjhkNTNmNDFlMzhmYjY2YWVjMzJhZDljMWMifQ=="
                    className="mr-8  ml-8 h-[400px] w-auto rounded-md"
                    allowFullScreen
