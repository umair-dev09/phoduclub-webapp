...
export default function Course() {
    ...
    return (
        ...
        <div className='flex flex-col flex-1 px-8 overflow-auto'>
            ...
            <Accordion selectedKeys={selectedKeys} onSelectionChange={setSelectedKeys} className=' gap-4 flex flex-col '
            >
                <AccordionItem className='bg-white active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300' indicator={({ isOpen }) => (isOpen ? <ArrowIcon /> : <ArrowIcon1 />)}
                    title="Accordion 1">
                    {defaultContent}
                </AccordionItem>
