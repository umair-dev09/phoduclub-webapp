...
export default function Course() {
    ...
    return (
        ...
        <div className='flex flex-col flex-1 px-8 overflow-auto'>
            ...
            <Accordion selectedKeys={selectedKeys} onSelectionChange={setSelectedKeys} className=' gap-4 flex flex-col focus:border-red-500 focus:border-2 ' itemClasses={itemClasses}
            >
                <AccordionItem className='bg-white ' indicator={({ isOpen }) => (isOpen ? <ArrowIcon /> : <ArrowIcon1 />)}
                    title="Accordion 1">
                    {defaultContent}
                </AccordionItem>
