    ...
    return (
        <div className="flex flex-row w-screen" >
            <div className="MainCourseLayout flex flex-col w-[75%] h-[100vh] overflow-y-auto py-3">
                ...
                <div className="h-auto ml-8 flex">
                    <div className="flex flex-col gap-[17px]">
                        <span className="font-bold text-[#1D2939] text-lg">1. Welcome and Introduction</span>
                ...
                <div className="ml-8 bg-red-500 mr-8 flex-grow mt-[24px] rounded-md overflow-y-auto">
                    {/* Content here */}
                </div>
                ...
                <div className="ml-8 mr-8 h-auto mt-[20px] gap-[16px] flex"
                    style={{ borderBottom: "2px solid #EAECF0" }}>
                    <button className="font-medium text-lg text-[#667085] mb-3">Overview</button>
                    <button className="font-medium text-lg text-[#667085] mb-3">Discussion</button>
                </div>
            </div>
