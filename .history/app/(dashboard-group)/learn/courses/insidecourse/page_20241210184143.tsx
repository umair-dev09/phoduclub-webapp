...
function SideButton() {
    ...
    return (
        <div className="flex flex-row w-screen">
            ...
            <div className="SideLayout w-[25%] flex flex-col bg-[#FFFFFF] overflow-y-auto p-3 gap-4">
                ...
                <div className="gap-[20px] flex flex-col">
                    ...
                    <Collapsible
                        ...
                        trigger={
                            <div
                                className="h-[60px] flex flex-row justify-between py-2 px-4 items-center bg-[#F7F8FB]"
