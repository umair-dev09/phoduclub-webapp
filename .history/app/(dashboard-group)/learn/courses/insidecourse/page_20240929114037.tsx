...
function sidebutton() {
    ...
    return (
        <div className="flex flex-row w-screen" >
           ...
           checked:bg-[#0B9055] appearance-none border-2 border-gray-300 
           checked:border-transparent checked:after:content-[''] 
           checked:after:block checked:after:w-3 checked:after:h-3 
