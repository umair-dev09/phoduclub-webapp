...
function SideButton() {
    ...
    const [activeComponent, setActiveComponent] = useState<string>('Read'); // default is 'Read'
    ...
    return (
        <div className="flex flex-row w-screen">
            <div className="MainCourseLayout flex flex-col w-[75%]  overflow-y-auto py-3">
                ...
                {/* Main part */}
                <div className="ml-8 bg-red-500 mr-8 mt-[24px] rounded-md flex flex-col h-auto w-auto">
                ...
                <div className="ml-8 h-[60px] mr-8 mt-[20px] rounded-md flex items-center justify-center">
                    <div className="flex flex-row justify-between w-full h-[44px]">
                        ...
                        <button className="h-full w-[111px] rounded-[8px] bg-[#8501FF] shadow-inner-button opacity-[50%]"
                            style={{
                ...
                <div className="ml-8 mr-8 h-[45px]  mt-[20px]  gap-[16px] flex" style={{ borderBottom: "2px solid #EAECF0" }}>
                    <button className="font-medium text-1g text-[#667085] mb-3">Overview</button>
                    <button className="font-medium text-1g text-[#667085] mb-3">Discussion</button>
                </div>
            </div>
            ...
            <div className="SideLayout w-[25%] flex flex-col bg-[#FFFFFF] overflow-y-auto p-3">
                <div className="gap-[20px] flex flex-col">
                    <div className="bg-[#F8F0FF] h-[64px] gap-[16px] rounded-[8px]">
                        <button className="flex justify-between" onClick={() => setActiveComponent('Read')}>
                    ...
                    <div className="bg-[#FFFFFF] h-[64px] gap-[16px] rounded-[8px]">
                        <button className="flex justify-between" onClick={() => setActiveComponent('Video')}>
                            <div className="flex flex-row mt-3 ml-4">
                                <Image src="/icons/vedio.svg" width={20} height={20} alt="" />
                            </div>
                            <div className="flex flex-col h-[52px] gap-[4px] ml-5 mt-2">
                                <span className="gap-[4px] text-1g text-[#1D2939] font-bold">1. Welcome and Introduction</span>
                                <div className="flex flex-row items-center">
                                    <Image src="/icons/vedio.svg" width={16} height={16} alt="" />
                                    <span className="ml-2 text-sm font-normal text-[#667085]">10:00</span>
                                </div>
                            </div>
                        </button>
                    ...
                    <div className="bg-[#FFFFFF] h-[64px] gap-[16px] rounded-[8px]">
                        <button className="flex justify-between" onClick={() => setActiveComponent('StartQuiz')}>
                            <div className="flex flex-row mt-3 ml-4">
                                <Image src="/icons/test.svg" width={20} height={20} alt="" />
                            </div>
                            <div className="flex flex-col h-[52px] gap-[4px] ml-5 mt-2">
                                <span className="gap-[4px] text-1g text-[#1D2939] font-bold">1. Welcome and Introduction</span>
                                <div className="flex flex-row items-center">
                                    <Image src="/icons/test.svg" width={16} height={16} alt="" />
                                    <span className="ml-2 text-sm font-normal text-[#667085]">10:00</span>
                                </div>
                            </div>
                        </button>
