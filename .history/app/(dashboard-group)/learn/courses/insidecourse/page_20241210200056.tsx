                ...
                <div className="gap-[20px] flex flex-col border-b border-solid border-[#EAECF0] ">
                    ...
                    >
                        <div className="flex flex-col">
                            <div className="flex flex-row gap-2 w-full hover:bg-[#F8F0FF] h-[64px] px-4 py-2 justify-center">
                                <Checkbox
                                    size="md"
                                    color="primary"
                                />
                                <button className='flex flex-col gap-2 w-full'
                                    onClick={() => setActiveComponent('Video')}>
                                    <span className="font-medium text-base text-[#1D2939] text-left items-start">Lesson 01</span>
                                    <div className='flex flex-row gap-2'>
                                        <Image
                                            src="/icons/vedio.svg"
                                            width={16}
                    ...
                    <Collapsible
                        ...
                        trigger={
                            <div
                                className="h-[60px] border-t border-solid border-[#EAECF0] flex flex-row justify-between py-2 px-4 items-center"
