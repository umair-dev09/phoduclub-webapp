                                        ...
                                        {iconCheckmarkVideo === 'Video' ? (
                                            <label className="relative inline-flex items-center cursor-pointer">
                                                <input
                                                    type="checkbox"
                                                    className="w-[20px] h-[20px] rounded-full cursor-pointer appearance-none border-2 border-gray-300  checked:border-transparent"
                                                    checked={iconCheckmarkRead === 'Video'}
                                                    onChange={() => setIconCheckmarkRead(iconCheckmarkRead === 'Video' ? null : 'Video')} // Toggle checkmark
                                                />
                                                <span className="absolute w-[20px] h-[20px] bg-[url('/icons/Green-tick.svg')] bg-contain bg-center" />
                                            </label>
                                        ) : (
                                        ...
                                        {iconCheckmarkStartQuiz === 'StartQuiz' ? (
                                            <label className="relative inline-flex items-center cursor-pointer">
                                                <input
                                                    type="checkbox"
                                                    className="w-[20px] h-[20px] rounded-full cursor-pointer appearance-none border-2 border-gray-300  checked:border-transparent"
                                                    checked={iconCheckmarkRead === 'StartQuiz'}
                                                    onChange={() => setIconCheckmarkRead(iconCheckmarkRead === 'StartQuiz' ? null : 'StartQuiz')} // Toggle checkmark
                                                />
                                                <span className="absolute w-[20px] h-[20px] bg-[url('/icons/Green-tick.svg')] bg-contain bg-center" />
                                            </label>
                                        ) : (
