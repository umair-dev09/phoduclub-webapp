    ...
    return (
        <div className="flex flex-row w-screen" >
            <div className="MainCourseLayout flex flex-col w-[75%]  overflow-y-auto py-3">
                ...
                <div className="ml-8 bg-red-500 mr-8 mt-[24px] rounded-md">
                ...
                <div className="ml-8 mr-8 mt-[20px] rounded-md flex items-center justify-center">
                ...
                <div className="ml-8 mr-8   mt-[20px]  gap-[16px] flex  "
