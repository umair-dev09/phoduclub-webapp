...
function sidebutton() {
    ...
    const [iconCheckmark, setIconCheckmark] = useState({});
    // Function to toggle the icon to a checkmark
    const handleIconClick = (component) => {
        setIconCheckmark((prevState) => ({
            ...prevState,
            [component]: !prevState[component], // Toggle checkmark on click
        }));
    };
                ...
                <div className="h-[64px]  ml-8 flex items-center ">
                    <div className="my-5 flex items-center">
                        ...
                        <div className="text-[#667085] h-full w-auto -ml-1" style={{ fontSize: "16px", fontWeight: "500" }}>
                            ...
                            <Checkbox defaultSelected radius="full" color="default">
                        ...
                        " onClick={() => setActiveComponent('Read')}
                            ...
                            <div className=" flex flex-row mt-3 ml-4">
                                ...
                                <button
                                    ...
                                    onClick={() => setIconCheckmark('Read')} // Trigger icon change to checkmark on click
                                >
                                    {iconCheckmark === 'Read' ? (
                    ...
                    <div className={`h-[64px] gap-[16px] rounded-[8px] hover:bg-[#F8F0FF] ${activeComponent === 'Video' ? 'bg-[#F8F0FF]' : 'bg-[#FFFFFF]'}`}>
                        ...
                        "onClick={() => setActiveComponent('Video')}
                            ...
                            <div className=" flex flex-row mt-3 ml-4">
                                ...
                                <Image
                                    src={activeComponent === 'Video' || hoverVideo ? "/icons/sidebuttonred.svg" : "/icons/sidebuttongray.svg"}
                                    width={20}
                                    height={20}
                                    alt=""
                                />
