    ...
    return (
        <div className="flex flex-row w-screen">
            ...
            <div className="SideLayout w-[25%] flex flex-col bg-[#FFFFFF] overflow-y-auto border-l border-solid border-[#EAECF0]  pb-3 gap-4">
                ...
                <div className=" flex flex-col border-b border-solid border-[#EAECF0] ">
                    ...
                    >
                        <button className='bg-[#FFFFFF] w-full flex flex-row justify-center gap-2 h-[64px] py-2 px-4 hover:bg-[#F8F0FF]'
                            onClick={() => setActiveComponent('Read')}>
                            <Checkbox
                                size="md"
                                color="primary" />
                    ...
                    <Collapsible
                        ...
                        trigger={
                            <div
                                className="border-t border-solid border-[#EAECF0] flex flex-row justify-between py-2 px-4 items-center h-[64px] hover:bg-[#EAECF0]"
                                onClick={() => handleToggle('maths')} // Pass section name to toggle function
                            >
                                <span className="font-semibold text-base text-[#1D2939] text-left">Maths</span>
                                <Image
                    ...
                    >
                        <div className="flex flex-col">
                            <div className="flex flex-row gap-2 w-full hover:bg-[#F8F0FF]  px-4 py-2">
                                <Checkbox
                                    size="md"
                                    color="primary"
                                ...
                                <button className='flex flex-col gap-2 w-full'
                                    onClick={() => setActiveComponent('Video')}>
                                    <span className="font-medium text-base text-[#1D2939] text-left">Lesson 01</span>
                                    <div className='flex flex-row gap-2'>
                                        <Image
                                            src="/icons/vedio.svg"
                                            width={16}
                            ...
                            <div className="flex flex-row gap-2 w-full hover:bg-[#F8F0FF]  px-4 py-2">
                                ...
                                <button className='flex flex-col gap-2 w-full'
                                    onClick={() => setActiveComponent('Video')}>
                                    <span className="font-medium text-base text-[#1D2939] text-left">Lesson 02</span>
                                    <div className='flex flex-row gap-2'>
                                        <Image
                                            src="/icons/vedio.svg"
                                            width={16}
                    ...
                    <Collapsible
                        ...
                        trigger={
                            <div
                                className="h-[64px] border-t border-solid border-[#EAECF0] flex flex-row justify-between py-2 px-4 items-center hover:bg-[#EAECF0]"
                                onClick={() => handleToggle('chemistry')} // Pass section name to toggle function
                            >
                                <span className="font-semibold text-base text-[#1D2939] text-left">Chemistry</span>
                                <Image
                    ...
                    >
                        <div className="flex flex-col">
                            <div className="flex flex-row gap-2 w-full hover:bg-[#F8F0FF]  px-4 py-2">
                                ...
                                <button className='flex flex-col gap-2 w-full'
                                    onClick={() => setActiveComponent('StartQuiz')}>
                                    <span className="font-medium text-base text-[#1D2939] text-left">2. Chapter 01 Carbon </span>
                                    <div className='flex flex-row gap-2'>
                                        <Image
                                            src="/icons/test.svg"
                                            width={16}
                            ...
                            <div className="flex flex-row gap-2 w-full hover:bg-[#F8F0FF]  px-4 py-2">
                                ...
                                <button className='flex flex-col gap-2 w-full'
                                    onClick={() => setActiveComponent('StartQuiz')}>
                                    <span className="font-medium text-base text-[#1D2939] text-left">2. Chapter 02</span>
                                    <div className='flex flex-row gap-2'>
                                        <Image
                                            src="/icons/test.svg"
                                            width={16}
                    ...
                    <Collapsible
                        ...
                        trigger={
                            <div
                                className="h-[64px] border-t border-solid border-[#EAECF0] flex flex-row justify-between py-2 px-4 items-center hover:bg-[#F7F8FB]"
                    ...
                    >
                        ...
                        <div className="flex flex-col">
                            <div className="flex flex-row gap-2 w-full hover:bg-[#F8F0FF]  px-4 py-2">
                                ...
                                <button className='flex flex-col gap-2 w-full'
                                    onClick={() => setActiveComponent('StartQuiz')}>
                                    <span className="font-medium text-base text-[#1D2939] text-left">2. Chapter 01 Newton</span>
                                    <div className='flex flex-row gap-2'>
                                        <Image
                                            src="/icons/test.svg"
                                            width={16}
                            ...
                            <div className="flex flex-row gap-2 w-full hover:bg-[#F8F0FF]  px-4 py-2">
                                ...
                                <button className='flex flex-col gap-2 w-full'
                                    onClick={() => setActiveComponent('StartQuiz')}>
                                    <span className="font-medium text-base text-[#1D2939] text-left">2. Chapter 01 Mass</span>
                                    <div className='flex flex-row gap-2'>
                                        <Image
                                            src="/icons/test.svg"
                                            width={16}
