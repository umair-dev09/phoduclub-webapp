                                    ...
                                    >
                                        {iconCheckmarkRead === 'Read' ? (
                                            ...
                                            <label className="relative inline-flex items-center cursor-pointer">
                                                <input
                                                    type="checkbox"
                                                    className="w-[18px] h-[18px] rounded-full cursor-pointer appearance-none border-2 border-gray-300 checked:bg-[#0B9055] checked:border-transparent"
                                                    checked={iconCheckmarkRead === 'Read'}
                                                    onChange={() => setIconCheckmarkRead(iconCheckmarkRead === 'Read' ? null : 'Read')} // Toggle checkmark
                                                />
                                                <span className="absolute w-[12px] h-[12px] bg-[url('/icons/Green-tick.svg')] bg-contain bg-center" />
                                            </label>
