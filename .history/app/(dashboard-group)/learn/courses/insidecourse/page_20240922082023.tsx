    ...
    return (
        <div className="flex flex-row w-screen" >
            <div className="MainCourseLayout flex flex-col w-[75%]  overflow-y-auto py-3">
                ...
                >
                    <button className="font-medium text-1g text-[#667085] mb-3 hover:bg-[#8501FF]"
                ...
                hy this code below should come when i press the overview button
                <div className="font-normal text-sm text-[#667085] leading-relaxed">
