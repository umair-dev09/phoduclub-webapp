        ...
        <div className="flex flex-row w-screen" >
            <div className="MainCourseLayout flex flex-col w-[75%]  overflow-y-auto py-3">
                ...
                <div>
                    ...
                    <div className="h-[64px]  ml-8 flex bg-white">
                        <div className="flex flex-col gap-[10px] ">
                            <span className="font-bold text-[#1D2939] text-1g">1. Welcome and Introduction</span>
                            <div className="flex flex-row items-center ">
                                <span className="font-normal text-sm text-[#1D2939] flex items-center"> {/* Add flex and items-center */}
                                    <Image
                                        src="/icons/read.svg"
                                        width={20}
                                        height={20}
                                        alt="" />
                                    <span className="font-semibold text-sm text-[#1D2939] ml-1">3h 20m</span> {/* Add ml-1 for spacing */}
                                    <span className="ml-1">readings left</span> {/* Add ml-1 for spacing */}
                                </span>
                                <span>
