                                ...
                                <div className=" flex flex-row mt-3 ml-4">
                                    ...
                                    >
                                        {iconCheckmarkRead === 'Read' ? (
                                            ...
                                            <input
                                                type="checkbox"
                                                className={`w-5 h-5 rounded-lg appearance-none border-2 border-gray-300 cursor-pointer flex items-center justify-center 
  bg-gray-100 checked:bg-purple-700 checked:border-purple-700 relative`}
                                                checked={iconCheckmarkRead === 'Read'}
                                                onChange={() => setIconCheckmarkRead(iconCheckmarkRead === 'Read' ? null : 'Read')} // Toggle checkmark state
                                            />
                                        ) : (
                                            <Image
