                ...
                <div className="gap-[20px] flex flex-col">
                    <button
                        ...
                        ">
                                ...
                                {/* ------------------------------------------------------------------------------------------------------------------------- */}
                                <div className="flex flex-col h-[64px] gap-[4px]  items-center">
                                    <span className="gap-[4px] text-1g text-[#1D2939] font-bold items-center">1. Welcome and Introduction</span>
                                    <div className="flex flex-row items-center ">
                                        ...
                                        <span className="  text-sm font-normal text-[#667085]">10:00</span>
                                    </div>
