        ...
        <div className="flex flex-row w-screen" >
            ...
            <div className="SideLayout w-[25%] flex flex-col bg-[#FFFFFF] overflow-y-auto p-3">
                ...
                <div className="gap-[20px] flex flex-col">
                    <div className=" h-[64px] gap-[16px] rounded-[8px]  ${activeComponent === 'Read' ? 'bg-[#F8F0FF]' : 'bg-[#FFFFFF]'}`} hover:bg-[#F8F0FF] ">
                    ...
                    <div className="bg-[#FFFFFF] h-[64px] gap-[16px] rounded-[8px]  ${activeComponent === 'Read' ? 'bg-[#F8F0FF]' : 'bg-[#FFFFFF]'}`} hover:bg-[#F8F0FF]">
                        <button className="flex justify-between
