...
function sidebutton() {
    ...
    const [iconCheckmarks, setIconCheckmarks] = useState({ Read: null, Video: null, StartQuiz: null });

    const handleCheckmark = (component, e) => {
        e.stopPropagation();
        setIconCheckmarks(prev => ({
            ...prev,
            [component]: prev[component] === component ? null : component
        }));
    };
                                ...
                                <div className=" flex flex-row mt-3 ml-4">
                                    ...
                                    >
                                        {iconCheckmarkRead === 'Read' ? (
                                            ...
                                            <input
                                                type="checkbox"
                                                className="w-[18px] h-[18px] rounded-full cursor-pointer appearance-none border-2 border-gray-300 
           checked:bg-[#0B9055] checked:border-transparent relative"
                                                checked={iconCheckmarks[component] === component}
                                                onChange={(e) => handleCheckmark(component, e)}
                                            />
                                        ) : (
                                            <Image
