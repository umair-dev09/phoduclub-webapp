                ...
                <div className="gap-[20px] flex flex-col border-b border-solid border-[#EAECF0] ">
                    ...
                    >
                        <div className="flex flex-col">
                            <div className="flex flex-row gap-2 w-full hover:bg-[#F8F0FF] items-start px-4 py-2">
                                <Checkbox
                                    size="md"
                                    color="primary" />
                                <button className='   <div className="flex flex-col gap-2 w-full'
                                    onClick={() => setActiveComponent('Video')}>
                            ...
                            <div className="flex flex-row gap-2 w-full hover:bg-[#F8F0FF]">
                                <Checkbox
                                    size="md"
                                    color="primary" />
                                <button className='bg-[#FFFFFF] w-full flex flex-col justify-center gap-2 h-[64px] px-4'>
