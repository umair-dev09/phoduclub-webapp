...
function sidebutton() {
    ...
    // const [iconCheckmarkRead, setIconCheckmarkRead] = useState({});
    // const [iconCheckmarkVideo, setIconCheckmarkVideo] = useState({});
    // Function to toggle the icon to a checkmark
    const [checkedComponent, setCheckedComponent] = useState<string | null>(null);

    const handleCheckmarkClick = (component: string) => {
        // Toggle checkmark state
        setCheckedComponent(checkedComponent === component ? null : component);
    };
                        ...
                        " onClick={() => setActiveComponent('Read')}
                            ...
                            <div className=" flex flex-row mt-3 ml-4">
                                ...
                                <button
                                    ...
                                    onClick={() => setIconCheckmarkRead('Read')} // Trigger icon change to checkmark on click
                                >
                                    {iconCheckmarkRead === 'Read' ? (
                                        <Image src="/icons/Green-tick.svg" width={20} height={20} alt="Checkmark" />
                                    ) : (
                                        <Image
                                            src={hoverRead ? "/icons/sidebuttonred.svg" : "/icons/sidebuttongray.svg"}
                                            width={20}
                                            height={20}
                                            alt="Icon"
                                        />
                                ...
                                <button className="icon-button" onClick={() => handleCheckmarkClick('Read')}>
                                    {checkedComponent === 'Read' ? (
                                        <Image src="/icons/Green-tick.svg" width={20} height={20} alt="Checkmark" />
                                    ) : (
                                        <Image
                                            src={hoverRead ? "/icons/sidebuttonred.svg" : "/icons/sidebuttongray.svg"}
                    ...
                    <div className={`h-[64px] gap-[16px] rounded-[8px] hover:bg-[#F8F0FF] ${activeComponent === 'Video' ? 'bg-[#F8F0FF]' : 'bg-[#FFFFFF]'}`}>
                        ...
                        "onClick={() => setActiveComponent('Video')}
                            ...
                            <div className=" flex flex-row mt-3 ml-4">
                                ...
                                <button
                                    className="icon-button" // Added a button specifically for the icon
                                    onClick={() => setIconCheckmarkVideo('Video')} // Trigger icon change to checkmark on click
                                >
                                    {iconCheckmarkVideo === 'Video' ? (
                                        <Image src="/icons/Green-tick.svg" width={20} height={20} alt="Checkmark" />
                                    ) : (
                                        <Image
                                            src={hoverVideo ? "/icons/sidebuttonred.svg" : "/icons/sidebuttongray.svg"}
                                            width={20}
                                            height={20}
                                            alt="Icon"
                                        />
                                ...
                                <button className="icon-button" onClick={() => handleCheckmarkClick('Video')}>
                                    {checkedComponent === 'Video' ? (
                                        <Image src="/icons/Green-tick.svg" width={20} height={20} alt="Checkmark" />
                                    ) : (
                                        <Image
                                            src={hoverVideo ? "/icons/sidebuttonred.svg" : "/icons/sidebuttongray.svg"}
                    ...
                    <div className={`h-[64px] gap-[16px] rounded-[8px] hover:bg-[#F8F0FF]  ${activeComponent === 'StartQuiz' ? 'bg-[#F8F0FF]' : 'bg-[#FFFFFF]'}`}>
                        <button className="flex justify-between"
                            ...
                            <div className=" flex flex-row mt-3 ml-4">
                                ...
                                <Image
                                    src={activeComponent === 'StartQuiz' || hoverStartQuiz ? "/icons/sidebuttonred.svg" : "/icons/sidebuttongray.svg"}
                                    width={20}
                                    height={20}
                                    alt=""
                                />
