            ...
            <div className="SideLayout w-[25%] flex flex-col bg-[#FFFFFF] overflow-y-auto p-3">
                ...
                <div className="gap-[20px] flex flex-col">
                    <button
                        ...
                        <div className={`h-[64px]  w-full gap-[16px] rounded-[8px]  hover:bg-[#F8F0FF] ${activeComponent === 'Read' ? 'bg-[#F8F0FF]' : 'bg-[#FFFFFF]'}`}>
                        ...
                        ">
                                ...
                                <div className="bg-red-500 h-[64px] w-full flex flex-1">
                                    sds
                                </div>
