...
function sidebutton() {
    return (
        <div className="flex flex-row w-screen" >
            <div className="MainCourseLayout flex flex-col w-[75%] bg-slate-700 overflow-y-auto py-3">
                {/* THIS IS THE HEADER PART OF MAIN---COURSE-----LAYOUT */}
                <div>
                    <div className="h-[64px] bg-red-500 ml-8 flex items-center ">
                        <div className="flex flex-row ">
                            <span className="text-[#1D2939] h-[24px] w-auto" style={{ fontSize: "16px", fontWeight: "600" }}>
                                Courses
                            </span>
                            <span className="ml-3 w-[24px]">
                                <Image
                            ...
                            <span className="text-[#667085] h-full w-auto -ml-1" style={{ fontSize: "16px", fontWeight: "500" }}>
                                BITSET Full Course
