                                ...
                                <div className=" flex flex-row mt-3 ml-4">
                                    ...
                                    <button
                                        ...
                                        onClick={(e) => {
                                            ...
                                            setIconChecked(!iconChecked); // Toggle the icon state
                                            setIconCheckmarkRead(iconChecked ? null : 'Read'); // Set 'Read' if not checked
                                        }} // Trigger icon change to checkmark on click
                                    >
                                        {iconChecked ? (
                                            <Image src="/icons/Green-tick.svg" width={20} height={20} alt="Checkmark" />
                                        ) : (
                                            <Image src="/icons/sidebuttongray.svg" width={20} height={20} alt="Icon" />
                                        )}

                                        {/* Optional: You can keep this part for the hover or active state */}
                                        <Image
                                            src={hoverRead || activeComponent === 'Read' ? "/icons/sidebuttonred.svg" : "/icons/sidebuttongray.svg"}
                                            width={20}
                                            height={20}
                                            alt="Icon"
                                        />
                                ...
                                <div className=" flex flex-row mt-3 ml-4">
                                    ...
                                    <button
                                        ...
                                        onClick={(e) => {
                                            e.stopPropagation(); // Prevent event from bubbling to the outer button
                                            setIconChecked(!iconChecked); // Toggle the icon state
                                            setIconCheckmarkRead(iconChecked ? null : 'Video'); // Set 'Read' if not checked
                                        }} // Trigger icon change to checkmark on click
                                    >
                                        {iconChecked ? (
                                            <Image src="/icons/Green-tick.svg" width={20} height={20} alt="Checkmark" />
                                        ...
                                        {/* Optional: You can keep this part for the hover or active state */}
                                        <Image
                                            src={hoverRead || activeComponent === 'Video' ? "/icons/sidebuttonred.svg" : "/icons/sidebuttongray.svg"}
                                            width={20}
                                            height={20}
                                            alt="Icon"
                                        />
