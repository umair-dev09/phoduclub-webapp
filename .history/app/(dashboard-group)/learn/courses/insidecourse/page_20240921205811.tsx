    ...
    return (
        <div className="flex flex-row w-screen" >
            <div className="MainCourseLayout flex flex-col w-[75%] h-[100vh]  overflow-y-auto py-3">
                ...
                <div className="ml-8 bg-red-500 mr-8 h-[300px] rounded-md">
                ...
                <div className="ml-8 h-[60px] mr-8  rounded-md flex items-center justify-center">
                ...
                <div className="ml-8 mr-8 h-[45px]  gap-[16px] flex  "
