            ...
            <div className="MainCourseLayout flex flex-col w-[75%] overflow-y-auto pt-3 pb-7">
                ...
                {activeComponent != 'StartQuiz' && (
                    <div className=" mt-[20px] rounded-md flex items-center justify-center flex-col">
                        ...
                        <div className="mr-8 ml-8 flex flex-row justify-between  h-[44px]">
                        ...
                        <div className="h-[45px] mt-[20px] gap-[16px] w-full ml-8 mr-8 flex" style={{ borderBottom: "2px solid #EAECF0" }}>
