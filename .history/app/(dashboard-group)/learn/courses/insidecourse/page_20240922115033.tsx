                    ...
                    <div className="my-5 flex items-center">
                        ...
                        <div className="text-[#667085] h-full w-auto -ml-1" style={{ fontSize: "16px", fontWeight: "500" }}>
                            ...
                            <Checkbox
                                ...
                                radius="full"
                                color="default"
                                size="lg" // Try increasing the size
                                className="bg-[#0B9055] rounded-full w-[24px] h-[24px] border-2 border-white" // Added border for visibility
                            ></Checkbox>
                        </div>
                    </div>
                    ...
                    <div className={`h-[64px] gap-[16px] rounded-[8px]  hover:bg-[#F8F0FF] ${activeComponent === 'Read' ? 'bg-[#F8F0FF]' : 'bg-[#FFFFFF]'}`}>
                        ...
                        " onClick={() => setActiveComponent('Read')}
                            ...
                            <div className=" flex flex-row mt-3 ml-4">
                                ...
                                <Image
                                    src={activeComponent === 'Read' || hoverRead ? "/icons/sidebuttonred.svg" : "/icons/sidebuttongray.svg"}
                                    width={20}
                                    height={20}
                                    alt=""
                                />
