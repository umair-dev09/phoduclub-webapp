                            ...
                            <div className=" flex flex-row mt-3 ml-4">
                                ...
                                >
                                    {iconCheckmarkRead === 'Read' ? (
                                        ...
                                        <Image
                                            src={hoverVideo || iconCheckmarkVideo === 'Read' ? "/icons/sidebuttonred.svg" : "/icons/sidebuttongray.svg"} // Show red icon when active or hovered
                                            width={20}
                                            height={20}
                                            alt="Icon"
                                        />
                            ...
                            <div className=" flex flex-row mt-3 ml-4">
                                ...
                                >
                                    {iconCheckmarkVideo === 'Video' ? (
                                        ...
                                        <Image
                                            src={hoverVideo || iconCheckmarkVideo === 'Video' ? "/icons/sidebuttonred.svg" : "/icons/sidebuttongray.svg"} // Show red icon when active or hovered
                                            width={20}
                                            height={20}
                                            alt="Icon"
                                        />
