    ...
    return (
        <div className="flex flex-row w-screen" >
            <div className="MainCourseLayout flex flex-col w-[75%]  overflow-y-auto py-3">
                ...
                <div className="ml-8 h-[60px] mr-8 mt-[24px] rounded-md flex items-center justify-center">
                    <div className="flex flex-row justify-between w-full h-[44px]">
                        <button className="h-full w-[111px] rounded-[8px] bg-[#FFFFFF]"
                            style={{ border: "1.5px solid #EAECF0" }}>
                            <span className="font-normal text-sm text-[#1D2939]">Previous</span>
                        </button>
                        <button className="h-full w-[111px] rounded-[8px] bg-[#FFFFFF]"
                            style={{ border: "1.5px solid #EAECF0" }}>
                            <span className="font-normal text-sm text-[#1D2939]">Next</span>
                        </button>
                    </div>
                </div>
