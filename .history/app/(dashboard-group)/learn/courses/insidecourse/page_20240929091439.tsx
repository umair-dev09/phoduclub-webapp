                ...
                {activeComponent != 'StartQuiz' && (
                    <div className="ml-8 h-[60px] mr-8 mt-[20px] rounded-md flex items-center justify-center">
                        ...
                        <div className="flex flex-row justify-between w-full h-[44px]">
                            <button className="h-full w-[111px] rounded-[8px] bg-[#FFFFFF]  hover:bg-[#8501FF] hover:shadow-inner-button "
                                style={{ border: "1.5px solid #EAECF0" }}>
                                <span className="font-normal text-sm text-[#1D2939] hover:text-[#FFFFFF] hover:font-semibold">Previous</span>
                            </button>
                            <button
