                        ...
                        <div className="flex flex-col">
                            <div className="flex flex-row gap-2 w-full hover:bg-[#F8F0FF]  px-4 py-2">
                                ...
                                <button className='flex flex-col gap-2 w-full'
                                    onClick={() => setActiveComponent('Video')}>
                                    <span className="font-medium text-base text-[#1D2939] text-left">1.Lesson 01</span>
                                    <div className='flex flex-row gap-2'>
                                        <Image
                                            src="/icons/vedio.svg"
                                            width={16}
                            ...
                            <div className="flex flex-row gap-2 w-full hover:bg-[#F8F0FF]  px-4 py-2">
                                ...
                                <button className='flex flex-col gap-2 w-full'
                                    onClick={() => setActiveComponent('Video')}>
                                    <span className="font-medium text-base text-[#1D2939] text-left">1. Chapter 01 Introduction</span>
                                    <div className='flex flex-row gap-2'>
                                        <Image
                                            src="/icons/vedio.svg"
                                            width={16}
