        ...
        <div className="flex flex-row w-screen" >
            ...
            <div className="SideLayout w-[25%] flex flex-col bg-[#FFFFFF] overflow-y-auto p-3">
                ...
                <div className="gap-[20px] flex flex-col">
                    <div className={`h-[64px] gap-[16px] rounded-[8px] ${activeComponent === 'Read' ? 'bg-[#F8F0FF]' : 'bg-[#FFFFFF]'}`}>
                        <button className="flex justify-between 
                        " onClick={() => setActiveComponent('Read')}>
                            {/* ------------------------------------------------------------------------------------------------------------------- */}
                            <div className=" flex flex-row mt-3 ml-4">
                                <Image
                                    src={activeComponent === 'Read' ? "/icons/sidebuttonred.svg" : "/icons/sidebuttongray.svg"}
                                    width={20}
                                    height={20}
                                    alt="" />
                    ...
                    <div className={`h-[64px] gap-[16px] rounded-[8px] ${activeComponent === 'Video' ? 'bg-[#F8F0FF]' : 'bg-[#FFFFFF]'}`}>
                        <button className="flex justify-between
                        "onClick={() => setActiveComponent('Video')}>
                            {/* ------------------------------------------------------------------------------------------------------------------- */}
                            <div className=" flex flex-row mt-3 ml-4">
                                <Image
                                    src={activeComponent === 'Video' ? "/icons/sidebuttonred.svg" : "/icons/sidebuttongray.svg"}
                                    width={20}
                                    height={20}
                                    alt="" />
                    ...
                    <div className={`h-[64px] gap-[16px] rounded-[8px] ${activeComponent === 'StartQuiz' ? 'bg-[#F8F0FF]' : 'bg-[#FFFFFF]'}`}>
                        <button className="flex justify-between"
                            onClick={() => setActiveComponent('StartQuiz')}>
                            {/* ---------------------------------------------------------------------------------------------------------------------------------- */}
                            <div className=" flex flex-row mt-3 ml-4">
                                <Image
                                    src={activeComponent === 'StartQuiz' ? "/icons/sidebuttonred.svg" : "/icons/sidebuttongray.svg"}
                                    width={20}
                                    height={20}
                                    alt="" />
