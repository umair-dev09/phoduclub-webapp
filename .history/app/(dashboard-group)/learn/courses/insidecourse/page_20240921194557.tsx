    ...
    return (
        <div className="flex flex-row w-screen" >
            <div className="MainCourseLayout flex flex-col w-[75%]  overflow-y-auto py-3">
                ...
                <div className="ml-8 bg-red-500 mr-8 h-[445px] mt-[24px] rounded-md">
                ...
                <div className="ml-8  bg-slate-950 h-[60px]  mr-8 mt-[24px] rounded md">

                    <div className="flex  flex-row justify-between h-[44px] w-[111px]">
                        <button className="h-[44px] rounded md bg-red-700">
                            Prevois
                        </button>
                        <button className="h-[44px] rounded md bg-red-700 w-[111px]">
                            Next
                        </button>
