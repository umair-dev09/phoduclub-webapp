            ...
            <div className="SideLayout w-[25%] flex flex-col bg-[#FFFFFF] overflow-y-auto p-3">
                ...
                <div className="gap-[20px] flex flex-col">
                    <button
                        ...
                        <div className={`h-[64px]  w-[100%] rounded-[8px]  hover:bg-[#F8F0FF] ${activeComponent === 'Read' ? 'bg-[#F8F0FF]' : 'bg-[#FFFFFF]'}`}>
                            <button className="flex justify-between 
                        ">
                                <div className=" flex flex-row mt-3 ml-4 w-[20%]">
                                ...
                                {/* ------------------------------------------------------------------------------------------------------------------------- */}
                                {/* <div className="flex flex-col h-[64px] gap-[4px] pt-2 pl-3">
                                    <span className="gap-[4px] text-1g text-[#1D2939] font-bold item">1. Welcome and Introduction</span>
                                ...
                                <div className="bg-red-500 h-[64px] w-[80%] flex flex-1">
                                    sds
                                </div>
