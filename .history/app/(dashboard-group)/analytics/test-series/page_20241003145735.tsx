                                ...
                                <div style={{ height: '300px' }}>
                                    <ResponsiveContainer width="100%" height="100%">
                                        <LineChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                                            ...
                                            />
                                            <Line type="monotone" dataKey="overall" stroke="#973AFF" dot={false} strokeWidth={20} />
                                            <Line type="monotone" dataKey="correct" stroke="#17B26A" dot={false} strokeWidth={20} />
                                            <Line type="monotone" dataKey="incorrect" stroke="#F04438" dot={false} strokeWidth={20} />
