    ...
    if (active && payload && payload.length) {
        ...
        return (
            <div style={{
                ...
                {/* Tooltip content */}
                <div className="m-2">
                    <div style={{ display: 'flex', alignItems: 'center', width: "139px", height: "27px", justifyItems: 'center', background: "red" }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', width: "139px", height: "27px", justifyItems: 'center', background: "green" }}>
                        <div style={{ display: 'flex', alignItems: 'center', }}>
                            ...
                            <span className="ml-17 mr-2 font-semibold text-base text-[#1D2939]">{incorrectValue}</span>
                        </div>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', width: "139px", height: "27px", justifyItems: 'center', background: "yellow" }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '3px' }}>
                            <span style={{
                                display: 'inline-block',
                                width: '10px',
