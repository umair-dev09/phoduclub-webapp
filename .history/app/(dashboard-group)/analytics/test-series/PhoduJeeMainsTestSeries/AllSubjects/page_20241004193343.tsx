...
import DifficultyAnalysis from "@C/components/DashboardComponents/AnalyticsComponents/Test-Series-Components/AllSubjectsComponents/DifficultyAnalysis";
function JeeMains() {
    ...
    return (
        <div className="flex flex-1 flex-col h-auto overflow-y-auto pb-2">
            ...
            {/* Difficulty Analysis */}
            <div id="hours" className="mx-8 h-[44px] flex flex-row  mb-2">
