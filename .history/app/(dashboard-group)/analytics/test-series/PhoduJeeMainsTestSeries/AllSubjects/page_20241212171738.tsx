                ...
                <div className="h-[50px] border-b border-solid border-[#EAECF0] flex flex-row gap-[16px] mt-2 mx-8">
                    ...
                    >
                        ...
                        <Tab
                            ...
                            title={
                                <div className="flex items-center space-x-2">
                                    <span className="font-medium text-base">Graphical View of Overview</span>
                                </div>
                            }
                        />
                        <Tab
                            ...
                            title={
                                <div className="flex items-center space-x-2">
                                    <span className="font-medium text-base">Time & Accuracy</span>
                                </div>
                            }
                        />
                        <Tab
                            ...
                            title={
                                <div className="flex items-center space-x-2">
                                    <span className="font-medium text-base">Attempts</span>
                                </div>
                            }
                        />
                    </Tabs>
                    ...
                    <div id="graphical-view" className="my-16">
                        <h2>Graphical View Section</h2>
                        <p>Content for the graphical view section.</p>
                    </div>
                    <div id="time-accuracy" className="my-16">
                        <h2>Time & Accuracy Section</h2>
                        <p>Content for the time and accuracy section.</p>
                    </div>
                    <div id="attempts" className="my-16">
                        <h2>Attempts Section</h2>
                        <p>Content for the attempts section.</p>
                    </div>
                </div>
            </div>
