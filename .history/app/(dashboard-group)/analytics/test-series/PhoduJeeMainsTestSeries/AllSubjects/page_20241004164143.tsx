...
function JeeMains() {
    ...
    return (
        ...
        <div className="flex flex-1 flex-col h-auto overflow-y-auto pb-2">
            ...
            {/* overview Line */}
            <div id="overview" className="mx-8 h-[44px] flex flex-col justify-end mt-5 gap-4">
                <span className="text-[#1D2939] text-lg font-semibold">Overview</span>
                <span className="font-normal text-[#475467] text-xs">Summary of marks scored in the test</span>
            </div>
            {/* Overall Data */}
