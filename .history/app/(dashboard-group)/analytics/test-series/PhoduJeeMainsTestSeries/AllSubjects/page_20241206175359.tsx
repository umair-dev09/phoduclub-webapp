    ...
    return (
        <div className="flex flex-1 flex-col h-auto overflow-y-auto pb-2">
                ...
                <div className="h-[50px] border-b border-solid border-[#EAECF0] flex flex-row gap-[16px] mt-2 mx-8">
                    ...
                    >
                        ...
                        <Tab
                            ...
                            title={
                                <div className="flex items-center space-x-2">
                                    <a href="#Attemptsoverthe3ours" className=" font-medium text-base">Attempts over the 3 hours</a>
                                </div>
                            }
                        />
                        <Tab
            ...
            <div className="overflow-y-auto flex-1 flex flex-col h-auto px-8">
                ...
                <div id="Graphicalviewofoverview" className="h-[44px] flex flex-col justify-end mb-4">
                ...
                {/* --------------------------------------******************************************************---------------------------------------------- */}
                {/* Difficulty Analysis */}
                <div id="DifficultyAnalysis" className="h-[44px] flex flex-row  mb-2 items-center gap-2">
                ...
                <div id="Attemptsoverthe3hours" className="h-[44px] flex flex-row items-center gap-2 mb-2">
                ...
                {/* --------------------------------------******************************************************---------------------------------------------- */}
                {/* Complete Analysis */}
                <div id="CompleteAnalysis" className="h-[44px] flex flex-col  mb-2">
