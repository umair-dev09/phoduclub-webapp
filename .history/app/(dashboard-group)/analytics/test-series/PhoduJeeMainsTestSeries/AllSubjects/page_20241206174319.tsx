    ...
    return (
        <div className="flex flex-1 flex-col h-auto overflow-y-auto pb-2">
                ...
                <div className="h-[50px] border-b border-solid border-[#EAECF0] flex flex-row gap-[16px] mt-2 mx-8">
                    ...
                    >
                        ...
                        <Tab
                            ...
                            title={
                                <div className="flex items-center space-x-2">
                                    <a href="#Graphical view of overview" className=" font-medium text-base">Graphical view of overview</a>
                                </div>
                            }
                        />
                        <Tab
                        ...
                        <Tab
                            ...
                            title={
                                <div className="flex items-center space-x-2">
                                    <a href="#Difficulty Analysis" className=" font-medium text-base">Difficulty Analysis</a>
                                </div>
                            }
                        />
                        <Tab
                            ...
                            title={
                                <div className="flex items-center space-x-2">
                                    <a href="#Attempts over the 3 hours" className=" font-medium text-base">Attempts over the 3 hours</a>
                                </div>
                            }
                        />
                        <Tab
            ...
            <div className="overflow-y-auto flex-1 flex flex-col h-auto px-8">
                ...
                <div id="Graphical view of overview" className="h-[44px] flex flex-col justify-end mb-4">
                ...
                {/* --------------------------------------******************************************************---------------------------------------------- */}
                {/* Time & Accuracy */}
                <div id="Time & Accuracy" className="h-[44px] flex flex-row  mb-2 items-center gap-2">
                ...
                {/* --------------------------------------******************************************************---------------------------------------------- */}
                {/* Attempts */}
                <div id="Attempts" className="h-[44px] flex flex-col justify-end mb-4">
                ...
                {/* --------------------------------------******************************************************---------------------------------------------- */}
                {/* Difficulty Analysis */}
                <div id="Difficulty Analysis" className="h-[44px] flex flex-row  mb-2 items-center gap-2">
                ...
                <div id="Attempts over the 3 hours" className="h-[44px] flex flex-row items-center gap-2 mb-2">
                ...
                {/* --------------------------------------******************************************************---------------------------------------------- */}
                {/* Complete Analysis */}
                <div id="Complete Analysis" className="h-[44px] flex flex-col  mb-2">
                ...
                {/* --------------------------------------******************************************************---------------------------------------------- */}
                {/* Summary */}
                <div id="Summary" className="h-[44px] flex flex-row items-center mt-6 mb-2 gap-2">
