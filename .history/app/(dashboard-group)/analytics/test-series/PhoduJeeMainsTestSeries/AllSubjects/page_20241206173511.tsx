                ...
                <div className="h-[50px] border-b border-solid border-[#EAECF0] flex flex-row gap-[16px] mt-2 mx-8">
                    ...
                    >
                        ...
                        <Tab
                            ...
                            title={
                                <div className="flex items-center space-x-2">
                                    <a href="#attempts" className=" font-medium text-base">Graphical view of overview</a>
                                </div>
                            }
                        />
                        <Tab
                            ...
                            title={
                                <div className="flex items-center space-x-2">
                                    <a href="#hours" className=" font-medium text-base">Time & Accuracy</a>
                                </div>
                            }
                        />
                        <Tab
                            ...
                            title={
                                <div className="flex items-center space-x-2">
                                    <a href="#hours" className=" font-medium text-base">Attempts</a>
                                </div>
                            }
                        />
                        <Tab
                            ...
                            title={
                                <div className="flex items-center space-x-2">
                                    <a href="#hours" className=" font-medium text-base">Difficulty Analysis</a>
                                </div>
                            }
                        />
                        <Tab
                            ...
                            title={
                                <div className="flex items-center space-x-2">
                                    <a href="#complete-analysis" className=" font-medium text-base">Attempts over the 3 hours</a>
                                </div>
                            }
                        />
                        <Tab
