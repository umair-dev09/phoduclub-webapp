                ...
                <table className="w-full rounded-xl bg-white text-sm font-medium">
                    <thead>
                        <tr className="text-[#667085]">
                            <th className="w-[7%] px-8 py-3 text-left">Subject</th>
                    ...
                    <tbody className="border-b border-[#EAECF0]">
                        <tr className="border-t border-[#EAECF0]">
                            ...
                            <td className="px-8 py-3 text-left text-[#1D2939] font-semibold text-sm">200/300</td>
                        ...
                        <tr className="border-t border-[#EAECF0]">
                            ...
                            <td className="px-8 py-3 text-left text-[#1D2939] font-semibold text-sm">100/300</td>
                            <td className="px-8 py-3 text-left text-[#1D2939] font-normal text-sm">5/75</td>
                        ...
                        <tr className="border-t border-[#EAECF0]">
                            ...
                            <td className="px-8 py-3 text-left text-[#1D2939] font-semibold text-sm">250/300</td>
                        ...
                        <tr className="border-t border-[#EAECF0]">
                            ...
                            <td className="px-8 py-3 text-left text-[#1D2939] font-semibold text-sm">20/300</td>
                            <td className="px-8 py-3 text-left text-[#1D2939] font-normal text-sm">5/75</td>
                            <td className="px-8 py-3 text-left text-[#1D2939] font-normal text-sm">1/25</td>
