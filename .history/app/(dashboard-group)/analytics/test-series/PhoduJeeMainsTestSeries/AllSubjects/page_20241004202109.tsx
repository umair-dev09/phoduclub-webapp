            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="h-auto  mx-8 bg-[#FFFFFF] border border-solid border-[#EAECF0] p-3  rounded-md">
                    <div className=" flex flex-col gap-2 ml-2">
                        ...
                        <span className="font-normal text-[#667085] text-sm ml-1">1.Extraction of Aluminum by Purification of Bauxite</span>
                        <span className="font-normal text-[#667085] text-sm ml-1">2.Types of Interhalogens</span>
                ...
                <div className="h-auto  mx-8 bg-[#FFFFFF] border border-solid border-[#EAECF0] p-3  rounded-md">
                    <div className=" flex flex-col gap-2 ml-2">
                        ...
                        <span className="font-normal text-[#667085] text-sm ml-1">1.Condition of one common root</span>
                        <span className="font-normal text-[#667085] text-sm ml-1">2.Condition for a line to be secant, tangent or a chord</span>
                        <span className="font-normal text-[#667085] text-sm ml-1">3.Question on tan inverse</span>
                        <span className="font-normal text-[#667085] text-sm ml-1">4.When limit tends to 0 or finite number</span>
