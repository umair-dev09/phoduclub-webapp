        ...
        <div className="flex flex-1 flex-col h-auto overflow-y-auto px-8 pb-2">
            <div>
                ...
                <div className="overflow-y-auto flex-1 flex flex-col h-auto">
                    ...
                    {/* --------------------------------------******************************************************---------------------------------------------- */}
                    {/* Summary */}
                    <div className="h-[44px] flex flex-row items-center mt-6 mb-2">
                        <span className="text-[#1D2939] text-lg font-semibold mr-1">Summary</span>
                        <Image
                            src="/icons/information-circle.svg"
                            width={20}
                            height={20}
                            alt="information-icon"
                            className="ml-2"  // Adding left margin between text and image
                        />
                    </div>
