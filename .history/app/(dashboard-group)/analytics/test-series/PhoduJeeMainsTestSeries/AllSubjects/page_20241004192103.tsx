    ...
    return (
        <div className="flex flex-1 flex-col h-auto overflow-y-auto pb-2">
            ...
            <div className="h-auto mx-8 rounded-xl  bg-[#FFFFFF] border border-solid border-[#EAECF0]">
                <table className="w-full rounded-xl bg-white text-sm font-medium">
                    <thead>
                        <tr className="text-[#667085] flex-row flex">
                            <div className="flex flex-row gap-2">
                                <th className="w-[10%] px-8 py-3 text-left ">Subject
                                    <Image
                            ...
                            <div className="flex flex-row gap-2">
                                <th className="w-[10%] px-8 py-3 text-left ">Perfect
                                    <Image
                                        src="/icons/information-circle.svg"
                                        width={16}
                                        height={16}
                            ...
                            <div className="flex flex-row gap-2">
                                <th className="w-[10%] px-8 py-3 text-left ">Wasted
                                    <Image
                                        src="/icons/information-circle.svg"
                                        width={16}
                                        height={16}
                            ...
                            <div className="flex flex-row gap-2">
                                <th className="w-[10%] px-8 py-3 text-left ">Overtime
                                    <Image
                                        src="/icons/information-circle.svg"
                                        width={16}
                                        height={16}
                            ...
                            <div className="flex flex-row gap-2">
                                <th className="w-[10%] px-8 py-3 text-left ">Confused
                                    <Image
                                        src="/icons/information-circle.svg"
                                        width={16}
                                        height={16}
                    ...
                    <tbody className="border-b border-[#EAECF0]">
                        <tr className="border-t border-[#EAECF0]">
                            <td className="px-3 py-3 text-left text-[#1D2939] font-semibold text-sm">Overall</td>
                            <td className="px-3 py-3 text-left text-[#1D2939] font-normal text-sm">2</td>
                            <td className="px-3 py-3 text-left text-[#1D2939] font-normal text-sm">5</td>
                            <td className="px-3 py-3 text-left text-[#1D2939] font-normal text-sm">15</td>
                            <td className="px-3 py-3 text-left text-[#1D2939] font-normal text-sm">25</td>
