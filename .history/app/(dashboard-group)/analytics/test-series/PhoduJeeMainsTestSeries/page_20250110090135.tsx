...
function JeeMains() {
    ...
    return (
        <div className="flex flex-1 flex-col pb-3 overflow-y-auto">
            <div className="h-[64px] ml-8 flex items-center">
                <div className="my-5 flex items-center">
                    ...
                    <button className="text-[#667085] h-full w-auto -ml-1 font-medium text-base">
                        ...
                        trigger={
                            ...
                            >
                                <div className="flex flex-col gap-1">
                                    ...
                                    <p className="text-[#667085] font-normal text-sm">5 Tests</p>
                                </div>
                        ...
                        trigger={
                            ...
                            >
                                ...
                                <div className="flex flex-row">
                                    ...
                                    <Image
                                        src={isOpenArray[1] ? "/icons/arrowdown.svg" : "/icons/arrowup.svg"} // Arrow based on first accordion state
                                        width={24}
                                        height={24}
                                        alt="arrow"
                                    />
