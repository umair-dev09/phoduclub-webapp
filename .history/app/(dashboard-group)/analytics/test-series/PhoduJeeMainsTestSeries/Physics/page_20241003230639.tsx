            ...
            <div className="h-auto mx-8 rounded-xl  bg-[#FFFFFF] border border-solid border-[#EAECF0]">
                ...
                <div className="flex flex-row justify-center h-[70px] items-center gap-4">
                    <div>
                        ...
                        <span className="font-normal text-[#667085] text-sm">correct</span>
                    </div>
                    <div>
                        <span style={{
                            display: 'inline-block',
                        ...
                        <span className="font-normal text-[#667085] text-sm">Incorrect</span>
                    </div>
                    <div>
                        <span style={{
                            display: 'inline-block',
                        ...
                        <span className="font-normal text-[#667085] text-sm">overall</span>
                    </div>
