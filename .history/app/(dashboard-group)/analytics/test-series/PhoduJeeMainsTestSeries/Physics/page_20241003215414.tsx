    ...
    return (
        <div className="flex flex-1 flex-col h-auto overflow-y-auto">
            ...
            <div className="h-[50px]  mx-8 bg-[#FFFFFF] border-b border-solid border-[#EAECF0] flex flex-row gap-[16px] mt-3">
                ...
                <span className="text-[#667085] font-medium text-lg">Overview</span>
                <span className="text-[#667085] font-medium text-lg">Attempts & Difficulty Analysis</span>
                <span className="text-[#667085] font-medium text-lg">Attempts over the 3 hours</span>
                <span className="text-[#667085] font-medium text-lg">Missed Concept</span>
                <span className="text-[#667085] font-medium text-lg">Complete Analysis</span>
