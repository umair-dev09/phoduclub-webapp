    ...
    return (
        <div className="flex flex-1 flex-col h-auto overflow-y-auto pb-2">
            ...
            <div className="h-[539px] mx-8 rounded-xl  bg-[#FFFFFF] border border-solid border-[#EAECF0]">
                <table className="w-full border border-lightGrey rounded-xl bg-white text-sm font-medium">
                    <thead>
                    ...
                    <tbody>
                        <tr className="border-t border-lightGrey">
                            <td className="px-8 py-3 text-left">First 30 mins</td>
                            <td className="text-center">143/150</td>
                            <td className="text-center">80%</td>
                            <td className="text-center">45h 30m</td>
                        </tr>
