        ...
        <div className="flex flex-1 flex-col h-auto overflow-y-auto">
            ...
            <div>
                ...
                <Popover placement="bottom-start">
                    <PopoverTrigger>
                        <button className="ml-8  bg-[#EDE4FF] rounded-md  items-center justify-center flex  outline-none transition-colors duration-150">
                            <div className="flex flex-row items-center gap-2 p-2">
                                <span className="font-medium text-xs text-[#9012FF]">Attempt 1 - Jan 6, 2024  05:32 PM</span>
                                <Image
                    ...
                    <PopoverContent className="w-auto px-0 py-1 rounded-md border border-lightGrey">
                        <button
                            ...
                            <p className='text-sm text-[#0C111D] font-normal '>Attempt 1 - Jan 6, 2024  05:01 PM</p>
                        </button>
                        <button
                            className='flex flex-row items-center w-full px-4 py-[10px] gap-1 transition-colors duration-150 hover:bg-[#EDE4FF]'>
                            <p className='text-sm text-[#0C111D] font-normal '>Attempt 2 - Jan 7, 2024  06:32 PM</p>
                        </button>
                        <button
                            className='flex flex-row items-center w-full px-4 py-[10px] gap-1 transition-colors duration-150 hover:bg-[#EDE4FF]'>
                            <p className='text-sm text-[#0C111D] font-normal '>Attempt 3 - Jan 10, 2024  10:15 PM</p>
                        </button>
                        <button
                            className='flex flex-row items-center w-full px-4 py-[10px] gap-1 transition-colors duration-150 hover:bg-[#EDE4FF]'>
                            <p className='text-sm text-[#0C111D] font-normal '>Attempt 4 - Jan 1, 2024  12:32 PM</p>
                        </button>
                        <button
                            className='flex flex-row items-center w-full px-4 py-[10px] gap-1 transition-colors duration-150 hover:bg-[#EDE4FF]'>
                            <p className='text-sm text-[#0C111D] font-normal '>Attempt 5 - Jan 18, 2024  05:32 PM</p>
                        </button>
                    </PopoverContent>
                </Popover>
    ...
    <ModalContent>
        <>
            <ModalHeader className="flex flex-row justify-between items-center gap-1">
                ...
                <button className="w-[32px] h-[32px]  rounded-full flex items-center justify-center transition-all duration-300 ease-in-out hover:bg-[#F2F4F7]">
                    <button><Image src="/icons/cancel.svg" alt="Cancel" width={20} height={20} onClick={() => setShowQuizDialog(false)} /></button>
                </button>
            </ModalHeader>
            <ModalBody>
            ...
            <ModalFooter className="border-t border-lightGrey">
                <Button variant="light" className="py-[0.625rem] px-6 border-2  border-solid border-[#EAECF0] font-semibold text-sm text-[#1D2939] rounded-md hover:bg-[#F2F4F7]" onClick={() => setShowQuizDialog(false)}>Cancel</Button>
                <Button className="py-[0.625rem] px-6 text-white text-sm shadow-inner-button font-semibold border border-solid  border-white bg-[#9012FF] hover:bg-[#6D0DCC]  rounded-md">Send</Button>
            </ModalFooter>
        </>
    </ModalContent>
</Modal >