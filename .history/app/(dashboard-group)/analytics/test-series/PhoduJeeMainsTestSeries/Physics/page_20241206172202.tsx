...
function JeeMains() {
    ...
    return (
        <div className="flex flex-1 flex-col h-auto overflow-y-auto">
            ...
            <div className="h-[50px] border-b border-solid border-[#EAECF0] flex flex-row gap-[16px] mt-2 mx-8"></div>
            <Tabs
            ...
            >
                ...
                <Tab
                    ...
                    title={
                        <div className="flex items-center space-x-2">
                            <a href="#missed-concept" className=" font-medium text-base">Missed Concept</a>
                        </div>
                    }
                />
                <Tab
