            ...
            <div className="h-[539px] mx-8 rounded-xl  bg-[#FFFFFF] border border-solid border-[#EAECF0]">
                <table className="flex flex-col w-full h-min border border-lightGrey rounded-xl bg-white text-sm font-medium">
                    <tr className="flex flex-1 py-3 text-neutral-500">
                        <td className="w-[35%] px-8">Test</td>
                        <td className="w-[23%] text-center"><p>Scores</p></td>
                        <td className="w-[23%] text-center"><p>Attempted Question</p></td>
                        <td className="w-[23%] text-center"><p>Accuracy</p></td>
