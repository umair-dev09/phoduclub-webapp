...
function JeeMains() {
    ...
    return (
        <div className="flex flex-1 flex-col h-auto overflow-y-auto">
            ...
            <div className="h-[40px]  mx-8  border-b border-solid border-[#EAECF0] flex flex-row gap-[16px] mt-4">
            ...
            <div className="mx-8 h-[34px] flex flex-col justify-end  ">
            ...
            <div className="flex flex-row gap-4 h-[265px] mx-8">
                <div className=" rounded-xl h-[265px] flex-col bg-[#FFFFFF] border border-solid border-[#EAECF0]">
