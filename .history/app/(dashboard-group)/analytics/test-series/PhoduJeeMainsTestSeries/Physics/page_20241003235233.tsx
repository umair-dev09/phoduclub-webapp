    ...
    return (
        <div className="flex flex-1 flex-col h-auto overflow-y-auto pb-2">
            ...
            <div className="h-auto flex flex-row">
                <span className="text-[#667085] font-normal text-sm">Great! You did not miss any concept.</span>
                <span className="text-[#667085] font-normal text-sm">Great! You did not miss any concept.</span>    <span className="text-[#667085] font-normal text-sm">Great! You did not miss any concept.</span>
            </div>
