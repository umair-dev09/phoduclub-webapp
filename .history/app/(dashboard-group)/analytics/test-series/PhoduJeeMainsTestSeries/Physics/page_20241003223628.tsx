...
function JeeMains() {
    ...
    return (
        <div className="flex flex-1 flex-col h-auto overflow-y-auto pb-2">
            ...
            <div className="h-[539px] mx-8 rounded-xl  bg-[#FFFFFF] border border-solid border-[#EAECF0]">
                <table className="flex flex-col w-full h-min border border-lightGrey rounded-xl bg-white text-sm font-medium">
                    <tr className="flex flex-1 py-3 text-[#667085]">
                        <td className="w-[30%] px-8">Interval</td>
                        <td className="w-[23%] text-center"><p>Correct</p></td>
                        <td className="w-[23%] text-center"><p>Incorrect</p></td>
                        <td className="w-[23%] text-center"><p>Overall</p></td>


                    </tr>
                    <td className="flex justify-center items-center w-[30%]">First 30 mins</td>
                    <td className="flex justify-center items-center w-[23%]">143/150</td>
                    <td className="flex justify-center items-center w-[23%]">80%</td>
                    <td className="flex justify-center items-center w-[23%]">45h 30m</td>
