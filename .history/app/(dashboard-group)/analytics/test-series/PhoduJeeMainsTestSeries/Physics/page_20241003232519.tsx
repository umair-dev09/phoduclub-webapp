                ...
                <table className="w-full rounded-xl bg-white text-sm font-medium">
                    <thead>
                        <tr className="text-[#667085]">
                            ...
                            <th className="w-[23%] text-center">Chapter</th>
                            <th className="w-[23%] text-center">Difficulty</th>
                            <th className="w-[23%] text-center">Allotted</th>
                            <th className="w-[23%] text-center">Spent</th>
                            <th className="w-[23%] text-center">Attempted</th>
                            <th className="w-[23%] text-center">Answer</th>
                            <th className="w-[23%] text-center">Remarks</th>
