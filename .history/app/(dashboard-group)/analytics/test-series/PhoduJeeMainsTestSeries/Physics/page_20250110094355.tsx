    ...
    return (
        <div className="flex flex-1 flex-col h-auto overflow-y-auto">
            ...
            <div className="overflow-y-auto flex-1 flex flex-col h-auto px-8">
                {/* overview Line */}
                <div onClick={() => { setShowpremiumDialog(true) }} id="overview" className="h-[44px] flex flex-col justify-end py-2 cursor-pointer">
            ...
            <div>
                ...
                {/* <Dialog open={showpremiumDialog} onClose={() => setShowQuizDialog(false)} className="relative z-50">
