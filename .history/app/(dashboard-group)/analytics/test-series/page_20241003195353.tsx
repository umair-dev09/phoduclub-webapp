                ...
                <div className=" gap-[6px] flex flex-col">
                    <div style={{ display: 'flex', alignItems: 'center', width: "auto", height: "auto", justifyItems: 'center', }}>
                        <div style={{ display: 'flex', alignItems: 'center', }}>
                            ...
                            <span className="font-semibold text-base text-[#1D2939]" style={{ marginLeft: '76px' }}>
                                {correctValue}
                            </span>
                        </div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', width: "auto", height: "auto", justifyItems: 'center' }}>
                        <div style={{ display: 'flex', alignItems: 'center', }}>
                            ...
                            <span className="font-semibold text-base text-[#1D2939]" style={{ marginLeft: '70px' }}>{incorrectValue}</span>
                        </div>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', width: "auto", height: "auto", justifyItems: 'center' }}>
                        <div style={{ display: 'flex', alignItems: 'center', }}>
