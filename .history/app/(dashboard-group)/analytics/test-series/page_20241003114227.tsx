                ...
                <div className="m-2">
                    <div style={{ display: 'flex', alignItems: 'center', width: "full", height: "27px", justifyItems: 'center', background: "red" }}>
                        <div style={{ display: 'flex', alignItems: 'center', }}>
                            ...
                            <span className="font-semibold text-base text-[#1D2939]" style={{ marginLeft: '70px' }}>
                                {correctValue}
                            </span>
                        </div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', width: "full", height: "27px", justifyItems: 'center', background: "green" }}>
                        <div style={{ display: 'flex', alignItems: 'center', }}>
                            ...
                            <span className="font-semibold text-base text-[#1D2939]" style={{ marginLeft: '65px' }}>{incorrectValue}</span>
                        </div>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', width: "full", height: "27px", justifyItems: 'center', background: "yellow" }}>
                        <div style={{ display: 'flex', alignItems: 'center', }}>
                            ...
                            <span className="font-semibold text-base text-[#1D2939]" style={{ marginLeft: '70px' }}>{overallValue}</span>
                        </div>
                    </div>
                </div>
            </div>
