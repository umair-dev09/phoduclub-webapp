                                ...
                                <div style={{ height: '300px' }}>
                                    <ResponsiveContainer width="100%" height="100%">
                                        <LineChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                                            ...
                                            />
                                            <Line type="monotone" dataKey="overall" fill="#973AFF" dot={false} />
                                            <Line type="monotone" dataKey="correct" fill="#17B26A" dot={false} />
                                            <Line type="monotone" dataKey="incorrect" fill="#F04438" dot={false} />
