    ...
    if (active && payload && payload.length) {
        ...
        return (
            <div style={{
                ...
                {/* Tooltip content */}
                <div className="">
                    <div style={{ display: 'flex', alignItems: 'center', width: "auto", height: "auto", justifyItems: 'center', gap: "6px" }}>
                        <div style={{ display: 'flex', alignItems: 'center', }}>
                            ...
                            <span className=" ml-10 font-semibold text-base text-[#1D2939]">{correctValue}</span>
                        </div>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', width: "auto", height: "auto", justifyItems: 'center', gap: "6px" }}>
                        <div style={{ display: 'flex', alignItems: 'center', }}>
