    ...
    if (active && payload && payload.length) {
        ...
        return (
            <div style={{
                ...
                {/* Tooltip content */}
                <div className="m-2">
                    <div style={{ display: 'flex', alignItems: 'center', width: "139px", height: "27px", justifyItems: 'center', backgroundColor: "red" }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', width: "139px", height: "27px", justifyItems: 'center' }}>
                        <div style={{ display: 'flex', alignItems: 'center', }}>
                            ...
                            <span>{`inCorrect `}</span>
                            <span className="ml-12 mr-3 font-semibold text-base text-[#1D2939]">{correctValue}</span>
