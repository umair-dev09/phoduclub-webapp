...
function Quizzes() {
    ...
    const handleClick = (data: { payload: any; }, index: any) => {
            ...
            <div className="flex w-full h-auto flex-row gap-4">
                <div className="w-1/2 rounded-xl h-[320px] flex-col bg-[#FFFFFF] border border-solid border-[#EAECF0]">
                    <div className="h-[50px] flex flex-row justify-between mt-3 ">
                        <span className="flex items-center justify-center  font-semibold text-[#1D2939] text-lg">Attempted Questions</span>
                    ...
                    >
                        ...
                        <Bar dataKey="correct" fill="#17B26A" barSize={55} onClick={handleClick} />
                        <Bar dataKey="incorrect" fill="#F04438" barSize={55} onClick={handleClick} />
                    </BarChart>
                    {setTooltipData && <CustomTooltip active={true} payload={setTooltipData} />}
...
function setTooltipData(payload: any) {
