    ...
    if (active && payload && payload.length) {
        ...
        return (
            <div style={{
                ...
                {/* Tooltip content */}
                <div style={{ display: 'flex', alignItems: 'center', width: "137px", height: "27px", gap: '6px', justifyItems: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', marginRight: '5px' }}>
                        ...
                        <span>{`Correct `}</span>
                        <span className="ml-8 font-semibold text-sm">{${correctValue}}</span>
                    </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', width: "137px", height: "27px", gap: '6px', justifyItems: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', marginRight: '5px' }}>
