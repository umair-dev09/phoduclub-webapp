...
interface CustomTooltipProps extends TooltipProps<number, string> { // Specify the types here
    active?: boolean; // Optional boolean for the active state
    payload?: { value: number }[]; // Payload array, adjust based on your data structure
    ...
    if (active && payload && payload.length) {
        return (
            <div style={{
                ...
                {/* Replace the below with your desired icon */}
                <img src="/path/to/icon.png" alt="icon" style={{ width: '20px', height: '20px', marginRight: '5px' }} />
                {/* Tooltip text */}
