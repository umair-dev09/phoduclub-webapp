        ...
        return (
            <div style={{
                ...
                <div className="mt-2">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', width: "full", height: "30px", justifyItems: 'center', background: "red" }}>
                        <div style={{ display: 'flex', alignItems: 'center', }}>
                            <span style={{
                                display: 'inline-block',
                                width: '10px',
                            ...
                            <span className="text-[#667085] font-normal text-sm ml-1">{`Attempts `}</span>
                            <span className="font-semibold text-base text-[#1D2939] ml-2 ">{Attempts}</span>
