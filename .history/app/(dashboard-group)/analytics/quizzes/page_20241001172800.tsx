            ...
            <div className="overflow-y-auto h-full flex flex-1 flex-col">
                ...
                <div className="flex w-full h-auto flex-row gap-4">
                    <div className="w-1/2 rounded-xl h-[300px]  flex flex-col">
                        ...
                        <BarChart
                            xAxis={[{ scaleType: 'band', data: ['Chemistry', 'Physics', 'Maths'] }]}
                            series={[
                                { data: [4, 1, 2], label: 'Incorrect - Jabir Ali' },  // First series with custom label
                                { data: [3, 6, 5], label: 'Correct - Jabir Ali' }   // Second series with custom label
                            ]}
                            width={500}
                            height={300}
                        ...
                        <div className="legend-container">
                            <Box className="legend-item">
                                <span className="legend-circle" style={{ backgroundColor: '#F04438' }}></span>
                                Incorrect - Jabir Ali
                            </Box>
                            <Box className="legend-item">
                                <span className="legend-circle" style={{ backgroundColor: '#17B26A' }}></span>
                                Correct - Jabir Ali
                            </Box>
                        </div>
