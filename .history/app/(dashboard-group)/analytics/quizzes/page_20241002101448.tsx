        ...
        <div className="flex flex-1 flex-col pt-6">
            ...
            <div className="flex w-full h-auto flex-row gap-4">
                <div className="w-1/2 rounded-xl h-[300px] flex-col">
                    <BarChart width={400} height={250} data={data} barGap={3} barCategoryGap="17%">
                        ...
                        <XAxis
                            ...
                            fontSize={12}
                            fontWeight={400}
                            fill="#667085"  // Correct attribute for text color
                        />
                        <YAxis domain={[0, 'dataMax']}
                            fontFamily="poppins"
                            fontSize={12}
                            fontWeight={400}
                            fill="#667085" /> {/* Set domain for Y-axis */}
                        <Tooltip content={<CustomTooltip />} cursor={false} />
                        <Legend wrapperStyle={{ display: 'none' }} />
                        <Bar dataKey="correct" fill="#17B26A" barSize={20} />
                        <Bar dataKey="incorrect" fill="#F04438" barSize={20} />
                    </BarChart>
                </div>
