        ...
        <div className="flex flex-1 flex-col pt-6">
            ...
            <div className="flex w-full h-auto flex-row gap-4">
                <div className="w-1/2 rounded-xl h-[300px] flex-col">
                    import {BarChart} from '@mui/x-charts'; // Import your BarChart component
                        ...
                        xAxis={[
                            {
                                ...
                                tickLabelStyle: {
                                    fontSize: 13,
                                    fill: '#667085',  // Color for x-axis labels
                                    fontWeight: '400',
                                    fontFamily: 'Poppins',
                                },
                                axisLine: {        // Correctly set the axis line color
                                    stroke: '#667085', // Color for x-axis line
                        ...
                        yAxis={[
                            {
                                tickLabelStyle: {
                                    fontSize: 13,
                                    fill: '#667085',  // Color for y-axis labels
                                    fontWeight: '400',
                                    fontFamily: 'Poppins',
                                },
                                axisLine: {        // Correctly set the axis line color
                                    stroke: '#667085', // Color for y-axis line
