            ...
            <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', marginBottom: '8px' }}>
                    <span style={{
                        ...
                        height: '12px',
                        borderRadius: '50%',
                        backgroundColor: '#17B26A', // Green color for "Correct"
                        marginRight: '8px',
                    }} />
                    <span style={{ color: '#667085', marginRight: '8px' }}>Correct</span>
                    <span style={{ color: '#1D2939', fontWeight: 'bold' }}>{correctValue}</span>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    <span style={{
                        ...
                        height: '12px',
                        borderRadius: '50%',
                        backgroundColor: '#F04438', // Red color for "Incorrect"
                        marginRight: '8px',
                    }} />
                    <span style={{ color: '#667085', marginRight: '8px' }}>Incorrect</span>
                    <span style={{ color: '#1D2939', fontWeight: 'bold' }}>{incorrectValue}</span>
                </div>
            </div>
        );
    }
