    ...
    if (active && payload && payload.length) {
        ...
        return (
            <div style={{
                ...
                {/* Tooltip content */}
                <div style={{ display: 'flex', alignItems: 'left', width: "137px", height: "27px", gap: '6px' }}>
                    <div style={{ display: 'flex', alignItems: 'left', marginRight: '5px' }}>
                        <span style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', width: "137px", height: "27px", gap: '6px' }}>
