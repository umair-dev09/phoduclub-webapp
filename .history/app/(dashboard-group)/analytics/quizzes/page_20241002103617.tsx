        ...
        <div className="flex flex-1 flex-col pt-6">
            ...
            <div className="flex w-full h-auto flex-row gap-4">
                <div className="w-1/2 rounded-xl h-[300px] flex-col bg-red-400 ">
                    <div className="h-[50px] flex-col flex justify-between ml-4 ">
                        <span>class</span>

                    </div>
                    <BarChart width={550} height={250} data={data} barGap={5} barCategoryGap="5%" margin={{ top: 5, right: 4, left: 4, bottom: 5 }}>
