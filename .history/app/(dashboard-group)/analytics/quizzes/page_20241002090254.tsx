    ...
    if (active && payload && payload.length) {
        ...
        return (
            <div style={{
                ...
                {/* Tooltip content */}
                <div style={{ display: 'flex', alignItems: 'center', width: "169px", height: "27px", gap: '6px', justifyItems: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', marginRight: '5px', }}>
                        ...
                        <span>{`Correct `}</span>
                        <span className="ml-15 font-semibold text-base text-[#1D2939]">{correctValue}</span>
