...
const CustomPieTooltip: React.FC<PieTooltipProps> = ({ active, payload }) => {
    if (active && payload && payload.length) {
        const { name, value, fill } = payload[0]; // Use the fill property from the payload for the dot color
            ...
            <div className="flex flex-row items-center justify-between w-40" style={{
                ...
                <div className="flex flex-row items-center">
                    ...
                    <span style={{
                        ...
                        backgroundColor: fill, // Fill color from data
                        marginRight: '8px',
                        flexShrink: 0, // Prevent shrinking or distortion
                        boxSizing: 'border-box' // Ensure padding or borders don’t affect the size
                    }} />
                    {/* Name and value */}
