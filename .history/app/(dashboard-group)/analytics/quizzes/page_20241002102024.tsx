        ...
        <div className="flex flex-1 flex-col pt-6">
            ...
            <div className="flex w-full h-auto flex-row gap-4">
                <div className="w-1/2 rounded-xl h-[300px] flex-col">
                    <BarChart width={400} height={250} data={data} barGap={10} barCategoryGap="30%">
                        ...
                        <Bar dataKey="correct" fill="#17B26A" barSize={40} />
                        <Bar dataKey="incorrect" fill="#F04438" barSize={40} />
                    </BarChart>
