    ...
    return (
        <div className="flex flex-1 flex-col pt-6">
            ...
            <div className="flex w-full h-auto flex-row gap-4">
                <div className="w-1/2 rounded-xl h-[300px] flex-col bg-red-400 ">
                    <div className="h-[50px] flex flex-row justify-between  ">
                        <span className="flex items-center justify-center ml-10">class</span>
                        <div className=" flex flex-row ">
                            ...
                            <div className="flex flex-row gap-2">
                                <span style={{
                                    ...
                                    marginTop: "10px" // Color for "Correct"
                            ...
                            <div className="flex flex-row gap-2">
                                ...
                                <span className="flex items-center justify-center text-[#667085] font-normal text-sm mr-2">Incorrect</span>
                            </div>
