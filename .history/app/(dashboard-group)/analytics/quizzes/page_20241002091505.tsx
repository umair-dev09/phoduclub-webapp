    ...
    if (active && payload && payload.length) {
        ...
        return (
            <div style={{
                ...
                {/* Tooltip content */}
                <div className="m-2">
                    <div style={{ display: 'flex', alignItems: 'center', width: "157px", height: "27px", justifyItems: 'center', backgroundColor: "red" }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', width: "157px", height: "27px", justifyItems: 'center' }}>
                        <div style={{ display: 'flex', alignItems: 'center', }}>
                            <span style={{
                                display: 'inline-block',
                                width: '10px',
