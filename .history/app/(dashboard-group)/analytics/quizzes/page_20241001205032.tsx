...
import { BarChart } from '@mui/x-charts'; // Ensure to import your BarChart component
            ...
            <div className="flex w-full h-auto flex-row gap-4">
                <div className="w-1/2 rounded-xl h-[300px] flex-col">
                    ...
                    <BarChart
                        xAxis={[
                            {
                                ...
                                axisLine: {
                                    color: '#667085',  // Color for x-axis line
                                },
                            }
                        ]}
                        yAxis={[
                            {
                                ...
                                axisLine: {
                                    color: '#667085',  // Color for y-axis line
                                },
                            }
                        ]}
                        series={[
                        ...
                        sx={{
                            '& .MuiChartsAxis-line': {
                                stroke: '#667085',  // This sets the color for both x and y axis lines
                                strokeWidth: 1,  // You can adjust the thickness of the axis lines
                            },
                            '& .MuiChartsAxis-tick': {
                                stroke: '#667085',  // This sets the color for the tick marks
                            },
                        }}
                    />
