...
export default function AnalyticsPage() {
     ...
     return (
          <div className="flex flex-col h-screen overflow-y-auto w-screen p-6">
               {/* 1st */}
               <div className="flex flex-row w-full gap-4">
                    <div className="flex flex-col flex-1 bg-white rounded-lg h-[327px]">
                    ...
                    <div className="flex flex-col flex-1 bg-white pb-4 rounded-lg h-[327px]">
                         <div className="flex flex-row justify-between pt-6 px-6 w-full text-[#1D2939] text-lg font-bold">
