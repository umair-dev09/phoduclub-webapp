...
export default function DashboardGroup({ children }: DashboardGroupProps) {
    return (
        <div className="h-screen bg-[#131313] flex flex-row overflow-y-auto flex-1 w-full">
            <div>
                <TabComps />
            </div>
            <div className="w-full h-full p-2">
                <div className="flex flex-col bg-[#f5f6fa] rounded-md text-[#131313] h-auto w-full m-2">
                    <div>
                        <Header />
                    </div>
