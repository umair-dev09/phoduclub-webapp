...
export default function DashboardGroup({ children }: DashboardGroupProps) {
    ...
    // This ensures the component is only rendered after the client has mounted
    useEffect(() => {
        setMounted(true);
    ...
    return (
        <div className="body">
            ...
            <div className="contents">
                <div className="content-box">
                    <div className="font-bold text-[#1D2939] text-lg">
                        {/* Render Header only after client has mounted and pathname is available */}
                        {mounted && !pathname?.includes('quizinfo') && (
                            <Header currentPage={currentPage} />
                        )}
                    </div>
                    <div className="variable-contents">
