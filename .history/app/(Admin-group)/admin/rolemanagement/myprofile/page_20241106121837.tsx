                ...
                <div className="fixed inset-0 flex items-center justify-center">
                    <DialogPanel className="bg-white rounded-2xl w-[559px] h-auto">
                        <div className="flex flex-col relative gap-6">
                            ...
                            <h3 className="mx-6 mt-6 text-2xl font-semibold text-[#1D2939]">Edit Profile</h3>
                            ...
                            <div className="flex flex-row justify-end mx-6 my-2 items-center gap-4">
                                <button onClick={closeEdit} className="py-[0.625rem] px-6 border-[1.5px] border-lightGrey rounded-md text-[#1D2939] font-semibold text-sm">Cancel</button>
                                <button
                                    onClick={closeEdit}
