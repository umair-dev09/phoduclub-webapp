...
function myprofile() {
    return (
        <div className=" flex justify-center w-full h-full">
            <div className="mt-8 flex h-[298px] w-[540px] bg-[#FFFFFF] border border-solid border-[#EAECF0] rounded-md p-6">
                <div className="flex justify-between flex-row">
                    ...
                    <div className="flex flex-row gap-3">
                        <button className="p-4 bg-[#FFFFFF] h-auto border border-solid border-[#EAECF0] rounded-[8px] flex flex-row justify-between w-[112px]">
