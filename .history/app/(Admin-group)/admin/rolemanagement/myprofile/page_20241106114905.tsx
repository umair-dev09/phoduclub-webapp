...
function myprofile() {
    return (
        <div className=" flex justify-center w-full h-full">
            <div className="mt-8 flex h-[298px] w-auto bg-[#FFFFFF]  gap-4 flex-col border border-solid border-[#EAECF0] rounded-md p-6 ">
                ...
                <div className="flex flex-row justify-between h-auto">
                    ...
                    <div className="flex flex-row gap-3">
                        ...
                        <button className="py-2 px-4 bg-[#FFFFFF] gap-2 h-[40px] w-auto items-center border border-solid border-[#EAECF0] rounded-[8px] flex flex-row justify-between ">
                            <Image src="/icons/logout-03.svg" width={18} height={18} alt="delete-quiz" />
                            <span className="text-sm text-[#DE3024] font-normal">Edit</span>
                        </button>
