...
function myprofile() {
    return (
        <div className=" flex justify-center w-full h-full">
            <div className="mt-8 flex h-auto w-[588px] bg-[#FFFFFF]  gap-6 flex-col border border-solid border-[#EAECF0] rounded-md p-6 ">
                ...
                <div className="flex flex-row justify-between h-[72px] w-auto items-center">
                    ...
                    <div className="flex flex-row gap-3">
                        ...
                        <button className="py-2 px-4 bg-[#FFFFFF] gap-2 h-[40px] w-auto items-center border border-solid border-[#EAECF0] rounded-[8px] flex flex-row justify-between ">
                            <Image src="/icons/edit-02.svg" width={18} height={18} alt="delete-quiz" />
                ...
                <div className="flex flex-row w-full">
                    ...
                    <div className="flex flex-col w-1/2 ">
                        ...
                        <span className="font-normal text-[#667085] text-[16px]">Moblie No.</span>
