...
function rolemangement() {
    ...
    const openAddUser = () => setisAddUser(true);
    const closeAddUser = () => setisAddUser(false);
    ...
    return (
        <div className="flex flex-col w-full mt-4 gap-4 px-6">
            ...
            {isAddUser && <Addnewuser close={closeAddUser} open={true} />}
        </div>
    );
}
