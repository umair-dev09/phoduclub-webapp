    ...
    return (
        <div className=' flex flex-col p-8 gap-6 w-full h-auto'>
            ...
            <div className='w-full gap-6 flex flex-row h-full'>
                ...
                {/* not div */}
                <div className='h-[700px] w-1/2 bg-[#FFFFFF] border border-solid overflow-y-auto border-[#EAECF0] shadow-md rounded-lg p-6 gap-6 flex flex-col'>
                    ...
                    <div className="border border-solid border-[#EAECF0]  rounded-lg h-auto">
                        <table className="w-full">
                            ...
                            <tbody>
                                <tr className="border-t h-[64px] flex items-center">
                                    <div className=' flex flex-row gap-2 py-2 px-8 text-left items-center '>
                                        <Image
                                            src="/icons/profile-pic2.svg"
                                            width={40}
                                            height={40}
                                            alt="plus-icon" />
                                        <td className="text-[#9012FF] font-semibold text-sm underline">BITSET Full Course</td>
                                    </div>
