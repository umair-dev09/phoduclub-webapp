        ...
        <div className=' flex flex-col p-8 gap-6 w-full'>
            ...
            <div className='w-full gap-6 flex flex-row'>
                ...
                <div className='h-auto w-1/2 bg-[#FFFFFF] border border-solid border-[#EAECF0] shadow-md rounded-lg p-6 gap-6 flex flex-col'>
                    ...
                    <table class="w-[492px] border-collapse border-2 border-black">
                        <tr>
                            <td class="border-2 border-black h-32 text-center bg-blue-200">Top Left</td>
                            <td class="border-2 border-black"></td>
                        </tr>
                        <tr>
                            <td class="border-2 border-black"></td>
                            <td class="border-2 border-black h-32 text-center bg-green-200">Bottom Right</td>
                        </tr>
                    </table>
                </div>
