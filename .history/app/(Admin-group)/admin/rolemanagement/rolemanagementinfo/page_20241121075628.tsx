            ...
            <div className='w-full gap-6 flex flex-row'>
                ...
                <div className='h-auto w-1/2 bg-[#FFFFFF] border border-solid border-[#EAECF0] shadow-md rounded-lg p-6 gap-6 flex flex-col'>
                    ...
                    <div className='h-10 flex flex-row justify-between items-center '>
                        ...
                        <div className='w-[200px] h-full rounded-md items-center flex flex-row justify-center gap-2 border-2 border-solid border-[#EAECF0]'>
                            <Image
                    ...
                    <table className="w-full border-collapse border border-gray-300">
                        <thead>
                            <tr className="bg-gray-100 text-left text-sm font-semibold text-gray-700">
                                <th className="p-4 border border-gray-300">Header 1</th>
                                <th className="p-4 border border-gray-300">Header 2</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr className="hover:bg-gray-50">
                                <td className="p-4 border border-gray-300">Row 1, Col 1</td>
                                <td className="p-4 border border-gray-300">Row 1, Col 2</td>
                            </tr>
                        </tbody>
                    </table>
