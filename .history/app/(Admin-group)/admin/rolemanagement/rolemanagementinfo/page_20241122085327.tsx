        ...
        <div className=' flex flex-col p-8 gap-6 w-full'>
            ...
            <div className='w-full gap-6 flex flex-row'>
                ...
                <div className='h-auto w-1/2 bg-[#FFFFFF] border border-solid border-[#EAECF0] shadow-md rounded-lg p-6 gap-6 flex flex-col'>
                    ...
                    <table>
                        <thead>
                            <tr className='h-[48px] rounded-md border border-solid border-[#EAECF0] rounded-md'>
                        ...
                        <tbody>
                            <tr className='h-[49px]  border border-solid border-[#EAECF0] '>
                                <td className="py-3 pl-8 text-left">jabir</td>
                                <td className="py-3 pr-8 text-right">jabir</td>  {/* Apply text-right here */}
                            </tr>
