...
function CustomerInfo() {
    ...
    return (
        <div className="h-auto w-full overflow-y-auto px-8 pt-8">
            <div className=" bg-[#FFFFFF] border border-solid border-[#E5E7EB] h-auto w-full rounded-t-[12px] flex flex-row ">
