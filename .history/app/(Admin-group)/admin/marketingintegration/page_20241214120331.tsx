    ...
    return (
        <div className="flex flex-col h-full gap-3 w-full p-8">
            ...
            <Dialog open={isOpen} onClose={() => setIsOpen(false)} className="relative z-50">
                <div className="fixed inset-0 bg-black/30 overflow-hidden" />

                <div className="fixed inset-0 flex items-center justify-center">
                    {/* Dialog Panel */}
                    <DialogPanel
                        className="bg-white rounded-2xl w-[500px] max-h-[92%] overflow-visible relative"
                        style={{ overflow: "visible" }} // Ensures overflow outside the panel
                    >
