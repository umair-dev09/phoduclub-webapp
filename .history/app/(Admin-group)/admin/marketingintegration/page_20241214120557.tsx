        ...
        <div className="flex flex-col h-full gap-3 w-full p-8">
            ...
            <Dialog open={isOpen} onClose={() => setIsOpen(false)} className="relative z-50">
                ...
                >
                    ...
                    {/* Modified container to allow overflow */}
                    <div className="fixed inset-0 overflow-y-auto flex items-center justify-center p-4">
                        <DialogPanel
                            className="bg-white rounded-2xl w-[500px] max-h-[92vh] overflow-y-auto relative transform"
                        >
                            <div className="flex flex-col relative px-6 max-h-[80vh]">
