        ...
        <div className="px-[20px] pt-[20px] w-full h-auto overflow-y-auto pb-24">
            ...
            <div className="flex justify-center">
                ...
                <div className="mt-4 h-auto p-6 gap-4  rounded-md bg-[#FFFFFF] border border-solid border-[#EAECF0] w-[684px] flex flex-col">
                    ...
                    <div className="flex flex-row  w-full gap-4">
                        <div className="flex flex-col gap-1 w-1/2 flex-grow">
                            <label htmlFor="discount-price" className="text-[#1D2939] text-sm font-medium">Ratings</label>
                            <div className="flex flex-row py-2 px-4 w-full gap-2 border border-solid border-[#D0D5DD] rounded-md transition duration-200 ease-in-out focus:border-red-300">
                                <input
                        ...
                        <div className="flex flex-col gap-1 w-1/2 flex-grow">
                            <label htmlFor="discount-price" className="text-[#1D2939] text-sm font-medium">No. of Ratings</label>
                            <div className="flex flex-row py-2 px-4 w-full gap-2 border border-solid border-[#D0D5DD] rounded-md transition duration-200 ease-in-out focus:border-red-300">
                                <input
                    ...
                    {/* star Ratings */}
                    <div className="flex items-center justify-between w-[255px] h-[24px] ">
