                ...
                <div className="mt-4 h-auto p-6 gap-4  rounded-md bg-[#FFFFFF] border border-solid border-[#EAECF0] w-[684px] flex flex-col">
                    ...
                    <div className="flex flex-row w-full gap-4">
                        <div className="flex flex-col gap-1 w-1/2 flex-grow">
                            ...
                            <div className="flex flex-row py-2 px-4 w-full gap-2 border border-solid border-[#D0D5DD] rounded-md transition duration-200 ease-in-out focus-within:border-red-300">
                                <input
                                    id="rating"
                                    value={rating}
                                    onChange={(e) => {
