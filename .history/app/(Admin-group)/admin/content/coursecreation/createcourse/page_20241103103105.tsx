        ...
        <div className="m-[20px] w-full">
            <div className="flex flex-row justify-between h-[60px] items-center ">
                ...
                <div className="flex flex-row ">
                    ...
                    <button className="h-[44px] w-[120px] ml-3 rounded-md items-center flex border border-solid border-[#800EE2] bg-[#9012FF] justify-center shadow-inner-button">
                        <span className="text-[#1D2939] font-semibold text-sm">Create</span>
