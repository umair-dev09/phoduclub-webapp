                ...
                <div className="relative flex">
                    <div className="pt-[10px]">
                        <button
                            ...
                            className={`relative py-2 pr-4 text-base transition duration-200 ${activeTab === 'CourseContent' ? 'text-[#7400E0]' : 'text-[#667085] hover:text-[#7400E0]'
                                } focus:outline-none`}
                    ...
                    <div
                        ...
                        style={{
                            height: '1.8px',
                            width: activeTab === 'CourseContent' ? '80px' : '180px', // Adjusted width to match the text
                            left: activeTab === 'CourseContent' ? '0px' : '113px', // Adjust left position to match each button
                            bottom: '-8px',
                        }}
                    />
                </div>
