            ...
            <div className="flex flex-col">
                <div className="relative flex">
                    ...
                    <div
                        ...
                        style={{
                            height: '1.8px',
                            width: activeTab === 'CourseContent' ? '123px' : '120px', // Adjusted width to match the text
                            left: activeTab === 'CourseContent' ? '0px' : '140px', // Adjust left position to match each button
                            bottom: '-8px',
                        }}
                    />
                </div>
