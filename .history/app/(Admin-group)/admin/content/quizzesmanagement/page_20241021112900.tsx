            ...
            <div className="mx-[32px]  h-[44px] mt-5 w-full">
                <div className="flex flex-row justify-between">
                    ...
                    <div>
                        ...
                        <button className="h-[44px] w-[143px] rounded-md bg-[#FFFFFF] border border-solid border-[#D0D5DD] mx-2 p-3">
                            <div className="flex flex-row items-center  gap-2">
                                ...
                                />
                                <span className="font-medium text-sm text-[#667085]">Select dates</span>
                        ...
                        <button className="h-[44px] w-[122px] rounded-md bg-[#FFFFFF] border border-solid border-[#D0D5DD]  p-3 mr-6">
                            <div className="flex flex-row items-center  gap-2">
