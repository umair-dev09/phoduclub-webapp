...
import RadioGroup from "@mui/material/RadioGroup";
import FormControlLabel from "@mui/material/FormControlLabel";
import scheduledDailog from "@/components/AdminComponents/QuizInfoDailogs/scheduledDailog";
...
function Quizinfo() {
    ...
    return (
        <div className="flex w-full h-auto overflow-y-auto flex-col p-8">
            ...
            {/* Conditionally render the ScheduledDialog based on state */}
            {isDialogOpen && <ScheduledDialog onClose={handleDialogClose} />}
        </div>
    );
}
