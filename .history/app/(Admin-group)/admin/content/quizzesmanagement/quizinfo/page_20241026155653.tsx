...
function Quizinfo() {
    return (
        <div className="flex  w-full h-auto overflow-y-auto flex-col m-8">
            ...
            <div className="flex flex-row mt-6 w-full h-[40px] justify-between bg-rose-200 items-center">
                <span className="font-semibold text-lg text-[#1D2939]">Questions</span>
                <button className="flex flex-row gap-1 h-[40px] bg-rose-400 items-center px-2">
                    <Image
