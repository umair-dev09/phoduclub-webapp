...
function Quizinfo() {
    return (
        <div className="flex  w-full h-auto overflow-y-auto flex-col m-8">
            ...
            <div className="w-full h-auto mt-6 flex flex-row gap-4 bg-[#FFFFFF]">

                <div className="w-full  flex flex-col p-4 border border-solid border-[#EAECF0] bg-[#FFFFFF] rounded-md">
