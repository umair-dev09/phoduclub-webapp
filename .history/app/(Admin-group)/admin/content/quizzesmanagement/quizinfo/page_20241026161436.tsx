...
function Quizinfo() {
    return (
        <div className="flex  w-full h-auto overflow-y-auto flex-col p-8">
            ...
            <div className=" bg-[#FFFFFF] rounded-md border border-solid border-[#EAECF0] ">
                <Collapsible
                    trigger={
                        <div className="h-auto flex flex-row gap-2 p-6 border border-solid border-[#EAECF0] ">
                ...
                >
                    <div className=" h-[160px] gap-[15px] flex flex-col mt-4">
