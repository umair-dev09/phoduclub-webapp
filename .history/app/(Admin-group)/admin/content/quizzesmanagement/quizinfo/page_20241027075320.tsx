                ...
                <div className="flex flex-row justify-between">
                    ...
                    <div className="flex flex-row gap-1">
                        ...
                        <Popover placement="bottom">
                            ...
                            <PopoverContent className="flex flex-col  text-sm font-normal  bg-white border border-lightGrey rounded-md w-auto shadow-md py-[10px] px-[16px]">
                                <button className="w-full hover:bg-[#F2F4F7] transition-colors">Schedule Quiz</button>
                                <button className="w-full  hover:bg-[#F2F4F7] transition-colors">Make Live Now</button>
                            </PopoverContent>
                        </Popover>
