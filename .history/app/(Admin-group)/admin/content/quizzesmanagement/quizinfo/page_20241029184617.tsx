        ...
        <div className="flex w-full h-auto overflow-y-auto flex-col p-8">
                        ...
                        >
                            <PopoverTrigger>
                                <button
                                    ...
                                    className={`w-auto p-[10px] h-[40px] gap-1 flex-row flex border bg-[#FFFFFF] rounded-md ${isPopoverOpen
                                        ? "border-[#C7A5FF] shadow-[0px_0px_0px_4px_#9E77ED3D,0px_1px_2px_0px_#1018280D]"
                                        : "border-[#EAECF0] shadow-none"
                                        }`}
                                    style={{ outline: "none" }}
                                >
                                    <Image src="/icons/select-date.svg" width={18} height={18} alt="Calendar" />
                                    <span className="text-sm text-[#667085] font-medium">Schedule Quiz</span>
                            ...
                            <PopoverContent className="flex flex-col px-0 text-sm font-normal bg-white border border-lightGrey rounded-md w-[180px] shadow-md"
                                ...
                                <button className="h-[40px] hover:bg-[#F2F4F7] w-full"
                                    onClick={openMakeLiveNowQuiz}>
                                    <span className="font-normal text-[#0C111D] text-sm">Make Live Now</span>
                                </button>
                            </PopoverContent>
                        </Popover>
            ...
            <div className="w-full h-auto mt-4 flex flex-row gap-4 ">
                <div className="w-full flex flex-col p-4 border border-solid border-[#EAECF0] bg-[#FFFFFF] rounded-xl">
                    <span className="text-[#667085] font-normal text-base">Quiz starts</span>
                    <span className="font-medium text-[#1D2939] text-xl">06 Jan, 2024  05:30 PM</span>

                </div>
                <div className="w-full flex flex-col p-4 border border-solid border-[#EAECF0] bg-[#FFFFFF] rounded-xl">

                    <span className="text-[#667085] font-normal text-base">Quiz ends</span>
                    <span className="font-medium text-[#1D2939] text-xl">06 Jan, 2024  07:30 PM</span>
                </div>
                <div className="w-full flex flex-col p-4 border border-solid border-[#EAECF0] bg-[#FFFFFF] rounded-xl">
