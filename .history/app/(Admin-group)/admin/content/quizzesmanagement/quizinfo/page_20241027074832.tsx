                ...
                <div className="flex flex-row justify-between">
                    ...
                    <div className="flex flex-row gap-1">
                        ...
                        <Popover placement="bottom">
                            ...
                            <PopoverContent className="flex flex-col items-start text-sm font-normal py-1 px-0 bg-white border border-lightGrey rounded-md w-[11.25rem] shadow-md">
                                <button className="w-full px-4 py-[0.625rem] gap-2 hover:bg-[#F2F4F7] transition-colors">Schedule Quiz</button>
