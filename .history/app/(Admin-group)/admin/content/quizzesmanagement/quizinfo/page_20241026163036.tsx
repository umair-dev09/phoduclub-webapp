...
function Quizinfo() {
    return (
        <div className="flex  w-full h-auto overflow-y-auto flex-col p-8">
            ...
            <div className="flex flex-row mt-6 w-full h-[40px] justify-between  items-center bg-slate-500">
            ...
            <div className=" bg-[#FFFFFF] h-auto rounded-md border border-solid border-[#EAECF0] mt-2 ">
                <Collapsible
                    trigger={
