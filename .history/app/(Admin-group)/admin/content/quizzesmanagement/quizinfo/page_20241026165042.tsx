    ...
    return (
        <div className="flex  w-full h-auto overflow-y-auto flex-col p-8">
            ...
            <div className="flex flex-col gap-2 mt-3">
                {/* First Accordian */}
                <div className={`bg-[#FFFFFF] h-auto rounded-xl border border-solid border-[#EAECF0] ${isOpen ? ' hover:border-[#9012FF]' : 'hover:border-[#182230] '}`}
                >
                    <Collapsible
                        open={isOpen}
                ...
                {/* Second Accordian */}
                <div className=" bg-[#FFFFFF] h-auto rounded-xl border border-solid border-[#EAECF0] hover:border-[#182230]">
                    <Collapsible
                        trigger={
                            <div className="h-auto flex flex-row gap-3 p-6">
                                <div className="h-6 w-6 rounded-[4px] bg-[#EAECF0] flex justify-center">
                    ...
                    >
                        <div className=" h-auto gap-[15px] flex flex-col px-6 pb-[8px]">
                            <RadioGroup>
                                <FormControlLabel
                                    value="option1"
                                    control={
