            ...
            <div className="w-full h-auto flex flex-col  pb-2">
                <div className="flex flex-row justify-between">
                    ...
                    <div className="flex flex-row gap-1">
                        ...
                        <button
                            className="w-auto p-3 gap-1 flex-row flex bg-[#FFFFFF] border border-solid border-[#EAECF0] rounded-[8px] h-[40px] items-center"
                        >
                            <Image src="/icons/select-date.svg" width={18} height={18} alt="Calendar" />
                            <span className="text-sm text-[#667085] font-medium">Schedule Quiz</span>
                        </button>
                        {/* Button for Publish Quiz */}
                        <button className="w-auto p-3 gap-1 flex-row flex bg-[#FFFFFF] border border-solid border-[#EAECF0] rounded-[8px] h-[40px] items-center"
                        >
