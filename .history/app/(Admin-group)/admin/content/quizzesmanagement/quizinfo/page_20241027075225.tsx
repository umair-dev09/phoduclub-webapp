                ...
                <div className="flex flex-row justify-between">
                    ...
                    <div className="flex flex-row gap-1">
                        ...
                        <Popover placement="bottom">
                            <PopoverTrigger>
                                <button className="w-auto  p-[10px] h-[40px] gap-1 flex-row flex border border-solid border-[#EAECF0] bg-[#FFFFFF] rounded-md">
                                    <Image src="/icons/select-date.svg" width={18} height={18} alt="Calender" />
                            ...
                            <PopoverContent className="flex flex-col  text-sm font-normal  bg-white border border-lightGrey rounded-md w-auto shadow-md">
                                <button className="w-full  py-[10px] px-[16px] hover:bg-[#F2F4F7] transition-colors">Schedule Quiz</button>
                                <button className="w-full   py-[10px] px-[16px] hover:bg-[#F2F4F7] transition-colors">Make Live Now</button>
                            </PopoverContent>
                        </Popover>
