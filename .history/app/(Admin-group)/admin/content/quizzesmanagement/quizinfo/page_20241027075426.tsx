                    ...
                    <div className="flex flex-row gap-1">
                        ...
                        <Popover placement="bottom">
                            ...
                            <PopoverContent className="flex flex-col  text-sm font-normal  bg-white border border-lightGrey rounded-md w-auto shadow-md ">
                                <button className=" h-[40px] hover:bg-[#F2F4F7] transition-colors">Schedule Quiz</button>
                                <button className=" h-[40px] hover:bg-[#F2F4F7] transition-colors">Make Live Now</button>
                            </PopoverContent>
                        </Popover>
