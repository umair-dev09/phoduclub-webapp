        ...
        <div className="mx-[32px]  h-[44px] mt-5 w-full">
            <div className="flex flex-row justify-between">
                ...
                <div>
                    ...
                    <button className="h-[44px] w-[143px] rounded-md bg-[#FFFFFF] border border-solid border-[#D0D5DD]">
                        select date

                    </button>
                    <button className="h-[44px] w-[122px] rounded-md bg-[#FFFFFF] border border-solid border-[#D0D5DD]">
                        by status
