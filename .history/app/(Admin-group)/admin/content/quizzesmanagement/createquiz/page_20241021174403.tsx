...
function CreateQuiz() {
    ...
    return (
        <>
            ...
            <div className="flex flex-col w-full ml-[15px] mr-[32px]">
                <div className="h-[60px] ml-1 mr-[32px]  mt-[32px] w-full border-b border-solid border-[#D0D5DD] ">
                    <div className="flex flex-row justify-between ">
                        <span className="text-lg font-semibold text-[#1D2939] ">Quiz info</span>
                ...
                <div className=" bg-[#FFFFFF] my-[32px] h-full">
                    {renderStepContent()}
                </div>
            </div>
        </>
