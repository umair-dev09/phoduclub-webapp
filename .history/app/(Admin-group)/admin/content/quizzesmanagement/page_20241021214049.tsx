...
function Quizz() {
    ...
    return (
        <div className="mx-[32px] mt-4 w-full h-auto flex overflow-y-auto">
            ...
            <div className="h-[672px] bg-[#FFFFFF] border border-solid border-[#EAECF0] rounded-md mt-3 flex overflow-y-auto">
