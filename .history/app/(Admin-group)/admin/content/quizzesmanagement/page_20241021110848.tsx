                ...
                <div>
                    <button className="h-[44px] w-[250px] rounded-md bg-[#FFFFFF] border border-solid border-[#D0D5DD]">
                        <div className="flex flex-row items-center gap-2 ml-2">
                            ...
                            />
                            <input
                                className="font-normal text-[#667085] text-sm placeholder:text-[#A1A1A1] border border-[#D1D5DB] rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                placeholder="Search"
                                type="text" // Ensure to set the type for better accessibility
                            />
                        </div>
