                                                ...
                                                <td className="flex items-center justify-center px-8 py-4 text-[#101828] text-sm">
                                                    <Popover placement="bottom-end" isOpen={!!openPopovers[index]}
                                                        ...
                                                        <PopoverTrigger className="ml-[50%] outline-none">
                                                            ...
                                                            <button onClick={(e) => { e.stopPropagation(); togglePopover(index) }} className="w-[32px] h-[32px] rounded-full flex items-center justify-center transition-all duration-300 ease-in-out hover:bg-[#F2F4F7]">
                                                                <button>
                                                                    <Image
