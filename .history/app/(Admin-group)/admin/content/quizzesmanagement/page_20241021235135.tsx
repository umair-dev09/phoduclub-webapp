                ...
                <table className="w-full bg-white rounded-xl">
                    ...
                    <tbody>
                        <tr className="">
                            ...
                            <td className="w-[17%] text-center px-8 py-4 border-t border-t-lightGrey text-[#1D2939] font-normal text-sm">Status</td>
                            <td className="w-[7%] text-center px-8 py-4 pr-8 rounded-br-xl border-t border-t-lightGreytext-[#1D2939] font-normal text-sm">
                                <Image
