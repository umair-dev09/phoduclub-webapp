                ...
                <div className="flex flex-row gap-3">
                    ...
                    >
                        ...
                        <PopoverContent className="w-[206px] items-start  py-2  h-auto gap-2 border border-lightGrey rounded-md shadow-[0_12px_16px_-4px_rgba(16,24,40,0.08)]">
                            <div className="flex flex-col w-full hover:bg-[#F2F4F7]  border-b border-solid border-lightGrey">
                            ...
                            <div className="flex flex-col w-full gap-4 hover:bg-[#F2F4F7]">

                                <div className="flex flex-row gap-2   items-center">
                                    <Checkbox color="primary" />
                                    <Image
                                        src="/icoms/big-profile-pic.svg"
                                        width={24}
                                        height={24}
                                        alt="profile" />
                                    <span className="text-[#0C111D] font-normal text-xs">Free</span>
