    ...
    return (
        <div className="h-full w-full flex flex-row">
            <div className="grid grid-rows-[72px_1fr_70px] w-[68%]">
                ...
                <div className=" p-6">
                    <div className="h-[67px] w-auto flex flex-col gap-1">
                        <div className="border border-solid border-[#EAECF0] bg-[#FFFFFF] rounded-[16px] flex items-center p-4 w-auto h-[45px]">
