        ...
        <div className="h-full w-full flex flex-row">
            <div className="grid grid-rows-[72px_1fr_70px] w-[68%]">
                ...
                <div className=" p-6 flex flex-col gap-3">
                    ...
                    {/* own chat */}
                    <div className="h-[67px] w-full flex flex-col gap-1 ml-auto">
                        <div className="border border-solid border-[#EAECF0] bg-[#FFFFFF] rounded-[16px] flex items-center p-3 w-[226px]">
                            <span className="text-[#182230] font-normal text-sm">This is my own message.</span>
                        </div>
                        <span className="text-[#475467] font-normal text-xs text-right">3:24 PM</span>
                    </div>
                </div>
