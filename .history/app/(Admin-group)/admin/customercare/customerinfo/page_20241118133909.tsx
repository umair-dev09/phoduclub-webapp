    ...
    return (
        <div className="h-auto w-full flex flex-row">
            <div className="flex flex-col  w-[68%] h-auto ">
                ...
                <div className="h-auto bg-[#FFFFFF] p-6 flex flex-row gap-4 ">

                    <div className="border border-solid border-[#D0D5DD] h-auto w-full rounded-md flex flex-row items-center p-2">
                        <textarea
                            placeholder="Type your message here..."
                            className="placeholder:text-[#667085] placeholder:font-normal placeholder:text-sm focus:text-[#182230] h-auto w-full outline-none resize-none" />
                    </div>
                    <button>
                        <Image
                            src='/icons/send.svg'
