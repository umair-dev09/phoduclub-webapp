...
function customerinfo() {
    ...
    return (
        <div className="h-full w-full flex flex-row">
            <div className="grid grid-col-[72px_1fr_70px] w-[68%] pb-6">
                ...
                <div className=" p-6 flex flex-col gap-3 h-auto w-full overflow-y-auto">
                    ...
                    <div className="h-[67px] w-full flex flex-col gap-1 items-start">
                        <div className="border border-solid border-[#EAECF0] bg-[#FFFFFF] rounded-[16px] flex items-center p-3 w-[250px]">
                            <span className="text-[#182230] font-normal text-sm">I am scammed in the group. Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint, enim. Laboriosam, eius, nulla facere eligendi sit dolores rerum facilis, asperiores obcaecati iusto harum tempora dolor quam aperiam. Numquam, officiis qui?</span>
                        </div>
                        <span className="text-[#475467] font-normal text-xs">3:24 PM</span>
                    </div>
                    {/* own chat */}
                    <div className="h-[67px] w-full flex flex-col gap-1 items-end">
                        <div className=" bg-[#9012FF] rounded-[16px] flex items-center p-3 w-[500px]">
