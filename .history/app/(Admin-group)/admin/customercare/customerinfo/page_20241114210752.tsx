            ...
            <div className="grid grid-rows-[72px_1fr_70px] w-[68%] pb-6">
                ...
                <div className=" p-6 flex flex-col gap-3 h-auto w-full overflow-y-auto">
                    ...
                    <div className="h-[67px] w-full flex flex-col gap-1 items-start">
                        <div className="border border-solid border-[#EAECF0] bg-[#FFFFFF] rounded-[16px] flex items-center p-3 w-max-[500px]">
                    ...
                    <div className="h-[67px] w-full flex flex-col gap-1 items-end">
                        <div className=" bg-[#9012FF] rounded-[16px] flex items-center p-3 w-max-[500px]">
