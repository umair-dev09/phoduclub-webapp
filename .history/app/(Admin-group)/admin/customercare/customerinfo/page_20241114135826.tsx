            ...
            <div className="w-[32%] h-full flex flex-col bg-[#FFFFFF] ml-auto overflow-y-auto border-l border-solid border-[#EAECF0]">
                ...
                <div className="flex-1 overflow-y-auto h-auto">
                    ...
                    <div className="h-auto border-b border-solid border-[#EAECF0] p-6">
                        ...
                        <div className="h-[192px] border-b border-solid border-[#EAECF0] w-full grid grid-cols-2 gap-x-4 gap-y-4 items-start">
                            {/* Labels */}
                            ...
                            <span className="text-sm font-medium text-[#1D2939]">2025</span>
                        </div>
                    </div>
