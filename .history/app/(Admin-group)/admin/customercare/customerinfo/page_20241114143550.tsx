...
function customerinfo() {
    ...
    return (
        <div className="h-screen w-full flex flex-row">
            ...
            <div className="w-[32%] h-auto flex flex-col bg-[#FFFFFF] ml-auto  border-l border-solid border-[#EAECF0]">
                ...
                <div className="flex flex-col overflow-y-auto h-auto mb-8">
                    ...
                    <h2>qkdnd</h2>  <h2>qkdnd</h2>  <h2>qkdnd</h2>
                    ...
                    <h2>jabir</h2>
                    nasasa  <h2>qkdnd</h2>
                    nasasa  <h2 className="mb-8">qkdnd</h2>
                    jathin
                    jathin
                    jathin
                </div>
