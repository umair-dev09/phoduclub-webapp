        ...
        <div className="h-full w-full flex flex-row">
            <div className="grid grid-rows-[72px_1fr_70px] w-[68%] pb-6">
                ...
                <div className=" p-6 flex flex-col gap-3 h-auto w-full overflow-y-auto">
                    {/* other chat */}
                    <div className="h-[67px] w-full flex flex-col gap-1 items-start">
                        <div className="border border-solid border-[#EAECF0] bg-[#FFFFFF] rounded-[16px] flex items-center p-3 w-max-[200px]">
                            <span className="text-[#182230] font-normal text-sm">I am scammed in the group webwuew w wewewe wewewewiwe weibweiwew ewebwe w  e weeewewe w ewewewewew ewewewewew.</span>
                        </div>
                        <span className="text-[#475467] font-normal text-xs">3:24 PM</span>
                    </div>
                    {/* own chat */}
                    <div className="h-[67px] w-full flex flex-col gap-1 items-end">
                        <div className=" bg-[#9012FF] rounded-[16px] flex items-center p-3 w-max-[350px]">
                            <span className="text-[#FFFFFF] font-normal text-sm">I am scammed in the group ww ewewe wewe weiweiw wewie wewew ewewe we9bw we9uwb9 we9we we9w ew9ew ewe owew9 ewe9w ewe w9e woew ew eweo we weow ewe woe wo .</span>
                        </div>
                        <span className="text-[#475467] font-normal text-xs">3:24 PM</span>
                    </div>
