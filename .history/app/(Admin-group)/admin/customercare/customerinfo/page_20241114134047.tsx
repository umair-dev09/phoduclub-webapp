...
function customerinfo() {
    ...
    const handleSelect = (option: { label: React.SetStateAction<string>; }) => {
                            ...
                            >
                                <PopoverTrigger>
                                    <button
                                        ...
                                        className="flex flex-row gap-1 focus:outline-none"
                                    >
                                        <div
                                            className={`py-2 px-3 flex flex-row rounded-[6px] items-center h-6 w-auto`}
                                            style={{
                                                backgroundColor:
                                                    options.find(
                                                        (opt) => opt.label === selectedPriority
                                                    )?.bgColor,
                                            }}
                                        >
                                            <span
                                ...
                                <PopoverContent className="w-auto py-1 px-0 bg-white border border-lightGrey rounded-md">
                                    {options.map((option) => (
                                        <button
                                            ...
                                            className={`flex flex-row items-center justify-start w-full px-4 py-[0.625rem] gap-2 hover:bg-[#F2F4F7] focus:outline-none`}
                                        >
                                            <div
                                                className="py-2 px-3 flex flex-row rounded-[6px] items-center h-6 w-auto"
