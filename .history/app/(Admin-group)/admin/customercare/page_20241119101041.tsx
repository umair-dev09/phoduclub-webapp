            ...
            <div className="flex flex-row justify-between items-center">
                ...
                <div className="flex flex-row gap-3">
                    ...
                    >
                        ...
                        <PopoverContent className="w-[8.875rem] p-4 hover:bg-[#F2F4F7] border border-lightGrey rounded-md shadow-[0_12px_16px_-4px_rgba(16,24,40,0.08)]">
                            <div className="w-full bg-white  gap-2">
                                <span className="text-xs font-normal text-[#475467]">Students</span>
                                <div className="flex flex-row gap-2">
                                    <Checkbox color="primary" />
                                    <span className="text-[#0C111D] font-normal text-xs">Free</span>
