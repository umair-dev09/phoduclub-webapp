        ...
        <div className="flex flex-col w-full gap-4 p-6">
            <div className="flex flex-row justify-between items-center">
                ...
                <div className="flex flex-row gap-3">
                    ...
                    >
                        <PopoverTrigger>
                            <button className={`h-[44px] justify-center rounded-md bg-[#FFFFFF] border border-solid border-[#D0D5DD] outline-none  flex items-center  transition-colors ${isPopoverOpen
                        ...
                        <PopoverContent className="w-[206px] items-start  py-2  gap-2 border border-lightGrey rounded-md shadow-[0_12px_16px_-4px_rgba(16,24,40,0.08)]">
