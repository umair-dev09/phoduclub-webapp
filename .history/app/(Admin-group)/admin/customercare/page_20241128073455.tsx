                ...
                <div className="flex flex-row gap-3">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <PopoverContent className="w-[12.875rem] items-start py-2 px-2 h-auto gap-2 border border-lightGrey rounded-md shadow-[0_12px_16px_-4px_rgba(16,24,40,0.08)]">
                                <div className="flex flex-col w-full ">
                                    <span className="text-xs font-normal text-[#475467] mb-3">Students</span>
                                    <button className="flex flex-row w-full gap-2 mb-4 items-center  hover:bg-neutral-100 h-10">
                                        <Checkbox color="primary" />
