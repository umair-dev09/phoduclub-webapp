        ...
        <div className="flex flex-col w-full gap-4 p-6">
            <div className="flex flex-row justify-between items-center">
                ...
                <div className="flex flex-row gap-3">
                    ...
                    >
                        <PopoverTrigger>
                            <button className={` px-[0.875rem] py-[0.625rem] bg-white rounded-md shadow-[0_1px_2px_0_rgba(16,24,40,0.05)] ${isPopoverOpen
                        ...
                        <PopoverContent className="w-[206px] gap-2 p-2 flex flex-col   border border-lightGrey rounded-md shadow-[0_12px_16px_-4px_rgba(16,24,40,0.08)]">
                            <span className="font-normal text-[#475467] text-xs">Students</span>
                            <button className="flex flex-row gap-2 justifly-start">
                                <Checkbox color="primary" />
                                <span className="font-normal text-sm text-[#0C111D]">Free</span>
                            </button>
                        </PopoverContent>
                    </Popover> */}
