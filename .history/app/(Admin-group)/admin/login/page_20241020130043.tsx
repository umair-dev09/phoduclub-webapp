            ...
            <div className=" flex-col w-[395px] h-[284px]">
                ...
                <div>
                    <form >
                        ...
                        <div className="mb-4">
                            ...
                            <PhoneInput
                                ...
                                containerClass="phone-input-container rounded-md h-[40px] border border-solid border-[#D0D5DD] 
                    hover:border-[#D6BBFB] 
                    ...
                    focus-within:shadow-[0px_0px_0px_4px_rgba(158,119,237,0.12)]"
                                inputClass="forminput w-[395px] h-[40px] rounded-[8px] border-none focus:ring-0"
                                inputStyle={{
                                    boxShadow: "0px 1px 2px 0px rgba(16, 24, 40, 0.05)", // Initial box-shadow
                                }}
                            />
