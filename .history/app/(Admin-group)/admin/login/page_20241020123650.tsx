                ...
                <div>
                    <form >
                        ...
                        <div className="mb-4">
                            ...
                            <div className='flex flex-col mt-1 bg-slate-600'>
                                <PhoneInput
                                    country={'in'}
                                    value={phone}
                                    ...
                                    containerClass="phone-input-container w-full rounded-md bg-red-500
                        ...
                        focus-within:shadow-[0px_0px_0px_4px_rgba(158,119,237,0.12)]"
                                    inputClass="form-input w-full h-[40px] pl-2 text-[#344054] font-normal text-sm bg-green-500
                    border-none focus:ring-0 focus:border-black focus:outline-none 
                    shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]"
                                />
                            </div>
