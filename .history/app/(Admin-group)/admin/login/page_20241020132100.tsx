...
function login() {
    ...
    }, [firstName, phone]); // Run effect when firstName or phone changes
                    ...
                    <form>
                        ...
                        <div className="mb-4">
                            ...
                            <PhoneInput
                                ...
                                inputStyle={{
                                    width: '395px', height: '40px', borderRadius: "8px", border: "1px solid #D0D5DD", boxShadow: "0px 1px 2px 0px #1018280D",
                                }}
                            />
                        </div>

                        <button
                            className="mt-3 h-[48px] w-full rounded-md bg-[#9012FF] border border-solid border-[#800EE2] shadow-inner-button"
