        ...
        <div className="flex flex-row w-full h-full">
            <div className="w-[270px] flex flex-col border-r border-solid border-[#EAECF0]">
                ...
                <div className="flex flex-col overflow-y-auto">
                    ...
                    >
                        <div className='bg-[#FFFFFF] flex flex-col justify-center items-center gap-4 hover:bg-[#F8F0FF]'>
                            <span className="font-semibold text-sm text-[#1D2939] text-left">Welcome and Introduction</span>
