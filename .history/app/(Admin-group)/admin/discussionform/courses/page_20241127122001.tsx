    ...
    return (
        <div className="flex flex-row w-full h-full">
            ...
            <div className="flex-1 flex flex-col h-full">
                ...
                <div className="flex flex-col h-[calc(100%-72px)]"> {/* Adjust height to subtract header */}
                    <Tabs
                        ...
                        classNames={{
                            ...
                            tabList: "sticky top-0 z-10 gap-6 w-full relative rounded-none p-0 border-b border-solid border-[#EAECF0] bg-white",
