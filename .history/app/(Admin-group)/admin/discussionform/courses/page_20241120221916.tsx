...
function Courses() {
    const [isOpen, setIsOpen] = useState(false); // State to track collapsible section open/close

    // Toggle function to handle opening and closing of the collapsible section
    const handleToggle = () => {
        setIsOpen(!isOpen);
    };
            ...
            <div className="w-[270px] flex flex-col border-r border-solid border-[#EAECF0]">
                ...
                <div className="flex flex-col overflow-y-auto">
                    <Collapsible
                        ...
                        trigger={
                            <div className='flex flex-row justify-between p-2 items-center text-left' onClick={handleToggle}>
