            ...
            <div className="w-[270px] flex flex-col border-r border-solid border-[#EAECF0]">
                ...
                <div className="flex flex-col overflow-y-auto">
                    <Collapsible
                        ...
                        trigger={
                            <div className=' h-[60px] flex flex-row justify-between py-2 px-4 items-center ' onClick={handleToggle}>
                                <span className="font-semibold text-base text-[#1D2939] text-left">Welcome and Introduction</span>
                                <Image
                                    src={isOpen ? '/icons/arrow-up-dark.svg' : '/icons/arrow-down-dark.svg'}
                                    width={20}
                                    height={20}
                                    alt="Arrow-toggle"
                                />
                    ...
                    <Collapsible
                        open={isOpen}  // Sets whether the content is open or closed
                        trigger={
                            <div className=' border-t border-solid border-[#EAECF0] flex flex-row justify-between py-2 px-4 items-center ' onClick={handleToggle}>
