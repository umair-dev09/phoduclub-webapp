...
function Courses() {
    ...
    return (
        <div className="flex flex-row w-full h-full">
            ...
            <div className="p-6 flex flex-col  flex-1 overflow-y-auto w-full h-full">
                <Tabs
                ...
                >
                    <Tab
                        ...
                        title={
                            ...
                            >
                                <span
                                    className={`font-medium text-base ${activeTab === "Content" ? 'text-pink-500' : 'text-[#667085]'} hover:text-[#7400E0]`}
                                >
                                    Content
                                </span>
                            </div>
                    ...
                    <Tab
                        ...
                        title={
                            ...
                            >
                                <span
                                    className={`font-medium text-base ${activeTab === "Discussion" ? 'text-pink-500' : 'text-[#667085]'} hover:text-[#7400E0]`}
                                >
                                    Discussion
                                </span>
                            </div>
