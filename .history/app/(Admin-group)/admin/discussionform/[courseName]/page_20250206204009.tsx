...
function Courses() {
    ...
    const currentSection = sections.find(sec => sec.sectionId === sectionId);
        ...
        <div className="flex flex-row w-full h-full">
            <div className="w-[270px] flex flex-col border-r border-solid border-[#EAECF0]">
                <div className="h-[72px] p-6 flex flex-row items-center gap-2 border-b border-solid border-[#EAECF0] bg-[#FFFFFF]">
                    <Image className="w-10 h-10 rounded-full" src={courseData?.courseImage || "/icons/default-community.svg"} alt="group icon" width={42} height={42} quality={100} />
                    <h1 className="text-[#182230] font-semibold text-sm">{courseData?.courseName || "phodu channel"}</h1>
                </div>
                    ...
                    {sections.map((section, index) => (
                        <Collapsible key={index}
                            ...
                            trigger={
                                ...
                                >
                                    <span className="font-semibold text-base text-[#1D2939] text-left">{index + 1}. {section.sectionName || "phodu section"}</span>
                                    <Image
                                                ...
                                                >
                                                    <div className="flex flex-col gap-1 pt-[-2px] w-full">
                                                        <span className="font-semibold text-sm text-[#1D2939] text-left">
                                                            {index + 1}. {content.lessonHeading || "phodu heading"}
                                                        </span>
                                                        {content.type === "Text" && (
            ...
            <div className="flex-1 flex flex-col">
                <div className="h-[72px] p-6 flex items-center border-b border-solid border-[#EAECF0] bg-[#FFFFFF]">
                    <span className="text-[#182230] font-semibold text-base">{currentSection?.sectionName || "phodu section"}</span>
