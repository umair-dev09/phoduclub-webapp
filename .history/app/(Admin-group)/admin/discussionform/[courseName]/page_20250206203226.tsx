        ...
        <div className="flex flex-row w-full h-full">
            <div className="w-[270px] flex flex-col border-r border-solid border-[#EAECF0]">
                <div className="h-[72px] p-6 flex flex-row items-center gap-2 border-b border-solid border-[#EAECF0] bg-[#FFFFFF]">
                    <Image className="w-10 h-10 rounded-full" src={"/icons/default-community.svg"} alt="group icon" width={42} height={42} quality={100} />
                    <h1 className="text-[#182230] font-semibold text-sm">{"phodu channel"}</h1>
                </div>
