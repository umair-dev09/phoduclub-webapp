            ...
            <div className="flex flex-row justify-between items-center">
                ...
                <div className="flex flex-row gap-3">
                    ...
                    <Popover placement="bottom-start">
                        ...
                        <PopoverContent className="w-[304px] p-6 bg-[#FFFFFF] border-solid border-[#EAECF0] rounded-md">
                            <div className='flex flex-col gap-2'>
                                <span className='font-medium text-[#1D2939] text-sm'>Unique ID</span>
                                <div className='flex items-center h-[40px] border border-solid border-[#D0D5DD] shadow-sm'>
                                    <input
                                        className="font-normal text-[#667085] text-sm placeholder:text-[#A1A1A1] rounded-md px-1 py-1 focus:outline-none focus:ring-0 border-none"
                            ...
                            <div className='w-auto h-auto gap-4 flex flex-row'>
                                ...
                                <button className='h-11 w-[120px] border border-solid border-[#800EE2] rounded-md bg-[#9012FF] flex items-center justify-center shadow-inner-button'>
