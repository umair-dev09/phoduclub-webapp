                                    ...
                                    <td className="py-[12px]">
                                        <div className="flex flex-row ml-8 gap-[10px] min-w-[260px]">
                                            ...
                                            <div className="flex items-start justify-center flex-col mb-[2px]">
                                                <span className="font-semibold text-sm text-[#182230] whitespace-nowrap">{"phodu user"}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-8 py-4 text-start text-[#101828] text-sm ">
                                        <span className="flex min-w-fit">{"phodu Id"}</span>
                                    </td>
                                    <td className="px-8 py-4 text-start text-[#101828] text-sm ">
                                        <span className="flex min-w-fit">{"-"}</span>
                                    </td>
