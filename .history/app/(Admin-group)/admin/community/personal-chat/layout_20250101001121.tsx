    ...
    return (
        <div className="flex flex-row h-full">
            {/* <div className=" flex flex-row items-center justify-center h-full w-full">
                ...
                <div className=" rounded-2xl w-[37.5rem] p-6  bg-white border-solid border-lightGrey border">
            ...
            <div className="flex flex-col w-[270px] bg-white border-t border-r border-lightGrey">
                <div className='flex flex-row items-center justify-between h-[72px] border-b border-lightGrey'>
                    <h2 className="ml-6 font-semibold text-[#182230]">Personal Messages</h2>
            ...
            <div className="flex flex-1 flex-col border-t border-lightGrey justify-between">
                ...
                <div className="flex flex-row bg-white h-auto px-4 py-4 gap-3">
