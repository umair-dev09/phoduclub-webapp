...
function Chatinfo() {
    ...
    return (
        <div className="grid grid-cols-[16.875rem_1fr_auto] w-full h-full">
            ...
            {/* Main Chat Area */}
            <div className="grid grid-rows-[4.5rem_1fr_auto] h-auto w-full">
                ...
                <div className="w-full pt-6 shadow-[0_8px_32px_0_rgba(0,0,0,0.02)] flex-1 h-auto overflow-y-auto">
                    <OwnChats />
                    <OtherChats />
                </div>
                <div className="flex flex-1 flex-row items-center min-h-[6.25rem] px-6 py-6 gap-2 bg-white">
