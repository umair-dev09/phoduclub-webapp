...
function Community({ children }: CommunityProps) {
    ...
    return (
        <div className="flex flex-1 flex-row">
            ...
            <div className="w-[90px] h-full bg-[#FFFFFF]  items-center justify-center flex flex-col gap-2 border-r-2 border-solid border-[#EAECF0]">
                <button className='h-[72px] border-b border-solid border-[#EAECF0]'>
