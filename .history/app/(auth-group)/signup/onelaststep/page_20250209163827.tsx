  ...
  return (
    <div className="flex flex-row w-full h-screen bg-[#F7F8FB]">
      <div className="lg:w-1/2 flex flex-col">
        ...
        <div className="font-medium text-base mt-[20px] ml-10 text-[#98a2b3] cursor-pointer flex flex-row"
          onClick={() => router.back()}>

          <p>&larr;</p>
          <span className="font-medium text-base text-[#98a2b3]">Back</span>
        </div>
        <div className="h-full flex items-center  justify-center flex-col gap-8 mt-10 ">
      ...
      <div className="hidden lg:flex w-1/2 items-center  bg-[#0E2138] rounded-lg m-2">
