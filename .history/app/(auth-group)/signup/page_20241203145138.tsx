                        ...
                        <div >
                            ...
                            <div className='w-[375px] '>
                                <PhoneInput
                                    ...
                                    containerClass="w-[375px] mt-2"  // Adjust container if necessary
                                    inputClass="w-[375px] h-10 border border-gray-300 rounded-md text-black 
                                     focus:outline-none focus:ring-2 focus:ring-[#D6BBFB] 
