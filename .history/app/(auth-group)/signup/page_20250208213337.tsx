...
export default function Sign() {
    ...
    return (
        ...
        <div className="flex flex-col md:flex-row w-full min-h-screen bg-[#f7f8fb]">
            <div className="w-full md:w-1/2 flex flex-col pt-6 px-4 md:px-6">
                <Image src="/images/phoduclublogo.png" width={140} height={10} quality={100} alt="Phodu Club Logo" />
                <div className="flex flex-col self-center mt-10 md:mt-20 items-center w-full px-4">
                    ...
                    <form className="flex flex-col items-center justify-center gap-4 pt-10 w-full">
                        <div className="w-full max-w-[375px]">
                            <label className="text-[14px] text-[#080808] font-medium">Name</label>
                            <div className="flex flex-col md:flex-row w-full justify-between gap-2">
                                <input className="w-full md:w-1/2 p-2 rounded-md border border-gray-300 focus:outline-[#D6BBFB]" placeholder="First Name" />
                                <input className="w-full md:w-1/2 p-2 rounded-md border border-gray-300 focus:outline-[#D6BBFB]" placeholder="Last Name" />
                            </div>
                        </div>
                        <div className="w-full max-w-[375px]">
                            <label className="text-[14px] text-[#080808] font-medium">Email</label>
                            <input className="w-full p-2 rounded-md border border-gray-300 focus:outline-[#D6BBFB]" placeholder="Enter email" />
                        </div>
                        <div className="w-full max-w-[375px]">
                            <label className="text-[14px] text-[#080808] font-medium">Phone Number</label>
                            <PhoneInput country="in" placeholder="+91 000000000" className="w-full" />
                        </div>
                        <div className="w-full max-w-[375px] flex items-start">
                            <Checkbox size="sm" color="primary" id="terms" />
                            <label className="text-sm text-gray-900 ml-2">
                                I agree to the <a href="#" className="text-[#6646A2] underline">privacy policy</a> and <a href="#" className="text-[#6646A2] underline">terms of use</a>.
                            </label>
                        </div>
                        <button className="w-full max-w-[375px] h-10 bg-[#e39ff6] rounded-md text-white hover:bg-[#7400e0] active:bg-[#7400e0]">
                            Send verification code
                        </button>
                        <p className="text-[#7d7d8a] font-semibold text-[15px] mt-2 text-center">
                            Already have an account? <span className="text-[#9012ff] cursor-pointer hover:underline">Log In</span>
                        </p>
                    </form>
                </div>
            </div>

            {/* Motivation Section (Hidden on Mobile) */}
            <div className="hidden md:flex w-1/2 items-center justify-center bg-[#0E2138] rounded-lg p-6">
                <div className="w-full max-w-[554px] flex flex-col gap-6">
                    <Image src="/icons/coma.svg" width={80} height={80} alt="coma-image" />
                    <h1 className="text-[#EAECF0CC] font-bold text-lg md:text-2xl text-center md:text-left">
                        Education is the foundation upon which we build our future.
                    </h1>
                    <span className="text-[#667085] text-center md:text-right">- Christine Gregoire</span>
                </div>
            </div>
        </div>
