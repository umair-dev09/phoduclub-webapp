...
export default function Sign() {
    ...
    return (
       <div className='flex flex-row p-[10px] w-screen h-full bg-[#f7f8fb]'>
        <div className='Left Area w-[50%] flex flex-col pt-6 pl-6'>
        ...
        <div className='Right Area w-[50%]'>
        <Image className="w-full h-full" src={"/images/test1.png"} width={10000} height={100} quality={100} alt="Quote Picture" />
        </div>
