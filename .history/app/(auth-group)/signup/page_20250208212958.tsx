...
export default function Sign() {
    ...
    return (
        ...
        // </div>
        <div className='flex flex-col md:flex-row w-full h-screen bg-[#f7f8fb]'>
            <div className='w-full md:w-1/2 flex flex-col pt-6 pl-6'>
                <Image src="/images/phoduclublogo.png" width={140} height={10} quality={100} alt="Phodu Club Logo" />
                <div className='flex flex-col self-center mt-10 md:mt-20 items-center'>
                    <h3 className='font-bold text-[24px]'>Get Started</h3>
                    <p className='mt-2 text-center'>Make yourself prepared, before time ✌️</p>
                    <form className='flex flex-col items-center justify-center gap-4 pt-[40px]' onSubmit={handleSubmit}>
                        <div>
                            <label className='text-[14px] text-[#080808] font-medium'>Name</label>
                            <div className='flex flex-col md:flex-row w-full md:w-[375px] justify-between'>
                                <input
                                    type="text"
                                    id='firstName'
                                    placeholder='First Name'
                                    className='p-[7px] text-base rounded-[5px] border border-gray-300 text-gray-900 w-full md:w-44 h-10 box-border mr-0 md:mr-2 focus:outline focus:outline-[#D6BBFB]'
                                />
                                <input
                                    type="text"
                                    id='lastName'
                                    placeholder='Last Name'
                                    className='p-[7px] text-base rounded-[5px] border border-gray-300 text-gray-900 w-full md:w-44 h-10 box-border focus:outline focus:outline-[#D6BBFB]'
                                />
                            </div>
                        </div>
                        <div className='w-full md:w-[375px]'>
                            ...
                            <input
                                ...
                                id='Email'
                                placeholder='Enter email'
                                className='p-[7px] text-base rounded-[5px] border border-gray-300 w-full h-10 focus:outline focus:outline-[#D6BBFB]'
                            />
                        </div>
                        <div className='w-full md:w-[375px]'>
                            <label className='text-[14px] text-[#080808] font-medium' htmlFor="Number">Phone Number</label>
                        ...
                        <div className='w-full md:w-[375px] flex items-start'>
                            <Checkbox size="sm" color="primary" id="terms" />
                            <label className='text-sm text-gray-900 mb-1.5 ml-2'>
                        ...
                        <button className='w-full md:w-[375px] h-10 bg-[#e39ff6] rounded-[7px] text-white hover:bg-[#7400e0] active:bg-[#7400e0]'>
                            Send verification code
                        </button>
                        <p className='text-[#7d7d8a] font-semibold text-[15px] mt-2'>Already have an account? <span className='text-[#9012ff] cursor-pointer hover:underline'>Log In</span></p>
                    </form>
                </div>
            </div>

            {/* Motivation Section (Hidden on Mobile) */}
            <div className="hidden md:flex w-1/2 items-center justify-center bg-[#0E2138] rounded-lg m-2">
                <div className="w-[554px] mx-3 flex flex-col gap-10 h-auto">
                    <Image src="/icons/coma.svg" width={80} height={80} alt="coma-image" />
                    <h1 className="text-[#EAECF0CC] font-bold text-2xl">Education is the foundation upon which we build our future.</h1>
                    <span className="text-[#667085] text-right">- Christine Gregoire</span>
                </div>
            </div>
        </div>
