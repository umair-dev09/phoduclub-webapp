...
export default function Login_Page() {
    ...
    return (
        <div className="flex flex-row w-full h-screen bg-gray-100">
            <div className="w-[45%] h-screen bg-gray-100 flex flex-col">
            ...
            <div className="w-[55%] flex items-center justify-center bg-gray-100 mt-1 mb-1 mr-1 rounded-xl overflow-hidden relative">
                <Image
                    src="/images/test1.png"
                    alt="Motivation"
                    width={10000}
