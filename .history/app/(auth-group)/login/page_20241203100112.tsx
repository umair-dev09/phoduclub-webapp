        ...
        <div className="flex flex-row w-full h-screen bg-[#F7F8FB]">
            ...
            <div className="w-1/2 flex flex-col  ">
                ...
                <div className="flex flex-col mt-12 gap-4 justify-center items-center h-auto w-full">
                    ...
                    <div>
                        <form onSubmit={(e) => e.preventDefault()} className="flex flex-col items-center pt-10 w-full">
                            <div className="flex flex-col w-[375px]">  {/* Set width here */}
                                ...
                                <PhoneInput
                                    ...
                                    containerClass="w-full"  {/* Ensures the container takes full width */}
                                    inputClass="w-full border border-gray-300 rounded-md px-3 py-2 text-black"  {/* Ensures the input field fills the container */}
                                />
                                {errorMessage && <p className="text-red-500 text-sm mt-2">{errorMessage}</p>}
                            </div>
                            <div id="recaptcha-container"></div>
                            <div className="flex justify-center mt-8">
                                <button
                                    type="button"
                                    className="text-white py-2 px-6 rounded-md w-[375px] font-medium"  {/* Consistent width */}
                                    style={{ backgroundColor: buttonColor }}
                                    onClick={handleSendVerificationCode}
                                    disabled={!isPhoneValid}
                                >
