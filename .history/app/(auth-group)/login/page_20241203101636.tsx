                        ...
                        <form onSubmit={(e) => e.preventDefault()} className="flex flex-col items-center pt-6 w-full">
                            <div className="flex flex-col w-full">
                                ...
                                <PhoneInput
                                    ...
                                    containerClass="w-full  rounded-md px-3 py-2 text-black focus:outline-none focus:ring-2 focus:ring-[#D6BBFB] hover:outline-1 hover:outline-[#D6BBFB] focus:ring-opacity-75"
