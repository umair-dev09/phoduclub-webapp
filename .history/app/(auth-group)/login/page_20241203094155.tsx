    ...
    return (
        <div className="flex flex-row w-full h-screen bg-[#F7F8FB]">
            ...
            <div className="w-1/2 flex flex-col  ">
                <div className="flex flex-row px-[134px] items-center">
                    <span className="font-bold text-base text-[#0E2138]">phodu</span>
                    <span className="font-bold text-base text-[#800EE2]">.club</span>
                </div>
            </div>
