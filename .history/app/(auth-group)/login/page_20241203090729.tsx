...
export default function Login_Page() {
    ...
    return (
        <div className="flex flex-row w-full h-screen bg-[#F7F8FB]">
            ...
            <div className="w-1/2 flex items-center justify-center flex-col gap-4 bg-[#0E2138] rounded-lg my-2">
                <Image
                    ...
                    alt="coma-image"
                />
                <h1 className="text-[#EAECF0] font-bold text-2xl">Education is the foundation upon which we build our future.</h1>
                <span className=" text-[#667085] font-normal text-base"></span>
            </div>
        </div>
    );
}
