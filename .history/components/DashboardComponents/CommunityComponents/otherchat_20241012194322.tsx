        ...
        <div className="mx-6 h-full  mt-6 flex flex-col gap-6">
            ...
            <div className="w-full h-auto flex flex-col">
                ...
                <div className="flex flex-wrap mt-1 gap-2 h-auto ml-11">
                    <button className=" rounded-[54px] border border-solid border-[#D0D5DD] bg-[#F2F4F7] h-[26px] w-[48px] p-1    flex flex-row justify-center gap-1 hover:bg-[#F8F0FF] hover:border-[#7400E0]">
                        <Image
                            src="/icons/emoji-5.png"
                            width={15}
                            height={15}
