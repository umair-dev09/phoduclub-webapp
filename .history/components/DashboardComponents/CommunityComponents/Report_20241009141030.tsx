                        ...
                        <div className="h-auto border-b border-solid border-[#EAECF0] px-[24px] pt-[24px] pb-3">
                            ...
                            <div className="pt-4 flex flex-row gap-2 h-auto ">
                                <button className="group">
                                    <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 hover:bg-[#9012FF] hover:border-[#9012FF]">
                                        <span className="text-[#344054] group-hover:text-[#FFFFFF] font-medium text-sm flex flex-row justify-center items-center">span</span>
                                    </div>
                                </button>
                                <button className=" group">
                                    <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 hover:bg-[#9012FF] hover:border-[#9012FF]">
                                        <span className="text-[#344054] group-hover:text-[#FFFFFF] font-medium text-sm flex flex-row justify-center items-center">Nudity</span>
                                    </div>
                                </button>
                                <button className=" group">
                                    <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 hover:bg-[#9012FF] hover:border-[#9012FF]">
                                        <span className="text-[#344054] group-hover:text-[#FFFFFF] font-medium text-sm flex flex-row justify-center items-center">scam</span>
                                    </div>
                                </button>
                                <button className=" group">
                                    <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 hover:bg-[#9012FF] hover:border-[#9012FF]">
                                        <span className="text-[#344054] group-hover:text-[#FFFFFF] font-medium text-sm flex flex-row justify-center items-center">Illegal</span>
                                    </div>
                                </button>
                                <button className=" group">
                                    <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 hover:bg-[#9012FF] hover:border-[#9012FF]">
                                        <span className="text-[#344054] group-hover:text-[#FFFFFF] font-medium text-sm flex flex-row justify-center items-center">Violence</span>
                                    </div>
                                </button>
                            ...
                            <div className="pt-2 flex flex-row gap-2 h-auto ">
                                ...
                                <button className=" group">
                                    <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 hover:bg-[#9012FF] hover:border-[#9012FF]">
                                        <span className="text-[#344054] group-hover:text-[#FFFFFF] font-medium text-sm flex flex-row justify-center items-center">Something else</span>
                                    </div>
                                </button>
                        ...
                        <div className="w-full h-[76px] flex justify-end gap-2 px-6">
                            ...
                            <div className="mt-5">
                                <button
                                    ...
                                    className="bg-[#8501FF] text-[#FFFFFF] text-sm font-semibold py-2 px-5 rounded-md w-auto h-[44px]"
                                    style={{
