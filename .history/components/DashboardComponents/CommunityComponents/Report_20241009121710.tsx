                    ...
                    <DialogPanel transition className="bg-white rounded-2xl w-[480px] h-auto border border-[#EAECF0]">
                        ...
                        <div className="h-[156px] border-b border-solid border-[#EAECF0] px-[24px] pt-[24px]">
                            ...
                            <div className="pt-4 flex flex-row gap-2">
                                <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 ">
                                    <span className="text-[#344054] font-medium text-normal flex flex-row justify-center items-center">span</span>
                                </div>
                                <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 ">
                                    <span className="text-[#344054] font-medium text-normal flex flex-row justify-center items-center">Nudity</span>
                                </div>
                                <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 ">
                                    <span className="text-[#344054] font-medium text-normal flex flex-row justify-center items-center">scam</span>
                                </div>
                                <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 ">
                                    <span className="text-[#344054] font-medium text-normal flex flex-row justify-center items-center">Illegal</span>
                                </div>
                                <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 ">
                                    <span className="text-[#344054] font-medium text-normal flex flex-row justify-center items-center">Hate Speech</span>
                                </div>

                            </div>
                            <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD]  ">
                                <span className="text-[#344054] font-medium text-normal flex flex-row justify-center items-center">Something else</span>
                            </div>
