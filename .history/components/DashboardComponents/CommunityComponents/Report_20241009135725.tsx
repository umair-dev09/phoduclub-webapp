            ...
            <Dialog open={isOpen} onClose={() => setIsOpen(false)} className="relative z-50">
                ...
                <div className="fixed inset-0 flex items-center justify-center ">
                    <DialogPanel transition className="bg-white rounded-2xl w-[480px] h-auto border border-[#EAECF0]">
                        ...
                        <div className="h-auto border-b border-solid border-[#EAECF0] px-[24px] pt-[24px] gap-">
                            <span className="text-[#344054] font-medium text-normal">Why are you reporting this message?</span>
                            <div className="pt-4 flex flex-row gap-2 h-auto w-[100px]">
                                ...
                                <button className=" group">
                                    <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 hover:bg-[#9012FF] hover:border-[#9012FF]">
                                        <span className="text-[#344054] group-hover:text-[#FFFFFF] font-medium text-normal flex flex-row justify-center items-center">Hate Speech</span>
                                    </div>
                                </button>
                                <button className=" group">
                                    <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 hover:bg-[#9012FF] hover:border-[#9012FF]">
