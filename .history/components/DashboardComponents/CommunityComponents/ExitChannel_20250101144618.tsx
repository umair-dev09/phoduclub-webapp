                ...
                <DialogPanel transition className="bg-white rounded-2xl w-[480px] h-auto">
                    <div className=' flex flex-col p-6 gap-2'>
                        <div className='flex flex-row justify-between items-center'>
                            ...
                            <button className="w-[32px] h-[32px]  rounded-full flex items-start justify-center transition-all duration-300 ease-in-out hover:bg-[#F2F4F7]">
                    ...
                    <div className="flex flex-row justify-end mx-6 my-4 gap-4">
                        ...
                        <button className="py-[0.625rem] px-6 text-white shadow-inner-button  bg-[#BB241A] border border-[#DE3024] rounded-md" onClick={onClose} >Yes, Exit channel</button>
                    </div>
