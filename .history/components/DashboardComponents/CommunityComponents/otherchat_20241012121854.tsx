    ...
    return (
        ...
        <div className="mx-6  h-full w-full mt-6 ">
            <div className="w-full h-auto flex flex-col">
                ...
                <div className="ml-11 bg-white h-auto rounded-md border border-solid border-[#EAECF0] max-w-[400px] min-w-[50px] break-words px-4 py-3 inline-block flex-shrink-0">
                    Hey
                </div>
            </div>
