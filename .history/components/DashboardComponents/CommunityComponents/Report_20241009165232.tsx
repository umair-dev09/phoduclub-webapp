                        ...
                        <div className="h-auto border-b border-solid border-[#EAECF0] px-[24px] pt-[24px] pb-3">
                            ...
                            <div className="pt-4 flex flex-row gap-2 h-auto ">
                                <button className="group" onClick={() => handleReasonClick("Scam")}>
                                    <div className={`h-[28px] w-auto rounded-[6px] border-2 ${activeButton === "Scam" ? "bg-[#9012FF] border-[#9012FF]" : "border-[#D0D5DD]"} px-2 flex flex-row justify-center items-center`}>
                                        <span className={`${activeButton === "Scam" ? "text-[#FFFFFF]" : "text-[#344054]"} font-medium text-sm`}>Scam</span>
                                    </div>
