    ...
    return (
        ...
        <div className="mx-6  h-full w-full mt-6 ">
            <div className="w-full h-auto flex  flex-col">
                ...
                <div className="ml-11 bg-white h-auto w-auto rounded-md inline-block border border-solid border-[#EAECF0] max-w-[400px] min-w-[50px] break-words px-4 py-3">
                    Hey everyone, Welcome to the channel! We are happy to have you here.
                </div>
