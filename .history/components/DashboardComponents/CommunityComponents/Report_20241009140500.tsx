                    ...
                    <DialogPanel transition className="bg-white rounded-2xl w-[480px] h-auto border border-[#EAECF0]">
                        ...
                        <div className="h-auto border-b border-solid border-[#EAECF0] px-[24px] pt-[24px] pb-3">
                            ...
                            <div className="pt-4 flex flex-row gap-2 h-auto ">
                                <button className="group">
                                    <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 hover:bg-[#9012FF] hover:border-[#9012FF]">
                                        <span className="text-[#344054] group-hover:text-[#FFFFFF] font-medium text-normal flex flex-row justify-center items-center">span</span>
                                    </div>
                                </button>
                                <button className=" group">
                                    <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 hover:bg-[#9012FF] hover:border-[#9012FF]">
                                        <span className="text-[#344054] group-hover:text-[#FFFFFF] font-medium text-normal flex flex-row justify-center items-center">Nudity</span>
                                    </div>
                                </button>
                                <button className=" group">
                                    <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 hover:bg-[#9012FF] hover:border-[#9012FF]">
                                        <span className="text-[#344054] group-hover:text-[#FFFFFF] font-medium text-normal flex flex-row justify-center items-center">scam</span>
                                    </div>
                                </button>
                                <button className=" group">
                                    <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 hover:bg-[#9012FF] hover:border-[#9012FF]">
                                        <span className="text-[#344054] group-hover:text-[#FFFFFF] font-medium text-normal flex flex-row justify-center items-center">Illegal</span>
                                    </div>
                                </button>
                                <button className=" group">
                                    <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 hover:bg-[#9012FF] hover:border-[#9012FF]">
                                        <span className="text-[#344054] group-hover:text-[#FFFFFF] font-medium text-normal flex flex-row justify-center items-center">Violence</span>
                                    </div>
                                </button>
                            ...
                            <div className="pt-2 flex flex-row gap-2 h-auto ">
                                ...
                                <button className=" group">
                                    <div className="h-[28px] w-auto rounded-[6px] border-2 border-solid border-[#D0D5DD] px-2 hover:bg-[#9012FF] hover:border-[#9012FF]">
                                        <span className="text-[#344054] group-hover:text-[#FFFFFF] font-medium text-normal flex flex-row justify-center items-center">Something else</span>
                                    </div>
                                </button>

                            </div>
                            <div className="pt-[24px] mb-1">
                                <span className="text-[#344054] font-medium text-normal ">Reason</span>
                            </div>
                            <div className="rounded-md  border-2 border-solid border-[#D0D5DD] h-[160px] ">
                                <textarea

                                    placeholder="Write a message"
                                    className="outline-none placeholder-[#667085] text-normal font-normal w-full h-full p-2 resize-none rounded-md  "
