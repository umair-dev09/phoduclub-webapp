    ...
    return (
        <>
            <Dialog open={isOpen} onClose={() => setIsOpen({ report: false, media: false })} className="relative z-50">
                ...
                <div className="fixed inset-0 flex items-center justify-center ">
                    <DialogPanel transition className="bg-white rounded-2xl w-[480px] h-auto border border-solid border-[#EAECF0]">
                        ...
                        <div className="mx-[24px] mt-4 ">
                            <div className="rounded-lg h-[44px] bg-[#F9FAFB] border border-solid border-[#EAECF0]  gap-1 flex flex-row ">
                                <button className="w-full hover:bg-[#EAECF0]  rounded-md my-[2px] ml-[2px]">
                                    <span className="text-[#667085] font-semibold text-sm">Images</span>

                                </button>
                                <button className="w-full hover:bg-[#EAECF0] rounded-md my-[2px]">
                                ...
                                <button className="w-full hover:bg-[#EAECF0]  rounded-md my-[2px] mr-[2px]">
