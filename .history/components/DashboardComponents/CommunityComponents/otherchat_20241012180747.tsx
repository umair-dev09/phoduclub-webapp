                            ...
                            <PopoverContent as="div">
                                <div className="flex flex-col bg-[#FFFFFF] w-auto h-auto border border-[#EAECF0] rounded-md">
                                    ...
                                    <button className='flex flex-row items-center gap-2 w-full px-4 py-[10px] transition-colors hover:bg-neutral-100'>
                                        <Image src={`/icons/reply.png`} alt="Reply icon" width={20} height={20} />
                                        <span className='font-normal text-[#0C111D] text-sm'>Reply</span>
                                    </button>

                                    <button className='flex flex-row items-center gap-2 w-full px-4 py-[10px] transition-colors hover:bg-neutral-100'>
                                        <Image src={`/icons/copy.png`} alt="Copy icon" width={20} height={20} />
                                        <span className='font-normal text-[#0C111D] text-sm'>Copy</span>
                                    </button>

                                    <button className='flex flex-row items-center gap-2 w-full px-4 py-[10px] transition-colors hover:bg-neutral-100'>
                                        <Image src={`/icons/bookmark.png`} alt="Bookmark icon" width={20} height={20} />
                                        <span className='font-normal text-[#0C111D] text-sm'>Bookmark</span>
                                    </button>

                                    <button className='flex flex-row items-center gap-2 w-full px-4 py-[10px] transition-colors hover:bg-neutral-100'>
                                        <Image src={`/icons/report-message.png`} alt="Report Message icon" width={20} height={20} />
