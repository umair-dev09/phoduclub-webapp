    ...
    return (
        <>
            <Dialog open={isOpen} onClose={() => setIsOpen({ report: false, media: false })} className="relative z-50">
                ...
                <div className="fixed inset-0 flex items-center justify-center ">
                    <DialogPanel transition className="bg-white rounded-2xl w-[480px] h-auto border border-[#EAECF0]">
                        <div className="h-[68px] border-b border-solid border-[#EAECF0] px-[24px]">
                            <div className="justify-between flex flex-row items-center justify-center">
                                <span className="text-lg font-bold text-[#1D2939] fontstyle-sora">
                                    Report
                                </span>
