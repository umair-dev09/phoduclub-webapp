    ...
    return (
        <div className="mx-6 h-full  mt-6 flex flex-col gap-6">
            ...
            <div className="w-full h-auto flex flex-col">
                ...
                <div className="ml-11 flex">
                    <div className="bg-white rounded-md border border-solid border-[#EAECF0] max-w-[400px] px-4 py-3 inline-block flex flex-col">
                        <div className="w-full h-full rounded-md border border-solid border-[#D0D5DD] flex flex-col bg-[#D0D5DD] p-4">
                            <div className="gap-2 flex items-center">
