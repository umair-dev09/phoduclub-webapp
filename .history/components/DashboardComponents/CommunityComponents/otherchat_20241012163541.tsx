    ...
    return (
        <div className="mx-6 h-full w-full mt-6 flex flex-col gap-6">
            ...
            <div className="w-full h-auto flex flex-col">
                ...
                <div className="ml-11 flex flex-row gap-2">
                    ...
                    <div className="w-[48px] h-[26px] rounded-[54px] border border-solid border-[#6770A9] flex justify-center items-center">
                        {/* Place your content here */}
                        <span className="text-xs text-[#6770A9]">Centered Text</span>
                    </div>
