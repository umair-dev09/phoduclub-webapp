                        ...
                        >
                            <PopoverTrigger>
                                <button
                                    ...
                                    className='w-[48px] h-[26px] rounded-[54px] border border-solid border-[#6770A9]  hover:bg-[#D0D5DD] flex items-center justify-center focus:outline-none bg-[#F2F4F7] ml-2'
                                >
                                    <Image
                            ...
                            <PopoverContent as="div">
                                <div className="flex flex-col bg-[#FFFFFF] w-auto h-auto border border-[#EAECF0] rounded-md">
                                    ...
                                    {/* Popover actions */}
                                    <button className='flex flex-row items-center gap-2 w-full px-4 py-[10px] transition-colors hover:bg-neutral-100'>
                                        <Image src={`/icons/Reply.svg`} alt="Reply icon" width={20} height={20} />
                                    ...
                                    <button className='flex flex-row items-center gap-2 w-full px-4 py-[10px] transition-colors hover:bg-neutral-100'>
                                        <Image src={`/icons/Report.svg`} alt="Report Message icon" width={20} height={20} />
