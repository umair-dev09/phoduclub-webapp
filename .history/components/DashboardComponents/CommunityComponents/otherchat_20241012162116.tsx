        ...
        <div className="mx-6 h-full w-full mt-6 flex flex-col gap-6">
            ...
            <div className="w-full h-auto flex flex-col">
                ...
                <div className="ml-11 flex">
                    ...
                    <button className="bg-white rounded-md border border-solid border-[#EAECF0] max-w-[400px] px-4 py-3 inline-block ">

                        <span className="break-words whitespace-pre-wrap font-normal text-[#182230] text-sm leading-5 ">
                            {messageStart1}
                        </span>
