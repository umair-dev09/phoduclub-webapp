            ...
            <div className="fixed inset-0 flex items-center justify-center ">
                <DialogPanel transition className="bg-white rounded-2xl w-[480px] h-auto">
                    ...
                    <div className="flex flex-row justify-end mx-6 my-4 gap-4">
                        ...
                        <button className="py-[0.625rem] px-6 text-white shadow-inner-button  hover:bg-[#DE3024] bg-[#BB241A] border border-[#DE3024] rounded-md" onClick={onClose} >Yes, Exit channel</button>
                    </div>
