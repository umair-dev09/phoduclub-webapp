        ...
        <div className="mx-6 h-full w-full mt-6">
            <div className="w-full h-auto flex flex-col">
                ...
                <div className="gap-2 flex-col flex">
                    <div className="ml-11 bg-white rounded-md border border-solid border-[#EAECF0]  break-words px-4 py-3 inline-flex">
                        <div className="max-w-[400px] min-w-auto">hy</div>
                    </div>
