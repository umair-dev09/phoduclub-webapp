            ...
            <div className="w-full h-auto flex flex-col">
                ...
                <div className="ml-11 flex flex-row gap-2 items-center">
                    ...
                    <Popover placement="bottom-start">
                        <PopoverTrigger>
                            <button className='w-[48px] h-[26px] rounded-[54px] border border-solid border-[#6770A9] flex items-center justify-center focus:outline-none bg-[#F2F4F7]'>
                                <Image
                        ...
                        <PopoverContent>
                            <div
                                ...
                                <button className='flex flex-row items-center gap-2 w-30 px-4 py-[10px] transition-colors hover:bg-neutral-100 rounded-tr-md  '>

                                    <Image src='/icons/Reply.svg' alt='search icon' width={20} height={20} />
                                ...
                                <button className='flex flex-row items-center gap-2 w-30 px-4 py-[10px] transition-colors hover:bg-neutral-100 rounded-br-md '>
