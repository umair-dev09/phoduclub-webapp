                    ...
                    <DialogPanel transition className="bg-white rounded-2xl w-[480px] h-auto border border-[#EAECF0]">
                        ...
                        <div className="h-[156px] border-b border-solid border-[#EAECF0] px-[24px] pt-[24px]">
                            ...
                            <div className="pt-4 flex flex-row">
                                <div className="h-[28px] w-auto rounded-sm border border-solid border-[#D0D5DD] px-2 flex flex-row justify-center items-center">
                                    <span className="text-[#344054] font-medium text-normal">san</span>
                                </div>
                            </div>
