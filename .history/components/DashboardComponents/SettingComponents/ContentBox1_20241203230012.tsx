    ...
    return (
        <div className="space-y-2">
            <div>
                ...
                ${activeTab === 'profile' ? 'text-[#7400e0]' : 'text-gray-800 bg-white border-white'} 
                hover:bg-[#7400e0] transition duration-150`}
                >
                    <Image
            ...
            <div>
                <button
                    ...
                    className={`flex items-center justify-start w-full px-4 py-2 rounded-lg border-2 font-medium 
                ${activeTab === 'purchase' ? 'text-[#7400e0]' : 'text-gray-800 bg-white border-white'} 
