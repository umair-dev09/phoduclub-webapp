            ...
            <div>
                <button
                    ...
                    <Image
                        ...
                        height={25}
                    />
                    <p className="flex items-center justify-start text-base font-medium  text-left">My Profile</p>
                </button>
            </div>
            ...
            <div>
                <button
                    ...
                    <Image
                        ...
                        height={25}
                    />
                    <p className="flex items-center justify-start font-medium text-base text-left">Purchase History</p>
                </button>
            </div>
        </div>
    );
