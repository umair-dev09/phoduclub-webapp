...
function Purchase() {
    ...
    return (
        <div className="mx-6 overflow-x-auto border border-solid border-[#EAECF0] rounded-lg">
            <table className="w-full border-collapse border-spacing-0  overflow-hidden">
                <thead className="bg-gray-100">
                    <tr className="text-gray-600">
                        ...
                        <th className="text-left py-4 px-6 font-medium w-[25%]">PAYMENT TYPE</th>
                        <th className="text-left py-4 px-6 font-medium w-[15%]">ACTIONS</th>
                    </tr>
                </thead>
