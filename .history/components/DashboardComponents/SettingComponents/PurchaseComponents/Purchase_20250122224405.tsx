        ...
        <div className="px-5 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
            <div className="mx-1 border border-solid border-[#EAECF0] rounded-lg h-fit">
                <div className="overflow-x-auto min-w-full"> {/* Ensure the table has a minimum width for scrolling */}
                    <table className="w-full min-w-[800px] border-collapse border-spacing-0 rounded-md"> {/* Add min-width to ensure table is scrollable */}
                        <thead className="bg-gray-100 sticky top-0 z-10 rounded-tl-md">
                            ...
                            {transactions.length > 0 ? (
                                transactions.map((transaction, index) => (
                                    <tr key={index} className="hover:bg-gray-50 text-sm">
                                        ...
                                        <td className="px-6 py-4 ">
                                            <div className="flex flex-row gap-2 whitespace-nowrap text-center">
                                                <span className=" text-[#667085] font-normal leading-6 ">{transaction.transactionId}</span>
                                                <button>
                                                    {/* onClick={handleCopy}> */}
                                                    <Image
