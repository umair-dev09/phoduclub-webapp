                                    ...
                                    <tr key={index} className="hover:bg-gray-50 text-sm">
                                        ...
                                        <td className="px-6 py-4 text-center text-[#667085] font-normal leading-6 whitespace-nowrap">
                                            <div className="flex items-center justify-center">
                                                <span className={`transition-transform ${copied ? 'transform -translate-y-2' : ''}`}>{transaction.transactionId}</span>
                                                <button
                                                ...
                                                {copied && (
                                                    <span className=" px-2 bg-[#1D2939] rounded-[6px] text-white font-medium text-[11px]">
                                                        Copied!!
                                                    </span>
                                                )}
                                            </div>
