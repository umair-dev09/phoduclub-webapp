                                        ...
                                        <td className="px-6 py-4 text-center text-[#667085] font-normal leading-6 whitespace-nowrap">
                                            <div className="flex items-center justify-center relative">
                                                ...
                                                {copied === transaction.transactionId && (
                                                    <span className="absolute -right-2 top-1/2 transform -translate-y-1/2 px-2 bg-[#1D2939] rounded-[6px] text-white font-medium text-[11px] transition-all duration-200">
                                                        Copied!!
                                                    </span>
