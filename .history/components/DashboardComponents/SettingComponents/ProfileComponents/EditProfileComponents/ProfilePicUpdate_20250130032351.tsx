        ...
        <ModalContent>
          <>
            ...
            <ModalBody className='flex gap-4 pb-4'>
              <div className={styles.picBox}>
                <label htmlFor="upload" className=" flex hover:bg-[#F9FAFB] flex-col rounded-md text-center cursor-pointer border border-solid border-lightGrey gap-3 items-center justify-center px-12 py-[30px]">
                  <input
                    type="file"
                    id="upload"
                    className="hidden"
                ...
                <button className=" flex hover:bg-[#F9FAFB]' flex-col rounded-md text-center cursor-pointer border border-solid border-lightGrey gap-3 items-center justify-center px-12 py-[30px]" onClick={onChooseAvatarClick}>
                  <Image src="/images/chooseAvatar.svg" alt="choose avatar" width={110} height={110} />
                  <p className="text-sm font-medium">Choose Avatar</p>
                </button>
              </div>
