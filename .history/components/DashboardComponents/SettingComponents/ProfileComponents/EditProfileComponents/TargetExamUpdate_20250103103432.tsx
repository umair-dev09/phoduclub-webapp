        ...
        <ModalContent>
          <>
            ...
            <ModalFooter className="border-t border-lightGrey">
              <Button onClick={() => setIsOpen(false)} variant="light" className=" border border-lightGrey">Cancel</Button>
              <Button className="hover:bg-[#6D0DCC] text-sm font-semibold bg-[#8501FF] text-white" onClick={onContinueClick}>Continue</Button>
            </ModalFooter>
          </>
        </ModalContent>
      </Modal>
