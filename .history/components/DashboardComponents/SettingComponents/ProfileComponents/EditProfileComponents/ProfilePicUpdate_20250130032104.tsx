        ...
        <ModalContent>
          <>
            ...
            <ModalBody className='flex gap-4 pb-4'>
              <div className={styles.picBox}>
                <label htmlFor="upload" className=" flex flex-col rounded-md text-center border border-solid border-lightGrey gap-3 items-center justify-center px-12 py-[30px]">
                  <input
                    type="file"
                    id="upload"
                    className="hidden"
