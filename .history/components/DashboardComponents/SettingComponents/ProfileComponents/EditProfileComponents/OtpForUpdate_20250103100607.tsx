  ...
  return (
    ...
    >
      {Array.from({ length: 6 }).map((_, index) => (
        <input
          key={index}
          className="w-auto h-16 font-medium border-solid border-[1.5px] border-[#D0D5DD] m-[5px] text-center text-[30px] text-black rounded-[8px] hover:border-none hover:outline hover:outline-[1.5px] hover:outline-[#D6BBFB] focus:outline focus:outline-[1.5px] focus:outline-[#D6BBFB] focus:border-none"
          type="text"
          inputMode="numeric"
          maxLength={1}
          placeholder="-"
