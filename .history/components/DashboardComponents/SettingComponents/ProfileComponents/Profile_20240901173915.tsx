    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.name}>
                ...
                <div className={styles.username}>Jabir Ali</div>
            </div>
            ...
            <div className={styles.name}>
                ...
                <div className={styles.username}>jabir@gmail.com</div>
            </div>
            <div className={styles.divider}><hr /></div>
            ...
            <div className={styles.name}>
                ...
                <div className={styles.username}>+91 7898525987</div>
            </div>
            <div className={styles.divider}><hr /></div>
            ...
            <div className={styles.name}>
                ...
                <div className={styles.username}>2024</div>
            </div>
