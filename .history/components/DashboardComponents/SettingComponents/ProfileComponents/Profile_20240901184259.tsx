    ...
    return (
        <div className={styles.container}>
                    ...
                    <div className={styles.nameInfo}>
                        ...
                        <div className={styles.nameId}>
                            ...
                            <div className={styles.id}>
                                ...
                                <div className={styles.sizeRecommendation}><p>File size must be less than 5MB</p></div>
                            </div>
                        </div>
                    </div>
            ...
            <div className={styles.base}>
                <div className={styles.cancle}><button className={styles.cancleButton}>Cancel</button></div>
