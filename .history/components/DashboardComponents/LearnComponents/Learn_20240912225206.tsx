        ...
        <div className="flex space-x-4">
            <div>
                <button
                    ...
                    className={`flex flex-col items-end py-2 px-4 text-base pb-[30px] ${activeTab === 'course' ? 'border-b-[2px] border-[#7400E0] text-[#7400E0]' : 'text-[#667085]'} focus:outline-none`}
                    style={{ fontSize: '16px', fontWeight: '500', marginLeft: '32px' }}
                >
                    Courses<span>10</span>
                </button>
            </div>
            <div>
                <button
