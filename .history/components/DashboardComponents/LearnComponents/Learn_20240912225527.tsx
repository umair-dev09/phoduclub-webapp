        ...
        <div className="flex space-x-4">
            <div>
                <button
                    ...
                    className={`py-2 px-4 text-base pb-[30px] ${activeTab === 'course' ? 'border-b-[2px] border-[#7400E0] text-[#7400E0]' : 'text-[#667085]'} focus:outline-none`}
                    style={{ fontSize: '16px', fontWeight: '500', marginLeft: '32px', borderBottom: '1px solid #6941C6' }}
                >
                    Courses
                </button>
            </div>
            <div>
                <button
                    ...
                    style={{ fontSize: '16px', fontWeight: '500', borderBottom: '1px solid #6941C6' }}
                >
                    Tests
                </button>
            </div>
