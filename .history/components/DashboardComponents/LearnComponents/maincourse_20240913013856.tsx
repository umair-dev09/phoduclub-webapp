            ...
            <div className={styles.course1}>
                ...
                <div className={styles.courseInfo}>
                    ...
                    <div className="flex flex-1 flex-col justify-evenly">
                        ...
                        <div className="relative w-10/12 h-2 rounded-full bg-gray-200">
                            <div
                                className="absolute top-0 left-0 h-2 rounded-full bg-purple-600"
                                style={{ width: "43%" }} // Dynamically set width
                            ></div>
                        </div>
