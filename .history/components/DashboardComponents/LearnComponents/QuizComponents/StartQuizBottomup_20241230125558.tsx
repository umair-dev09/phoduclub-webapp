            ...
            >
                ...
                <div className="flex flex-col h-full"> {/* Change 1: Wrap everything in a flex column container */}
                    ...
                    <div className="p-5 flex justify-between items-center h-[69px] w-full border-b-[1.5px] border-t-[1.5px] border-[#EAECF0] rounded-tl-[18px] rounded-tr-[16px]">
                        ...
                        <div className={`w-[150px] h-[44px] bg-[#FFFFFF] border-[1px] border-[#EAECF0] rounded-[8px] flex items-center justify-center  `}>
                            <button
                                ...
                                className="w-full h-full flex items-center justify-center text-sm font-semibold text-[#1D2939] border-none p-[10px_24px] hover:bg-[#F2F4F7]"
                            >
                                Save and Exit
                            </button>
                        </div>
                    ...
                    <div className="flex flex-row items-center justify-end border-t border-lightGrey h-[76px]">
                        <button className=" mr-6 flex justify-end rounded-lg py-2.5 px-6 text-sm bg-[#9012FF] text-white border border-[#800EE2] shadow-inner-button hover:bg-[#6D0DCC]">
                            <p>Submit</p>
                        </button>
                    </div>
