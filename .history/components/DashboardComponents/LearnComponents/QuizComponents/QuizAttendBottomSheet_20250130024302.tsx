...
function QuizAttendBottomSheet({
    ...
    return (
        <>
            ...
            <Modal isOpen={isOpenReviewD} onOpenChange={(isOpen) => !isOpen && onCloseReviewD()} hideCloseButton
                size="lg"
            >
                <ModalContent>
                    <>
            ...
            <Modal isOpen={isOpenReviewD} size="2xl" onOpenChange={(isOpen) => !isOpen && onCloseReviewD()}
                    ...
                    {(onClose) => (
                        <ModalBody className="px-0">
                            ...
                            <div className="flex flex-row justify-end mx-6 mb-2 mt-1 gap-4">
                                ...
                                <button className="py-[0.625rem] px-6 text-white shadow-inner-button bg-[#8501FF] font-semibold text-sm border border-[#800EE2] rounded-md" onClick={() => { setShowReviewSheet(true); onCloseReviewD(); }}>Review Answers</button>
                            </div>
                        </ModalBody>
                    )}
                </ModalContent>
