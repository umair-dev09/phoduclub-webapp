        ...
        <div className="flex flex-1">
            ...
            <div className="grid grid-cols-3 gap-5 w-full">
                ...
                <div className="flex flex-col justify-between h-[11.25rem] rounded-xl py-6 px-6 bg-white border border-lightGrey">
                    ...
                    <div>
                        <button onClick={onStartQuiz} className="flex items-center justify-center w-full px-[14px] py-[10px] text-xs text-white font-semibold shadow-inner-button bg-[#9012FF] rounded-[6px] border border-darkPurple  hover:bg-[#6D0DCC]">
                            Start Quiz
                        </button>
                    </div>
                </div>
