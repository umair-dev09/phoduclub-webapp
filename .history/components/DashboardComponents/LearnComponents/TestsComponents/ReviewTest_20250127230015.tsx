        ...
        <div className='w-full h-auto'>
            ...
            >
                <div className="flex flex-col w-[full] h-full">
                    ...
                    <div className="p-5 flex justify-between items-center h-[69px] w-full border-b-[1.5px] border-t-[1.5px] border-[#EAECF0] rounded-tl-[18px] rounded-tr-[16px]">
                        <button className='border border-lightGrey rounded-md items-center justify-center h-11 w-[111px]'>
                            <span className="text-lg font-semibold text-[#1D2939]">Previous</span>
                        </button>
