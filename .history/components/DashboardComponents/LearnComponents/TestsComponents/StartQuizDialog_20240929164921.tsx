        ...
        <div className="contianer flex flex-1 flex-col h-auto overflow-y-auto pb-5">
            ...
            <div className="gap-4 flex flex-col ">
                ...
                <div className="TEST CONTAINER ml-8 mr-8 rounded-[12px] border border-solid border-[#EAECF0] bg-[#FFFFFF] ">
                        ...
                        trigger={
                            <div className="h-[46px] m-2 flex justify-between items-center">
                                ...
                                {!accordionOpen ? (
                                    ...
                                    <button className="flex justify-center items-center mr-3" onClick={() => onStartNow}>
                                        <Image
                                            src={accordionOpen ? "/icons/arrowup.svg" : "/icons/arrowdown.svg"} // Toggle arrow based on accordion state
                                            alt="arrow"
                                            width={24}
                                            height={24}
                                        />
                    ...
                    >
                        <div
                            className={`transition-all duration-300 ease-in-out overflow-hidden  "max-h-0" : "max-h-[500px]"} `}
                        >
