            ...
            >
                <div className="flex flex-col w-[full] h-full">
                    ...
                    <div className="p-5 flex justify-between items-center h-[69px] w-full border-b-[1.5px] border-t-[1.5px] border-[#EAECF0] rounded-tl-[18px] rounded-tr-[16px]">
                        ...
                        <button
                            className="w-auto h-[44px] px-8 border border-[#800EE2] bg-[#800EE2] rounded-[8px] flex items-center justify-center hover:bg-[#6D0DCC]"
                            onClick={() => setShowReviewSheet(false)}
                        >
                            <span className="w-auto h-full flex items-center justify-center text-sm font-semibold text-[#1D2939] border-none">
                                Submit
                            </span>
                        </button>
                    </div>
