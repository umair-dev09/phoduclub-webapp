                        ...
                        trigger={
                            <div className="h-[46px] m-2 flex justify-between items-center">
                                ...
                                {!accordionOpen ? (
                                    ...
                                    <button className="flex justify-center items-center mr-3" onClick={toggleAccordion}>
                                        <Image
                                            src={accordionOpen ? "/icons/arrowup.svg" : "/icons/arrowdown.svg"}  {/* Use accordionOpen for arrow direction */}
                                            alt="arrow"
                                            width={24}
                                            height={24}
                                        />
