...
//                     </div>
//                     <div className="p-5 flex justify-between items-center h-[69px] w-full border-b-[1.5px] border-t-[1.5px] border-[#EAECF0] rounded-tl-[18px] rounded-tr-[16px]">
//                         <button className='border border-lightGrey rounded-md flex items-center justify-center h-11 w-[111px] hover:bg-lightGrey'>
...
function ReviewTest({ showReviewSheet, setShowReviewSheet, questionsList, answeredQuestions, timeTaken }: ReviewTestProps) {
    ...
    // Replace the mapping section in the JSX with the single question display
    return (
        <div className='w-full h-auto'>
            <Drawer
                open={showReviewSheet}
                ...
                style={{ height: "98vh" }}
            >
                {/* Keep the existing header div unchanged */}
                <div className="flex flex-col w-[full] h-full">
                    <div className="p-5 flex justify-between items-center h-[69px] w-full border-b-[1.5px] border-t-[1.5px] border-[#EAECF0] rounded-tl-[18px] rounded-tr-[16px]">
                        <span className="text-lg font-semibold text-[#1D2939]">Review Attempted Questions</span>
                        <span className="text-lg font-semibold text-[#1D2939] flex items-center justify-center gap-2">
                                    ...
                                    <div className="bg-[#FFFFFF] w-[800px] h-auto flex flex-col gap-[20px]">
                                        ...
                                        {isAnswered && !isCorrect && (
                                            ...
                                            <div className='flex flex-row justify-between items-center '>
                                                ...
                                                <button
                                                    className='text-white px-2 py-1 font-medium text-sm rounded-md shadow-inner-button bg-purple hover:bg-[#6D0DCC]'
                                        ...
                                        {!isAnswered && (
                                            ...
                                            <div className='flex flex-row justify-between items-center '>
                                                ...
                                                <button
                                                    className='text-white px-2 py-1 font-medium rounded-md shadow-inner-button text-sm bg-purple hover:bg-[#6D0DCC]'
                                                    onClick={() => setshowexplanation(true)}
                                                >
                                                    Show Explanation
                                                </button>
                    ...
                    <div className="p-5 flex justify-between items-center h-[69px] w-full border-b-[1.5px] border-t-[1.5px] border-[#EAECF0] rounded-tl-[18px] rounded-tr-[16px]">
                        <div>
                            {currentQuestionIndex !== 0 && (
                                <button
                                    className='border border-lightGrey rounded-md flex items-center justify-center h-11 w-[111px] hover:bg-[#F2F4F7]'
                        ...
                        {!isLastQuestion && (
                            <button
                                className="w-[111px] h-[44px] border border-[#800EE2] bg-[#800EE2] shadow-inner-button rounded-md flex items-center justify-center hover:bg-[#6D0DCC]"
                                onClick={handleNext}
                            >
                                <span className="w-auto h-full flex items-center justify-center text-sm font-semibold text-[#FFFFFF] border-none">
                                    Next
