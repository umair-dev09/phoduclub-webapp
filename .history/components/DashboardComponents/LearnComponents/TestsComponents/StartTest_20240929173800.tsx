...
export default function TestSubject() {
    ...
    const [quizStarted, setQuizStarted] = useState(false); // To disable the button after quiz starts
                            ...
                            <div className="h-[46px] m-2 flex justify-between items-center">
                                ...
                                <div className="flex items-center mr-3 mb-3">
                                    {!quizStarted ? (
                                        <button
                                            onClick={onStartQuiz}
                                            disabled={quizStarted} // Disable button after starting dailog 
                                        >
                                        ...
                                        <Image
                                            src={
                                                accordionOpen
                                                    ? "/icons/arrowup.svg"
                                                    : "/icons/arrowdown.svg"
                                            } // Toggle arrow based on accordion state
                                            alt="arrow"
                                            width={24}
                                            height={24}
                                            className="cursor-pointer"
                                            onClick={toggleAccordion} // Icon changes based on state
                                        />
                                    )}
                                    <div className="flex flex-row ">
                                        ...
                                        <span className="font-semibold text-xs text-[#0B9055]">Test Completed</span>
                                    </div>
                                    <button className="h-[36px] flex flex-row items-center justify-center rounded-md w-[127px] gap-1"
