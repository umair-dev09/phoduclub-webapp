    ...
    return (
        <div className='flex flex-col flex-1 mx-8'>
            ...
            < div className="h-[271px] flex items-center " >
                ...
                <div
                    className="w-auto h-[271px] border border-[#EAECF0] rounded-[16px] gap-[10px] bg-slate-500"
                    style={{ color: "#9012FF" }}
            ...
            < div className='flex flex-col ml-1' >
                ...
                <div className='flex flex-col bg-white  border border-lightGrey rounded-lg'>
