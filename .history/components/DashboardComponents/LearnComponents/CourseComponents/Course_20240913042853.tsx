                ...
                <div className='flex flex-col bg-white  border border-lightGrey rounded-xl mt-4'>
                    <div className='flex items-center justify-between h-[56px] mx-5'>
                        ...
                        <div className='flex items-center'>
                            <button>
                                <Image src='/icons/dropDownclose.svg' alt='drop down close button' width={24} height={24} />
                            </button>
                            <button className='absolute'>
                                <Image className='right-0 top-0' src='/icons/dropDownopen.svg' alt='drop down open button' width={24} height={24} />
                            </button>
                        </div>
                    </div>
                    <div><hr /></div>
