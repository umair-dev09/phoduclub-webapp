        ...
        <div className="gap-2 flex flex-col ">
          ...
          <div className='bg-white border border-lightGrey rounded-xl'>
            <Collapsible
              ...
              trigger={
                <div className=''>
                  <div
                    ...
                    onClick={() => setIsOpen(!isOpen)} // Toggle the arrow state
                  >
                    <p className="text-base font-bold">Lesson: Lorem ipsum dolor sit amet.</p>
                    <Image
                      src={isOpen ? "/icons/arrowdown.svg" : "/icons/arrowup.svg"} // Conditionally render the arrow
                      width={24}
                      height={24}
                      alt="arrow"
                    />
              ...
              transitionTime={350}
              onOpening={() => setIsOpen(true)}  // Set the state to open when expanding
              onClosing={() => setIsOpen(false)} // Set the state to closed when collapsing
            >
              <Lessons />
            </Collapsible>
          </div>
              ...
              trigger={
                ...
                <div className=''>
                  <div className="flex items-center justify-between h-[56px] mx-5 relative">
                    <p className="text-base font-bold">Lesson: Lorem ipsum dolor sit amet.</p>
                    <Image
                      src={isOpen ? "/icons/arrowdown.svg" : "/icons/arrowup.svg"}
                      width={24}
                      height={24}
                      alt="arrow"
                    />
              ...
              trigger={
                ...
                <div className=''>
                  <div className="flex items-center justify-between h-[56px] mx-5 relative">
                    <p className="text-base font-bold">Lesson: Lorem ipsum dolor sit amet.</p>
                    <Image
                      src={isOpen ? "/icons/arrowdown.svg" : "/icons/arrowdup.svg"}
                      width={24}
                      height={24}
                      alt="arrow"
                    />
