              ...
              trigger={
                <div className=''>
                  ...
                  >
                    ...
                    <Image
                      src={isOpenArray[0] ? "/icons/arrowup.svg" : "/icons/arrowdown.svg"} // Arrow based on first accordion state
                      width={24}
                      height={24}
                      alt="arrow"
                    />
              ...
              trigger={
                <div className=''>
                  ...
                  >
                    <p className="text-base font-bold">Lesson: Lorem ipsum dolor sit amet.</p>
                    <Image
                      src={isOpenArray[1] ? "/icons/arrowup.svg" : "/icons/arrowdown.svg"} // Arrow based on second accordion state
                      width={24}
                      height={24}
                      alt="arrow"
                    />
              ...
              trigger={
                <div className=''>
                  ...
                  >
                    <p className="text-base font-bold">Lesson: Lorem ipsum dolor sit amet.</p>
                    <Image
                      src={isOpenArray[2] ? "/icons/arrowup.svg" : "/icons/arrowdown.svg"} // Arrow based on third accordion state
                      width={24}
                      height={24}
                      alt="arrow"
                    />
