...
export default function Course() {
  ...
  return (
    <div className="flex flex-col flex-1 h-screen px-8 overflow-y-auto pb-5">
      ...
      <Collapsible
        trigger={
          <div className="flex flex-col bg-white border border-lightGrey  rounded-t-xl mt-4">
            <div className="flex items-center justify-between h-[56px] mx-5 relative">
      ...
      >
        <div className="flex flex-col bg-white  border border-lightGrey rounded-b-xl ">
      ...
      >
        <div className="flex flex-col bg-white mx-1">
          <div className="mx-5 my-5">
            <div className="text-base font-medium">1. Welcome and Introduction</div>
            <div className="flex flex-row text-sm font-normal">
              <div className="mr-1">
