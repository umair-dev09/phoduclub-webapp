  ...
  const StarIcon = ({ filled }) => {
    return (
      <svg
        ...
        viewBox="0 0 24 24"
        stroke={filled ? "yellow" : "gray"}
      >
        <path d="M12 .587l3.668 7.429 8.232 1.193-5.95 5.488 1.407 8.203L12 18.896l-7.357 3.867 1.407-8.203-5.95-5.488 8.232-1.193z" />
      </svg>
    );
  }
          ...
          <div className="flex flex-col flex-1 h-full bg-[#FFFFFF] border border-lightGrey rounded-xl">
            ...
            <div className="flex items-center justify-between w-[255px] h-[24px] mt-10 ">
              ...
              <div className="flex items-center ml-5">
                ...
                {rating % 1 !== 0 && (
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="yellow">
                    <defs>
                      <linearGradient id="half-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="50%" stopColor="yellow" />
                        <stop offset="50%" stopColor="gray" />
                      </linearGradient>
                    </defs>
                    <path d="M12 .587l3.668 7.429 8.232 1.193-5.95 5.488 1.407 8.203L12 18.896l-7.357 3.867 1.407-8.203-5.95-5.488 8.232-1.193z" fill="url(#half-gradient)" />
                  </svg>
                )}
