...
export default function Course() {
  ...
  const totalStars = 5;
  // -------------------------------------------------------------------------------------
  const [isOpenArray, setIsOpenArray] = useState([false, false, false, false]); // Initialize with false for each collapsible
  ...
  return (
    <div className='h-screen overflow-y-auto'>
      <div className="contianer flex flex-1 flex-col  pb-5 mx-8">
            ...
            <Collapsible
              ...
              trigger={
                <div className=''>
                  <div
                    className="flex items-center justify-between h-[56px] mx-5 relative"
                    onClick={() => toggleCollapsible(1)} // Toggle second accordion
                  >
                    <p className="text-base font-bold">Lesson: Lorem ipsum dolor sit amet.</p>
                    <Image
                      src={isOpenArray[1] ? "/icons/arrowdown.svg" : "/icons/arrowup.svg"} // Arrow based on second accordion state
                      width={24}
                      height={24}
                      alt="arrow"
                    />
              ...
              transitionTime={350}
              onOpening={() => toggleCollapsible(1)}  // Set the state to open when expanding
              onClosing={() => toggleCollapsible(1)} // Set the state to closed when collapsing
            >
              <Lessons />
            </Collapsible>
          </div>
            ...
            <Collapsible
              ...
              trigger={
                <div className=''>
                  <div
                    className="flex items-center justify-between h-[56px] mx-5 relative"
                    onClick={() => toggleCollapsible(2)} // Toggle third accordion
                  >
                    <p className="text-base font-bold">Lesson: Lorem ipsum dolor sit amet.</p>
                    <Image
                      src={isOpenArray[2] ? "/icons/arrowdown.svg" : "/icons/arrowup.svg"} // Arrow based on third accordion state
                      width={24}
                      height={24}
                      alt="arrow"
                    />
              ...
              transitionTime={600}
              onOpening={() => toggleCollapsible(2)}  // Set the state to open when expanding
              onClosing={() => toggleCollapsible(2)} // Set the state to closed when collapsing
            >
              <Lessons />
            </Collapsible>
          </div>
            ...
            <Collapsible
              ...
              trigger={
                <div className=''>
                  <div
                    className="flex items-center justify-between h-[56px] mx-5 relative"
                    onClick={() => toggleCollapsible(3)} // Toggle third accordion
                  >
                    <p className="text-base font-bold">Lesson: Lorem ipsum dolor sit amet.</p>
                    <Image
                      src={isOpenArray[3] ? "/icons/arrowdown.svg" : "/icons/arrowup.svg"} // Arrow based on third accordion state
                      width={24}
                      height={24}
                      alt="arrow"
                    />
              ...
              transitionTime={600}
              onOpening={() => toggleCollapsible(3)}  // Set the state to open when expanding
              onClosing={() => toggleCollapsible(3)} // Set the state to closed when collapsing
            >
              <Lessons />
            </Collapsible>
          </div>
        ...
        {/* end -------------------------------------------------------------------------------------------------------------------- */}
        <div className='h-[80px] bg-slate-950'
