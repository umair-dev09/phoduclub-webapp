...
export default function Course() {
  ...
  return (
    <div className="flex flex-col flex-1 h-full px-8 overflow-y-auto">
      ...
      <div className="h-[271px] flex items-center gap-4">
        <div>
          <Image src="/icons/image.png" width={437} height={271} alt="course-image" />
        </div>
        <div className="flex flex-col flex-1 h-full bg-[#FFFFFF] border border-lightGrey rounded-xl">
          <div className="flex flex-1 flex-col h-[105px] p-4">
            <div className='text-[#1D2939] mt-2 ml-2'>
          ...
          <div className="flex items-center justify-between h-full">
            <div className="flex items-center ml-7 mb-7 mt-7 space-x-3">
              <div className="text-[#1D2939] text-2xl font-bold">₹ 3,990</div>
              <div className="text-[#667085] text-base font-normal line-through">₹ 7,499</div>
              <div className="bg-[#DB6704] w-[76px] h-[25px] flex items-center justify-center rounded-full text-white text-xs font-semibold">86% off</div>
            </div>
            {/* Buy Course Button */}
            <div className="m-7">
              <button className="text-white text-sm font-semibold py-3 px-6 rounded-md shadow-md" style={{ width: "182px", height: "44px", backgroundColor: "#9012FF", borderWidth: "1px 0 0 0", borderColor: "#9012FF" }}>
                Buy Course
              </button>
            </div>
          </div>
      ...
      <div className='flex flex-col'>
        ...
        {[1, 2, 3, 4].map(index => (
          <div key={index} className='flex flex-col bg-white border border-lightGrey rounded-xl mt-4'>
            <div className='flex items-center justify-between h-[56px] mx-5 relative'>
              <div className='test-base font-bold'>
                <p>Lesson {index}: Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
              </div>
              <button
              ...
              >
                {collapsed[index] ? (
                  <Image src="/icons/arrow-up.svg" width={10} height={6} alt="collapse-icon" />
                ) : (
                  <Image src="/icons/arrow-down.svg" width={10} height={6} alt="expand-icon" />
                )}
              </button>
            </div>
            <div
              className={`transition-all duration-300 ease-in-out ${collapsed[index] ? 'max-h-0 overflow-hidden' : 'max-h-[200px] overflow-auto'}`}
            >
              <Lesson />
            </div>
          </div>
