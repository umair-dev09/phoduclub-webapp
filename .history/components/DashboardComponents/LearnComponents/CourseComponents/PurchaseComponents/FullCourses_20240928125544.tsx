...
export default function Course() {
  ...
  return (
    <div className="flex flex-col flex-1 h-screen px-8 overflow-y-auto pb-5">
      ...
      <Collapsible
        className="flex flex-col border border-lightGrey mt-4 rounded-xl"
        trigger={
          <div className="flex items-center justify-between h-[56px] mx-5 relative bg-white rounded-t-xl">
      ...
      >
        {/* Collapsible Content */}
        <div className="mx-5 my-5 bg-white rounded-b-xl">
      ...
      <Collapsible className='flex flex-col bg-white border border-lightGrey  mt-4'
        trigger={
