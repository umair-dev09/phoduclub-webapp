...
function Discussion() {
    ...
    return (
        <div className="flex flex-col overflow-y-auto h-auto  w-auto">
            ...
            <hr className="mt-[30px] mr-3 border border-solid border-[#EAECF0]" />
            {/* -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */}
                    ...
                    <div className="mr-[24px] ml-[24px] mt-[12px] font-normal text-[#1D2939] text-sm opacity-[70%] leading-relaxed">
                        <SafeAreaView style={tailwind('flex-1 bg-white')}>
                            <View style={tailwind('p-4')}>
                                <Text style={tailwind('text-purple text-lg')}>Hello, Tailwind!</Text>

                                {/* Button with custom shadow */}
                                <TouchableOpacity style={tailwind('mt-4 bg-purple p-4 rounded-lg shadow-inner-button')}>
                                    <Text style={tailwind('text-customWhite')}>Click Me</Text>
                                </TouchableOpacity>

                                {/* Radial gradient background */}
                                <View style={tailwind('mt-4 h-20 w-20 rounded-lg bg-gradient-radial from-purple to-lightGrey')}></View>
                            </View>
                        </SafeAreaView>
                    </div>
