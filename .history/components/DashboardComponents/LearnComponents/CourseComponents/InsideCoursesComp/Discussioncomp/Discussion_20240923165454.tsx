...
function discussion() {
    ...
    return (
        <div className="flex flex-col overflow-y-auto h-auto  w-auto">
            ...
            <div className="mr-[24px] h-auto mt-[20px] ml-[24px] bg-[#F7F8FB] border border-solid border-[#EAECF0] rounded-[12px]  ">
                <div className="h-[72px] bg-[#F7F8FB] border-b border-solid border-b-[#EAECF0] rounded-tl-[12px] rounded-tr-[12px] ">


                    <textarea
                        placeholder="Type your response here..."
                        className="w-full h-auto bg-transparent border-0 text-[#1D2939] focus:outline-none resize-none"
