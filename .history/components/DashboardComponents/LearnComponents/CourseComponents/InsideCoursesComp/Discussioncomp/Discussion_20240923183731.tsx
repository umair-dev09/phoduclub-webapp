...
function discussion() {
    ...
    return (
        <div className="flex flex-col overflow-y-auto h-auto  w-auto">
            ...
            <div className="mr-[24px] mt-[20px] ml-[24px] bg-[#F7F8FB] border border-solid border-[#EAECF0] rounded-[12px]  ">
                <div className="h-auto bg-[#F7F8FB] border-b border-solid border-b-[#EAECF0] rounded-tl-[12px] rounded-tr-[12px] ">


                    <textarea
                        placeholder="Type your response here..."
                        className="w-full h-[150px] bg-transparent border-0 text-[#1D2939] focus:outline-none resize-none"
                ...
                <div className="h-[66p] bg-[#F7F8FB] rounded-bl-[12px] rounded-br-[12px] flex justify-center items-center">
