                    ...
                    <div className="flex flex-row w-full justify-between items-center mx-5">
                        ...
                        <div className="h-[24px] w-[288px] gap-[24px] flex flex-row">
                            ...
                            <Popover backdrop="blur" placement="bottom-end">
                                ...
                                <PopoverContent className="absolute  z-10">
                                    {/* These buttons will be inside the popover */}
                                    <div className="flex flex-row bg-white rounded-[8px] border-[1px] border-solid border-[#EAECF0] p-2 w-[100px] shadow-[0_2px_4px_#EAECF0]  ">
