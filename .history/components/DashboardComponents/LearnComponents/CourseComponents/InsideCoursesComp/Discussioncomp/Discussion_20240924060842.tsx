                        ...
                        <div className="h-[24px] w-[288px] gap-[24px] flex flex-row">
                            ...
                            <Popover backdrop="blur" placement="bottom-end">
                                <PopoverTrigger>
                                    ...
                                    <button>
                                        {alignment === 'center' ? (
                                            <Image src="/icons/align-middle.svg" width={24} height={24} alt="align-center" />
                                        ) : alignment === 'right' ? (
                                ...
                                <PopoverContent className="absolute left-0 mt-2 z-10">
                                    ...
                                    <div className="flex flex-row bg-white rounded-[8px] border-[1px] border-solid border-[#EAECF0] p-1 w-[100px] shadow-[0_2px_4px_#EAECF0] gap-[8px]">
                                        <button onClick={() => handleIconClick("align-left")}>
                                            <Image src="/icons/align-left.svg" width={40} height={40} alt="align-left" />
                                        </button>
                                        <button onClick={() => handleIconClick("align-center")}>
                                            <Image src="/icons/align-middle.svg" width={40} height={40} alt="align-center" />
                                        </button>
                                        <button onClick={() => handleIconClick("align-right")}>
                                            <Image src="/icons/align-right.svg" width={40} height={40} alt="align-right" />
                                        </button>
                                    </div>
                                </PopoverContent>
                            </Popover>
...
function setAlignment(arg0: string) {
