                        ...
                        <div className="h-[24px] w-[288px] gap-[24px] flex flex-row">
                            ...
                            <Popover backdrop="blur" placement="bottom-end">
                                <PopoverTrigger>
                                    ...
                                    <button>
                                        {alignment === 'center' ? (
                                            <Image src="/icons/align-middle.svg" width={32} height={24} alt="align-center" />
                                        ) : alignment === 'right' ? (
                                            <Image src="/icons/align-right.svg" width={32} height={24} alt="align-right" />
                                        ) : (
                                            <Image src="/icons/align-left.svg" width={32} height={24} alt="align-left" />
                                        )}
                                    </button>
                                </PopoverTrigger>
