    ...
    return (
        <div className="flex flex-col overflow-y-auto h-auto  w-auto">
            ...
            <div className="gap-[20px]">
                ...
                <div className="mr-[24px] ml-[24px]  mt-[24px] h-auto bg-green-300">
                ...
                <div className="mr-[24px] ml-[24px] font-normal text-[#1D2939] opacity-[70%]">
                    <textarea
                        ...
                        className="w-full h-24 bg-transparent border border-[#EAECF0] p-4 rounded-lg resize-none focus:outline-none"
                    />
                </div>
            </div>
