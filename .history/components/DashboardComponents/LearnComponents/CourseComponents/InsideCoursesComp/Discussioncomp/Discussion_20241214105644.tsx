    ...
    return (
        ...
        <div className="flex flex-col overflow-y-auto h-auto  w-auto">
            ...
            <div className="gap-[20px]">
                ...
                <div className="flex flex-col gap-4 pl-6 h-auto w-full">
                    <div className="flex flex-row gap-2 w-full items-center">
                        ...
                        <div className="h-[24px] w-[66px] rounded-sm flex items-center justify-center bg-[#EAECF0]">
                            <span className=" font-semibold text-[#1D2939] text-xs">Teacher</span>
                        </div>
                    </div>
                </div>
