            ...
            <div className="mr-[24px] mt-[20px] ml-[24px] bg-[#F7F8FB] border border-solid border-[#EAECF0] rounded-[12px]  h-auto">
                <div className="h-auto bg-[#F7F8FB] border-b border-solid border-b-[#EAECF0] rounded-tl-[12px] rounded-tr-[12px] ">
                    ...
                    <textarea
                        ...
                        style={{ padding: "1.5rem", minHeight: "72px" }} // Adjust padding for vertical centeringh-
                    />
                    <style jsx>{`
                ...
                <div className="h-auto bg-[#F7F8FB] rounded-bl-[12px] rounded-br-[12px] flex justify-center items-center">
