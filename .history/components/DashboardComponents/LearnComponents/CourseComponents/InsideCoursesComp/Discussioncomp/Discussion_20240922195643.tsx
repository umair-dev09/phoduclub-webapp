        ...
        <div className="flex flex-col overflow-y-auto h-auto  w-auto">
            ...
            <div className="mr-[24px] h-[140px] mt-[20px] ml-[24px] bg-[#F7F8FB] border border-solid border-[#EAECF0] rounded-[12px]">
                ...
                <div className="h-[66px] bg-[#F7F8FB] rounded-bl-[12px] rounded-br-[12px] flex justify-center items-center">
                    <div className="flex flex-row w-full gap-[24px] justify-between items-center mx-5">
                        {/* First div with text */}
                        <div className="bg-slate-800 h-[30px] w-[288px] flex justify-center items-center">
                            efneof
                        </div>
                        {/* Button */}
                        <button className="bg-rose-700 w-[88px] h-[32px] flex justify-center items-center">
                            button
                        </button>
                    </div>
                </div>
