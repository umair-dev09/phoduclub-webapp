    ...
    const handleIconClick = (format: string) => {
        if (quill) {
            ...
            if (range) {
                ...
                if (format === 'ordered') {
                    if (currentFormats.list === 'list1') {
                        quill.format('ordered', false); // Remove ordered list formatting
                    } else {
                        quill.format('ordered', 'list1'); // Apply ordered list
                    }
                }
                else if (format === 'bullet') {
                    if (currentFormats.list === 'list2') {
                        quill.format('bullet', false);

                    }
                    else {
                        quill.format('bullet', 'list2');
                    }
                ...
                <div className="h-[66px] bg-[#F7F8FB] rounded-bl-[12px] rounded-br-[12px] flex justify-center items-center">
                    <div className="flex flex-row w-full justify-between items-center mx-5">
                        ...
                        <div className="h-[24px] w-[288px] gap-[24px] flex flex-row">
                            ...
                            <div>
                                <Image src="/icons/dropdown-icon-1.svg" width={32} height={24} alt="dropdown-icon" />
                            </div>
                            ...
                            <button
                                ...
                                <Image src="/icons/dropdown-icon-2.svg" width={32} height={24} alt="dropdown-icon" />
                            </button>
                            <button
                                onClick={() => handleIconClick('bullet')}>
                                <Image src="/icons/dropdown-icon-3.svg" width={32} height={24} alt="dropdown-icon" />
