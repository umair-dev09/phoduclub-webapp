                    ...
                    <div className="flex flex-row w-full justify-between items-center mx-5">
                        ...
                        <div className="h-[24px] w-[288px] gap-[24px] flex flex-row">
                            ...
                            <Popover backdrop='blur' placement='bottom-end'>
                                ...
                                <PopoverContent>
                                    <div className='flex flex-col bg-white rounded-[8px] border-[1px] border-solid border-[#EAECF0] p-3 w-[120px] shadow-[0_2px_4px_#EAECF0] h-[30px]'>
                                        <button
                                            onClick={() => handleIconClick('align')}>
                                            <Image src="/icons/align-left.svg" width={24} height={24} alt="dropdown-icon" />

                                        </button>
                                        <button
                                            onClick={() => handleIconClick('align')}>
                                            <Image src="/icons/align-middle.svg" width={24} height={24} alt="dropdown-icon" />

                                        </button>
                                        <button
                                            onClick={() => handleIconClick('align')}>
                                            <Image src="/icons/align-right.svg" width={24} height={24} alt="dropdown-icon" />
