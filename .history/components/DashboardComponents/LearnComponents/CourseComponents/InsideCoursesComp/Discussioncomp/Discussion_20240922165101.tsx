    ...
    return (
        <div className="flex flex-col overflow-y-auto h-[1144px] ">
            ...
            <div className="mr-[24px] h-[140px] mt-[20px] ml-[24px] bg-[#F7F8FB] border border-solid border-[#EAECF0] rounded-[12px]">
                <div className="h-[72px] bg-[#F7F8FB] border-b border-solid border-b-[#EAECF0] rounded-tl-[12px] rounded-tr-[12px] "></div>

                <div className="h-[68px] bg-[#F7F8FB] rounded-bl-[12px] rounded-br-[12px]"></div>
