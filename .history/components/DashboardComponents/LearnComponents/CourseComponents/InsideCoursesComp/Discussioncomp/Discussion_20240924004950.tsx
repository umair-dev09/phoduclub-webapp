...
function Discussion() {
    ...
    const handleChange = (content: string) => {
        setValue(content);
        // Clear bold formatting when typing new content
        if (quill) {
            // Clear bold formatting when typing new content
    ...
    const handleIconClick = (format: string) => {
        if (quill) {
            const currentFormat = quill.getFormat(); // Get current formats
            const isBold = currentFormat.bold; // Check if bold is applied
