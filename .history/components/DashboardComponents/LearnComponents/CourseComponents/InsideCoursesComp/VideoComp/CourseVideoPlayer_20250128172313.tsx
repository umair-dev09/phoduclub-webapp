...
//           style={{
//             paddingBottom: '56.25%',
//             // Critical styles for anti-capture protection
//             isolation: 'isolate', // Creates new stacking context
//             transform: 'translateZ(0)', // Forces hardware acceleration
//             contain: 'strict', // Prevents layout interference
//             overflow: 'visible', // Ensures overlay can extend
//           }}
//         >
//           <iframe
//             src={iframeSrc}
...
const CourseVideoPlayer = () => {
  ...
  const videocipherid = "3f49cd28d53f41e38fb66aec32ad9c1c";

  // Enhanced security headers for API call
  const fetchVideoData = async () => {
    try {
      const response = await fetch("/api/Videocipher", {
        method: "POST",
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full security-container"
      style={{
        paddingBottom: '56.25%',
        isolation: 'isolate',
        transform: 'translateZ(0)',
      ...
      {videoData && (
        <iframe
          ...
          style={{
            ...
            transform: 'translateZ(0)',
            backfaceVisibility: 'hidden',
            pointerEvents: 'none', // Prevent direct DOM access
          }}
          allow="encrypted-media; fullscreen"
          allowFullScreen
          title="Secured Video Content"
          sandbox="allow-same-origin allow-scripts"
          loading="eager"
          // Security enhanced attributes
          referrerPolicy="no-referrer"
          importance="high"
        />
      )}

      {/* Add defensive overlay */}
