...
const CourseVideoPlayer: React.FC<VideoPlayerProps> = ({ videoSrc }) => {
  ...
  useEffect(() => {
    const otp = "20160313versASE323AWWi78FR8ryjZUNRzzM25dT6jczQYmPKvEfL4Qe5kEvWVM";
    const playbackInfo = "eyJ2aWRlb0lkIjoiM2Y0OWNkMjhkNTNmNDFlMzhmYjY2YWVjMzJhZDljMWMifQ==";
