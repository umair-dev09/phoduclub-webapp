                ...
                <div className="fixed inset-0 flex items-center justify-center p-4">
                    <DialogPanel transition className="bg-white rounded-2xl p-5 w-[480px] h-[261px]">
                        ...
                        <div className="flex flex-col gap-4 w-[432px] h-[100px]">
                            <span className="text-sm text-[#667085] font-normal">Lorem ipsum is a dummy text widely used...</span>
                        </div>
            ...
            {showBottomSheet && (
                ...
                >
                    ...
                    <div className="p-5 flex justify-between items-center h-[69px] w-full border-b-[1.5px] border-[#EAECF0] rounded-tl-[18px] rounded-tr-[16px]">
                        ...
                        <button onClick={closeBottomSheet} className="text-sm font-semibold text-[#1D2939]">Close</button>
                    </div>
