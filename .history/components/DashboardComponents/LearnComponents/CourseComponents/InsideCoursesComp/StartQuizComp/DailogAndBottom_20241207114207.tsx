                            ...
                            <div className="flex items-center justify-center ">
                                <div className="w-[880px] h-auto rounded-[12px] border-2 border-[#EAECF0]  flex py-4 flex-col items-center justify-center">
                                    <div className="bg-[#FFFFFF] w-[832px] h-auto flex  flex-col gap-[20px]">
                                        ...
                                        <div className="w-full h-auto bg-[#F9FAFB] border border-solid border-[#F2F4F7] rounded-[8px] flex items-center justify-center">
                                            <span className="text-[#1D2939] font-normal text-sm italic line-height-[25px]"></span>
                                        </div>
                                    </div>
