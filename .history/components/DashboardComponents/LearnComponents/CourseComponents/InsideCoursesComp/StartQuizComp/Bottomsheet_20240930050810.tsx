                                            ...
                                            <div className="w-[168.75px] h-[160px] gap-[20px] flex flex-col mt-4">
                                                <form>
                                                    <label className="custom-radio">
                                                        ...
                                                        />
                                                        <span className="custom-radio-button"></span> Apple
                                                    </label>
                                                    ...
                                                    <label className="custom-radio">
                                                        ...
                                                        />
                                                        <span className="custom-radio-button"></span> Orange
                                                    </label>

                                                    <label className="color-[#9012FF]">
                                                        <input
                                                            type="radio"
                                                            name="fruit"
                                                            value="watermelon"
                                                        ...
                                                        />
                                                        <span className="custom-radio-button"></span> Watermelon
                                                    </label>
                                                </form>
