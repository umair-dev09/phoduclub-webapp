...
//     const handleSubmit = () => {
//         // Close the bottom sheet and open Jabir Dialog
//         setIsJabirDialogOpen(true); // Open Jabir Dialog
//         setShowBottomSheet(false); // Close Bottom Sheet
//     };

//     const handleSaveExit = () => {
//         // Close the quiz dialog and do not open Jabir Dialog
//         setIsOpen(false); // Close the quiz dialog
//         setShowBottomSheet(false); // Close Bottom Sheet
//     };
...
function Quiz({
    ...
    const handleSubmit = () => {
        // Open the Jabir Dialog, but don't close the drawer
        setIsJabirDialogOpen(true); // Open Jabir Dialog
        // Don't close the drawer, so leave `setShowBottomSheet(true)` as is
    };
            ...
            >
                <div className="flex flex-col h-full overflow-y-auto">
                    <div className="p-5 flex justify-between items-center h-[69px] w-full border-b-[1.5px] border-t-[1.5px] border-[#EAECF0] rounded-tl-[18px] rounded-tr-[16px]">
                        ...
                        <div className="w-[150px] h-[44px] bg-[#FFFFFF] border-[1px] border-[#EAECF0] rounded-[8px] flex items-center justify-center transition-transform duration-500 ease-in-out transform z-50">
                            <button
                                onClick={handleSubmit} // Trigger Jabir dialog without closing the drawer
                                className="w-full h-full flex items-center justify-center text-sm font-semibold text-[#1D2939] border-none p-[10px_24px] z-50"
                            >
                                Save and Exit
                            </button>
                    ...
                    <div className="flex flex-row items-center justify-end border-t border-lightGrey p-4">
                        <button
                            className="border rounded-lg py-2.5 px-6 text-sm bg-purple text-white border-darkPurple"
                            style={{
                                border: "1px solid #800EE2",
                                boxShadow: "0px -4px 4px 0px #1018281F inset, 0px 3px 2px 0px #FFFFFF3D inset",
                            }}
                    ...
                    <DialogPanel transition>
                        <div className="bg-white rounded-2xl p-5 w-[480px] h-[261px]">
                            ...
                            <div className="border-t border-[#EAECF0] w-full h-[76px] mt-5 flex justify-end gap-2">
                                ...
                                <div className="mt-5">
                                    <button
                                        onClick={handleJabirDialogSubmit} // This closes the drawer and Jabir dialog
                                        className="bg-[#8501FF] text-[#FFFFFF] text-sm font-semibold py-2 px-5 rounded-md w-[118px] h-[44px]"
                                        style={{
                                            border: "1px solid #800EE2",
                                            boxShadow: "0px -4px 4px 0px #1018281F inset, 0px 3px 2px 0px #FFFFFF3D inset",
