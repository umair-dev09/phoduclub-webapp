                            ...
                            <div className="flex items-center justify-center ">
                                <div className="w-[880px] h-auto rounded-[12px] border-2 border-[#EAECF0]  flex py-4 flex-col items-center justify-center">
                                    <div className="bg-[#FFFFFF] w-[832px] h-auto flex  flex-col gap-[20px]">
                                        ...
                                        <hr />
                                        <div className="w-[121px] h-10 justify-center flex flex-row items-center bg-[#EDFCF3] border border-solid border-[#AAF0C7] rounded-[6px] gap-1">
                                            <Image
                                        ...
                                        {/* <div className="w-[121px] h-10 justify-center flex flex-row items-center bg-[#FEF3F2] border border-solid border-[#FFCDC9] rounded-[6px] gap-1">
                                            <Image
                                        ...
                                        <div className="w-full h-auto bg-[#F9FAFB] border border-solid border-[#F2F4F7] rounded-[8px] flex p-4">
