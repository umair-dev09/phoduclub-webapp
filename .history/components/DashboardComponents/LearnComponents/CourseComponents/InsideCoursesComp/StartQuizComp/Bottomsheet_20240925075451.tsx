...
//         setTimeout(() => {
//             setShowBottomSheet(true); // Show the bottom sheet after animation
...
//         setShowBottomSheet(false); // Hide bottom sheet after animation
                                            ...
                                            <div className="bg-[#FFFFFF] w-[832px] h-[204px] gap-[20px]">
                                                ...
                                                <div className="w-[168.75px] h-[160px] gap-[20px] flex flex-col mt-4">
                                                    {["1000", "2000", "3000", "4000"].map((value) => (
                                                        <span className="font-normal text-base text-[#667085] flex flex-row" key={value}>
                                                            <input
                                                                type="radio"
                                                                name="option"
                                                                value={value}
