                    ...
                    <div className="overflow-y-auto p-5 h-full">
                        ...
                        <div className="gap-[20px] flex flex-col">
                            ...
                            <div className="flex items-center justify-center ">
                                <div className="w-[880px] h-[252px] rounded-[12px] border-2 border-[#EAECF0] flex flex-col items-center justify-center">
                                    <div className="bg-[#FFFFFF] w-[832px] h-auto gap-[20px]">
                                    ...
                                    <div className="w-[121px] h-10  flex flex-row "
                                    >
                                        jabir
                                    </div>
                                </div>
