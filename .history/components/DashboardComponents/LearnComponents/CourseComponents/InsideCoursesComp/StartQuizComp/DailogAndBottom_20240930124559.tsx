...
function Quiz({ isOpen, setIsOpen }: QuizProps) {
    ...
    const [selectedValue, setSelectedValue] = useState<string | null>(null); // State can be a string or null

    const handleRadioChange = (e: RadioChangeEvent) => {
        const value = e.target.value;
        // Deselect if the same value is clicked, otherwise set the new value
                                    ...
                                    <div className="bg-[#FFFFFF] w-[832px] h-[204px] gap-[20px]">
                                        ...
                                        <div className="w-[168.75px] h-[160px] gap-[20px] flex flex-col mt-4">
                                            <div className="w-[168.75px] h-[160px] gap-[20px] flex flex-col mt-4">
                                                ...
                                                <Radio.Group
                                                    className="custom-radio"  // Applying the custom CSS class here
                                                    value={selectedValue}
