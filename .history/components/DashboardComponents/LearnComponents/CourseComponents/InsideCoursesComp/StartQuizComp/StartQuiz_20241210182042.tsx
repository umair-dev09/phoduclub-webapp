                ...
                <div className="relative flex justify-between items-end h-full ml-8">
                    ...
                    {isQuizSubmitted && (
                        <div className="absolute flex flex-row justify-between w-full">
                            <button className="border border-[#9012FF] bg-white text-[#1D2939] text-sm font-semibold px-6 py-[0.625rem] hover:bg-[#f0f0f0] hover:border-[#f0f0f0] rounded-md">Review your attempt</button>
