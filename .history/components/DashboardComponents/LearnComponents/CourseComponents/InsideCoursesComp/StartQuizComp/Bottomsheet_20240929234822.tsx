                                ...
                                <div className="w-[880px] h-[252px] rounded-[12px] border-2 border-[#EAECF0] flex items-center justify-center">
                                    <div className="bg-[#FFFFFF] w-[832px] h-[204px] gap-[20px]">
                                        ...
                                        <div className="w-[168.75px] h-[160px] gap-[20px] flex flex-col mt-4">
                                            <div className="w-[168.75px] h-[160px] gap-[20px] flex flex-col mt-4">
                                                <RadioGroup>
                                                    <Radio value="buenos-aires" colorScheme="purple">Buenos Aires</Radio>
                                                    <Radio value="sydney" colorScheme="green">Sydney</Radio>
                                                    <Radio value="san-francisco" colorScheme="blue">San Francisco</Radio>
                                                    <Radio value="london" colorScheme="red">London</Radio>
                                                    <Radio value="tokyo" colorScheme="yellow">Tokyo</Radio>
                                                </RadioGroup>
