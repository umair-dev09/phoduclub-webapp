            ...
            <div className="h-[271px] flex items-center gap-4">
                ...
                <div className="flex flex-1 h-full bg-[#FFFFFF] border border-lightGrey rounded-xl">
                    <div className="flex flex-1 h-full p-4">
                        ...
                        <h6>The BITSET Full Course is designed to provide students with an in-depth understanding of bit manipulation techniques and the use of bitsets in data structures.</h6>
                        <div>
