                ...
                <div className="flex flex-col flex-1 h-full bg-[#FFFFFF] border border-lightGrey rounded-xl">
                    ...
                    <div >
                        <div>
                            ...
                            <div
                                className="bg-[#F79009] text-white text-sm font-bold rounded-md"
                                style={{
                                    width: '76px', // Custom width
                                    height: '25px', // Custom height
                                    padding: '2px 12px', // Custom padding
                                    borderRadius: '130px 0px 0px 0px', // Custom border radius
