            ...
            <div className="h-[271px] flex items-center gap-4">
                ...
                <div className="flex flex-col flex-1 h-full bg-[#FFFFFF] border border-lightGrey rounded-xl">
                    ...
                    <div className="flex items-center mt-2 ml-2 ">
                        ...
                        {/* Rating and Reviews */}
                        <div className="text-[#344054] text-sm font-medium ml-2">
                            4.7 <span className="text-[#667085]">(500+ Ratings)</span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center mt-2 ml-2">
                        ...
                        <div className="text-[#667085] text-sm font-medium line-through ml-2">
                            ₹ 7,499
                        </div>
                        <div className="bg-[#F79009] text-white text-sm font-bold rounded-md px-2 py-1 ml-4">
                            86% off
                        </div>
                    </div>
                    ...
                    <div className="relative mt-6">
                        <button className="absolute right-0 bg-[#7F56D9] hover:bg-[#6935BB] text-white text-sm font-semibold py-3 px-3 rounded-md shadow-md">
                            Buy Course
                        </button>
                    </div>
                    ...
                    <div className='flex items-center justify-between h-[56px] mx-5 relative'>
                        ...
                        <div className='flex items-center'>
                            ...
                            <button className='relative'>
                                <Image src='/icons/dropDownopen.svg' alt='drop down open button' width={24} height={24} />
                            </button>
                        </div>
                    </div>
                    <div><hr /></div>
