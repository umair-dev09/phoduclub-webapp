            ...
            <div className="h-[271px] flex items-center gap-4">
                ...
                <div className="flex flex-col flex-1 h-full bg-[#FFFFFF] border border-lightGrey rounded-xl">
                    ...
                    <div className='flex items-center justify-between'>
                        7<div className='flex items-center ml-4 mb-7'>
                            <div className="text-[#1D2939] text-2xl font-bold">
                                ₹ 3,990
                            </div>
                            <div className="text-[#667085] text-sm font-medium line-through">
                                ₹ 7,499
                            </div>
                            <span
                                className="bg-[#DB6704] text-[#FFFFFF]  font-semibold "
                                style={{
                        ...
                        {/* Buy Course Button */}
                        <div className='self-end mb-5 mr-4'>
                            <button
