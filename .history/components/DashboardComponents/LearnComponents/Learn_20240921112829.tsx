            ...
            <div className="flex w-full flex-col">
                <Tabs
                    ...
                    classNames={{
                        ...
                        tabContent: "group-data-[selected=true]:text-[#9012FF] group-data-[selected=true]:font-bold", // Purple color and bold text for the active tab
                    }}
                >
                    <Tab
                        key="courses"
                        title={
                            <div className="flex items-center space-x-2">
                                <span className="text-gray-500 font-bold">Courses</span> {/* Active tab styled */}
                            </div>
                        }
                    />
                    <Tab
