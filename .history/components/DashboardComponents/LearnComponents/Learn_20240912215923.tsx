    ...
    return (
        <div className="flex space-x-4">
            <button
                ...
                className={`py-2 px-4 text-base pb-[31px] ${activeTab === 'course' ? 'border-b-2   border-bottom-color-  border-bottom-color  text-purple-700' : 'text-gray-500'} focus:outline-none`}
