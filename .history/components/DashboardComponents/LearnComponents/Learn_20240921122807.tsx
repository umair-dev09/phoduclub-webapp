...
function Learned() {
    ...
    useEffect(() => {
        if (pathname) {
            const currentPath = pathname.split("/")[2]; // Adjust this index based on your route structure
            if (currentPath === "test") {
                setActiveTab("test");
            } else if (currentPath === "Quiz") {
                setActiveTab("Quiz");
            ...
            <div className="flex w-full flex-col">
                ...
                >
                    <Tab
                        ...
                        title={
                            <div className="flex items-center space-x-2 ml-[32px]">
                                <span className={`${activeTab === "courses" ? "text-[#9012FF] font-bold" : "text-gray-500"}`}>
                                    Courses
                                </span>
                            </div>
                        }
                    ...
                    <Tab
                        ...
                        title={
                            <div className="flex items-center space-x-2">
                                <span className={`${activeTab === "test" ? "text-[#9012FF] font-bold" : "text-gray-500"}`}>
                                    Test
                                </span>
                    ...
                    <Tab
                        ...
                        title={
                            <div className="flex items-center space-x-2">
                                <span className={`${activeTab === "Quiz" ? "text-[#9012FF] font-bold" : "text-gray-500"}`}>
                                    Quiz
                                </span>
                            </div>
                        }
