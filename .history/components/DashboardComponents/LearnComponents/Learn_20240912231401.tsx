    ...
    return (
        ...
        <div className="flex space-x-4">
            <div className="pt-[15px] "
                style={{
                    borderBottom: '2px solid #6941C6' // Adjust the width and color as needed
                }} >
                <button
                    onClick={() => handleTabClick('course', '/learn/course')}
                    className={`relative py-2 px-4 text-base  ${activeTab === 'course' ? 'text-[#6941C6]' : 'text-[#667085]'} focus:outline-none`}
            ...
            <div className="pt-[15px]">
                <button
                    ...
                    className={`relative py-2 px-4 text-base  ${activeTab === 'test' ? 'text-[#6941C6]' : 'text-[#667085]'} focus:outline-none`}
            ...
            <div className="pt-[15px]">
                <button
                    ...
                    className={`relative py-2 px-4 text-base  ${activeTab === 'Quiz' ? 'text-[#6941C6]' : 'text-[#667085]'} focus:outline-none`}
                    style={{ fontSize: '16px', fontWeight: '500' }}
                >
                    Quizzes
                    {activeTab === 'Quiz' && (
