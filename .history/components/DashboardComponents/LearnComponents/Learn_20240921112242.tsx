                    ...
                    <Tab
                        ...
                        title={
                            <div className="flex items-center space-x-2">
                                <span className="text-purple-600 font-bold">Courses</span> {/* Active tab styled */}
                            </div>
                        }
                    />
                    <Tab
                        ...
                        title={
                            <div className="flex items-center space-x-2">
                                ...
                                <Chip size="sm" variant="faded" className="bg-purple-100 text-purple-600">10</Chip> {/* Chip styled */}
                            </div>
                        }
                    />
                    <Tab
