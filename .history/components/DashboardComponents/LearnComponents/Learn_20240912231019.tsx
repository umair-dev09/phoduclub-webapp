        ...
        <div className="flex space-x-4">
            <div className="pt-[15px]">
                <button
                    ...
                    className={`relative py-2 px-4 text-base pb-[20px] ${activeTab === 'course' ? 'text-[#6941C6]' : 'text-[#667085]'} focus:outline-none`}
            ...
            <div className="pt-[15px]">
                <button
                    ...
                    className={`relative py-2 px-4 text-base pb-[18px] ${activeTab === 'test' ? 'text-[#6941C6]' : 'text-[#667085]'} focus:outline-none`}
            ...
            <div className="pt-[15px]">
                <button
                    ...
                    className={`relative py-2 px-4 text-base pb-[20px] ${activeTab === 'Quiz' ? 'text-[#6941C6]' : 'text-[#667085]'} focus:outline-none`}
                    style={{ fontSize: '16px', fontWeight: '500' }}
                >
                    Quizzes
                    {activeTab === 'Quiz' && (
