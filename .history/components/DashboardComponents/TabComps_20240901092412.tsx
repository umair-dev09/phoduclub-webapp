        ...
        <div className={`${styles.tabComps} ${isCollapsed ? styles.collapsed : ''}`}>
            <div>
                <button className={styles.collapseIcon} onClick={handleCollapseClick}>
                    {isCollapsed ? <Image className={styles.collapseIconRight} alt='collapse icon' src="/icons/collapseIconRight.png" width={10} height={10} /> : <Image className={styles.collapseIconLeft} alt="collap" src="/icons/Vector (3).png" width={10} height={10} />}
                </button>
            </div>
