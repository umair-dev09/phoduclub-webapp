                ...
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={data} margin={{ top: 5, right: 10, left: 10, bottom: 20 }}>
                        ...
                        <XAxis
                            ...
                            fill="#667085"
                            tickMargin={12}
                            dx={5}  // Adjust this value for horizontal positioning of labels
                            textAnchor="start" // You can try "middle", "start", or "end" based on your need
                            interval={0}
                            tickFormatter={(value, index) => {
                                ...
                                if (index === firstIndex) {
                                    return `First: ${value}`;  // Customize the first label
                                } else if (index === middleIndex) {
                                    return `Middle: ${value}`; // Customize the middle label
                                } else if (index === lastIndex) {
                                    return `Last: ${value}`;   // Customize the last label
                                }
                                return value;  // For all other labels, return the value as is
                            }} // This ensures every tick label is shown
