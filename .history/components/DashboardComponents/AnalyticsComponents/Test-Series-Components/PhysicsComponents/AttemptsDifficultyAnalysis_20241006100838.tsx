                        ...
                        <ChartContainer config={chartConfig} className="h-auto w-[70%]">
                            <PieChart>
                                ...
                                <Pie
                                    ...
                                    strokeWidth={3}
                                    stroke="#FFFFFF"
                                    isAnimationActive={true} // Activate animation
            ...
            <div className="flex flex-col w-1/2 h-auto rounded-xl bg-white border border-[#EAECF0]">
                ...
                <ResponsiveContainer width="100%" height="80%">
                    ...
                    >
                        ...
                        <Bar dataKey="correct" fill="#17B26A" barSize={55} isAnimationActive={true} // Activate animation
                            animationDuration={1500} // Set animation duration
                            animationEasing="ease-in-out" />
                        <Bar dataKey="incorrect" fill="#F04438" barSize={55} isAnimationActive={true} // Activate animation
                            animationDuration={1500} // Set animation duration
                            animationEasing="ease-in-out" />
                        <Bar dataKey="Unanswered" fill="#D0D5DD" barSize={55} isAnimationActive={true} // Activate animation
                            animationDuration={1500} // Set animation duration
                            animationEasing="ease-in-out" />
                    </BarChart>
                </ResponsiveContainer>
