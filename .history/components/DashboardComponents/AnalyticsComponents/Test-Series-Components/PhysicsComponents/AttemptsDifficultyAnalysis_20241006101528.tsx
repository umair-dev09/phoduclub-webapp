...
function Quizzes() {
    ...
    return (
        <div className="flex flex-row mb-6 w-[100%] gap-4 h-auto">
            ...
            <h1>mmmmmmmmm</h1>
            <h1>mmmmmmmmm</h1>    <h1>mmmmmmmmm</h1>    <h1>mmmmmmmmm</h1>    <h1>mmmmmmmmm</h1>    <h1>mmmmmmmmm</h1>    <h1>mmmmmmmmm</h1>    <h1>mmmmmmmmm</h1>    <h1>mmmmmmmmm</h1>    <h1>mmmmmmmmm</h1>    <h1>mmmmmmmmm</h1>
        </div>
