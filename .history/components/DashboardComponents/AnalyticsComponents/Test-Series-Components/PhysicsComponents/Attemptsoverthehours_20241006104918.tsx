                ...
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={data} margin={{ top: 5, right: 10, left: 10, bottom: 20 }}>
                        ...
                        <XAxis
                            ...
                            fill="#667085"
                            tickMargin={15}
                            dx={20}  // Adjust this value for horizontal positioning of labels
                            textAnchor="end" // You can try "middle", "start", or "end" based on your need
                            interval={0}  // This ensures every tick label is shown
                            angle={-45}     // Rotate the text if necessary (use values like 0, 45, -45)
                            tick={{ width: 100 }}  // Ensure there's enough width for long labels
                        />
