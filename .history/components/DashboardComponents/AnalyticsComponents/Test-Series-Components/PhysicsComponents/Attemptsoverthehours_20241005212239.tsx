        ...
        <div className="h-auto rounded-xl mb-6 bg-[#FFFFFF] border border-solid border-[#EAECF0]">
            ...
            <div style={{ height: '300px' }}>
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={data} margin={{ top: 5, right: 50, left: 40, bottom: 20 }}>
                        ...
                        <XAxis dataKey="name"
                            ...
                            tickMargin={10}        // Adds margin between the labels and X-axis
                            dx={10}                // Smaller shift to the right for labels
