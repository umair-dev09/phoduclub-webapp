...
const CustomTick: React.FC<CustomTickProps> = ({ x, y, payload, index, dataLength }) => {
    ...
    const firstLabelAdjustment = 10; // Adjustment for the first label
    const lastLabelAdjustment = 20;  // Adjustment for the last label
                    ...
                    <LineChart data={data} margin={{ top: 5, right: 50, left: 10, bottom: 20 }}>
                        ...
                        <XAxis
                            ...
                            tick={<CustomTick x={0} y={0} payload={{
                                value: ""
                            }} index={0} dataLength={0} />} // Pass the component here
                            tickMargin={1} // Adjust tick margin if needed
                        />
                        <YAxis
                            fontFamily="Poppins"
                            fontSize={14}
