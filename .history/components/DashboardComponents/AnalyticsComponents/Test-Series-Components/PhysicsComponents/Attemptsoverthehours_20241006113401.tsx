...
const CustomTick: React.FC<CustomTickProps> = ({ x, y, payload, index, dataLength, visibleTicksCount }) => {
    let positionX = x;
                ...
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={data} margin={{ top: 5, right: 50, left: 10, bottom: 20 }}>
                        ...
                        <XAxis
                            ...
                            fontWeight={400}
                            fill="#667085"
                            tick={<CustomTick x={0} y={0} payload={{ value: "" }} index={0} dataLength={0} visibleTicksCount={0} />}
