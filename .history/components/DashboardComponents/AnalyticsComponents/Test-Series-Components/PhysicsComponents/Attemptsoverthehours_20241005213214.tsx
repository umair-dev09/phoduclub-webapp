...
// THe End----------------------------------------------------------------------------------------------------------------------------------------------------------
const CustomXAxisTick = ({ x, y, payload, width, index, payloadLength }) => {
    // Check if it's the last tick
    const isLastTick = index === payloadLength - 1;

    // Adjust position accordingly
    const adjustedX = isLastTick ? x - 50 : x + 30; // Further adjust x values as needed
                ...
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={data} margin={{ top: 5, right: 10, left: 10, bottom: 20 }}>
                        ...
                        <XAxis
                            ...
                            fontWeight={400}
                            fill="#667085"
                            tick={(props) => <CustomXAxisTick {...props} width={props.width} index={props.index} payloadLength={data.length} />}
