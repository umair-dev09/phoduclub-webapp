                ...
                <div className='flex flex-col gap-1.5'>
                    ...
                    <div className='flex flex-row gap-1'>
                        ...
                        <Tooltip
                            ...
                            classNames={{
                                content: [
                                    "bg-black text-white text-sm py-2 px-4",
                                    "rounded-b-lg", // rounded only at bottom corners
                                    "relative", // needed for the arrow positioning
                                    "after:content-['']",
                                    "after:absolute",
                                    "after:top-full",
                                    "after:left-1/2",
                                    ...
                                    "after:border-t-black", // arrow color matching tooltip
                                ],
                            }}
                        >
                            <button>
