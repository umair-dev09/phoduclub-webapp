...
function AccordianAllSubjects() {
    ...
    const [forallsubject, setForallsubject] = useState(false);
    ...
    return (
        <div className=' border-t border-lightGrey mx-5 py-2'>
            ...
            {detailview && <TestDialog open={detailview} forallsubject={forallsubject} onClose={() => setDetailview(false)} />}
