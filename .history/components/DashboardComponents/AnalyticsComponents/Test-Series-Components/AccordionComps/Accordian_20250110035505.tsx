...
function Accordian() {
    ...
    return (
        <div className=' border-t border-lightGrey mx-5 py-2'>
            ...
            <Modal
                isOpen={detailview}
                onOpenChange={(isOpen) => !isOpen && setDetailview(false)}
                className="flex items-center justify-center" // Centers the modal on the screen
            >
                <ModalContent
                    ...
                    <>
                        ...
                        <ModalBody>
                            <span className="font-normal pb-2 text-[16px] text-[#344054]">
                                You have attempted 5 times this test. Please select which attempt's analytics you would like to see.
                            </span>
                        </ModalBody>
                    </>
                </ModalContent>
