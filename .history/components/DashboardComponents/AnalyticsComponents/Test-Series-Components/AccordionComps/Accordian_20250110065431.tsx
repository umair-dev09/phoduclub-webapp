                    ...
                    <>
                        ...
                        <ModalBody>
                            ...
                            <div className="overflow-y-auto pb-2">
                                <table className="w-full rounded-md text-left bg-white shadow-md border border-lightGrey">
                                    <thead className="  border border-lightGrey">
                                        <tr>
                                            <th className="px-4 py-2 rounded-tl-md text-[#667085] font-medium text-sm">Attempts</th>
                                            <th className="px-4 py-2 text-[#667085] font-medium text-sm">Date & Time</th>
                                            <th className="px-4 py-2 text-[#667085] font-medium text-sm">Accuracy</th>
                                            <th className="px-4 py-2 text-[#667085] font-medium text-sm">Score</th>
                                            <th className="px-4 py-2 rounded-tr-md text-[#667085] font-medium text-sm">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr className="border border-lightGrey">
                                            <td className="px-4 py-2">1</td>
                                            <td className="px-4 py-2">Jan 6, 2024  05:32 PM</td>
