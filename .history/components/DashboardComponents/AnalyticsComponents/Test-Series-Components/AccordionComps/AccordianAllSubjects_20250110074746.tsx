...
function AccordianAllSubjects() {
    const [detailviewallsubject, setDetailviewallsubject] = useState(false);
        ...
        <div className=' border-t border-lightGrey mx-5 py-2'>
            <div className="flex flex-row justify-between pt-2 pb-2">
                ...
                <div className="flex items-center justify-center h-auto">
                    ...
                    <button
                        onClick={() => setDetailviewallsubject(true)}
                    >
            ...
            {detailviewallsubject && <TestDialog open={detailviewallsubject} onClose={() => setDetailviewallsubject(false)} />}
