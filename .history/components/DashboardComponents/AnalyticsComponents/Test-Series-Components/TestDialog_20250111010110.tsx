                ...
                <>
                    ...
                    <ModalBody>
                        ...
                        <div className="flex rounded-md overflow-hidden border border-lightGrey">
                            <table className="w-full max-h-[300px] text-left bg-white">
                                ...
                                <tbody className="overflow-y-auto max-h-[300px] block">
                                    {dummyData.map((item, index) => (
                                        <tr key={index} className="border-t border-lightGrey flex w-full">
                                            <td className="px-4 py-2 text-[#1D2939] font-normal text-sm w-1/5">
                                                {item.attempt}
                                            </td>
                                            <td className="px-4 py-2 text-[#1D2939] font-normal text-sm w-1/5">
                                                {item.date}
