            ...
            <div>
                <div className="flex flex-row gap-5 ml-8 items-center mb-1">
                    ...
                    <Popover placement="bottom-start" isOpen={attemptPopover} onOpenChange={(open) => setAttemptPopover(open)} >
                        ...
                        <PopoverContent className="w-auto px-0 py-1 mt-5 rounded-md border border-lightGrey  max-h-[300px] overflow-y-auto">
                            {[...attemptedDetails]
                                ...
                                .map((attempt, index) => (
                                    <button
                                        ...
                                        className='flex flex-row items-center w-full mt-2 px-4 py-[10px] gap-1 transition-colors duration-150 hover:bg-[#EDE4FF]'
                                    >
