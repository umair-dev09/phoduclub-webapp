...
function TestSeriesComp() {
    ...
    return (
        ...
        <button className="hover:bg-[#F9FAFB] "
            ...
            <tr className="flex flex-1 py-3 border-t border-lightGrey text-[#1D2939] hover:bg-[#F2F4F7]">
                <td className="flex flex-col px-8 w-[30%] text-left">
                    <div className="text-sm text-[#9012FF] font-semibold underline">Phodu JEE Mains Test Series 2025</div>
                    <div className="text-[13px] text-[#667085] font-medium">30 Tests</div>
                </td>
