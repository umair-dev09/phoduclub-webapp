            ...
            <ModalContent>
                <>
                    ...
                    <ModalBody>
                        ...
                        <div className="overflow-y-auto pb-2 max-h-[300px]">
                            <table className="w-full  text-left bg-white border border-lightGrey">
                                <thead className="border border-lightGrey  overflow-y-auto pb-2 max-h-[300px] sticky top-0 bg-white z-10">
                                    <tr>
