            ...
            <div className="flex flex-row gap-4 h-auto">
                <div className=" w-full rounded-xl h-auto flex  bg-[#FFFFFF] border border-solid border-[#EAECF0]">
                    ...
                    <div className="flex flex-1 flex-col">
                        <span className="font-semibold text-[#1D2939] text-lg ml-11 mt-3">Difficulty Analysis</span>

                        <div className="h-[50px] flex flex-row items-center justify-center mt-3  ">
