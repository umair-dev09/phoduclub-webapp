...
function Quizzes() {
    ...
    return (
        <div className="flex gap-2 flex-col h-auto mb-4">
            ...
            <div className="flex flex-row gap-4">
                <div className=" w-full rounded-xl h-auto flex  bg-[#FFFFFF] border border-solid border-[#EAECF0] flex-col">
                    <h3>hiiiiiiiiiiii</h3>
                    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>


                </div>
                <div className=" w-full rounded-xl h-auto flex bg-[#FFFFFF] border border-solid border-[#EAECF0] flex-col">
                    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>    <h3>hiiiiiiiiiiii</h3>
