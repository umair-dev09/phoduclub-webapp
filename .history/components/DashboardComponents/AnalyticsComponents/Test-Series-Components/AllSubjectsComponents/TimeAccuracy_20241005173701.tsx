...
function Quizzes() {
    ...
    return (
        <div className="flex gap-2 flex-col h-auto mb-8">
            ...
            {/* <div className="flex flex-row gap-4 h-auto w-auto">
                ...
                <div className=" w-full rounded-xl h-auto flex  bg-[#FFFFFF] border border-solid border-[#EAECF0] flex-col">
                    ...
                    <ResponsiveContainer width="100%" height="50%" style={{ marginLeft: "50px" }}>
                        <BarChart
                            data={Attempts}
                            layout="vertical"
                        >
                            ...
                            <Bar
                                dataKey="Attempts"
                                barSize={35} // Adjust this size to create gaps between bars
                            />
                        </BarChart>
                    </ResponsiveContainer>
                </div>
            ...
            <div className="flex flex-row gap-4 h-auto">
                ...
                <div className=" w-full rounded-xl h-full flex  bg-[#FFFFFF] border border-solid border-[#EAECF0] pr-3 ">
                    <div className="flex flex-1 flex-col  p-2">
                        <span className="font-semibold text-[#1D2939] text-lg ml-10 pt-4">Difficulty Analysis</span>


                        <ResponsiveContainer width="100%" height="100%" style={{ marginLeft: "50px" }}>
                            <BarChart
                                data={Attempts}
                                layout="vertical"
                            >
