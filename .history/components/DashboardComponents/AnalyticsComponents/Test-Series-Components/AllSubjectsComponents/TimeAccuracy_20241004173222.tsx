                    ...
                    <table className="w-full rounded-xl bg-white text-sm font-medium">
                        ...
                        <tbody className="border-b border-[#EAECF0]">
                            <tr className="border-t border-[#EAECF0]">
                                <td className=" text-left text-[#1D2939] font-semibold text-sm">Overall</td>
                                <td className=" text-left text-[#1D2939] font-normal text-sm">200/300</td>
                                <td className="text-left text-[#1D2939] font-normal text-sm">5/75</td>

                            </tr>
                            <tr className="border-t border-[#EAECF0]">
                                <td className=" text-left text-[#1D2939] font-semibold text-sm">Physics</td>
