    ...
    return (
        <div className="flex gap-2 flex-col h-auto mb-8">
            ...
            <div className="flex flex-row gap-4 h-[250px]">
                ...
                <div className=" w-full rounded-xl h-auto flex  flex-col bg-[#FFFFFF] border border-solid border-[#EAECF0] px-5">
                    <div className=" mt-5 mb-5">
                        <span className="font-semibold text-[#1D2939] text-lg">Difficulty Analysis</span>
                    </div>
