                ...
                <>
                    ...
                    <ModalBody>
                        ...
                        <div className=" flex rounded-md">
                            <table className="w-full overflow-y-auto pb-2 max-h-[300px] text-left bg-white border border-lightGrey flex rounded-md">
                                <thead className="border border-lightGrey  sticky top-0 bg-white z-10">
                                    <tr>
