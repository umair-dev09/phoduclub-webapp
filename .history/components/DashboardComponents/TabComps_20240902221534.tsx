        ...
        <div className={`${styles.tabComps} ${isCollapsed ? styles.collapsed : ''}`}>
            <div>
                <button className={styles.collapseButton} onClick={handleCollapseClick}>
                    {isCollapsed ? (
                        <Image className={styles.collapseIconRight} alt='collapseIconRight' src="/icons/collapse-right.svg" width={12} height={12} />
                    ) : (
                        <Image className={styles.collapseIconLeft} alt="collapseIconLeft" src="/icons/collapse-left.svg" width={12} height={12} />
                    )}
                </button>
            </div>
