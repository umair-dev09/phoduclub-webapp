...
function TabComps() {
    ...
    return (
        <div className={`flex flex-col relative transition-all duration-[500ms] ease-in-out ${isCollapsed ? 'w-[3.5rem]' : 'w-[16rem]'} pl-2 py-[0.625rem] bg-[#131313]`}>
            ...
            {renderButtonWith('Analytics', '/icons/analytics.svg', '/icons/analytics-2.svg', activeTab === 'analytics', () => handleTabClick('analytics', '/analytics/test-series'))}
            {renderButtonWith('Settings', '/icons/settings.svg', '/icons/settings-2.svg', activeTab === 'settings', () => handleTabClick('settings', '/settings/profile'))}
