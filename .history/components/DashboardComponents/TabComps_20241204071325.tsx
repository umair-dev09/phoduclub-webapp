...
function TabComps() {
    ...
    return (
        <div className={`flex flex-col relative transition-all duration-[500ms] ease-in-out h-full overflow-y-auto ${isCollapsed ? 'w-[3.5rem]' : 'w-[16rem]'} pl-2 py-[0.625rem] bg-[#131313]`}>
