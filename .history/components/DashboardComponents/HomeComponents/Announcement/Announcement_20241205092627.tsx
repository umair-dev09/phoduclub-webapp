...
function Announcement() {
    ...
    return (
        <div className="h-[300px] flex-col   flex  flex-1 overflow-y-auto rounded-b-lg">
            ...
            <div className=' flex flex-col gap-4 m-6 items-start border-b border-solid border-[#EAECF0]'>
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    <span className='text-sm font-normal text-[#475467]'>Our new mock test series is now live. check it out now.</span>
                </div>
            </div>
        </div>
    );
