      ...
      {isLoading ? (
        ...
        <div className="flex flex-col h-full justify-between">
          ...
          <div className="flex flex-row items-center gap-4 justify-end border-t border-[#EAECF0] h-[76px] pr-6">
            <button
              className="h-11 w-22 py-4 px-6 shadow-inner-button flex flex-row items-center justify-center rounded-md hover:bg-[#F2F4F7] bg-[#FFFFFF] border-2 border-solid border-pink"
              onClick={closeModal}
            >
