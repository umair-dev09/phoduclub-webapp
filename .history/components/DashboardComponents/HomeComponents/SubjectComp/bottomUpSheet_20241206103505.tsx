        ...
        <>
            ...
            >
                <div className="flex flex-col h-full">
                    ...
                    <div>
                        <div className="overflow-auto">
                            <table className="w-full table-fixed border-separate border-spacing-0">
                                <thead className="bg-[#F9FAFB] h-11 border border-solid border-[#EAECF0]">
                                    <tr className="text-xs text-gray-700">
                                        <th className="text-left pl-6 border border-solid border-[#EAECF0] w-1/4">Chapter</th>
                    ...
                    <div className="flex flex-row items-end justify-end border-t border-lightGrey">
                        <button
