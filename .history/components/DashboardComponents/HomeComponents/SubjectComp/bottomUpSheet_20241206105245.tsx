        ...
        <>
            ...
            >
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex flex-row items-center justify-end mt-auto border-t border-[#EAECF0] h-[76px]">
                        <button
                        ...
                        <button className="h-11 w-22 shadow-inner-button flex items-center justify-center rounded-md">
