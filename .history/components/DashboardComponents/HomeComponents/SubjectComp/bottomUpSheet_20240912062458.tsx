    ...
    const CustomCalendarContainer = ({ className, children }: any) => (
        ...
        <div className={`${className} bg-gray-100 border border-gray-300 shadow-lg rounded-lg p-4`}>
            ...
            <div className="flex justify-between mt-4">
                <button onClick={cancelDate} className="bg-customwhite-500 text-white px-4 py-2 rounded-md">Cancel</button>
                <button onClick={applyDate} className="bg-custompurple-500 text-white px-4 py-2 rounded-md">Apply</button>
            </div>
        </div>
    );
