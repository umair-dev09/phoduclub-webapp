            ...
            {subjectsData.map((subject) => {
                ...
                return (
                    <button
                        ...
                        key={subject.name}
                        className="bg-white border border-gray-200 rounded-lg px-6 py-2 flex items-center justify-between hover:bg-gray-200  transition-transform duration-300 ease-in-out hover:border-[#7400E03D] hover:shadow-lg hover:scale-105"
                    >
                        <div className="pt-2">
