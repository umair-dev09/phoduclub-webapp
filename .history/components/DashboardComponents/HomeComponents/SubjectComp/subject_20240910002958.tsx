...
const SubjectLayout: React.FC = () => {
    ...
    const handleButtonClick = (subject: string) => {
        console.log('Button clicked for subject:', subject); // Debug log
        setSelectedSubject(subject); // Set the subject
    ...
    return (
        <div className={styles.container}>
            ...
            >
                ...
                <p>{selectedSubject ? `Details for ${selectedSubject}` : 'No subject selected'}</p>
