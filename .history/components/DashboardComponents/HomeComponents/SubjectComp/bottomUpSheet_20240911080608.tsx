                ...
                return (
                    <>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <div class="inline-flex items-center justify-center border border-gray-300 rounded-full bg-white text-sm font-medium text-gray-700 p-1 max-w-full whitespace-nowrap overflow-hidden shadow-sm" style="width: 67px; height: 28px;">
                                        <span class="w-2 h-2 bg-red-500 rounded-full mr-2"></span>
                                        <p class="m-0 text-sm text-gray-700">High</p>
                                    </div>
