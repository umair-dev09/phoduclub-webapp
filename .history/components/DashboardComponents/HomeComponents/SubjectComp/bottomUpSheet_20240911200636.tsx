...
//     const [checkboxes, setCheckboxes] = useState<boolean[]>([false, false, false, false, false]);
...
//     //LOGIC FOR THE PERCENTAGE  SHOW CASE OF  THE CHECKBOX

//     const handleCheckboxChange = (index: number) => {
//         const updatedCheckboxes = [...checkboxes]; // Copy the checkbox array
//         updatedCheckboxes[index] = !updatedCheckboxes[index]; // Toggle the checkbox state (boolean)
//         setCheckboxes(updatedCheckboxes); // Update the checkbox state



//     };
//     const getProgress = (): number => {
//         const checkedCount = checkboxes.filter(checked => checked).length; // Count checked checkboxes
//         return (checkedCount / checkboxes.length) * 100; // Calculate percentage
//     };
...
const BottomSheet: React.FC<BottomUpSheet> = ({ closeModal, subjectName }) => {
    ...
    const [tempDate, setTempDate] = useState<Date | null>(new Date());
    const [calendarVisible, setCalendarVisible] = useState(false);
    // Changed state to manage checkboxes for each row
    const [checkboxes, setCheckboxes] = useState<boolean[][]>([
        [false, false, false, false, false], // Row 1 checkboxes
        [false], // Row 2 checkboxes
    ]);
                    ...
                    <>
                        <tr className='h-[84px]'>
                            <td>
                                ...
                                <div className='flex flex-row items-center ml-6'>
                                    <progress value={getProgress(0)} max="100" className={styles.progressBar} />
                                    <div className="ml-2 text-sm font-normal">
                                        <p>{getProgress(0)}%</p>
                                    </div>
                                </div>
                            ...
                            {checkboxes[0].map((checked, index) => (
                                <td key={index}>
                                    <input
                                        className={styles.customCheckbox}
                                        type='checkbox'
                        ...
                        <tr className='h-[84px]'>
                            <td>
                                ...
                                <div className='flex flex-row items-center ml-6'>
                                    <progress value={getProgress(1)} max="100" className={styles.progressBar} />
                                    <div className="ml-2 text-sm font-normal">
                                        <p>{getProgress(1)}%</p>
                                    </div>
                                </div>
                            ...
                            {checkboxes[1].map((checked, index) => (
                                <td key={index}>
                                    <input
                                        className={styles.customCheckbox}
                                        type='checkbox'
