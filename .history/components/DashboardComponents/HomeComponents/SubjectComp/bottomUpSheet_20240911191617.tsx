...
const BottomSheet: React.FC<BottomUpSheet> = ({ closeModal, subjectName }) => {
    ...
    const handleCheckboxChange = (index: number) => {
        ...
        updatedCheckboxes[index] = !updatedCheckboxes[index]; // Toggle the checkbox
        setCheckboxes(updatedCheckboxes);

        // Calculate progress based on the number of checkboxes checked
        const checkedCount = updatedCheckboxes.filter(checked => checked).length;
        setProgress((checkedCount / checkboxes.length) * 100); // Each checked box contributes 20%
    };
    /* ******************XXXXXXXXXXXXXXXXX***************************/
