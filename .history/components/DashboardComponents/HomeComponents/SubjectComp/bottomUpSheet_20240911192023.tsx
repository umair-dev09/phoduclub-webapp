...
const BottomSheet: React.FC<BottomUpSheet> = ({ closeModal, subjectName }) => {
    ...
    const handleCheckboxChange = (index: number) => {
        ...
        // Calculate progress based on the number of checkboxes checked
        const checkedCount = updatedCheckboxes.filter(checked => checked).length; // Count checked checkboxes
        setProgress((checkedCount / checkboxes.length) * 100); // Update the progress (each checkbox contributes equally)
    };
