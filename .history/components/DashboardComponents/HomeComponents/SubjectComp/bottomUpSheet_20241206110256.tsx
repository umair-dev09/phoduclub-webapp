            ...
            >
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex flex-row items-center gap-4 justify-end  border-t border-[#EAECF0] h-[76px] pr-6">
                        <button className="h-11 w-22 py-4 px-6 shadow-inner-button flex flex-row items-center justify-center rounded-md bg-[#FFFFFF] border-2 border-solid border-[#EAECF0]"
                            onClick={closeModal}
                        >
                            <p className='font-semibold text-sm text-[#1D2939]'>Cancel</p>
                        </button>
                        <button className="h-11 w-22 py-4 px-6 shadow-inner-button flex flex-row items-center justify-center rounded-md bg-[#9012FF] border border-solid border-[#800EE2]">
