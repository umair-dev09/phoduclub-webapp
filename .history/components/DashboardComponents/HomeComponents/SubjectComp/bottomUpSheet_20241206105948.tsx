        ...
        <>
            ...
            >
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex flex-row items-center gap-4 justify-end  border-t border-[#EAECF0] h-[76px] pr-4">
                        <button className="h-11 w-22 p-4 shadow-inner-button flex flex-row items-center justify-center rounded-md bg-[#9012FF] border border-solid border-[#800EE2]"
                            onClick={closeModal}
                        >
                            <p>Cancel</p>
                        </button>
