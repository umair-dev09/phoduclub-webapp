...
const BottomSheet: React.FC<BottomUpSheet> = ({ closeModal, subjectName }) => {
    ...
    useEffect(() => {
        if (subjectName === 'Physics') {
            ...
            setNumRows(chapterNames.length); // Use length of chapter names for rows
            setNumColumns(5);
    ...
    }, [subjectName, numRows, numColumns, chapterNames]);
    ...
    // BELOW LOGIC IS FOR THE CALENDER--------------------------------------------------------------------------------------------------------------->
    const applyDate = () => {
                        ...
                        <table>
                            <thead className={styles.tableHead}>
                                <tr className='text-xs'>
                                    ...
                                    <th><p>Practice</p></th>
                                    <th><p>PYQ's</p></th>
                                    <th><p>Mock Tests</p></th>
                                    <th><p>Final Review</p></th>
                                </tr>
                            </thead>
