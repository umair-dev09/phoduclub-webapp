...
import 'react-spring-bottom-sheet/dist/style.css'; // Importing the CSS for BottomSheet
...
const SubjectLayout: React.FC = () => {
    const [open, setOpen] = useState(false); // State to manage BottomSheet visibility
    const [selectedSubject, setSelectedSubject] = useState<string | null>(null); // Store selected subject for the popup

    const handleButtonClick = (subject: string) => {
        setSelectedSubject(subject); // Set the subject to display in the pop-up
        setOpen(true); // Open the BottomSheet
    };
        ...
        <div className={styles.container}>
            ...
            <BottomSheet open={open} onDismiss={() => setOpen(false)}>
                <div className={styles.popupContent}>
                    <h2>{selectedSubject} Details</h2>
                    <p>Here you can display more information about {selectedSubject}.</p>
