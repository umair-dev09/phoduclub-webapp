...
const SubjectLayout: React.FC = () => {
    ...
    const subjectsData = [ /* FECTECH THE DATA FROM BACKEND*/];
            ...
            <button className={styles.Buttons} onClick={() => handlebuttonClick('overall')}>
                <div className={styles.box1}>
                    <div className={styles.IconContainer}>
                        ...
                        {renderCheckmark(20)}   {/*  FETECHED DATA NAME HERE */}
                    </div>
                ...
                <div className={styles.progressValue}>
                    <CircularProgress percentage={30} />{/*  FETECHED DATA NAME HERE */}
                </div>
            </button>
            ...
            <button className={styles.Buttons} onClick={() => handlebuttonClick('physics')}>
                <div className={styles.box1}>
                    <div className={styles.IconContainer}>
                        ...
                        {renderCheckmark(50)} {/*  FETECHED DATA NAME HERE */}
                    </div>
                    <div className={styles.totalMarks}>
                ...
                <div className={styles.progressValue}>
                    <CircularProgress percentage={50} /> {/*  FETECHED DATA NAME HERE */}
                </div>
            </button>
            ...
            <button className={styles.Buttons} onClick={() => handlebuttonClick('chemistry')}>
                <div className={styles.box1}>
                    <div className={styles.IconContainer}>
                        ...
                        {renderCheckmark(100)}   {/*  FETECHED DATA NAME HERE */}
                    </div>
                    <div className={styles.totalMarks}>
                ...
                <div className={styles.progressValue}>
                    <CircularProgress percentage={100} /> {/*  FETECHED DATA NAME HERE */}
                </div>
            </button>
