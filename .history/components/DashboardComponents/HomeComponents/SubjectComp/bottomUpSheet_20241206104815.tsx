        ...
        <>
            ...
            >
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex flex-row items-end justify-end mt-auto border-t border-lightGrey">
                        <button
...
<div className="flex flex-row items-center justify-end mt-auto border-t border-lightGrey p-4">
    <button
        className="border rounded-lg py-2.5 px-6 text-sm border-lightGrey text-blackLike"
        onClick={closeModal}
    >
    ...
    <button className="ml-2.5 border rounded-lg py-2.5 px-6 text-sm bg-purple text-white border-darkPurple">
        <p>Save</p>
    </button>
</div>
