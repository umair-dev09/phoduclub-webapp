            ...
            {subjectsData.map((subject) => {
                ...
                return (
                    <button
                        ...
                        key={subject.name}
                        className={`border border-[#EAECF0] rounded-lg px-6 py-2 flex items-center justify-between transition-transform duration-300 ease-in-out hover:border-[#7400E03D] hover:shadow-lg hover:scale-105 ${isComplete ? 'bg-[#F9FAFB] border-[#EAECF0] ' : 'bg-[#FFFFFF] hover:border-[#7400E03D] '  // Conditional background color
                            }`}
                    >
                        <div className="pt-2 ">
