...
const BottomSheet: React.FC<BottomUpSheet> = ({ closeModal, subjectName }) => {
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-end justify-center z-10">
            <div id="bottomSheet"
                className={`fixed bottom-0 left-0 grid grid-rows-[69px_1fr_76px] w-full h-[98vh] bg-white rounded-t-lg transform ${isOpen ? (isClosing ? 'animate-slideDown' : 'animate-slideUp') : ''} transition-transform duration-500`}
            >
                ...
                <div className="overflow-auto">
                    <table className="w-full table-fixed border-collapse">
                        <thead className='bg-gray-100'>
                            <tr>
                                <th className="py-2 text-[14px] text-left">Chapter</th>
                                <th className="py-2 text-[14px] text-left">Priority</th>
                                <th className="py-2 text-[14px] text-left">Start Date</th>
                                <th colSpan={numColumns} className="py-2 text-[14px] text-left">Checkpoints</th>
                            </tr>
                        </thead>
