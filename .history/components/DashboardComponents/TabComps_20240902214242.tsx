    ...
    return (
        <div className={`${styles.tabComps} ${isCollapsed ? styles.collapsed : ''}`}>
            ...
            <div className={styles.tabs}>
                ...
                >
                    <Image className={styles.learIcon} src="/icons/dashboard.svg" width={22} height={22} alt="dashboard Icon" />
                ...
                >
                    <Image className={styles.learIcon} src="/icons/learn.svg" width={22} height={22} alt="Learn Icon" />
                ...
                >
                    <Image className={styles.communitiesIcon} src="/icons/community-icon.png" width={22} height={22} alt="Communities Icon" />
                ...
                >
                    <Image className={styles.analyticsIcon} src="/icons/analytics-icon.png" width={22} height={22} alt="Analytics Icon" />
