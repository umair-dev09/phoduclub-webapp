...
function TabComps() {
    ...
    useEffect(() => {
        ...
        if (savedState !== null) {
            ...
            console.log('Loaded sidebar state from localStorage:', parsedState);
        } else {
            console.log('No sidebar state found in localStorage, defaulting to false');
        }
    ...
    useEffect(() => {
        ...
        console.log('Saved sidebar state to localStorage:', isCollapsed.toString());
    }, [isCollapsed]);
