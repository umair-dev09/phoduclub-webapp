        ...
        <div>
            <div className="flex w-full flex-row items-center justify-between px-6 bg-white h-[65px] rounded-t border border-b-[#e9ebf0] border-t-white border-r-white border-l-white">
                ...
                >
                    ...
                    {
                        (currentPage === 'Back to Quizzes Management' || currentPage === 'Back to Role Management' ||
                            currentPage === 'Back to Course Management' || currentPage === 'Back to Test Series Management') && (
                            <button className='text-[#667085] text-base font-medium' onClick={handleBackClick}>
                                ...
                                {currentPage === 'Back to Role Management' && (
                                    <>
                                        <Image src='/icons/arrow-left-02-round.svg' alt='back' width={24} height={24} />
                                        {currentPage}
                                    </>
                                ...
                                {currentPage === 'Back to Course Management' && (
                                    <>
                                        <Image src='/icons/arrow-left-02-round.svg' alt='back' width={24} height={24} />
                                        {currentPage}
                                    </>
                                ...
                                {currentPage === 'Back to Test Series Management' && (
                                    <>
                                        <Image src='/icons/arrow-left-02-round.svg' alt='back' width={24} height={24} />
                                        {currentPage}
                                    </>
