...
function HelpDropDown() {
    ...
    return (
        <div>
            ...
            <div className="mx-2">
                {/* <button
                    className="w-[32px] outline-none h-[32px] bg-[#F7F8FA] border-[1.5px] border-[#EAECF0] rounded-full flex items-center justify-center transition-all duration-300 ease-in-out hover:bg-[#F2F4F7]"
                ...
                <ModalContent>
                    <>
                        ...
                        <ModalFooter className="border-t border-lightGrey">
                            <Button
                                variant='light' className="py-[0.625rem] px-6 border-2 border-solid border-[#EAECF0] font-semibold text-sm text-[#1D2939] rounded-md hover:bg-[#F7F8FB]"
                                onClick={handleCloseAll}
                            >
                                Cancel
                            </Button>
