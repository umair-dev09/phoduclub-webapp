                    ...
                    <DialogPanel className="bg-white rounded-2xl w-[480px] h-auto flex flex-col">
                        <div className="flex flex-col p-4 px-6 gap-3 border-solid border-[#EAECF0] border-b rounded-t-2xl">
                            <div className="flex flex-row justify-between items-center">
                                ...
                                <div
                                    className="w-8 h-8 flex items-center justify-center  hover:rounded-full hover:bg-[#f0f0f0]  transition-all duration-300 ease-in-out"
                                >
                                    <Image
                        ...
                        <div className='w-full border-solid border-[#EAECF0] border-b flex flex-col p-6 gap-3'>
                            ...
                            <div className='flex flex-col gap-1'>
                                ...
                                <button
                                    className={`rounded-md border hover:border-custom-hover  hover:border-[#D6BBFB] border-solid ${reasonText.trim() !== "" ? "border-[#D6BBFB]" : "border-[#D0D5DD]"
                                        } h-[160px]`}
                                    style={{
                                        boxShadow:
                                            reasonText.trim() !== ""
