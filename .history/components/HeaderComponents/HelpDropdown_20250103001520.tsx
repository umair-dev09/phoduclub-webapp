            ...
            >
                <ModalContent>
                    <>
                        ...
                        <ModalFooter className="flex justify-end mx-6 my-4">
                            <button
                                className="py-[0.625rem] w-[103px] px-6 text-white text-sm shadow-inner-button font-semibold bg-[#9012FF] rounded-md"
                                onClick={handleCloseAll}
                            >
                                Ok
                            </button>
