                    ...
                    <Popover placement="bottom" isOpen={open} onOpenChange={(open) => setOpen(open)} onClose={() => setOpen(false)}>
                        ...
                        <PopoverContent className="flex flex-col bg-white border border-lightGrey rounded-md w-[167px] px-0 shadow-md">
                            ...
                            <button className="flex items-center p-3 hover:bg-[#FEE4E2] w-full" onClick={() => {
                                ...
                                <p className="text-sm text-[#DE3024] ml-2">Log out1</p>
                            </button>
                        </PopoverContent>
                    </Popover>
                </div>
                ...
                <ModalContent>
                    <>
                        ...
                        <ModalFooter className="border-t border-lightGrey">
                            ...
                            <Button className="py-[0.625rem] px-6 text-white font-semibold shadow-inner-button  hover:bg-[#B0201A] bg-[#BB241A] border border-white rounded-md " onClick={handleLogout} >Delete User</Button>
