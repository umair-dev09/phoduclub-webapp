      ...
      <Popover placement='bottom-end'>
        <PopoverTrigger>
          <div className="relative flex flex-col">
            ...
            <button className="w-[32px] h-[32px] bg-[#F7F8FA] border-[1.5px] border-[#EAECF0] rounded-full flex items-center justify-center hover:bg-[#F2F4F7] transition-all duration-200  hover:scale-105">
