        ...
        <div id="inputs" ref={inputsRef} className="flex space-x-2 justify-center">
            {Array.from({ length: 6 }).map((_, index) => (
                <input
                    ...
                    placeholder="-"
                    className={`
              w-12 h-12 border border-[#98a2b3] rounded-md 
              text-center text-2xl font-medium text-black 
              focus:outline-none focus:border-[#7400e0] 
              appearance-none
            `}
                />
            ))}
        ...
        <div className="w-1/2 flex flex-col">
            ...
            <div className="flex flex-col justify-center h-full">
                <div className="flex items-center justify-center">
                    <p className=" text-[#101828] font-bold text-2xl">Verification Code</p>
                </div>
