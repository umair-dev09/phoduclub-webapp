    ...
    return (
        <div className="w-1/2 flex flex-col h-full">
            ...
            <div className="flex flex-col mt-[60px] items-center h-full gap-4">
                ...
                <p className="text-[#667085] font-medium text-base w-[313px] text-center">Please enter the verification code
                    we sent to your mobile 99*****99 <span id="mobile">{phoneNumber}</span></p>
