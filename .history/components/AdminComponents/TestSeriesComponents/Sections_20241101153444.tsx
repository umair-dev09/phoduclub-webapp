                ...
                <div key={index} className={`h-auto rounded-[16px] ${index > 0 ? 'mt-4' : ''} flex flex-col border border-solid border-[#EAECF0] bg-[#FFFFFF] mt-4`}>
                    {section.showContent ? (
                        <>
                            ...
                            {showContent && (
                                <div>
                                    <div className="h-[48px] bg-[#F2F4F7]  flex flex-row  px-4  items-center">
                                        <div className=" flex flex-row gap-5 w-[700px]">
                                            <input
                                                type="checkbox" />
                                            <span className="text-[#667085] font-medium text-base">Questions</span>
                                        </div>
                                        <div className=" flex flex-row gap-4 ">
                                            <span className="text-[#667085]  flex flex-row items-center font-medium w-[202px] text-base">Difficulty</span>
