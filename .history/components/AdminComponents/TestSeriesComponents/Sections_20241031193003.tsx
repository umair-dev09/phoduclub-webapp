...
interface SectionProps {
    toggleAddSection: () => void;
    isAddSectionVisible: boolean; // Add this line
}
    ...
    return (
        <>
            {sections.map((section) => (
                <div key={section.id} className="h-auto rounded-[16px] mt-4 flex flex-col border border-solid border-[#EAECF0] bg-[#FFFFFF]">
                    <div className="h-[76px] bg-[#FFFFFF] rounded-t-[16px] border-b border-solid border-[#EAECF0]">
                        <div className="flex flex-row justify-between p-4">
                            <div className="flex flex-col">
