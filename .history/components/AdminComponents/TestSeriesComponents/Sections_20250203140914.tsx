                        ...
                        <div className={`flex flex-row gap-3 ${section.isParentUmbrellaTest ? 'mt-1' : 'mt-2'} items-center `}>
                          ...
                          {section.hasQuestions ? (
                            ...
                            >
                              ...
                              <span className=" px-3 py-1 transition duration-200 ease-in-out text-[#9012FF] hover:bg-[#F5F0FF] font-semibold text-sm">View Questions</span>
                            </button>
                          ) : (
                            !section.isParentUmbrellaTest && (
                              <button
                              ...
                              >
                                <span className="text-[#9012FF] px-3 py-1 transition duration-200 ease-in-out font-semibold  hover:bg-[#F5F0FF] text-sm">View Section</span>
                              </button>
                            )
                          )}
