                        ...
                        <>
                            ...
                            {showContent && (
                                <div>
                                    ...
                                    <div className="flex flex-row justify-end mx-6 my-4 gap-4 h-[76px]">
                                        <button className="py-[0.625rem] px-6 border-[1.5px] border-lightGrey rounded-md text-[#1D2939] font-semibold text-sm" >Cancel</button>
                                        <button
