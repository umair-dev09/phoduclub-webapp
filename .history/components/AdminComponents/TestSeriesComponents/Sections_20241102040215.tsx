                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-row gap-2 px-2">
                                            <div className="flex flex-row gap-1 items-center">
                                                ...
                                                <span className="font-medium text-[#101828] text-xs">{timeDuration || "10 min"}</span>
                                            </div>
                        ...
                        <div className="flex flex-col relative gap-6">
                            ...
                            <div className="flex flex-col px-6">
                                ...
                                <div className="flex flex-row gap-4">
                                    <div className="flex flex-row w-[74px] h-10 px-1 outline-none border border-[#D0D5DD] rounded-md">
                                        <input
                                            type="text"
                                            value={timeDuration}
