...
function Sections({ sectionsCount }: SectionProps) {
    ...
    const handleDifficultySelect = (difficulty: React.SetStateAction<string>) => {
                                            ...
                                            <div className="h-[48px] bg-[#FFFFFF]  flex flex-row justify-between px-4  items-center ">
                                                ...
                                                <div className=" flex flex-row gap-14 items-center justify-center">
                                                    <Popover placement="bottom">
                                                        <PopoverTrigger>
                                                            <div className="flex flex-row bg-[#D3F8E0] items-center justify-between rounded-[6px] h-[26px] p-2 w-[92px] cursor-pointer">
