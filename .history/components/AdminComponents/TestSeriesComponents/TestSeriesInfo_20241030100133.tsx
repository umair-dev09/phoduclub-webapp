...
function Quizinfo({ onClose }: QuizinfoProps) {
    ...
    return (
        <>
            <div className='mt-2 h-auto rounded-xl border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col p-5 gap-2'>
            ...
            <div className="bg-[#FFFFFF] border border-solid border-[#EAECF0] rounded-xl h-[154px] my-4 p-4 ">

                <span className="text-lg font-semibold text-[#1D2939] ">Price</span>
                ...
                <div className="fixed inset-0 flex items-center justify-center ">
                    <DialogPanel transition className="bg-white rounded-2xl w-[559px] h-auto">
                        <div className="flex flex-col relative">
                            <button className="absolute right-4 top-4" onClose={closeUploadImageDialog}  >
                                <Image src="/icons/cancel.svg" alt="cancel" width={20} height={20} />
                            </button>
                            <h3 className="mx-6 mt-6 text-2xl font-semibold task-[#1D2939]">Pause quiz "Physics"?</h3>
                            <div className="flex flex-row items-center my-4 mx-6 gap-2">
                                <input type="checkbox" className="border-lightGrey h-4 w-4" />
                            ...
                            <p className="mx-6 mt-4 mb-6 text-sm text-[#475467] font-normal">Quiz will be live for 2 hours.</p>
                            <hr />
                            <div className="flex flex-row justify-end mx-6 my-4 gap-4">
                                ...
                                >
                                    Cancel</button>
                                <button className="py-[0.625rem] px-6 text-white shadow-inner-button bg-[#9012FF] border border-[#8501FF] rounded-md">Schedule Quiz</button>
                            </div>
                        </div>
                    </DialogPanel>
                </div>
