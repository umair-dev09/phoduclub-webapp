...
function Section() {
    ...
    // State to manage content visibility and section details
    ...
    const handleCreateSection = () => {
        ...
        const timeInput = document.getElementById('section-time') as HTMLInputElement;
                ...
                {isSectionCreated ? (
                    <div className="content-div h-[76px] bg-[#FFFFFF] rounded-t-[16px] border-b border-solid border-[#EAECF0]">
                        <div className="flex flex-row justify-between p-4">
                            <div className="flex flex-col">
                                <span className="font-semibold text-base text-[#1D2939]">{sectionDetails.name}</span>
                                <div className="flex flex-row mt-2 items-center">
                                    <Image
                                        src="/icons/select-date.svg"
                                        width={16}
                                    ...
                                    <span className="ml-2 text-[#101828] text-xs font-medium">
                                        {sectionDetails.date} {sectionDetails.time}
                                    </span>
                                </div>
                            </div>
                            <button>
