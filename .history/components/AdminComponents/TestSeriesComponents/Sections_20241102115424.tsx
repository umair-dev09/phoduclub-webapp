...
function Sections({ sectionsCount }: SectionProps) {
    ...
    const handleAddQuestion = () => {
        // Add a new question with a unique ID
                    ...
                    {section.showContent ? (
                        <>
                            ...
                            <div className="h-auto bg-[#FFFFFF] rounded-t-[16px] border-b border-solid border-[#EAECF0]">
                                ...
                                {showContent2 && (
                                    <div>
                                        <span className="font-normal text-sm text-[#475467] mb-1 px-2">
                                            {description || "Lorem ipsum dolor sit amet consectetur adipisicing"}
                                        </span>
                                        <div className="flex flex-row gap-2 px-2">
                                            <div className="flex flex-row gap-1 items-center">
                                                <Image src="/icons/clock-01.svg" width={16} height={16} alt="overall time" />
                                                <span className="text-[#475467] font-normal text-sm">Overall Time :</span>
                                                <span className="font-medium text-[#101828] text-xs">{timeDuration || "10"} <span className="font-medium text-[#101828] text-xs"></span>{minutes || "min"}</span>
                                            </div>
                                            <div className="w-4 h-4 border-l border-solid border-[#D0D5DD]"></div>
                                            <div className="flex flex-row gap-1 items-center">
                                                <span className="text-[#475467] font-normal text-sm">Marks per Question:</span>
                                                <span className="font-medium text-[#101828] text-xs">{marksPerQuestion || "1"}</span>
                                            </div>
                                            <div className="w-4 h-4 border-l border-solid border-[#D0D5DD]"></div>
                                            <div className="flex flex-row gap-1 items-center">
                                                <span className="text-[#475467] font-normal text-sm">Negative Marks:</span>
                                                <span className="font-medium text-[#101828] text-xs">{negativeMarks || "0"}</span>
                                            </div>
                                                ...
                                                <div className="h-[48px] bg-[#FFFFFF]  flex flex-row justify-between px-4  items-center ">
                                                    ...
                                                    <div className=" flex flex-row ">
                                                        ...
                                                        <div className="h-6 w-5 rounded-[4px] bg-[#EAECF0] flex justify-center items-center ml-5 mr-2 ">
                                                            <span className="text-[#1D2939] font-semibold text-sm">{index + 1}</span>
                                                        </div>
                        ...
                        <div className="flex flex-col relative gap-6">
                            ...
                            <div className="flex flex-col px-6">
                                ...
                                <div className="flex flex-row gap-4">
                                    <div className="flex flex-row w-[74px] h-10  outline-none border border-[#D0D5DD] rounded-md">
                                        <input
                                            type="text"
                                            value={timeDuration}
