...
function Quizinfo() {
    ...
    return (
        <>
            ...
            <div className="bg-[#FFFFFF] border border-solid border-[#EAECF0] rounded-xl h-[154px] my-4 px-4 pt-4 pb-3 ">
                ...
                <div className="flex flex-row pt-4 w-full">
                    <div className="flex flex-col gap-1 w-1/2 flex-grow">
                        ...
                        <div className="relative">
                            <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#1D2939]">₹</span>
                            <input
