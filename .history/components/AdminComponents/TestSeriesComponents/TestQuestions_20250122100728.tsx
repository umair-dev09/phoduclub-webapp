                                    ...
                                    <div className="flex flex-row items-start w-full  border-lightGrey py-2 ">
                                        ...
                                        <div className="w-[65%] flex ">
                                            <div className="flex gap-2 pr-4 items-start">
                                                ...
                                                <div className={`"font-normal text-sm break-all "${isDataMissing(question) ? " text-red-600 ml-1 mt-1" : " text-[#1D2939]  ml-1 mt-1"}`} dangerouslySetInnerHTML={{ __html: question.question || "Question" }}></div>
                                            </div>
                                        </div>
