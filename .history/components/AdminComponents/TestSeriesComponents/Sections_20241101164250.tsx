...
function Sections({ sectionsCount }: SectionProps) {
    ...
    const handleChange = (content: string) => {
        const sanitizedContent = content.replace(/<\/?p>/g, ""); // Remove <p> tags if they appear
    ...
    const [question, setQuestion] = useState(""); // Define the question state
                                ...
                                <div>
                                    ...
                                    <Collapsible
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <div
                                                className="pt-2 mx-4 bg-[#FFFFFF] border border-solid border-[#EAECF0]'
                                                     rounded-[12px] h-auto">
