                    ...
                    <div className="flex flex-col w-full">
                        <div className="flex flex-row items-center bg-[#F2F4F7] border-b">
                            ...
                            <div className="relative">
                                ...
                                {/* Popover content */}
                                {isPopoverOpen && (
                                    <div className="absolute left-80 top-60 bg-white rounded-md border border-solid border-[#EAECF0] px-4 py-3 w-auto shadow-[0_2px_4px_#EAECF0]">
                                        ...
                                        {/* Difficulty Dropdown as Popover */}
                                        <Popover placement="top">
                                            <PopoverTrigger>
                                                <button className="flex items-center gap-1">
                                                    <p className="text-xs text-[#182230] font-medium leading-5">Difficulty</p>
