        ...
        <>
            <div className="h-auto rounded-[16px] mt-4 flex flex-col border border-solid border-[#EAECF0] bg-[#FFFFFF]">
                {showContent && (
                    <div className="h-[76px] bg-[#FFFFFF] rounded-t-[16px] border-b border-solid border-[#EAECF0]">
                        <div className="flex flex-row justify-between p-4">
                            ...
                            <button>
                                <Image src="/icons/three-dots.svg" width={20} height={20} alt="Three Dots Icon" />
                            </button>
                        </div>
                    </div>
                )}
                <div className="bg-[#FFFFFF] h-[184px] p-6 items-center flex flex-col gap-2 rounded-[16px]">
                    ...
                    {!showContent ? (
                        <button
                            className="flex flex-row items-center justify-center rounded-md bg-[#9012FF] shadow-button text-white font-semibold text-sm h-[44px] w-[162px] transition-all"
                            onClick={openCreateSection}
                        >
                            Create Section
                        </button>
                        ...
                        <button
                            className="flex flex-row items-center justify-center rounded-md bg-[#F9FAFB] shadow-button text-[#1D2939] font-semibold text-sm h-[44px] w-[162px] transition-all"
            ...
            {/* Dialog for creating a section */}
            <Dialog open={isCreateSection} onClose={closeCreateSection}>
                <DialogBackdrop className="fixed inset-0 bg-black opacity-30" />
                <DialogPanel className="fixed left-1/2 top-1/2 w-[510px] -translate-x-1/2 -translate-y-1/2 rounded-[16px] bg-white p-8 shadow-dialog">
                    <h2 className="font-semibold text-base text-[#1D2939]">Create Section</h2>
                    <div className="flex flex-col mt-6">
                        <label className="text-xs font-normal text-[#344054]" htmlFor="section-name">Section Name</label>
                        <input
                            type="text"
                            id="section-name"
                            className="h-[40px] border border-lightGrey rounded-md px-3 mt-1"
                    ...
                    <div className="flex flex-row mt-4">
                        <div className="flex flex-col mr-4">
                            <label className="text-xs font-normal text-[#344054]" htmlFor="section-date">Date</label>
                            <input
                                type="date"
                                id="section-date"
                                className="h-[40px] border border-lightGrey rounded-md px-3 mt-1"
                        ...
                        <div className="flex flex-col">
                            <label className="text-xs font-normal text-[#344054]" htmlFor="section-time">Time</label>
                            <input
                                type="time"
                                id="section-time"
                                className="h-[40px] border border-lightGrey rounded-md px-3 mt-1"
                    ...
                    <button
                        className="mt-6 rounded-md bg-[#9012FF] h-[44px] text-white font-semibold transition-all"
