                            ...
                            <div className="h-auto bg-[#FFFFFF] rounded-t-[16px] border-b border-solid border-[#EAECF0]">
                                ...
                                <div className="flex flex-row gap-2 px-2">
                                    <div className="flex flex-row gap-1 items-center">
                                        ...
                                        <span className="font-medium text-[#101828] text-xs">10 min</span>

                                    </div>
                                    <div className="w-4 h-4 border-l  border border-solid border-[#D0D5DD]"></div>
                                    ...
                                    <div className="w-4 h-4 border border-solid border-[#D0D5DD]"></div>
