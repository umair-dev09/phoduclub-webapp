...
function section() {
    return (
        <>
            <div className=" h-auto rounded-[16px] mt-4 flex flex-col ">
                <div className="h-[76px]   bg-[#FFFFFF]  border border-solid border-[#EAECF0] rounded-[16px]">
                ...
                <div className="bg-[#FFFFFF] border border-solid border-[#EAECF0] h-[184px] p-6 items-center flex flex-col gap-2 ">
