...
interface QuillEditorProps {
    showContent: boolean; // This is required
    value?: string;       // Make value optional
    setValue?: (content: string) => void; // Make setValue optional
}
const QuillEditor: React.FC<QuillEditorProps> = ({ showContent, value, setValue }) => {
    ...
    const handleChange = (content: string) => {
        ...
        // If setValue is provided, call it
        if (setValue) {
            setValue(content);
        }
    };
