                        ...
                        <div className="flex flex-row items-center bg-[#F2F4F7] border-b">
                            <div className="w-[5%] pl-4 py-3">
                                ...
                                >
                                    ...
                                    <PopoverContent className="flex gap-2 flex-row bg-white rounded-[8px] border-[1px] border-solid border-[#EAECF0] h-[66px] px-4 w-auto h shadow-[0_2px_4px_#EAECF0]">
                                        <p className="font-semibold text-[#1D2939] text-base w-auto">10 select</p>
                                        <button className="rounded-md border border-lightGrey px-1  ">
