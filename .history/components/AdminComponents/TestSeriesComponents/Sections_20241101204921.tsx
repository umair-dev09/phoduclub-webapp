                            ...
                            {showContent && (
                                <div className="">
                                    ...
                                    <Collapsible
                                        ...
                                        <span className="font-semibold text-base text-[#1D2939] mx-4 my-2">Correct answer</span>
                                        <Popover
                                        ...
                                        >
                                            <PopoverTrigger>
                                                <button
                                                    className="h-[40px] mx-4  items-center w-full justify-between flex flex-row rounded-md border border-solid"


                                                >
                                                    <span
                                                        className="font-normal text-sm text-[#667085] ml-2"
