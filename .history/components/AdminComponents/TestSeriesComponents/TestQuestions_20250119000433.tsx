...
function TestQuestions({ questionsList, setQuestionsList }: QuestionsProps) {
    ...
    const [popoveropen1, setPopoveropen1] = useState(false); // Popover state to control visibility

    const handleCheckboxClick = () => {
        setPopoveropen1(true); // Open popover when checkbox is clicked
    };
    return (
                        ...
                        <div className="flex flex-row items-center bg-[#F2F4F7] border-b">
                            <div className="w-[5%] pl-4 py-3">
                                <Popover
                                    ...
                                    onOpenChange={(open) => { } /* Do nothing when the popover opens or closes (prevent outside clicks from closing it) */}
                                ...
                                >
                                    <PopoverTrigger>
                                        <Checkbox
                                            size="md"
                                            color="primary"
                                            onClick={handleCheckboxClick}  // Open popover on checkbox click
                                        />
                                    </PopoverTrigger>
