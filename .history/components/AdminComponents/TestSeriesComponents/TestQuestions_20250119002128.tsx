                        ...
                        <div className="flex flex-row items-center bg-[#F2F4F7] border-b">
                            <div className="w-[5%] pl-4 py-3">
                                ...
                                <Popover
                                    ...
                                    onOpenChange={(open) => setPopoveropen1(open)} // Toggle popover visibility
                                    className="absolute left-80 align-middle top-80"
                                >
                                    <PopoverTrigger>
                                        <Checkbox size="md" color="primary" />
                                    </PopoverTrigger>

                                    <PopoverContent className="flex flex-row items-center justify-between bg-white rounded-md border border-solid border-[#EAECF0] px-4 py-3 w-auto shadow-[0_2px_4px_#EAECF0]">
                                        {/* Text */}
                                        <p className="font-semibold text-[#1D2939] text-base">10 selected</p>

                                        {/* Select All & Unselect All Buttons */}
                                        <div className="flex gap-2">
                                            <button className="rounded-md border border-lightGrey px-2 py-1">
                                        ...
                                        <Popover placement="top">
                                            ...
                                            <PopoverContent className="w-[141px] rounded-md border border-lightGrey py-2">
                                                <div className="flex flex-col gap-1">
                                                    <button className="w-full px-2 py-2 transition-colors duration-150 hover:bg-[#F2F4F7]">
                                                        <p className="w-full py-1 text-sm text-center text-[#0C111D] font-normal leading-5 rounded-sm bg-[#D3F8E0]">
                                                            Easy
                                                        </p>
                                                    </button>
                                                    <button className="w-full px-2 py-2 transition-colors duration-150 hover:bg-[#F2F4F7]">
                                                        <p className="w-full py-1 text-sm text-center text-[#0C111D] font-normal leading-5 rounded-sm bg-[#FFFAEB]">
                                                            Medium
                                                        </p>
                                                    </button>
                                                    <button className="w-full px-2 py-2 transition-colors duration-150 hover:bg-[#F2F4F7]">
                                                        <p className="w-full py-1 text-sm text-center text-[#0C111D] font-normal leading-5 rounded-sm bg-[#FEE4E2]">
                                                            Hard
                                                        </p>
                                                    </button>
                                                </div>
