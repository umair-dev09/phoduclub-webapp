...
function section() {
    return (
        <div className="bg-[#FFFFFF] border border-solid border-[#EAECF0] h-[184px] p-6 items-center flex flex-col gap-2 rounded-[16px] mt-4 ">
            ...
            <div className="flex flex-row gap-4">
                <button className="flex flex-row gap-1 items-center rounded-md border border-solid border-[#9012FF]">
                    <Image
                ...
                <button className="flex flex-row gap-1 items-center border border-solid border-[#9012FF]">
                    <Image
                        src="/icons/plus-sign.svg"
                        height={18}
                        width={18}
