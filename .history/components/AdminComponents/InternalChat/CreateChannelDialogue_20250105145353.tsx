            ...
            >
                <ModalContent>
                    <>
                        ...
                        <ModalBody>
                            <p className="text-sm font-medium text-[#1D2939]">Channel name</p>
                            <div className="flex flex-row w-full pb-4  gap-1 border border-gray-300  h-10 focus:outline focus:outline-[1.5px] focus:outline-[#D6BBFB] hover:outline hover:outline-[1.5px] hover:outline-[#D6BBFB] rounded-md">
                        ...
                        <ModalFooter className='border-t border-lightGrey'>
                            <Button
                                variant="light" className="py-[0.625rem] px-6 border-[1.5px] border-lightGrey rounded-md font-medium hover:bg-[#F2F4F7]"
                                onClick={handleClose}
                            >
                                Cancel
                            </Button>
