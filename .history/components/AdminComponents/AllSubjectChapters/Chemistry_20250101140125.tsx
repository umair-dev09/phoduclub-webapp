...
function Chemisty() {
    ...
    // Close popover and open the dialog
    const openDialogAndClosePopover = (editMode: boolean) => {
        closePopover();
        setAddchapterdialog(true);
        setIseditopen(editMode);
        setIsdelete(!editMode);
    };
