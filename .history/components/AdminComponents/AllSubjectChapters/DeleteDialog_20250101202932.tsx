                    ...
                    <ModalBody>
                        <div className="flex flex-col pb-2 gap-2">
                            ...
                            <div className="flex flex-col  gap-2">
                                ...
                                <div className='flex px-2 items-bcenter h-[40px] border border-gray-300 focus:outline focus:outline-[1.5px] focus:outline-[#f3b7b3] hover:outline hover:outline-[1.5px] hover:outline-[#f3b7b3] focus-within:border-[#f3b7b3] focus-within:ring-4 focus-within:ring-[#f3b7b3] focus-within:outline-none transition-colors rounded-md'>
                                    <input
