...
function Chemisty() {
    ...
    return (
        <div className="flex flex-col w-full gap-4 ">
            ...
            {addchapterdialog && isdelete && (
                <DeleteChapter
                    open={addchapterdialog && isdelete} // Ensure the delete dialog opens only for delete actions
                    onClose={() => {
                        setAddchapterdialog(false); // Close the overall dialog
                        setIseditopen(false); // Reset edit mode
                        setIsdelete(false); // Reset delete mode
                    }}
                />
            )}
            ...
            {addchapterdialog && !isdelete && (
                <Addchapterdialog
                    ...
                    iseditopen={iseditopen} // Determines if "Edit Chapter" or "Create Chapter" is shown
                    onClose={() => {
                        setAddchapterdialog(false); // Close the dialog
                        setIseditopen(false); // Reset edit mode
                    }}
                />
            )}
