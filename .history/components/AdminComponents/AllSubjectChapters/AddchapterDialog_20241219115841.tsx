                    ...
                    <div className="flex flex-col p-6 gap-3 border-solid border-[#EAECF0] border-b rounded-t-2xl">
                        ...
                        <div className="flex flex-col gap-1 w-full">
                            ...
                            <Popover>
                                ...
                                <PopoverContent className=" bg-white border border-lightGrey rounded-md shadow-md px-0 w-[450px]">
                                    {priorities.map((item) => (
                                        <button
                                            key={item.label}
                                            className="flex justify-between items-center  w-full py-2 hover:bg-[#F2F4F7] transition-colors"
