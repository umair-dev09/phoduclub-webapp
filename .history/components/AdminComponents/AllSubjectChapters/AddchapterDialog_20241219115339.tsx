...
function Allsubject({ onClose, open }: DialogProps) {
    ...
    const [priorityColor, setPriorityColor] = useState<string>("bg-transparent");

    // Example handler for setting priority and color
    const handlePrioritySelection = (selectedPriority: string) => {
        setPriority(selectedPriority);
        if (selectedPriority === "Low") setPriorityColor("bg-[#0B9055]");
        else if (selectedPriority === "Medium") setPriorityColor("bg-[#DB6704]");
        else if (selectedPriority === "High") setPriorityColor("bg-[#DE3024]");
    };
