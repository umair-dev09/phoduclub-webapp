                                    ...
                                    {data.length > 0 ? (
                                        currentItems.map((subject, index) => (
                                            <tr key={index} className="border-t border-solid border-[#EAECF0]">
                                                <td>
                                                    <p className="px-8 text-start text-sm text-[#1D2939] font-normal leading-6 whitespace-nowrap">{subject.chapterName || "phodu chapter"}</p>
                                                </td>
                                                <td className="px-8 py-4 text-center text-[#101828] text-sm">
                                                    <span className='flex justify-start rounded-full'>
                                                        <SubjectPriority Priority={subject.priority || "phodu priority"} />
                                                    </span>
                                                </td>
