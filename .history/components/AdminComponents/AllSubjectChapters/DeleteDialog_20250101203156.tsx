                    ...
                    <ModalBody>
                        <div className="flex flex-col pb-2 gap-2">
                            ...
                            <div className="flex flex-col  gap-2">
                                ...
                                <div className='flex px-2 items-center h-[40px] border border-gray-300 focus:outline focus:outline-[1.5px] focus:outline-[#e57373] hover:outline hover:outline-[1.5px] hover:outline-[#ff6b6b] focus-within:border-[#e57373] focus-within:ring-4 focus-within:ring-[#e57373] focus-within:outline-none transition-colors rounded-md'>
                                    <input
