                    ...
                    <ModalBody>
                        <div className="flex flex-col pb-2 gap-2">
                            ...
                            <div className="flex flex-col  gap-2">
                                ...
                                <div className='flex px-2 items-bcenter h-[40px] border border-gray-300   focus:outline focus:outline-[1.5px] focus:outline-[#BB241A] hover:outline hover:outline-[1.5px] hover:outline-[#BB241A] shadow-sm rounded-md'>
                                    <input
