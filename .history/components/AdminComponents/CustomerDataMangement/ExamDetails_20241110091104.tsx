        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2 px-8">
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    <div className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-[#344054]  border border-solid border-[#D0D5DD] rounded-full cursor-pointer hover:bg-gray-100">
                        <span className="w-2 h-2 rounded-full bg-orange-500"></span> BITSAT
                    </div>
                    <div className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-gray-700  border border-solid border-[#D0D5DD] rounded-full cursor-pointer hover:bg-gray-100">
