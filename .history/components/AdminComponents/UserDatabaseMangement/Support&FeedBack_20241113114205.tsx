...
import Queries from '@/components/AdminComponents/UserDatabaseMangement/Queries';
import Reporting from '@/components/AdminComponents/UserDatabaseMangement/Reporting';
