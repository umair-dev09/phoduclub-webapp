...
function Community() {
    return (
        <div className="flex flex-col gap-6 p-8">
            ...
            <div className=" border border-solid border-[#F7F8FB rounded-md h-auto">
                <span className="text-[#667085] font-medium text-sm m-6">Groups</span>

                < Collapsible
                    trigger={
                        <div className="h-[76px] w-full p-6 flex flex-row justify-between  items-center border-b border-solid border-[#EAECF0]">
