    ...
    return (
        <div className="flex flex-col gap-6 p-8">
            ...
            <div className=" border border-solid border-[#F7F8FB rounded-xl h-auto">
                ...
                < Collapsible
                    trigger={
                        <div className="h-[76px] w-full px-6 flex flex-row justify-between  items-center ">
                    ...
                    <div className="rounded-lg h-auto border border-solid border-[#EAECF0] mx-6 my-4">
                        <div className="flex flex-row h-[50px] justify-between items-center p-6">
                            <div className="flex flex-row gap-2">
                                <Image
                                    src='/icons/MathsQuicktest.svg'
                                    width={20}
                                    height={20}
                                    alt="Arrow-down" />
