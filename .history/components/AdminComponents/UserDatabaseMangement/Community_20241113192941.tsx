    ...
    return (
        <div className="flex flex-col gap-6 p-8">
            ...
            <div className=" border border-solid border-[#F7F8FB rounded-xl h-auto">
                <span className="text-[#667085] font-medium text-sm m-6">Groups</span>

                < Collapsible
                    trigger={
                        <div className="h-[76px] w-full p-6 flex flex-row justify-between  items-center ">
                            <div className="flex flex-row gap-2">
                                <Image
                                    src='/icons/arrow-down-02-round.svg'
                                    width={20}
                                    height={20}
                                    alt="Arrow-down" />
                                <Image
                    ...
                    <div className="rounded-lg h-auto border border-solid border-[#EAECF0]">
                        <div className="flex flex-row h-[50px] justify-between items-center">
                            <div className="flex flex-row gap-2">
                                <Image
                                    src='/icons/arrow-down-02-round.svg'
                                    width={20}
