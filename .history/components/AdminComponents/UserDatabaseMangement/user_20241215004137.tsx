                            ...
                            <div className="flex flex-col px-6 gap-6">
                                ...
                                <div className="flex flex-row w-full gap-4">
                                    <div className="flex flex-col gap-1 w-1/2 flex-grow">
                                        ...
                                        <input
                                            className="w-full text-sm font-medium text-[#1D2939] placeholder:normal placeholder:text-[#A1A1A1] rounded-md  px-4 py-2 border border-gray-300  h-10 focus:outline focus:outline-[1.5px] focus:outline-[#D6BBFB] hover:outline hover:outline-[1.5px] hover:outline-[#D6BBFB]"
                                            type="text"
