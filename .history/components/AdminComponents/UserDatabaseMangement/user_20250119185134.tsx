                ...
                <ModalContent>
                    <>
                        ...
                        <ModalFooter className="border-t border-lightGrey">
                            ...
                            <Button className={`py-[0.625rem] px-6 text-white text-sm shadow-inner-button font-semibold border border-solid  border-white ${categoryName ? "bg-[#9012FF] hover:bg-[#6D0DCC] " : "bg-[#CDA0FC] cursor-not-allowed"} rounded-md`} onClick={handleCreateCategory}>{isEditing ? 'Save Changes' : 'Create Category'}</Button>
                        </ModalFooter>
                    </>
                </ModalContent>
            </Modal >
