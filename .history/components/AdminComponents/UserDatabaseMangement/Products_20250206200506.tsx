        ...
        <div className="flex flex-col gap-6">
            <div className="flex flex-row gap-3 border-b border-solid border-[#EAECF0] p-8">
                <div className="relative">
                    <Image className="rounded-full w-[72px] h-[72px]" src={"/images/DP_Lion.svg"} alt="DP" width={72} height={72} />
                    {userData.isPremium && (
                        <Image
                ...
                <div className="flex items-start flex-col justify-center">
                    <div className="font-semibold text-[#1D2939] text-2xl">{"phodu user"}</div>
                    <div className="flex justify-start items-start text-[16px] font-medium text-[#667085]">{"phodu Id"}</div>
                </div>
            </div>
