            ...
            <ModalContent>
                <>
                    ...
                    <ModalFooter className="border-t border-lightGrey">
                        ...
                        <Button className={`py-[0.625rem] px-6 text-white font-semibold shadow-inner-button  ${banUser ? 'bg-[#BB241A] hover:bg-[#B0201A] ' : 'hover:bg-[#02743A] bg-[#0B9055]'} border border-white rounded-md`} onClick={handleBanUser}>{banUser ? 'Ban User' : 'Revoke Ban'}</Button>
                    </ModalFooter>
                </>
            </ModalContent>
        </Modal >
