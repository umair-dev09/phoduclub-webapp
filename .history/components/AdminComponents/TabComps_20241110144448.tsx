    ...
    return (
        <div className={`flex flex-col relative transition-all duration-[500ms] ease-in-out ${isCollapsed ? 'w-[3.5rem]' : 'w-[16rem]'} pl-2 py-[0.625rem] bg-[#131313]`}>
            ...
            <Collapsible
                ...
                transitionTime={300}
            >
                <Tooltip title="Quizzes Management" arrow placement="right-end"
                    sx={{
                        "& .MuiTooltip-tooltip": {
                            backgroundColor: "#000000", // Set the tooltip background to black
                            color: "#FFFFFF",           // Set the text color to white
                            fontSize: "0.875rem",
                            height: "50px"    // Optional: Adjust font size if needed
                        },
                        "& .MuiTooltip-arrow": {
                            color: "#000000",           // Set the arrow color to match the tooltip background
                        }
                    }}>
                    <button
