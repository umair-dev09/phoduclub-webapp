                                ...
                                <div className="flex flex-row p-2 w-full justify-between border border-solid border-[#D0D5DD] rounded-md">
                                    ...
                                    <div>
                                        <Popover placement="bottom">
                                            ...
                                            {/* Popover Content without Gap */}
                                            <PopoverContent className="p-0 m-0 border-none rounded-none shadow-none">
                                                <div className="flex items-center justify-center w-full h-[50px] bg-white border border-solid border-[#D0D5DD] rounded-md">
                                                    <span className="text-sm text-[#182230]">Jabir</span>
                                                </div>
                                            </PopoverContent>
                                        </Popover>
                                    </div>
