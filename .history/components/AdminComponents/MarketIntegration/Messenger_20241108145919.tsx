                            ...
                            <div className="flex flex-col w-full gap-1 ">
                                ...
                                <div className="flex flex-row p-2 w-full gap-2 border border-solid border-[#D0D5DD] rounded-md ">
                                    <Popover placement="bottom">
                                        ...
                                        <PopoverContent>
                                            <div className="w-[250px] p-4 bg-white border border-solid border-[#D0D5DD] rounded-md flex flex-col gap-4">
                                                <h3 className="text-sm font-semibold text-[#182230]">Choose Role</h3>
                                                <div className="flex flex-row justify-between gap-4">
                                                    {/* Marketing Integration */}
                                                    <button
                                                        onClick={() => handleRoleSelect("Marketing Integration")}
                                                        className="flex flex-col items-center gap-2"
                                                    >
                                                        <Image
                                                            src="/icons/Marketing Integration.svg"
                                                            width={48}
                                                            height={48}
                                                            alt="Marketing Integration"
                                                        />
                                                        <span className="text-xs text-[#0C111D]">Marketing</span>
                                                    </button>
                                                    ...
                                                    >
                                                        <Image
                                                            ...
                                                            alt="Read"
                                                        />
                                                        <span className="text-xs text-[#0C111D]">Read</span>
                                                    </button>

                                                    {/* Idea */}
                                                    <button
                                                        onClick={() => handleRoleSelect("Idea")}
                                                        className="flex flex-col items-center gap-2"
                                                    >
                                                        <Image
                                                            ...
                                                            alt="Idea"
                                                        />
                                                        <span className="text-xs text-[#0C111D]">Idea</span>
                                                    </button>
                                                </div>
                                            </div>
                                        </PopoverContent>
