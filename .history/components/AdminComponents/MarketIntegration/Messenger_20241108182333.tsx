...
function Messenger() {
    ...
    const handleImageClick = (imageSrc: React.SetStateAction<null>) => {
                                    ...
                                    <Popover placement="bottom">
                                        <PopoverTrigger>
                                            <button className="flex flex-row w-[44px] items-center rounded-md transition duration-200 ease-in-out justify-between">
                                                <Image
                                                    ...
                                                    size={24}
                                                    onClick={() => handleImageClick('/icons/idea-2.svg')}
                                                />
                                                <Image
                                        ...
                                        <PopoverContent>
                                            <div className="py-1 w-[56px] border border-solid border-[#EAECF0] bg-[#FFFFFF] rounded-md flex flex-col shadow-lg">
                                                ...
                                                <button
                                                    className="flex flex-row h-[40px] w-full p-1 hover:bg-[#F2F4F7] justify-center items-center"
                                                    onClick={() => handleImageClick('/icons/megaphone.svg')}
                                                >
                                                    <Image
                                                ...
                                                <button
                                                    className="flex flex-row h-[40px] w-full p-1 hover:bg-[#F2F4F7] justify-center items-center"
                                                    onClick={() => handleImageClick('/icons/read-2.svg')}
                                                >
                                                    <Image
                                        ...
                                        {activeImage && (
                                            <div className="fixed top-0 left-0 w-screen h-screen bg-gray-800 flex justify-center items-center">
                                                <img src={activeImage} alt="Showcase" className="max-w-[400px] max-h-[400px]" />
                                            </div>
                                        )}
                                    </Popover>
