        ...
        <div className="flex flex-col w-full pt-4 gap-4">
            <div className="flex flex-row justify-between items-center">
                ...
                <div className="flex flex-row gap-3">
                    ...
                    >
                        <PopoverTrigger>
                            <button className="h-[44px] w-[105px] rounded-md bg-[#FFFFFF] border border-solid border-[#D0D5DD] outline-none flex items-center justify-center gap-2">
                        ...
                        <PopoverContent className="w-[10.875rem] items-start py-2 px-0 h-auto gap-1 border border-lightGrey rounded-md shadow-[0_12px_16px_-4px_rgba(16,24,40,0.08)]">
                            <div className="flex flex-col w-full ">

                                <button className="flex flex-row w-full gap-2  items-center  hover:bg-neutral-100 h-10 px-2"
                                    onClick={() => { setIsPopoverOpen(false); }}>
                                    <Checkbox color="primary" onClick={() => { setIsPopoverOpen(false); }} />
