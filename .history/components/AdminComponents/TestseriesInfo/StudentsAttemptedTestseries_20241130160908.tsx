    ...
    return (
        <div className="flex flex-col w-full pt-4 gap-4">
            <div className="flex flex-row justify-between items-center">
                <button className="h-[44px] w-[250px] rounded-md bg-[#FFFFFF] shadow-md border border-solid border-[#D0D5DD] flex items-center">
                            ...
                            <div className="flex flex-row justify-between gap-4">
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        ...
                                        setPopoveropen(false); // Close after adding
                                    }}
                                >
                                    Add
                                </button>
