                ...
                <div className=" bg-[#F7F8FB] w-full border border-solid border-[#EAECF0] rounded-[12px] h-auto">
                    <div className="bg-[#F7F8FB] border-b border-solid border-b-[#EAECF0] rounded-tl-[12px] rounded-tr-[12px]">
                        <ReactQuill
                            ...
                            className="text-[#1D2939] focus:outline-none rounded-b-[12px] custom-quill placeholder:flex items-center placeholder:not-italic min-h-[66px] max-h-[350px] overflow-y-auto border-none font-normal"
