            ...
            <div className={styles.tabs}>
                ...
                <div className={styles.tooltip}>
                    <button
                        ...
                        className={`flex flex-row w-full rounded-md py-2 px-3 ${activeTab === 'marketingintegration' ? 'bg-[#7400E0]' : 'hover:bg-[#e1ffe11a]'}`}
                    >
                        <Image className='mr-2' src={activeTab === '' ? "/icons/admin-learn.svg" : "/icons/admin-learn-2.svg"} width={22} height={22} alt="marketingintegration Icon" />
                        {!isCollapsed && <p className={`${activeTab === 'marketingintegration' ? 'text-white' : 'text-[#AAAAAA]'}`}>Learn CMS</p>}
                    </button>
