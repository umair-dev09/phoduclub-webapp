        ...
        <div className="pb-4 h-auto">
            {questionsList.map((question, index) => (
                <div key={index} className="rounded-md border border-solid border-[#EAECF0] mt-4 h-auto bg-[#FFFFFF]">
                    <Collapsible
                        className={`${data ? "border border-red-500 rounded-md" : "border border-solid border-[#EAECF0] rounded-md"}`}
                        trigger={
                                ...
                                <div
                                    ...
                                    <div className="bg-[#FFFFFF] ">
                                        <ReactQuill
                                            ...
                                            onChange={(content) => { handleQuillChange(index, 'question', content); setData(true); }}
                                            modules={modules}
