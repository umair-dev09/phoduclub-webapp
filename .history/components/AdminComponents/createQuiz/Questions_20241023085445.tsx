        ...
        <div className="pb-4 h-auto ">
            {questionsList.map((q, index) => (
                <Collapsible className=""
                    key={index}
                    trigger={
                        <div className='mt-2 h-auto rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col px-5 gap-2 '>
                            <div className="h-auto flex flex-row justify-between">
                                <div className="flex gap-2">
                ...
                >
                    <div className=' h-auto rounded-md  bg-[#FFFFFF] flex flex-col p-5 gap-2 mb-5'>
                        <div className="flex flex-col gap-2">
                            <span className="font-semibold text-base text-[#1D2939]">Questions</span>
                            <input
