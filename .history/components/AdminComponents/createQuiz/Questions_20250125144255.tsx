    ...
    return (
        <div className="pb-4 h-auto">
            {questionsList.map((question, index) => (
                <div key={index} className={` ${visited[index] && isDataMissing(question) ? "border-1.5 border-[#F04438]" : "border-[#EAECF0]"} rounded-md   mt-4 h-auto bg-[#FFFFFF]  ${openIndex === index ? "border-[#F04438]" : ""}`}>
