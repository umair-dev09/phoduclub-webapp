                    ...
                    >
                        <div className='h-auto bg-[#FFFFFF] flex flex-col pb-5 px-5 gap-2 rounded-br-md rounded-bl-md'>
                            <div className="flex flex-col gap-2">
                                ...
                                {/* Quill 1 */}
                                <div
                                    className={`pt-2 bg-[#FFFFFF] border ${isWriting
                                ...
                                >
                                    <div className="bg-[#FFFFFF]">
                                        <ReactQuill
                                            ...
                                            onChange={(value) => handleInputChange(index, value, 'question')}
                                        ...
                                        <div className="flex flex-row w-full justify-between items-center mx-5">
                                            <div className="h-[24px] w-[288px] gap-[24px] flex flex-row">
                                                ...
                                                <Popover placement="bottom-start">
                                                    ...
                                                    <PopoverContent className="flex flex-row bg-white rounded-[8px] border border-[#EAECF0] p-2 w-[120px] shadow-[0_2px_4px_#EAECF0] gap-2">
                                                ...
                                                <button onClick={() => handleIconClick('image')} className="hover:bg-[#EAECF0]">
