            ...
            <div className='mt-2 h-auto rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col p-5 gap-2 mb-5'>
                <div className="h-auto  flex flex-row justify-between ">
                    ...
                    <Popover placement="right">
                        ...
                        <PopoverContent>
                            <div className="h-[88px] w-[167px] border border-solid border-[#EAECF0] bg-[#FFFFFF] rounded-md  shadow-[0px_0px_0px_4px_rgba(158,119,237,0.25),0px_1px_2px_0px_rgba(16,24,40,0.05)] flex flex-col">
                                <div className="flex flex-row h-[40px] w-full p-5 gap-3">
