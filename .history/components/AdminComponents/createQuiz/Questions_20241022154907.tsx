    ...
    return (
        <div className='mt-2 h-auto rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col p-5 gap-2 mb-3'>
            ...
            <Popover placement="top">
                ...
                <PopoverContent>
                    <div className="w-[832px]  h-[168px] rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF]  flex flex-col pt-[8px]"
                        style={{
                            boxShadow: '0px 4px 6px -2px rgba(16, 24, 40, 0.05), 0px 12px 16px -4px rgba(16, 24, 40, 0.08)',
                        }}>
                        <div className="flex flex-row justify-between w-full h-[40px] items-center hover:bg-[#F2F4F7] px-2">
                            <span className="font-normal text-[#0C111D] text-sm">A. 1000</span>
                            <Image
                        ...
                        <div className="flex flex-row justify-between w-full h-[40px] items-center hover:bg-[#F2F4F7] px-2">
                            <span className="font-normal text-[#0C111D] text-sm">B. 2000</span>
                            <Image
                                src="/icons/tick-02.svg"
                                width={18}
                                height={18}
                        ...
                        <div className="flex flex-row justify-between w-full h-[40px] items-center hover:bg-[#F2F4F7] px-2">
                            <span className="font-normal text-[#0C111D] text-sm">C. 3000</span>
                            <Image
                                src="/icons/tick-02.svg"
                                width={18}
                                height={18}
                        ...
                        <div className="flex flex-row justify-between w-full h-[40px] items-center hover:bg-[#F2F4F7] px-2 rounded-bl-md rounded-br-md">
                            <span className="font-normal text-[#0C111D] text-sm">D. 4000</span>
                            <Image
                                src="/icons/tick-02.svg"
                                width={18}
                                height={18}
