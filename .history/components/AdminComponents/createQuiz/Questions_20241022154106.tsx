    ...
    return (
        <div className='mt-2 h-auto rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col p-5 gap-2 mb-3'>
            ...
            <Popover placement="top">
                <PopoverTrigger>
                    <button className="h-[40px] px-3 items-center w-[700px] justify-between flex flex-row border border-solid border-[#D0D5DD] bg-[#FFFFFF] rounded-md">
                ...
                <PopoverContent>
                    <div className="w-full h-[168px] rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF]  flex flex-col pt-[8px]"
                        style={{
                            boxShadow: '0px 4px 6px -2px rgba(16, 24, 40, 0.05), 0px 12px 16px -4px rgba(16, 24, 40, 0.08)',
                        }}>
                        <div className="flex flex-row justify-between w-full h-[40px] items-center hover:bg-[#F2F4F7]">
                            <span className="font-normal text-[#0C111D] text-sm">A. 1000</span>
                            <Image
                                src="/icons/tickmark1.svg"
                                width={18}
                                height={18}
                                alt="right mark" />
