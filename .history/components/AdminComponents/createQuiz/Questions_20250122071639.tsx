    ...
    return (
        <div className="pb-4 h-auto">
            {questionsList.map((question, index) => (
                <div key={index} className={` ${isDataMissing(question) ? "border-red-500" : "border-[#EAECF0]"}"rounded-md border  mt-4 h-auto bg-[#FFFFFF]"}`}>
                    <Collapsible
                        className={`border border-lightGrey rounded-md ${isDataMissing(question) ? "border-red-500" : "border-[#EAECF0]"}`}
                        trigger={
