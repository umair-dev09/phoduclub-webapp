...
//                 <PopoverTrigger>
//                     <button
//                         className={`h-[40px] px-3 items-center w-full justify-between flex flex-row rounded-md 
//                         border border-solid ${activeQuestionIndex !== null ? 'border-[#D6BBFB]' : 'border-[#D0D5DD]'} 
//                         bg-[#FFFFFF] ${activeQuestionIndex !== null ? 'shadow-[0px_0px_0px_4px_rgba(158,119,237,0.25),0px_1px_2px_0px_rgba(16,24,40,0.05)]' : ''}`}
//                         onClick={() => handlePopoverToggle(0)} // Adjust index accordingly
//                     >
...
//                             <div
//                                 key={index}
//                                 className={flex flex-row justify-between w-full h-[40px] items-center hover:bg-[#F2F4F7] px-2 ${index === Object.entries(options).length - 1 ? 'rounded-bl-md rounded-br-md' : ''}}
//                                 onMouseEnter={() => setHoveredIndex(index)}
//                                 onMouseLeave={() => setHoveredIndex(null)}
//                             >
//                                 <span className="font-normal text-[#0C111D] text-sm">{value || Option ${key}}</span>
                ...
                <div key={index} className="rounded-md border border-solid border-[#EAECF0] mt-4 h-auto bg-[#FFFFFF]">
                    ...
                    >
                        <div className='h-auto bg-[#FFFFFF] flex flex-col pb-5 px-5 gap-2 rounded-br-md rounded-bl-md'>
                            ...
                            <Popover placement="bottom">
                                <PopoverTrigger>
                                    <button className="h-[40px] px-3 items-center w-full justify-between flex flex-row rounded-md border border-solid border-[#D0D5DD]">
                                        ...
                                        {(Object.keys(question.options) as Array<keyof Options>).map((optionKey) => (
                                            ...
                                            >
                                                <span className="font-normal text-[#0C111D] text-sm">
                                                    {question.options[optionKey] || `Option ${optionKey}`}
                                                </span>
