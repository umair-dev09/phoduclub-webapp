            ...
            <div className="flex   flex-col h-[503px] w-[598px]">
                ...
                <div className="p-5 gap-5 flex flex-col w-full rounded-md h-[334px] bg-[#FFFFFF] ">
                    ...
                    <div className="h-[62px] w-full rounded-md bg-[#F2F4F7]">
                        <span className="text-[#475467] font-normal text-[13px] py-2 px-3 italic">This quiz will be available for 2 hours, starting from January 6th, 2024, 5:30 PM, and ending at 7:30 PM.</span>
