        ...
        <div className='mt-2 h-auto rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col p-5 gap-2'>
            ...
            <div className="flex flex-col gap-3">
                <div className="flex flex-row">
                    <div className="h-8 w-8 bg-[#F9FAFB] border border-solid border-[#F9FAFB] rounded-[6px]">
                        <span className="text-[#475467] text-sm font-medium flex justify-center items-center">A</span>
