                ...
                <div
                    ...
                    <div className="bg-[#FFFFFF] ">
                        <ReactQuill
                            ...
                            placeholder="Description"
                            className=" text-[#1D2939] focus:outline-none rounded-b-[12px] custom-quill placeholder:not-italic min-h-[10px] max-h-[150px] mb-7 overflow-y-auto  border-none font-normal"
                        />
                    </div>
