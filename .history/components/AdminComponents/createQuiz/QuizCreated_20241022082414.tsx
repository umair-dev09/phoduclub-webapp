            ...
            <div className="flex   flex-col h-[503px] w-[598px]">
                ...
                <div className="p-5 gap-5 flex flex-col w-full rounded-md h-[334px] bg-[#FFFFFF] ">
                    ...
                    <div className="h-[48px]  w-full flex flex-row gap-[23px]">
                        <div className="flex flex-col justify-between h-full w-[98px]">
                        ...
                        <div className="w-[35px] h-0 border-l border-[#EAECF0] opacity-0 rotate-90"></div>


                        <div className="flex flex-col justify-between h-full w-[113px]">
                        ...
                        <div className="flex flex-col justify-between h-full w-[134px]">
                            <span className="text-sm font-normal text-[#667085] flex justify-center">Marks Per Question</span>
                            <span className="text-lg font-semibold text-[#1D2939]">
                                3</span>
