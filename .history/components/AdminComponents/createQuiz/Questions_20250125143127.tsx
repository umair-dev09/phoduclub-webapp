            ...
            {questionsList.map((question, index) => (
                <div key={index} className="border-lightGrey rounded-md  mt-4 h-auto bg-[#FFFFFF] ">
                    ...
                    <Collapsible
                        ...
                        trigger={
                            <div className='h-auto bg-[#FFFFFF] flex flex-col p-5 gap-2 rounded-md  border-b border-r border-l border-lightGrey'>
                    ...
                    >
                        <div className='h-auto bg-[#FFFFFF] border border-lightGrey flex flex-col pb-5 px-5 gap-2 rounded-br-md rounded-bl-md'>
