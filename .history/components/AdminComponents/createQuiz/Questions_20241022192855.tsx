...
function Questions() {
    ...
    const handleClick = (index: number) => {
        const newQuestionsList = [...questionsList];
        newQuestionsList[index].isActive = !newQuestionsList[index].isActive; // Toggle isActive for the specific question
        setQuestionsList(newQuestionsList); // Update the questionsList state
    };
