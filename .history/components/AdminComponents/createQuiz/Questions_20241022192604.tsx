...
function Questions() {
    ...
    const handleClick = (index: number) => {
        const newQuestionsList = questionsList.map((question, i) => ({
            ...question,
            isActive: i === index ? !question.isActive : false, // Toggle isActive for the clicked question, deactivate others
        }));
        setQuestionsList(newQuestionsList);
    }
