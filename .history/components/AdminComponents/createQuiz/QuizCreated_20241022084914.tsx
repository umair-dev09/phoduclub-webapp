                    ...
                    <div className=" flex flex-col">
                        ...
                        <div className="p-1 flex flex-col">
                            <div className="flex items-center">
                                <span className="w-[2px] h-[2px] bg-[#1D2939] rounded-full mr-2"></span>
                                <span className="text-[#1D2939] text-[16px] font-normal">This quiz contains - 10 Questions</span>
                            </div>
                            <div className="flex items-center">
                                <span className="w-2 h-2 bg-[#1D2939] rounded-full mr-2"></span>
                                <span className="text-[#1D2939] text-[16px] font-normal">Each question will be of 3 Marks</span>
                            </div>
                            <div className="flex items-center">
                                <span className="w-2 h-2 bg-[#1D2939] rounded-full mr-2"></span>
                                <span className="text-[#1D2939] text-[16px] font-normal">There’s negative marking (-1) for each wrong</span>
                            </div>
                        </div>
