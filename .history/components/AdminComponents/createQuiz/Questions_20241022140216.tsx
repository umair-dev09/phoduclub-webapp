    ...
    return (
        <div className='mt-2 h-auto rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col p-5 gap-2'>
            ...
            <div className="flex flex-row gap-2">
                ...
                <input type="checkbox" className="w-4 h-4 appearance-none bg-[#9012FF] border border-[#9012FF] rounded-[4px] cursor-pointer checked:bg-[#9012FF] checked:border-[#9012FF] checked:text-white checked:checkmark" />
