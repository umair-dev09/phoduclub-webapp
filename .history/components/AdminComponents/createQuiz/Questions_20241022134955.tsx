        ...
        <div className='mt-2 h-auto rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col p-5 gap-2'>
            ...
            <div className="flex flex-row gap-2">
                ...
                <Checkbox
                    ...
                    sx={{
                        '& .MuiSvgIcon-root': {
                            fontSize: 28, // Correct property for icon size
                        },
                        color: '#9012FF', // Default color for the unchecked state (icon color)
                        borderRadius: '4px',
                        width: 16, // Width in px
                        height: 16, // Height in px
                        '&.Mui-checked': {
                            color: 'white', // Color of the checkmark when checked
                        },
                        '&.Mui-checked .MuiSvgIcon-root': {
                            backgroundColor: '#FF00FF', // Pinkish background for checked state
                            borderRadius: '50%', // Optional: for rounded background shape
                        },
                    }}
                />
