                ...
                <div className="p-5 gap-5 flex flex-col w-full rounded-md h-[334px] bg-[#FFFFFF] ">
                    ...
                    <div className="h-[48px]  w-full flex flex-row">
                        <div className="flex felx-col">
                            <span className=" text-[#667085] text-sm font-normal">Time Duration</span>

                            <span className="text-lg font-semibold text-[#1D2939]">10:00<span className="text-sm font-semibold text-[#1D2939]"></span >Min</span>
                        </div>
