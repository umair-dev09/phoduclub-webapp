            ...
            <div className='mt-2 h-auto rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col p-5 gap-2 mb-5'>
                <div className="h-auto  flex flex-row justify-between ">
                    ...
                    <Popover placement="right">
                        ...
                        <PopoverContent>
                            <div className="h-[88px] w-[167px] border border-solid border-[#EAECF0] bg-[#FFFFFF] hover:bg-[#F2F4F7] rounded-md  flex flex-col py-[8px]">
                                <button className="flex flex-row h-[40px] w-full px-5 gap-3 hover:bg-[#F2F4F7]">
                                    ...
                                    <Image
                                        ...
                                        alt="Duplicate"
                                    />
                                    <span className="text-[#0C111D] text-sm font-normal">Duplicate</span>



                                </button>
                                <button className="flex flex-row h-[40px] w-full p-5 gap-3 hover:bg-[#F2F4F7]">
                ...
                <Popover placement="bottom">
                    <PopoverTrigger>
                        <button
                            className={`h-[40px] px-3 items-center w-full justify-between flex flex-row rounded-md popover border-none
