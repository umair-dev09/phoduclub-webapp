        ...
        <div className="h- full w-full flex  justify-center mt-10">
            <div className="flex   flex-col h-auto w-[598px]">
                ...
                <div className="p-5 gap-5 flex flex-col w-full rounded-md h-auto bg-[#FFFFFF] border border-solid border-[#EAECF0]">
                    ...
                    <div className="h-auto w-full rounded-md bg-[#F2F4F7] p-4">

                        <div className="text-[#475467] font-normal text-sm italic ">This quiz will be available for 2 hours, starting from January 6th, 2024, 5:30 PM, and ending at 7:30 PM.</div>
