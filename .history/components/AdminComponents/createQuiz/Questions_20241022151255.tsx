...
function Questions() {
    ...
    return (
        <div className='mt-2 h-auto rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col p-5 gap-2 mb-3'>
            ...
            <div className="h-[40px]  w-full px-2 justify-between flex flex-row border border-solid border-[#D0D5DD] bg-[#FFFFFF] rounded-md">
                <span className="font-normal text-sm text-[#667085] flex justify-center">Select correct answer</span>
                <Image
