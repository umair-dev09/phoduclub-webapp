    ...
    return (
        <div className='mt-2 h-auto rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col p-5 gap-2 mb-3'>
            ...
            <Popover placement="top">
                ...
                <PopoverContent>
                    <div
                        className="w-[832px] h-[168px] rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col pt-[8px]"
                        style={{
                    ...
                    >
                        {options.map((item, index) => (
                            <div
                                key={index}
                                className="flex flex-row justify-between w-full h-[40px] items-center hover:bg-[#F2F4F7] px-2"
