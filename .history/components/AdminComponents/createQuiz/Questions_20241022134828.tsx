            ...
            <div className="flex flex-row gap-2">
                ...
                <Checkbox
                    ...
                    sx={{
                        ...
                        color: '#9012FF', // Color in hexadecimal
                        borderRadius: '4px', // Use camelCase for properties, and correct spelling (radius)
                        width: 16,        // Width in number (px assumed)
                        height: 16,       // Height in number (px assumed)
                        '& .Mui-checked': {
