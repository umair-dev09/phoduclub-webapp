...
function Questions() {
    ...
    const handlePopoverOpenChange = (isOpen: boolean) => {
        setIsActive(isOpen); // Set isActive based on popover open state
    };
    ...
    return (
        <div className='mt-2 h-auto rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col p-5 gap-2 mb-3'>
            ...
            <Popover placement="bottom" onOpenChange={handlePopoverOpenChange}>
                <PopoverTrigger>
                    <button
                        className={`h-[40px] px-3 items-center w-full justify-between flex flex-row rounded-md border-[#D0D5DD]
                        border border-solid ${isActive ? 'border-[#D0D5DD]' : 'border-[#D6BBFB]'} 
