...
function Questions() {
    ...
    return (
        <div className="pb-4 h-auto ">
            {questionsList.map((q, index) => (
                <div className="rounded-md border border-solid border-[#EAECF0] mt-2 mb-5 ">
                    <Collapsible
                        key={index}
                        trigger={
                            <div className='h-auto  bg-[#FFFFFF] flex flex-col p-5 gap-2 rounded-bl-md rounded-br-md'>
                                <div className="h-auto flex flex-row justify-between">
                                    <div className="flex gap-2">
