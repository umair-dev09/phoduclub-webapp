...
function Questions() {
    ...
    const OptionList = () => {
        ...
        const swapOptions = (index1: string | number, index2: string | number) => {
                        ...
                        {options.map((option, index) => (
                            <div className="flex flex-row gap-2" key={index}>
                                ...
                                <Image
                                    ...
                                    alt="Three-dots"
                                    onClick={() => {
                                        // Swap with the next option (loop back to start if at the end)
                                        swapOptions(index, (index + 1) % options.length);
                                    }}
                                />
                                <input
