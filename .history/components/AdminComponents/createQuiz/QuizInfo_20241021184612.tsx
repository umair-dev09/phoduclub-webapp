    ...
    return (
        <div className='mt-2 h-auto rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col p-5 gap-2'>
            ...
            {/* <div className=' flex flex-col gap-1 pt-2'>
                <span className='text-[#1D2939] text-sm font-medium'>Description</span>
                <input
                    className="font-normal pl-3 text-[#667085] text-sm placeholder:text-[#A1A1A1] rounded-md 
                        focus:outline-none focus:ring-0 
                        border border-solid border-[#D0D5DD] h-[40px] 
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="pt-2 bg-[#FFFFFF] border border-solid border-[#EAECF0] rounded-[12px] h-auto ">
                    ...
                    <div className="flex flex-col gap-1">
                        <span className="text-[#1D2939] text-sm font-medium">Quiz Name</span>
                        <input
                            className={`font-normal pl-3 text-sm placeholder:text-[#A1A1A1] rounded-md h-[40px] transition-all duration-200 
                        ${isFocused ? "text-[#101828] border border-[#D6BBFB] shadow-[0px_0px_0px_4px_rgba(158,119,237,0.25),0px_1px_2px_0px_rgba(16,24,40,0.05)]" :
                                    "text-[#667085] border border-solid border-[#D0D5DD] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]"}`}
