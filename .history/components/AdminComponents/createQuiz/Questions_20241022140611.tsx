...
function Questions() {
    ...
    return (
        <div className='mt-2 h-auto rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col p-5 gap-2'>
            ...
            <div className="relative h-[148px] rounded-xl bg-[#F9FAFB] border border-solid border-[#EAECF0]">
                <div className="absolute inset-0 rounded-xl border-2 border-[#F9FAFB] border-t-0 border-l-0"></div>
            </div>
