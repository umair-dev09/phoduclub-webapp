    ...
    return (
        <>
            <div className="flex flex-row mt-3 w-full h-[40px] justify-between items-center">
                ...
                <button className="text-sm font-semibold text-[#7400E0] hover:bg-[#EAECF0] hover:rounded-full px-3 py-1 transition duration-200 ease-in-out">
                    <button className="flex flex-row gap-1 h-[30px] items-center hover:rounded-full px-2" onClick={toggleExpandAll}>
                        {areAllExpanded ? (
