    ...
    return (
        <>
            <div className="flex flex-row mt-3 w-full h-[40px] justify-between items-center">
                ...
                <button className="text-sm font-semibold text-[#7400E0] hover:bg-[#F5F0FF] hover:rounded-full px-3 py-1 transition duration-200 ease-in-out">
                    <button className="flex flex-row gap-1 h-[25px] items-center px-2" onClick={toggleExpandAll}>
                        {areAllExpanded ? (
