            ...
            <ModalContent>
                <>
                    ...
                    <ModalFooter className="border-t border-lightGrey">
                        <Button variant="light" className="py-[0.625rem] px-6 border-[1.5px] border-lightGrey font-semibold rounded-md hover:bg-[#F2F4F7]" onClick={onclose}>Cancel</Button>
                        <Button className="py-[0.625rem] px-6 text-white shadow-inner-button  font-semibold bg-[#BB241A] border border-[#DE3024] hover:bg-[#B0201A] rounded-md" onClick={handleLogout}>Log out</Button>
                    </ModalFooter>
                </>
            </ModalContent>
        </Modal >
