                    ...
                    <div className="flex flex-col relative gap-6">
                        ...
                        <div className="flex flex-row w-full gap-4">
                            ...
                            <div className="flex flex-col gap-1 w-1/2 flex-grow">
                                ...
                                <input
                                    className="w-full text-sm font-medium text-[#1D2939] placeholder:font-normal placeholder:text-[#A1A1A1] hover:shadow-red-500 rounded-md outline-none border border-solid border-[#D0D5DD] py-2 px-4 focus:outline focus:outline-[1.5px] focus:outline-[#D6BBFB] hover:outline hover:outline-[1.5px] hover:outline-[#D6BBFB]"
                                    type="text"
