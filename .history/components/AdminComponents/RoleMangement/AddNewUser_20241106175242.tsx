...
const addnewuser: React.FC<addnewuser> = ({ open, close }) => {
                    ...
                    <div className="flex flex-col relative gap-6">
                        ...
                        <div className="flex flex-col gap-1 w-full ">
                            ...
                            <Popover placement="bottom">
                                ...
                                <PopoverContent>
                                    <div className="w-[450px] py-1 bg-white border border-lightGrey rounded-md">
                                        <button className="flex flex-row items-center justify-start w-full py-[0.625rem] px-4 gap-2 hover:bg-[#F2F4F7]">

                                            <span className="text-sm text-[#0C111D] font-normal">Admin</span>
                                        </button>
                                        <button className=" flex flex-row items-center justify-start w-full py-[0.625rem] px-4 gap-2 hover:bg-[#F2F4F7]"
                                        >
                                            <p className="text-sm text-[#0C111D] font-normal">Teacher</p>
                                        </button>
                                        <button className="flex flex-row items-center justify-start w-full py-[0.625rem] px-4 gap-2 hover:bg-[#F2F4F7]">

                                            <span className="text-sm text-[#0C111D] font-normal">Customer Care</span>
                                        </button>
                                        <button className="flex flex-row items-center justify-start w-full py-[0.625rem] px-4 gap-2 hover:bg-[#F2F4F7]">
                                            <span className="text-sm text-[#0C111D] font-normal">Guide</span>
                                        </button>
                                        <button className="flex flex-row items-center justify-start w-full py-[0.625rem] px-4 gap-2 hover:bg-[#F2F4F7]">

                                            <span className="text-sm text-[#0C111D] font-normal">Editor</span>
                                        </button>
                                        <button className="flex flex-row items-center justify-start w-full py-[0.625rem] px-4 gap-2 hover:bg-[#F2F4F7]">

                                            <span className="text-sm text-[#0C111D] font-normal">Chief Moderator</span>
                                        </button>
                                    </div>
                                </PopoverContent>
                            </Popover>
