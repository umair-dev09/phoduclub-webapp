...
function CourseContent({ courseId }: CourseContentProps) {
    ...
    const [sectionScheduleTime, setSectionScheduleTime] = useState<string | null>(null);
                                    ...
                                    <PopoverContent className="flex flex-col bg-white border border-lightGrey rounded-xl w-auto shadow-md">
                                        <div className="flex flex-col gap-4 p-4">
                                            ...
                                            <div className="rounded-lg">
                                                <Calendar
                                                    onChange={(date) => {
                                                        ...
                                                        setSectionScheduleDate(dateString); // Store the selected date
                                                    }}
                                            ...
                                            <div className="rounded-lg">
                                                <TimeInput
                                                    label="Event Time"
                                                    value={sectionScheduleTime} // Bind to the state for time
                                                    onChange={(time) => setSectionScheduleTime(time)} // Update the state with selected time
                                                />
                                            </div>
                                        </div>
                                    </PopoverContent>
