                ...
                <ModalContent>
                    <>
                        ...
                        <ModalFooter className="border-t border-lightGrey">
                            ...
                            <Button className="py-[0.625rem] px-6 text-white font-semibold shadow-inner-button   hover:bg-[#B0201A] bg-[#BB241A]'} border border-white rounded-md" onClick={() => handleDeleteSection(section.sectionId)}  >Delete User</Button>
                        </ModalFooter>
                    </>
                </ModalContent>
            </Modal >
