            ...
            >
                ...
                <div className="flex flex-col h-full"> {/* Change 1: Wrap everything in a flex column container */}
                    ...
                    <div className="flex justify-center">
                        <div className="h-auto p-6 gap-4  rounded-md w-[684px] flex flex-col">
                        ...
                        transition duration-200 ease-in-out "
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <input
                                    className="font-normal pl-3 mt-5 text-[#1D2939] text-sm placeholder:text-[#A1A1A1] rounded-md placeholder:font-normal min-h-[80px] max-h-[150px] overflow-y-auto 
                        focus:outline-none focus:ring-0 
