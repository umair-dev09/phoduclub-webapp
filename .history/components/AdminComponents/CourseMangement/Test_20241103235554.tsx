        ...
        <div>
            ...
            >
                ...
                <div className="flex flex-col h-full"> {/* Change 1: Wrap everything in a flex column container */}
                    ...
                    <div className="flex justify-center h-auto overflow-y-auto p-6">
                        <div className="h-auto gap-4  rounded-md w-[684px] flex flex-col">
                            ...
                            <div className="flex flex-row justify-between border border-solid border-[#EAECF0] h-[49px] bg-[#F9FAFB] rounded-md items-center px-4">
