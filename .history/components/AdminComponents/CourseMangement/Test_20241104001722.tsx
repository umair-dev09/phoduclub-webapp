                ...
                <div className="flex flex-col h-full pb-6"> {/* Change 1: Wrap everything in a flex column container */}
                    ...
                    <div className="flex justify-center h-auto overflow-y-auto ">
                        <div className="h-auto gap-4 p-6 rounded-md w-[684px] flex flex-col">
                            ...
                            <div className="flex flex-col gap-2">
                                <span className='text-[#1D2939] text-sm font-semibold '>Overview</span>
                                <input
                            ...
                            <div className=" flex flex-col gap-2">
                                ...
                                <div className="border border-solid border-[#EAECF0] rounded-md h-[58px] flex flex-row justify-between items-center p-4">
                                    <div className="flex flex-row gap-2">
                                        <Image src='/icons/pdf-icon.svg' alt="PDF" width={42} height={42} />
                                        <span className="text-[#1D2939] font-normal text-sm flex items-center">chapter 01.pdf</span>
                                    </div>
