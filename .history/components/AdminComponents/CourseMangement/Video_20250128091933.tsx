...
import CourseVideoPlayer from "@/components/DashboardComponents/LearnComponents/CourseComponents/InsideCoursesComp/VideoComp/CourseVideoPlayer"
...
function Video({ isOpen, toggleDrawer, sectionId, courseId, isEditing, contentId }: VideoProps) {
    ...
    return (
        <div>
            ...
            <CourseVideoPlayer videoData={videoData} />
        </div>
    )
}
