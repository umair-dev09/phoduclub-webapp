                        ...
                        <div className="flex flex-col relative gap-6">
                            ...
                            <div className="flex flex-col w-full gap-2 px-6 mb-2">
                                ...
                                <div className="flex flex-row justify-between items-center">
                                    ...
                                    {isSectionEditing ?
                                        <button className="w-[150px] h-[30px]  rounded-full flex items-center justify-center transition-all duration-300 ease-in-out hover:bg-[#F2F4F7]">
                                            <button onClick={() => setShowDatepicker(true)}>
                                                <p className="text-sm">{formatScheduleDate(sectionScheduleDate) || " "}</p>
                                            </button>
                                        </button>
                                        : ""
