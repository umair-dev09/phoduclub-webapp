                ...
                <div className="flex flex-col justify-between">
                    ...
                    <div className='flex flex-row  text-xs'>
                        <div className='flex flex-row'>
                            ...
                            <div className='mr-3 font-normal text-base text-[#1D2939]'>3 Lessons</div>
                        </div>
                        <div className='flex flex-row'>
                            <div className='mr-2'>
                                <Image src="/icons/vedio.svg" alt="video-icon" width={20} height={20} />
                            </div>
                            <div className='mr-3 font-normal text-base text-[#1D2939]'>4 Videos</div>
                        </div>
                        <div className='flex flex-row'>
                            <div className='mr-2'>
                                <Image src="/icons/test.svg" alt="test-icon" width={20} height={20} />
                            </div>
                            <div className='mr-3 font-normal text-base text-[#1D2939]'>2 Tests</div>
                        </div>
                    </div>
