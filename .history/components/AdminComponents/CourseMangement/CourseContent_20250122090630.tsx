                                        ...
                                        <tr key={content.contentId} className="border-t border-solid border-[#EAECF0]">
                                            ...
                                            <td className="flex items-center justify-center px-8 py-4 text-[#101828] text-sm">
                                                <Popover placement="bottom-end"
                                                    isOpen={popoveropen4}
                                                    onOpenChange={(open) => setPopoveropen4(open)}>
                                                    <PopoverTrigger>
                                                        <button
                                                            onClick={() => setPopoveropen4(!popoveropen4)}>
                                                            <Image
                                                        ...
                                                        <div >
                                                            <button className="flex flex-row items-center justify-start w-full py-2 gap-2 hover:bg-[#F2F4F7] pl-4 pr-9"
                                                                onClick={() => {
                                                                    ...
                                                                    setPassedSectionId(section.sectionId); setIsContentEditing(true); setContentId(content.contentId); setPopoveropen4(false);
                                                                }} >
                                                            ...
                                                            <button className=" flex flex-row items-center justify-start w-full py-2 gap-2 hover:bg-[#FEE4E2] pl-4 pr-9"
                                                                onClick={() => { handleDeleteContent(section.sectionId, content.contentId); setPopoveropen4(false); }}>
