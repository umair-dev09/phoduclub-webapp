...
function CourseContent({ courseId }: CourseContentProps) {
    ...
    useEffect(() => {
        const handleKeyDown = (event: KeyboardEvent) => {
            if (event.key === "Enter" && deletedialog) {
    ...
    }, [deletedialog, sectionToDelete, contentToDelete, handleDeleteSection, handleDeleteContent]);


    useEffect(() => {
        const handleKeyDown = (event: KeyboardEvent) => {
            if (event.key === "Enter" && isCreateSectionFilled) {
                handleAddSection();
            }
        };
    ...
    }, [openSectionDialog, isCreateSectionFilled]);
