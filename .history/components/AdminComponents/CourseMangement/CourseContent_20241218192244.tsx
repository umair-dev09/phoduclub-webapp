...
function CourseContent({ courseId }: CourseContentProps) {
    ...
    const [selectedDate, setSelectedDate] = useState<Date>(today(getLocalTimeZone())); // Use Date type here
    const [selectedTime, setSelectedTime] = useState<{ hour: number; minute: number } | null>(null); // Time object with hour and minute
                                        ...
                                        <div className="flex flex-col gap-4 p-4">
                                            ...
                                            <div className="rounded-lg">
                                                <TimeInput
                                                    label="Event Time"
                                                    value={selectedTime}
                                                    onChange={handleTimeChange} // Handle time change here
