...
function CourseContent() {
    ...
    const handleCreateSection = () => {
        setShowAddSectionButton(true); // Show "Add Section" button and "Course Content"
    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex flex-row justify-between h-16">
                ...
                {/* Conditionally Render Add Section Button */}
                {showAddSectionButton && (
                    <button className="flex flex-row gap-1 items-center rounded-md border-[2px] border-solid border-[#9012FF] bg-[#FFFFFF] h-[44px] w-[162px] justify-center">
            ...
            {/* Conditionally Render Creating Section/Content */}
            {!isCreateSection && (
                <div className="bg-[#FFFFFF] h-[184px] p-6 items-center flex flex-col gap-2 rounded-[16px] border border-solid border-[#EAECF0]">
                    ...
                    <div className="flex flex-row gap-4 mt-2">
                        <button onClick={openCreateSection} className="flex flex-row gap-1 items-center rounded-md border-[2px] border-solid border-[#9012FF] h-[44px] w-[162px] justify-center">
                            <Image src="/icons/plus-sign.svg" height={18} width={18} alt="Plus Sign" />
                            <span className="text-[#9012FF] font-semibold text-sm">Add Section</span>
                        </button>
            ...
            {showAddSectionButton && (
                <div className="bg-[#FFFFFF] h-auto items-center flex flex-col rounded-[16px] border border-solid border-[#EAECF0]">
                    <div className="flex flex-row justify-between items-center p-4 w-full border-b border-solid border-[#EAECF0]">
                        ...
                        <button
                            className="w-10 p-[10px] h-[40px] gap-1 flex-row flex bg-[#FFFFFF] rounded-md shadow-none"
                            style={{ outline: "none" }}
                        >
                    ...
                    <DialogPanel className="bg-white rounded-2xl w-[559px] h-auto">
                        <div className="flex flex-col relative gap-6">
                            ...
                            <div className="flex flex-row justify-end mx-6 my-2 items-center gap-4">
                                ...
                                <button onClick={handleCreateSection} className="py-[0.625rem] px-6 text-white shadow-inner-button bg-[#9012FF] border border-[#8501FF] rounded-md font-semibold text-sm">
                                    Create Section
                                </button>
                            </div>
                        </div>
