                    ...
                    <DialogPanel className="bg-white rounded-2xl w-[559px] h-auto">
                        <div className="flex flex-col relative gap-6">
                            ...
                            <div className="flex flex-col w-full gap-1 px-6">
                                ...
                                <div className="flex flex-row w-full h-10 px-3 outline-none border border-lightGrey hover:outline hover:outline-[1.5px] hover:outline-[#D6BBFB]  focus-within:border-[#D7BBFC] focus-within:ring-4 focus-within:ring-[#E8DEFB] focus-within:outline-none transition-colors  focus:outline focus:outline-[1.5px] focus:outline-[#D6BBFB] rounded-md">
                                    <input
                                        type="text"
