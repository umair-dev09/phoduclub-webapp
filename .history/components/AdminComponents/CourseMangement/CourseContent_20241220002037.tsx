                                ...
                                {isSectionEditing ? (
                                    ...
                                    <>
                                        <div className="flex flex-row items-end">
                                            <button
                                                className="flex flex-row gap-1 items-center rounded-md border-[2px] border-solid border-[#9012FF]  bg-[#FFFFFF] p-6 justify-center"
                                                onClick={() => setShowDatepicker(true)}>
                                                <Image src="/icons/plus-sign.svg" height={18} width={18} alt="Plus Sign" />
                                        ...
                                        {showDatepicker && (
                                            <DatePicker
                                                ...
                                                onChange={(date) => {
                                                    const dateString = date ? date.toString() : "";
                                                    setSectionScheduleDate(dateString);
                                                    setShowDatepicker(false); // Hide after selecting date
                                                }}
                                            />
                                        )}
                                    </>
