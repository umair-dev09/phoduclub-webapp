...
function CourseContent() {
    ...
    return (
        <div className="flex flex-col gap-4 ">
            ...
            <div className="border border-solid border-[] bg-[#FFFFFF] rounded-md h-auto">
                <Collapsible
                    trigger={
                        <div className="flex flex-row justify-between items-center rounded-md p-4 w-full border border-solid border-[#EAECF0] bg-[#FFFFFF]">
                            <div className="flex flex-col gap-1">
                ...
                >
                    <div className="h-auto p-4 w-full">
                        <div className="h-[44px] flex flex-row justify-between bg-[#F2F4F7]">
