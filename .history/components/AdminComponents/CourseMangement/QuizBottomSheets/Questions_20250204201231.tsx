                        ...
                        >
                            <div className='h-auto bg-[#FFFFFF] flex flex-col pb-5 px-5 gap-2 rounded-br-md rounded-bl-md'>
                                ...
                                >
                                    <PopoverTrigger>
                                        <button
                                            className={`min-h-11 py-2 max-h-auto  px-3 items-center w-full justify-between flex flex-row rounded-md border border-solid ${isActive(index)
                                    ...
                                    <PopoverContent className="px-0 w-[60.813rem] rounded-md border border-solid border-[#EAECF0] bg-[#FFFFFF] flex flex-col pt-[8px] shadow-lg">
                                        ...
                                        {(Object.keys(question.options) as Array<keyof Options>).map((optionKey) => (
                                            <div
                                                key={optionKey}
                                                className="flex flex-row justify-between w-full min-h-11 max-h-auto  my-1 items-center hover:bg-[#F2F4F7] px-2 cursor-pointer"
