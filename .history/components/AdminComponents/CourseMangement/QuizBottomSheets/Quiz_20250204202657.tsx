...
function Quiz({ isOpen, toggleDrawer, courseId, sectionId, isEditing, contentId }: QuizProps) {
    ...
    useEffect(() => {
        const handleKeyPress = (event: KeyboardEvent) => {
            ...
            if (event.key === "Enter" && !isNextButtonDisabled && !isQuillFocused && isSaveValid) {
        ...
        isOpen,
        isSaveValid,
        handleNextClick,  // Ensure latest function reference
        handleSaveClick,   // Ensure latest function reference
    ]);
