...
// Changed from using new Date(dateString)
const formatScheduleDate = (date: CalendarDate | null): string => {
    if (!date) return "-";

    try {
        // Now directly using CalendarDate properties
                                                ...
                                                <Calendar
                                                    onChange={(date: CalendarDate) => {
                                                        ...
                                                        setSelectedDateTime(prev => ({
                                                            ...prev,
                                                            date: date,  // Store the full CalendarDate object
                                                            timestamp: timestamp
                                                        }));

                                                        // Convert CalendarDate to string explicitly
