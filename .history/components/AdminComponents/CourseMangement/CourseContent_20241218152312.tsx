                        ...
                        <div className="flex flex-col relative gap-6">
                            ...
                            <div className="flex flex-col w-full gap-2 px-6 mb-2">
                                ...
                                <Calendar
                                    ...
                                    onChange={(value) => {
                                        // Create a Date object from the selected calendar value
                                        const date = new Date(value.year, value.month - 1, value.day); // Adjust for zero-based month index
                                        setSectionScheduleDate(prev => ({ ...prev, date })); // Update the date in the state
                                    }}
                                />

                                {/* Time Selection Dropdown */}
                                <div className="mt-4">
                                    <label htmlFor="timePicker" className="text-sm font-medium">Select Time:</label>
                                    <select
                                        id="timePicker"
                                        className="border border-gray-300 rounded-md p-2 w-full"
                                        onChange={(e) => {
                                            const selectedTime = e.target.value;
                                            setSectionScheduleDate((prev) => ({
                                                ...prev,
                                                time: selectedTime,
                                    ...
                                    >
                                        ...
                                        {Array.from({ length: 24 }, (_, hour) =>
                                            Array.from({ length: 60 / 15 }, (_, quarter) => {
