...
function ResumeQuiz({ open, onClose }: ResumeQuizProps) { // Use the interface
    return (
        ...
        //                     <button className="py-[0.625rem] px-6 border-[1.5px] border-lightGrey  hover:bg-[#F2F4F7] rounded-md font-semibold text-sm" onClick={onClose}>Cancel</button>
                ...
                <DialogPanel transition className="bg-white rounded-2xl w-[480px] h-auto">
                    <div className="flex flex-col gap-2 p-6">
                        <div className="flex flex-row justify-between items-center ">
                            <h3 className=" font-bold task-[#1D2939]">Live Quiz</h3>
                            <button className="w-[32px] h-[32px]  rounded-full flex items-center justify-center transition-all duration-300 ease-in-out hover:bg-[#F2F4F7] ">
                        ...
                        <p className=" text-sm font-normal text-[#667085]">Are you sure you want to live this quiz?</p>
                    </div>
                    <hr />
                    <div className="flex flex-row justify-end mx-6 my-4 gap-4">
