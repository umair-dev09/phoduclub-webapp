                ...
                <DialogPanel transition className="bg-white rounded-2xl w-[480px] h-auto">
                    <div className="flex flex-col relative">
                        ...
                        <div className="flex flex-row justify-end mx-6 my-4 gap-4">
                            <button className="py-[0.625rem] px-6 border-[1.5px] border-solid border-[#EAECF0] font-semibold text-sm  rounded-md" onClick={onClose}>Cancel</button>
                            <button className="py-[0.625rem] px-6 text-[#FFFFFF] shadow-inner-button bg-[#BB241A] border border-[#DE3024] text-sm font-semibold rounded-md">Pause Quiz</button>
                        </div>
                    </div>
                </DialogPanel>
            </div>
