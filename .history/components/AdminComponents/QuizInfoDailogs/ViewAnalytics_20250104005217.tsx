...
function ViewAnalytics({ open, onClose }: ViewAnalyticsProps) { // Use the interface
    return (
        ...
        //                 <button className="py-[0.625rem] px-6 border-[1.5px] border-lightGrey font-semibold hover:bg-[#F2F4F7] rounded-md" onClick={onClose}>Cancel</button>
        //                 <button className="py-[0.625rem] px-6 text-white shadow-inner-button bg-[#8501FF] font-semibold border border-[#9012FF] rounded-md">View quiz details</button>
        //             </div>
