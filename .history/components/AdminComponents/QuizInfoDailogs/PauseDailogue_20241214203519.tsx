...
function PausedDDialog({ onClose }: PausedDialogProps) { // Use the interface
    return (
        ...
        //                     <button className="py-[0.625rem] px-6 border-[1.5px] border-lightGrey  hover:bg-[#F2F4F7] font-semibold text-sm rounded-md" onClick={onClose}>Cancel</button>
        //                     <button className="py-[0.625rem] px-6 text-white shadow-inner-button bg-[#BB241A] border border-[#DE3024]  font-semibold text-sm rounded-md">Pause Quiz</button>
        //                 </div>
        //             </div>
        //         </DialogPanel>
        //     </div>
