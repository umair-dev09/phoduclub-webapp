    ...
    return (
        <div className={`flex flex-col relative transition-all duration-[500ms] ease-in-out ${isCollapsed ? 'w-[3.5rem]' : 'w-[16rem]'} pl-2 py-[0.625rem] bg-[#131313]`}>
            ...
            {isCollapsed && (
                ...
                >
                    <button
                        onClick={() => handleTabClick('userdatabase', '/admin/userdatabase')}
                        className={`relative group flex items-center w-full h-10 py-2 px-3 text-left rounded-md mb-2 transition-colors ${activeTab === 'userdatabase'
                            ? 'bg-[#444444] text-white'
                            : 'hover:bg-[#e1ffe11a] text-[#AAAAAA]'
                            }`}
                    >
                        <span className="ml-1 font-medium text-base">U</span>
                    </button>
                </Tooltip>
            )}

            {/* Render without tooltip when not collapsed */}
            {!isCollapsed && (
                <button
                    onClick={() => handleTabClick('userdatabase', '/admin/userdatabase')}
                    className={`relative group flex items-center w-full h-10 py-2 px-3 text-left rounded-md mb-2 transition-colors ${activeTab === 'userdatabase'
                ...
                >
                    <span className="ml-7 text-[0.813rem]">User Database</span>
                </button>
            )}
