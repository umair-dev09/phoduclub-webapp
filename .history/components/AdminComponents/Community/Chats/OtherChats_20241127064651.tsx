                    ...
                    <div className='w-fit'>
                        <Popover
                            ...
                            <PopoverContent className='flex flex-col bg-[#FFFFFF] px-0 w-auto h-auto border border-[#EAECF0] rounded-md shadow-md '>
                                ...
                                {/* Other options */}
                                <button className='flex flex-row items-center gap-2 px-4 py-[10px] h-10 text-left w-full
                                ...
                                <button className='flex flex-row items-center gap-2  px-4  h-10 text-left transition-colors hover:bg-neutral-100'>
                                    <Image src='/icons/copy.svg' alt='search icon' width={20} height={20} />
                                    <span className='font-normal text-[#0C111D] text-sm'>Copy</span>
                                </button>
                                <button className='flex flex-row items-center gap-2   h-10 text-left px-4 py-[10px] transition-colors hover:bg-neutral-100'>
                                ...
                                <button className='flex flex-row items-center gap-2 px-4 py-[10px]  h-10 text-left transition-colors hover:bg-neutral-100 rounded-br-md rounded-bl-md'>
