    ...
    <ModalContent>
        <>
            ...
            <ModalFooter className="border-t border-lightGrey">
                ...
                <Button
                    className={`py-[0.625rem] px-6 text-white shadow-inner-button font-semibold rounded-md transition-all duration-200 bg-[#8501FF] border border-[#9012FF] hover:bg-[#7001CF]
                            ${isAddMembersButtonDisabled
                            ? 'cursor-not-allowed opacity-35'
                            : 'opacity-100'
                        }`}
