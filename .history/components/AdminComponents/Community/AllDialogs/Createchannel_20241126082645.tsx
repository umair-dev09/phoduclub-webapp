...
const MIN_HEIGHT = 32;  // Minimum height in pixels
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="border border-solid bg-[#FCFCFD] border-[#D0D5DD] h-auto w-full rounded-md flex flex-row items-center p-2 justify-between">
                                <textarea
                                    ...
                                    className="w-full bg-[#FCFCFD] resize-none px-3 rounded-md outline-none font-normal text-sm leading-tight pt-[5px]"
