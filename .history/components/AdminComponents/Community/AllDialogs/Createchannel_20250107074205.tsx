                ...
                <ModalContent>
                    <>
                        ...
                        <ModalFooter className="border-t border-lightGrey">
                            ...
                            <Button className={`py-[0.625rem] px-6 text-white text-sm shadow-inner-button font-semibold border border-solid  border-white ${!isFormValid ? "bg-[#CDA0FC] cursor-not-allowed" : " hover:bg-[#6D0DCC] bg-[#9012FF]"} rounded-md`} onClick={handleCreateChannel}>Create Channel</Button>
                        </ModalFooter>
                    </>
                </ModalContent>
            </Modal >
