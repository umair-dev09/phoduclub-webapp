                    ...
                    <div className=' flex flex-col p-6 gap-6 border-solid border-[#EAECF0] border-b rounded-t-2xl'>
                        ...
                        <div className="flex flex-col items-center gap-2">
                            <Image
                                ...
                                height={120}
                                alt="upload-image" />
                            <button className="border-2 border-solid border-[#EAECF0] gap-1 flex flex-row justify-center w-[111px] h-[36px] rounded-md hover:bg-[#EAECF0]">
                                <Image
                                    src="/icons/edit-02.svg"
                                    width={18}
                                    height={18}
                                    alt="edit-icon" />
                                <p className="text-sm text-[#1D2939] font-semibold flex items-center">Change</p>
                            </button>
                        </div>
