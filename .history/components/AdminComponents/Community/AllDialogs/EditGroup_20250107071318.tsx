            ...
            <ModalContent>
                <>
                    ...
                    <ModalFooter className="border-t border-lightGrey">
                        ...
                        <Button className={`py-[0.625rem] px-6 text-white text-sm shadow-inner-button font-semibold ${!isFormValid ? "bg-[#CDA0FC] cursor-not-allowed" : "bg-[#9012FF]  border border-solid hover:bg-[#6D0DCC]  border-[#9012FF]"} rounded-md`} onClick={handleCreateGroup}>Save Changes</Button>
                    </ModalFooter>
                </>
            </ModalContent>
        </Modal >
