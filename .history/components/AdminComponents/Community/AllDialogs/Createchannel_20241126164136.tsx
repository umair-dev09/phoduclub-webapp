                        ...
                        <div className=' flex flex-col p-6 gap-4 border-solid border-[#EAECF0] border-b rounded-t-2xl'>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex flex-row gap-2">
                                    <RadioGroup className="ml-6 mb-2" value={selectedValue} onChange={onChange}>
                                        <FormControlLabel
                                            ...
                                            label={<h3 className="text-base font-normal">{label}</h3>} // Replace label as needed
                                        />
                                    </RadioGroup>
                                    <span className="text-sm text-[#182230] font-normal">All users</span>
                                    <span className="text-sm text-[#182230] font-normal">Premium users</span>
                                </div>
