            ...
            <ModalContent>
                <>
                    ...
                    <ModalFooter className="border-t border-lightGrey">
                        ...
                        <Button className={`py-[0.625rem] px-6 text-white text-sm shadow-inner-button font-semibold ${!isFormValid ? "bg-[#CDA0FC] cursor-not-allowed" : "bg-[#9012FF] hover:bg-[#F2F4F7] border border-solid  border-[#9012FF]"} rounded-md`} onClick={handleCreateGroup}>Create Group</Button>
                    </ModalFooter>
                </>
            </ModalContent>
        </Modal >
