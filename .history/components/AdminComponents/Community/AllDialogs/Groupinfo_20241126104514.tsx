                    ...
                    <div className=' flex flex-col p-6 gap-2 border-solid border-[#EAECF0] border-b rounded-t-2xl'>
                        ...
                        <div className="flex flex-row items-center  justify-between group gap-2  mb-1">
                            ...
                            <Popover placement="bottom-end">
                                ...
                                <PopoverContent className="w-auto py-0 px-0 bg-white rounded-md  shadow-md flex flex-col border border-solid border-[#EAECF0]">
                                    <button className="px-2  gap-2 flex flex-row justify-center items-center  h-[36px] rounded-md hover:bg-[#EAECF0]"
