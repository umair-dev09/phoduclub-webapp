    ...
    return (
        <div>
                ...
                <div className="fixed inset-0 flex items-center justify-center">
                    <DialogPanel className="bg-white rounded-2xl w-[568px] h-auto flex flex-col ">
                        ...
                        <div className="flex flex-row justify-end mx-6 my-4 gap-4">
                            ...
                            <button className={`py-[0.625rem] px-6 text-white text-sm shadow-inner-button font-semibold ${uniqueIDfordesc ? "bg-[#9012FF]  border border-solid  border-[#9012FF]" : "bg-[#CDA0FC] cursor-not-allowed"} rounded-md`} onClick={handleCreateChannelClick}>Create Channel</button>
                        </div>
                    </DialogPanel>
                </div >
            </Dialog >
            <Dialog open={open2} onClose={handleCloseAll} className="relative z-50">
                ...
                <div className="fixed inset-0 flex items-center justify-center">
                    <DialogPanel className="bg-white rounded-2xl w-[568px] h-auto flex flex-col ">
                        <div className=' flex flex-col p-6 gap-4 border-solid border-[#EAECF0] border-b rounded-t-2xl'>
                            <div className='flex flex-row justify-between items-center'>
                                <h1 className='text-[#1D2939] font-bold text-lg'>Create Channel</h1>
                                <Image src="/icons/cancel.svg" alt="Cancel" width={20} height={20} onClick={handleCloseAll} />
                            </div>
                            <h3 className="font-semibold text-lg text-[#1D2939]">Add Users</h3>
                            <div className="flex flex-col">
                                <p className="font-medium text-sm text-[#1D2939]">Channel Type</p>
                                <div className="flex flex-row gap-2">
                                    <RadioGroup>
                                        <FormControlLabel
                                            value="radioValue" // Replace with your desired value
                                            control={
                                                <Radio
                                                    sx={{
                                                        color: '#D0D5DD', // Default border color when unchecked
                                                        '&.Mui-checked': {
                                                            color: '#9012FF', // Outer border color when checked
                                                        },
                                                        '& .MuiSvgIcon-root': {
                                                            '& circle': { // Target the circle inside the SVG
                                                                fill: '#FFFFFF', // White inner circle when checked
                                                                fontSize: '16px', // Adjust the size of the radio button
                                            ...
                                            label={
                                                <span className="text-sm text-[#182230] font-normal">
                                                    All users
                                                </span>
                                            }
                                        />
                                                ...
                                                <Radio
                                                    sx={{
                                                        ...
                                                        '& .MuiSvgIcon-root': {
                                                            '& circle': { // Target the circle inside the SVG
                                                                fill: '#FFFFFF', // White inner circle when checked
                                                                fontSize: '14px', // Adjust the size of the radio button
                                                                width: '18px', // Custom width
                                                                height: '16px', // Custom height
                                                            },
                                                        },
