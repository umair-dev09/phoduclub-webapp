...
//     return (
//         <div className="absolute bottom-8 z-auto flex flex-row items-center p-4 gap-4 bg-white border border-[#D0D5DD] rounded-xl shadow-[4px_8px_13px_0_rgba(0,0,0,0.05), 4px_4px_12px_0_rgba(0,0,0,0.05), 4px_8px_14px_0_rgba(0,0,0,0.04)]">
...
// // GroupInfo Component
// const GroupInfo: React.FC<GroupInfoProps> = ({ open, onClose }) => {
...
//                         transition
//                     >
//                         <div className="flex flex-col relative bg-white rounded-2xl w-[38.375rem] h-auto overflow-hidden" >
