    ...
    return (
        <div>
            ...
            <Dialog open={open1} onClose={handleCloseAll} className="relative z-50">
                ...
                <div className="fixed inset-0 flex items-center justify-center">
                    <DialogPanel className="bg-white rounded-2xl w-[568px] h-auto flex flex-col">
                        ...
                        <button onClick={handleCreateChannelClick}>Next</button> {/* Transition */}
                    </DialogPanel>
                </div>
            </Dialog>
            ...
            <Dialog open={open2} onClose={handleCloseAll} className="relative z-50">
                ...
                <div className="fixed inset-0 flex items-center justify-center">
                    <DialogPanel className="bg-white rounded-2xl w-[568px] h-auto flex flex-col">
                        <h1 className='text-[#1D2939] font-bold text-lg'>Confirm Details</h1>
                        {/* Additional content */}
        ...
        //                         <h1 className='text-[#1D2939] font-bold text-lg'>Create Channel</h1>
        //                         <Image src="/icons/cancel.svg" alt="Cancel" width={20} height={20} onClick={() => setOpen1(false)} />
        //                     </div>
        ...
        //                     <button className="py-[0.625rem] px-6 border-2  border-solid border-[#EAECF0] font-semibold text-sm text-[#1D2939] rounded-md" onClick={() => setOpen1(false)} >Cancel</button>
        //                     <button className={`py-[0.625rem] px-6 text-white text-sm shadow-inner-button font-semibold ${uniqueIDfordesc ? "bg-[#9012FF]  border border-solid  border-[#9012FF]" : "bg-[#CDA0FC] cursor-not-allowed"} rounded-md`} onClick={() => setOpen2(true)}>Create Channel</button>
        //                 </div>
        //             </DialogPanel>
        //         </div >
        //     </Dialog >
