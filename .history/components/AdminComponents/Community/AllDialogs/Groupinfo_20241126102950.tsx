                    ...
                    <div className=' flex flex-col p-6 gap-2 border-solid border-[#EAECF0] border-b rounded-t-2xl'>
                        ...
                        <div className="flex flex-row items-center  justify-between group gap-2 ">
                            ...
                            <Popover placement="bottom-end">
                                ...
                                <PopoverContent className="border-2 border-solid border-[#EAECF0] gap-2 flex flex-row justify-center items-center w-[111px] h-[36px] rounded-md hover:bg-[#EAECF0]">
