                                ...
                                <PopoverContent className="w-auto py-1 px-0 bg-white border border-lightGrey rounded-md flex flex-col">
                                    <button className="border-2 border-solid border-[#EAECF0] gap-2 flex flex-row justify-center items-center w-[111px] h-[36px] rounded-md hover:bg-[#EAECF0]">
                                        <Image
                                            ...
                                            height={18}
                                            alt="edit-icon" />
                                        <p className="text-sm text-[#1D2939] font-semibold">Edit Details</p>
                                    </button>

                                </PopoverContent>
                            </Popover>
                        </div>
                        <span className='text-[#667085] font-normal text-sm'>Lorem ipsum is placeholder text commonly Lorem ipsum dolor sit amet consectetur, adipisicing elit. Corporis, minima sunt! Rerum, quisquam doloribus odit ratione aliquid provident adipisci cum cumque et velit labore saepe sint illum qui. Ducimus, aut? used</span>
                    </div>
