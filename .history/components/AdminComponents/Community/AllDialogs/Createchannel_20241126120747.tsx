...
function createchannel({ open, onClose }: createchannelProps) {
    ...
    const handleCreateChannel = () => {
        if (channelName.trim()) {
            ...
            setCurrentDialog("addMembers");  // Switch dialog
        }
    };
                        ...
                        <DialogPanel className="bg-white rounded-2xl w-[568px] h-auto flex flex-col ">
                            <div className=' flex flex-col p-6 gap-6 border-solid border-[#EAECF0] border-b rounded-t-2xl'>
                                <div className='flex flex-row justify-between items-center'>
                                    ...
                                    <Image src="/icons/cancel.svg" alt="Cancel" width={20} height={20} onClick={handleDialogClose} />
                                </div>
                            ...
                            <div className="flex flex-row justify-end mx-6 my-4 gap-4">
                                <button className="py-[0.625rem] px-6 border-2  border-solid border-[#EAECF0] font-semibold text-sm text-[#1D2939] rounded-md" onClick={handleDialogClose}  >Cancel</button>
                                <button className={`py-[0.625rem] px-6 text-white text-sm shadow-inner-button font-semibold ${uniqueIDfordesc ? "bg-[#9012FF]  border border-solid  border-[#9012FF]" : "bg-[#CDA0FC] cursor-not-allowed"} rounded-md`} onClick={handleCreateChannel}>Create Channel</button>
                            </div>
                        </DialogPanel>
                    </div >
                </Dialog >
