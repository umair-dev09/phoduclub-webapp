...
function TabComps() {
    ...
    return (
        <div className={`flex flex-col relative transition-all duration-[500ms] ease-in-out ${isCollapsed ? 'w-[3.5rem]' : 'w-[16rem]'} pl-2 py-[0.625rem] bg-[#131313]`}>
            ...
            {renderButtonWithTooltip('User Database', '/icons/community-2.svg', '/icons/community.svg', activeTab === 'User Database', () => handleTabClick('userdatabase', '/admin/userdatabase'))}
        </div>
    );
}
