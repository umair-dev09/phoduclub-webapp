    ...
    return (
        <div className={`flex flex-col relative transition-all duration-[500ms] ease-in-out ${isCollapsed ? 'w-[3.5rem]' : 'w-[16rem]'} pl-2 py-[0.625rem] bg-[#131313]`}>
            ...
            >
                ...
                {renderButtonWithTooltip('Quizzes Management', '/icons/quizzes-management.svg', '/icons/quizzes-management.svg', activeTab === 'quizzesmanagement', () => handleTabClick('quizzesmanagement', '/admin/content/quizzesmanagement'))}

                {/* Test Series Management Button */}
                {renderButtonWithTooltip('Test Series Management', '/icons/test-series-management.svg', '/icons/test-series-management.svg', activeTab === 'testseriesmanagement', () => handleTabClick('testseriesmanagement', '/admin/content/testseriesmanagement'))}

                {/* Course Creation Button */}
                {renderButtonWithTooltip('Course Creation', '/icons/course-creation.svg', '/icons/course-creation.svg', activeTab === 'coursecreation', () => handleTabClick('coursecreation', '/admin/content/coursecreation'))}
            </Collapsible>
