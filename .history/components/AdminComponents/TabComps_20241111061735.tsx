            ...
            >
                ...
                <div className="relative group">
                    <button
                        ...
                        className={`flex items-center w-full h-10 py-2 px-3 text-left rounded-md mb-2 transition-colors ${activeTab === 'quizzesmanagement'
                ...
                <div className="relative group">
                    <button
                        ...
                        className={`flex items-center w-full h-10 py-2 px-3 text-left rounded-md mb-2 transition-colors ${activeTab === 'testseriesmanagement'
                                ? 'bg-[#444444] text-white'
                                : 'hover:bg-[#e1ffe11a] text-[#AAAAAA]'
                            }`}
                    >
                ...
                <div className="relative group">
                    <button
                        ...
                        className={`flex items-center w-full h-10 py-2 px-3 text-left rounded-md mb-2 transition-colors ${activeTab === 'coursecreation'
                                ? 'bg-[#444444] text-white'
                                : 'hover:bg-[#e1ffe11a] text-[#AAAAAA]'
                            }`}
                    >
