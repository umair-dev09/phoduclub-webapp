                    ...
                    <form onSubmit={(e) => e.preventDefault()} className="flex flex-col items-center justify-center gap-6 max-w-[420px] w-full">
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <div className="flex justify-center w-full mt-8">
                                ...
                                >
                                    {isLoading ? (
                                        <div className='w-5 h-5 animate-spin-loading rounded-[50%] shadow-inner-button border-4 border-[#ffffff4d] border-solid border-t-4 border-t-customWhite '></div> // Show spinner
                                    ) : (
