                                ...
                                <tr key={index} className="border-t border-solid border-[#EAECF0]">
                                    <td className="py-[12px]">
                                        <div className="flex flex-row ml-8 gap-[10px] min-w-[260px]">
                                            <Image className="rounded-full object-cover" src={user.profilePic || '/images/DP_Lion.svg'} alt="DP" width={38} height={38} />
                                            <div className="flex items-start justify-center flex-col mb-[2px]">
                                                <span className="font-semibold text-sm text-[#182230] whitespace-nowrap">{user.name || "phodu user"}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-8 py-4 text-start text-[#101828] text-sm ">
                                        <span className="flex min-w-fit">{user.userId || "phodu Id"}</span>
                                    </td>
                                    <td className="px-8 py-4 text-start text-[#101828] text-sm ">
