                                ...
                                <button className='flex flex-row items-center justify-between w-full px-2 py-2 mt-2 bg-white border border-lightGrey rounded-md'>
                                    ...
                                    <div className='flex flex-wrap gap-2'>
                                        {selectedYears.map((year) => (
                                            <div key={year} className='px-2 py-1 bg-[#E9D7FE] text-[#6941C6] rounded-full flex items-center gap-1'>
                                                {year}
                                                <button onClick={() => toggleYear(year)} className='text-[#6941C6]'>×</button>
                                            </div>
                                        ))}
                                    </div>
                        ...
                        <div className='flex flex-wrap gap-2'>
                            {selectedExams.map((exam) => (
                                <div key={exam} className='px-2 py-1 bg-[#E9D7FE] text-[#6941C6] rounded-full flex items-center gap-1'>
                                    {exam}
                                    <button onClick={() => toggleExam(exam)} className='text-[#6941C6]'>×</button>
                                </div>
                            ))}
                        </div>
                        <Popover placement='bottom-start'>
