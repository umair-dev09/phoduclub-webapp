          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-row justify-end p-4 gap-3">
              ...
              <button
                ...
                className={`py-2 px-7 text-white shadow-inner-button border border-white ${
                  isSaveButtonDisabled ? 'bg-[#CDA0FC]' : 'bg-[#9012FF]'
          ...
          <div className='flex flex-col w-full gap-1'>
              ...
              <div className="flex flex-row justify-end mx-6 my-2 items-center gap-4 pb-2">
                ...
                <button
                  ...
                  className={`py-[0.625rem] px-6 text-white shadow-inner-button border border-white ${
                    !isDoneWithQuestionDetailsButton ? 'bg-[#CDA0FC]' : 'bg-[#9012FF]'
                  } rounded-md font-semibold text-sm`}
                >
                  Done
                </button>
