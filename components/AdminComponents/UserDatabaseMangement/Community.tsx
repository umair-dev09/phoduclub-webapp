    ...
    return (
       ...
       <div className="flex flex-row gap-3 border-b border-solid border-[#EAECF0] p-8">
                     ...
                     <div className="flex items-start flex-col justify-center">
                         <div className="font-semibold text-[#1D2939] text-2xl">{userData.name}</div>
                         <div className="flex justify-start items-start text-[16px] font-medium text-[#667085]">{userData.userId}</div>
                     </div>
                 </div>
            ...
            <div className="border border-solid border-[#F7F8FB] rounded-xl h-auto px-8">
                ...
                {communities.map((community, index) => (
                    <Collapsible
                        ...
                        trigger={
                            <div
                                className={`h-[76px] w-full px-6 flex flex-row justify-between items-center border-t border-lightGrey transition-colors hover:bg-[#F9FAFB] ${
                                    isOpenArray[index] ? "" : "rounded-b-xl"
                                }`}
                    ...
                    >
                        <div className="rounded-lg h-auto border border-solid border-[#EAECF0] mx-6 mb-4">
                            {community.channels.map((channel, channelIndex) => (
                                <div
                                    key={channel.id}
                                    className={`flex flex-row h-[50px] hover:bg-[#F9FAFB] justify-between items-center p-6 ${
                                        channelIndex !== 0 ? "border-t border-solid border-[#EAECF0]" : ""
                                    }`}
                                >
                                    <div className="flex flex-row gap-2">
