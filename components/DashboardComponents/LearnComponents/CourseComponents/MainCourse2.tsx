...
function Main2() {
  ...
  return (
    <div className="flex flex-1 flex-row mx-4 gap-6 flex-wrap">
      {/* Start of Component */}
      <div className="flex items-center justify-center flex-col rounded-lg relative overflow-hidden transition-transform duration-300 w-[280px] h-auto">
