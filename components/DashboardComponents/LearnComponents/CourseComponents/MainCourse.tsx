...
function Main() {
    ...
    return (
        <div className="flex flex-1 flex-row">
            ...
            {/* ----------- Course Component ----------- */}
            {/* Main course container with flex layout and specified dimensions */}
            <div className="flex ml-2 w-[350px] items-center justify-center flex-col rounded-lg relative overflow-hidden transition-transform duration-300 ease-in-out h-[330px] mr-4">
