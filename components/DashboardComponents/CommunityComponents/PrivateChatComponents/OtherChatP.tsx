...
function OtherChatP({ message, currentUserId, isDeleted, highlightedText, messageType, fileUrl, fileName, isHighlighted, scrollToReply, fileSize, senderId, timestamp, pChatId, chatId, isReplying, replyingToId, replyingToChatId, replyingToFileName, replyingToFileUrl, replyingToMsg, replyingToMsgType, setShowReplyLayout, handleReply }: OtherChatProps) {
  ...
  return (
    <div className="w-full h-auto flex flex-col pr-[10%] ">
      ...
      {!isDeleted && (
        <div className="flex flex-row justify-start mt-1 gap-2 h-auto w-full flex-wrap">
